...
}`;function P0(n,e,t){let i=new bf;const r=new qe,s=new qe,a=new vt,o=new A0({depthPacking:cm}),l=new w0,c={},u=t.maxTextureSize,f={[ti]:Nt,[Nt]:ti,[Pn]:Pn},d=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:R0,fragmentShader:C0}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new Hn;x.setAttribute("position",new sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Dn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rf;let h=this.type;this.render=function(w,U,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const Z=n.getRenderTarget(),y=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),re=n.state;re.setBlending(jn),re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const J=h!==bn&&this.type===bn,ae=h===bn&&this.type!==bn;for(let P=0,V=w.length;P<V;P++){const z=w[P],B=z.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",z,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const K=B.getFrameExtents();if(r.multiply(K),s.copy(B.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/K.x),r.x=s.x*K.x,B.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/K.y),r.y=s.y*K.y,B.mapSize.y=s.y)),B.map===null||J===!0||ae===!0){const se=this.type!==bn?{minFilter:Ct,magFilter:Ct}:{};B.map!==null&&B.map.dispose(),B.map=new Si(r.x,r.y,se),B.map.texture.name=z.name+".shadowMap",B.camera.updateProjectionMatrix()}n.setRenderTarget(B.map),n.clear();const le=B.getViewportCount();for(let se=0;se<le;se++){const N=B.getViewport(se);a.set(s.x*N.x,s.y*N.y,s.x*N.z,s.y*N.w),re.viewport(a),B.updateMatrices(z,se),i=B.getFrustum(),T(U,R,B.camera,z,this.type)}B.isPointLightShadow!==!0&&this.type===bn&&b(B,R),B.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget(Z,y,A)};function b(w,U){const R=e.update(v);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Si(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,n.setRenderTarget(w.mapPass),n.clear(),n.renderBufferDirect(U,null,R,d,v,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,n.setRenderTarget(w.map),n.clear(),n.renderBufferDirect(U,null,R,m,v,null)}function E(w,U,R,Z){let y=null;const A=R.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)y=A;else if(y=R.isPointLight===!0?l:o,n.localClippingEnabled&&U.clipShadows===!0&&Array.isArray(U.clippingPlanes)&&U.clippingPlanes.length!==0||U.displacementMap&&U.displacementScale!==0||U.alphaMap&&U.alphaTest>0||U.map&&U.alphaTest>0){const re=y.uuid,J=U.uuid;let ae=c[re];ae===void 0&&(ae={},c[re]=ae);let P=ae[J];P===void 0&&(P=y.clone(),ae[J]=P),y=P}if(y.visible=U.visible,y.wireframe=U.wireframe,Z===bn?y.side=U.shadowSide!==null?U.shadowSide:U.side:y.side=U.shadowSide!==null?U.shadowSide:f[U.side],y.alphaMap=U.alphaMap,y.alphaTest=U.alphaTest,y.map=U.map,y.clipShadows=U.clipShadows,y.clippingPlanes=U.clippingPlanes,y.clipIntersection=U.clipIntersection,y.displacementMap=U.displacementMap,y.displacementScale=U.displacementScale,y.displacementBias=U.displacementBias,y.wireframeLinewidth=U.wireframeLinewidth,y.linewidth=U.linewidth,R.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const re=n.properties.get(y);re.light=R}return y}function T(w,U,R,Z,y){if(w.visible===!1)return;if(w.layers.test(U.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===bn)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,w.matrixWorld);const J=e.update(w),ae=w.material;if(Array.isArray(ae)){const P=J.groups;for(let V=0,z=P.length;V<z;V++){const B=P[V],K=ae[B.materialIndex];if(K&&K.visible){const le=E(w,K,Z,y);n.renderBufferDirect(R,null,J,le,w,B)}}}else if(ae.visible){const P=E(w,ae,Z,y);n.renderBufferDirect(R,null,J,P,w,null)}}const re=w.children;for(let J=0,ae=re.length;J<ae;J++)T(re[J],U,R,Z,y)}}function L0(n,e,t){const i=t.isWebGL2;function r(){let L=!1;const xe=new vt;let fe=null;const ee=new vt(0,0,0,0);return{setMask:function(he){fe!==he&&!L&&(n.colorMask(he,he,he,he),fe=he)},setLocked:function(he){L=he},setClear:function(he,Pe,Ke,ct,Wt){Wt===!0&&(he*=ct,Pe*=ct,Ke*=ct),xe.set(he,Pe,Ke,ct),ee.equals(xe)===!1&&(n.clearColor(he,Pe,Ke,ct),ee.copy(xe))},reset:function(){L=!1,fe=null,ee.set(-1,0,0,0)}}}function s(){let L=!1,xe=null,fe=null,ee=null;return{setTest:function(he){he?Ie(n.DEPTH_TEST):Je(n.DEPTH_TEST)},setMask:function(he){xe!==he&&!L&&(n.depthMask(he),xe=he)},setFunc:function(he){if(fe!==he){switch(he){case Bp:n.depthFunc(n.NEVER);break;case zp:n.depthFunc(n.ALWAYS);break;case Hp:n.depthFunc(n.LESS);break;case Fs:n.depthFunc(n.LEQUAL);break;case Gp:n.depthFunc(n.EQUAL);break;case Vp:n.depthFunc(n.GEQUAL);break;case Wp:n.depthFunc(n.GREATER);break;case kp:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}fe=he}},setLocked:function(he){L=he},setClear:function(he){ee!==he&&(n.clearDepth(he),ee=he)},reset:function(){L=!1,xe=null,fe=null,ee=null}}}function a(){let L=!1,xe=null,fe=null,ee=null,he=null,Pe=null,Ke=null,ct=null,Wt=null;return{setTest:function(nt){L||(nt?Ie(n.STENCIL_TEST):Je(n.STENCIL_TEST))},setMask:function(nt){xe!==nt&&!L&&(n.stencilMask(nt),xe=nt)},setFunc:function(nt,Tt,on){(fe!==nt||ee!==Tt||he!==on)&&(n.stencilFunc(nt,Tt,on),fe=nt,ee=Tt,he=on)},setOp:function(nt,Tt,on){(Pe!==nt||Ke!==Tt||ct!==on)&&(n.stencilOp(nt,Tt,on),Pe=nt,Ke=Tt,ct=on)},setLocked:function(nt){L=nt},setClear:function(nt){Wt!==nt&&(n.clearStencil(nt),Wt=nt)},reset:function(){L=!1,xe=null,fe=null,ee=null,he=null,Pe=null,Ke=null,ct=null,Wt=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let d={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,E=null,T=null,w=null,U=null,R=null,Z=null,y=new Ze(0,0,0),A=0,re=!1,J=null,ae=null,P=null,V=null,z=null;const B=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,le=0;const se=n.getParameter(n.VERSION);se.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(se)[1]),K=le>=1):se.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(se)[1]),K=le>=2);let N=null,G={};const _e=n.getParameter(n.SCISSOR_BOX),ge=n.getParameter(n.VIEWPORT),pe=new vt().fromArray(_e),ye=new vt().fromArray(ge);function Ue(L,xe,fe,ee){const he=new Uint8Array(4),Pe=n.createTexture();n.bindTexture(L,Pe),n.texParameteri(L,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(L,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ke=0;Ke<fe;Ke++)i&&(L===n.TEXTURE_3D||L===n.TEXTURE_2D_ARRAY)?n.texImage3D(xe,0,n.RGBA,1,1,ee,0,n.RGBA,n.UNSIGNED_BYTE,he):n.texImage2D(xe+Ke,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,he);return Pe}const Re={};Re[n.TEXTURE_2D]=Ue(n.TEXTURE_2D,n.TEXTURE_2D,1),Re[n.TEXTURE_CUBE_MAP]=Ue(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Re[n.TEXTURE_2D_ARRAY]=Ue(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Re[n.TEXTURE_3D]=Ue(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Ie(n.DEPTH_TEST),l.setFunc(Fs),ie(!1),te(Dl),Ie(n.CULL_FACE),H(jn);function Ie(L){d[L]!==!0&&(n.enable(L),d[L]=!0)}function Je(L){d[L]!==!1&&(n.disable(L),d[L]=!1)}function Ge(L,xe){return m[L]!==xe?(n.bindFramebuffer(L,xe),m[L]=xe,i&&(L===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=xe),L===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=xe)),!0):!1}function _(L,xe){let fe=v,ee=!1;if(L)if(fe=x.get(xe),fe===void 0&&(fe=[],x.set(xe,fe)),L.isWebGLMultipleRenderTargets){const he=L.texture;if(fe.length!==he.length||fe[0]!==n.COLOR_ATTACHMENT0){for(let Pe=0,Ke=he.length;Pe<Ke;Pe++)fe[Pe]=n.COLOR_ATTACHMENT0+Pe;fe.length=he.length,ee=!0}}else fe[0]!==n.COLOR_ATTACHMENT0&&(fe[0]=n.COLOR_ATTACHMENT0,ee=!0);else fe[0]!==n.BACK&&(fe[0]=n.BACK,ee=!0);ee&&(t.isWebGL2?n.drawBuffers(fe):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(fe))}function C(L){return p!==L?(n.useProgram(L),p=L,!0):!1}const I={[mi]:n.FUNC_ADD,[yp]:n.FUNC_SUBTRACT,[Tp]:n.FUNC_REVERSE_SUBTRACT};if(i)I[Fl]=n.MIN,I[Ol]=n.MAX;else{const L=e.get("EXT_blend_minmax");L!==null&&(I[Fl]=L.MIN_EXT,I[Ol]=L.MAX_EXT)}const W={[bp]:n.ZERO,[Ap]:n.ONE,[wp]:n.SRC_COLOR,[oa]:n.SRC_ALPHA,[Up]:n.SRC_ALPHA_SATURATE,[Lp]:n.DST_COLOR,[Cp]:n.DST_ALPHA,[Rp]:n.ONE_MINUS_SRC_COLOR,[aa]:n.ONE_MINUS_SRC_ALPHA,[Dp]:n.ONE_MINUS_DST_COLOR,[Pp]:n.ONE_MINUS_DST_ALPHA,[Ip]:n.CONSTANT_COLOR,[Np]:n.ONE_MINUS_CONSTANT_COLOR,[Fp]:n.CONSTANT_ALPHA,[Op]:n.ONE_MINUS_CONSTANT_ALPHA};function H(L,xe,fe,ee,he,Pe,Ke,ct,Wt,nt){if(L===jn){h===!0&&(Je(n.BLEND),h=!1);return}if(h===!1&&(Ie(n.BLEND),h=!0),L!==Ep){if(L!==b||nt!==re){if((E!==mi||U!==mi)&&(n.blendEquation(n.FUNC_ADD),E=mi,U=mi),nt)switch(L){case Ji:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFunc(n.ONE,n.ONE);break;case Il:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Ji:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Il:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}T=null,w=null,R=null,Z=null,y.set(0,0,0),A=0,b=L,re=nt}return}he=he||xe,Pe=Pe||fe,Ke=Ke||ee,(xe!==E||he!==U)&&(n.blendEquationSeparate(I[xe],I[he]),E=xe,U=he),(fe!==T||ee!==w||Pe!==R||Ke!==Z)&&(n.blendFuncSeparate(W[fe],W[ee],W[Pe],W[Ke]),T=fe,w=ee,R=Pe,Z=Ke),(ct.equals(y)===!1||Wt!==A)&&(n.blendColor(ct.r,ct.g,ct.b,Wt),y.copy(ct),A=Wt),b=L,re=!1}function Y(L,xe){L.side===Pn?Je(n.CULL_FACE):Ie(n.CULL_FACE);let fe=L.side===Nt;xe&&(fe=!fe),ie(fe),L.blending===Ji&&L.transparent===!1?H(jn):H(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),l.setFunc(L.depthFunc),l.setTest(L.depthTest),l.setMask(L.depthWrite),o.setMask(L.colorWrite);const ee=L.stencilWrite;c.setTest(ee),ee&&(c.setMask(L.stencilWriteMask),c.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),c.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Q(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Ie(n.SAMPLE_ALPHA_TO_COVERAGE):Je(n.SAMPLE_ALPHA_TO_COVERAGE)}function ie(L){J!==L&&(L?n.frontFace(n.CW):n.frontFace(n.CCW),J=L)}function te(L){L!==xp?(Ie(n.CULL_FACE),L!==ae&&(L===Dl?n.cullFace(n.BACK):L===Mp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Je(n.CULL_FACE),ae=L}function oe(L){L!==P&&(K&&n.lineWidth(L),P=L)}function Q(L,xe,fe){L?(Ie(n.POLYGON_OFFSET_FILL),(V!==xe||z!==fe)&&(n.polygonOffset(xe,fe),V=xe,z=fe)):Je(n.POLYGON_OFFSET_FILL)}function Me(L){L?Ie(n.SCISSOR_TEST):Je(n.SCISSOR_TEST)}function M(L){L===void 0&&(L=n.TEXTURE0+B-1),N!==L&&(n.activeTexture(L),N=L)}function g(L,xe,fe){fe===void 0&&(N===null?fe=n.TEXTURE0+B-1:fe=N);let ee=G[fe];ee===void 0&&(ee={type:void 0,texture:void 0},G[fe]=ee),(ee.type!==L||ee.texture!==xe)&&(N!==fe&&(n.activeTexture(fe),N=fe),n.bindTexture(L,xe||Re[L]),ee.type=L,ee.texture=xe)}function D(){const L=G[N];L!==void 0&&L.type!==void 0&&(n.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function j(){try{n.compressedTexImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function $(){try{n.compressedTexImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ne(){try{n.texSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ve(){try{n.texSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function de(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Te(){try{n.texStorage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ke(){try{n.texStorage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ue(){try{n.texImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ne(){try{n.texImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ae(L){pe.equals(L)===!1&&(n.scissor(L.x,L.y,L.z,L.w),pe.copy(L))}function Ce(L){ye.equals(L)===!1&&(n.viewport(L.x,L.y,L.z,L.w),ye.copy(L))}function we(L,xe){let fe=f.get(xe);fe===void 0&&(fe=new WeakMap,f.set(xe,fe));let ee=fe.get(L);ee===void 0&&(ee=n.getUniformBlockIndex(xe,L.name),fe.set(L,ee))}function Ee(L,xe){const ee=f.get(xe).get(L);u.get(xe)!==ee&&(n.uniformBlockBinding(xe,ee,L.__bindingPointIndex),u.set(xe,ee))}function Ye(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},N=null,G={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,E=null,T=null,w=null,U=null,R=null,Z=null,y=new Ze(0,0,0),A=0,re=!1,J=null,ae=null,P=null,V=null,z=null,pe.set(0,0,n.canvas.width,n.canvas.height),ye.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Ie,disable:Je,bindFramebuffer:Ge,drawBuffers:_,useProgram:C,setBlending:H,setMaterial:Y,setFlipSided:ie,setCullFace:te,setLineWidth:oe,setPolygonOffset:Q,setScissorTest:Me,activeTexture:M,bindTexture:g,unbindTexture:D,compressedTexImage2D:j,compressedTexImage3D:$,texImage2D:ue,texImage3D:Ne,updateUBOMapping:we,uniformBlockBinding:Ee,texStorage2D:Te,texStorage3D:ke,texSubImage2D:ne,texSubImage3D:ve,compressedTexSubImage2D:ce,compressedTexSubImage3D:de,scissor:Ae,viewport:Ce,reset:Ye}}function D0(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),x=new WeakMap;let v;const p=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(M,g){return h?new OffscreenCanvas(M,g):Vs("canvas")}function E(M,g,D,j){let $=1;if((M.width>j||M.height>j)&&($=j/Math.max(M.width,M.height)),$<1||g===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const ne=g?Gs:Math.floor,ve=ne($*M.width),ce=ne($*M.height);v===void 0&&(v=b(ve,ce));const de=D?b(ve,ce):v;return de.width=ve,de.height=ce,de.getContext("2d").drawImage(M,0,0,ve,ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+ve+"x"+ce+")."),de}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function T(M){return pa(M.width)&&pa(M.height)}function w(M){return o?!1:M.wrapS!==Qt||M.wrapT!==Qt||M.minFilter!==Ct&&M.minFilter!==Xt}function U(M,g){return M.generateMipmaps&&g&&M.minFilter!==Ct&&M.minFilter!==Xt}function R(M){n.generateMipmap(M)}function Z(M,g,D,j,$=!1){if(o===!1)return g;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ne=g;if(g===n.RED&&(D===n.FLOAT&&(ne=n.R32F),D===n.HALF_FLOAT&&(ne=n.R16F),D===n.UNSIGNED_BYTE&&(ne=n.R8)),g===n.RED_INTEGER&&(D===n.UNSIGNED_BYTE&&(ne=n.R8UI),D===n.UNSIGNED_SHORT&&(ne=n.R16UI),D===n.UNSIGNED_INT&&(ne=n.R32UI),D===n.BYTE&&(ne=n.R8I),D===n.SHORT&&(ne=n.R16I),D===n.INT&&(ne=n.R32I)),g===n.RG&&(D===n.FLOAT&&(ne=n.RG32F),D===n.HALF_FLOAT&&(ne=n.RG16F),D===n.UNSIGNED_BYTE&&(ne=n.RG8)),g===n.RGBA){const ve=$?Os:et.getTransfer(j);D===n.FLOAT&&(ne=n.RGBA32F),D===n.HALF_FLOAT&&(ne=n.RGBA16F),D===n.UNSIGNED_BYTE&&(ne=ve===rt?n.SRGB8_ALPHA8:n.RGBA8),D===n.UNSIGNED_SHORT_4_4_4_4&&(ne=n.RGBA4),D===n.UNSIGNED_SHORT_5_5_5_1&&(ne=n.RGB5_A1)}return(ne===n.R16F||ne===n.R32F||ne===n.RG16F||ne===n.RG32F||ne===n.RGBA16F||ne===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function y(M,g,D){return U(M,D)===!0||M.isFramebufferTexture&&M.minFilter!==Ct&&M.minFilter!==Xt?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function A(M){return M===Ct||M===Bl||M===xo?n.NEAREST:n.LINEAR}function re(M){const g=M.target;g.removeEventListener("dispose",re),ae(g),g.isVideoTexture&&x.delete(g)}function J(M){const g=M.target;g.removeEventListener("dispose",J),V(g)}function ae(M){const g=i.get(M);if(g.__webglInit===void 0)return;const D=M.source,j=p.get(D);if(j){const $=j[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&P(M),Object.keys(j).length===0&&p.delete(D)}i.remove(M)}function P(M){const g=i.get(M);n.deleteTexture(g.__webglTexture);const D=M.source,j=p.get(D);delete j[g.__cacheKey],a.memory.textures--}function V(M){const g=M.texture,D=i.get(M),j=i.get(g);if(j.__webglTexture!==void 0&&(n.deleteTexture(j.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(D.__webglFramebuffer[$]))for(let ne=0;ne<D.__webglFramebuffer[$].length;ne++)n.deleteFramebuffer(D.__webglFramebuffer[$][ne]);else n.deleteFramebuffer(D.__webglFramebuffer[$]);D.__webglDepthbuffer&&n.deleteRenderbuffer(D.__webglDepthbuffer[$])}else{if(Array.isArray(D.__webglFramebuffer))for(let $=0;$<D.__webglFramebuffer.length;$++)n.deleteFramebuffer(D.__webglFramebuffer[$]);else n.deleteFramebuffer(D.__webglFramebuffer);if(D.__webglDepthbuffer&&n.deleteRenderbuffer(D.__webglDepthbuffer),D.__webglMultisampledFramebuffer&&n.deleteFramebuffer(D.__webglMultisampledFramebuffer),D.__webglColorRenderbuffer)for(let $=0;$<D.__webglColorRenderbuffer.length;$++)D.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(D.__webglColorRenderbuffer[$]);D.__webglDepthRenderbuffer&&n.deleteRenderbuffer(D.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let $=0,ne=g.length;$<ne;$++){const ve=i.get(g[$]);ve.__webglTexture&&(n.deleteTexture(ve.__webglTexture),a.memory.textures--),i.remove(g[$])}i.remove(g),i.remove(M)}let z=0;function B(){z=0}function K(){const M=z;return M>=l&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+l),z+=1,M}function le(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function se(M,g){const D=i.get(M);if(M.isVideoTexture&&Q(M),M.isRenderTargetTexture===!1&&M.version>0&&D.__version!==M.version){const j=M.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ie(D,M,g);return}}t.bindTexture(n.TEXTURE_2D,D.__webglTexture,n.TEXTURE0+g)}function N(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Ie(D,M,g);return}t.bindTexture(n.TEXTURE_2D_ARRAY,D.__webglTexture,n.TEXTURE0+g)}function G(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Ie(D,M,g);return}t.bindTexture(n.TEXTURE_3D,D.__webglTexture,n.TEXTURE0+g)}function _e(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Je(D,M,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,D.__webglTexture,n.TEXTURE0+g)}const ge={[ua]:n.REPEAT,[Qt]:n.CLAMP_TO_EDGE,[fa]:n.MIRRORED_REPEAT},pe={[Ct]:n.NEAREST,[Bl]:n.NEAREST_MIPMAP_NEAREST,[xo]:n.NEAREST_MIPMAP_LINEAR,[Xt]:n.LINEAR,[Jp]:n.LINEAR_MIPMAP_NEAREST,[Br]:n.LINEAR_MIPMAP_LINEAR},ye={[hm]:n.NEVER,[xm]:n.ALWAYS,[dm]:n.LESS,[mm]:n.LEQUAL,[pm]:n.EQUAL,[vm]:n.GEQUAL,[_m]:n.GREATER,[gm]:n.NOTEQUAL};function Ue(M,g,D){if(D?(n.texParameteri(M,n.TEXTURE_WRAP_S,ge[g.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,ge[g.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,ge[g.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,pe[g.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,pe[g.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(g.wrapS!==Qt||g.wrapT!==Qt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,A(g.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,A(g.minFilter)),g.minFilter!==Ct&&g.minFilter!==Xt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,ye[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const j=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Ct||g.minFilter!==xo&&g.minFilter!==Br||g.type===Kn&&e.has("OES_texture_float_linear")===!1||o===!1&&g.type===zr&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||i.get(g).__currentAnisotropy)&&(n.texParameterf(M,j.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy)}}function Re(M,g){let D=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",re));const j=g.source;let $=p.get(j);$===void 0&&($={},p.set(j,$));const ne=le(g);if(ne!==M.__cacheKey){$[ne]===void 0&&($[ne]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,D=!0),$[ne].usedTimes++;const ve=$[M.__cacheKey];ve!==void 0&&($[M.__cacheKey].usedTimes--,ve.usedTimes===0&&P(g)),M.__cacheKey=ne,M.__webglTexture=$[ne].texture}return D}function Ie(M,g,D){let j=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(j=n.TEXTURE_3D);const $=Re(M,g),ne=g.source;t.bindTexture(j,M.__webglTexture,n.TEXTURE0+D);const ve=i.get(ne);if(ne.version!==ve.__version||$===!0){t.activeTexture(n.TEXTURE0+D);const ce=et.getPrimaries(et.workingColorSpace),de=g.colorSpace===Kt?null:et.getPrimaries(g.colorSpace),Te=g.colorSpace===Kt||ce===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);const ke=w(g)&&T(g.image)===!1;let ue=E(g.image,ke,!1,u);ue=Me(g,ue);const Ne=T(ue)||o,Ae=s.convert(g.format,g.colorSpace);let Ce=s.convert(g.type),we=Z(g.internalFormat,Ae,Ce,g.colorSpace,g.isVideoTexture);Ue(j,g,Ne);let Ee;const Ye=g.mipmaps,L=o&&g.isVideoTexture!==!0,xe=ve.__version===void 0||$===!0,fe=y(g,ue,Ne);if(g.isDepthTexture)we=n.DEPTH_COMPONENT,o?g.type===Kn?we=n.DEPTH_COMPONENT32F:g.type===Yn?we=n.DEPTH_COMPONENT24:g.type===vi?we=n.DEPTH24_STENCIL8:we=n.DEPTH_COMPONENT16:g.type===Kn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===xi&&we===n.DEPTH_COMPONENT&&g.type!==za&&g.type!==Yn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=Yn,Ce=s.convert(g.type)),g.format===ir&&we===n.DEPTH_COMPONENT&&(we=n.DEPTH_STENCIL,g.type!==vi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=vi,Ce=s.convert(g.type))),xe&&(L?t.texStorage2D(n.TEXTURE_2D,1,we,ue.width,ue.height):t.texImage2D(n.TEXTURE_2D,0,we,ue.width,ue.height,0,Ae,Ce,null));else if(g.isDataTexture)if(Ye.length>0&&Ne){L&&xe&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let ee=0,he=Ye.length;ee<he;ee++)Ee=Ye[ee],L?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Ae,Ce,Ee.data):t.texImage2D(n.TEXTURE_2D,ee,we,Ee.width,Ee.height,0,Ae,Ce,Ee.data);g.generateMipmaps=!1}else L?(xe&&t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,ue.width,ue.height,Ae,Ce,ue.data)):t.texImage2D(n.TEXTURE_2D,0,we,ue.width,ue.height,0,Ae,Ce,ue.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){L&&xe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,we,Ye[0].width,Ye[0].height,ue.depth);for(let ee=0,he=Ye.length;ee<he;ee++)Ee=Ye[ee],g.format!==en?Ae!==null?L?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,Ee.width,Ee.height,ue.depth,Ae,Ee.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ee,we,Ee.width,Ee.height,ue.depth,0,Ee.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?t.texSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,Ee.width,Ee.height,ue.depth,Ae,Ce,Ee.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ee,we,Ee.width,Ee.height,ue.depth,0,Ae,Ce,Ee.data)}else{L&&xe&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let ee=0,he=Ye.length;ee<he;ee++)Ee=Ye[ee],g.format!==en?Ae!==null?L?t.compressedTexSubImage2D(n.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Ae,Ee.data):t.compressedTexImage2D(n.TEXTURE_2D,ee,we,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Ae,Ce,Ee.data):t.texImage2D(n.TEXTURE_2D,ee,we,Ee.width,Ee.height,0,Ae,Ce,Ee.data)}else if(g.isDataArrayTexture)L?(xe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,we,ue.width,ue.height,ue.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,Ae,Ce,ue.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,we,ue.width,ue.height,ue.depth,0,Ae,Ce,ue.data);else if(g.isData3DTexture)L?(xe&&t.texStorage3D(n.TEXTURE_3D,fe,we,ue.width,ue.height,ue.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,Ae,Ce,ue.data)):t.texImage3D(n.TEXTURE_3D,0,we,ue.width,ue.height,ue.depth,0,Ae,Ce,ue.data);else if(g.isFramebufferTexture){if(xe)if(L)t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height);else{let ee=ue.width,he=ue.height;for(let Pe=0;Pe<fe;Pe++)t.texImage2D(n.TEXTURE_2D,Pe,we,ee,he,0,Ae,Ce,null),ee>>=1,he>>=1}}else if(Ye.length>0&&Ne){L&&xe&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let ee=0,he=Ye.length;ee<he;ee++)Ee=Ye[ee],L?t.texSubImage2D(n.TEXTURE_2D,ee,0,0,Ae,Ce,Ee):t.texImage2D(n.TEXTURE_2D,ee,we,Ae,Ce,Ee);g.generateMipmaps=!1}else L?(xe&&t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ae,Ce,ue)):t.texImage2D(n.TEXTURE_2D,0,we,Ae,Ce,ue);U(g,Ne)&&R(j),ve.__version=ne.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function Je(M,g,D){if(g.image.length!==6)return;const j=Re(M,g),$=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+D);const ne=i.get($);if($.version!==ne.__version||j===!0){t.activeTexture(n.TEXTURE0+D);const ve=et.getPrimaries(et.workingColorSpace),ce=g.colorSpace===Kt?null:et.getPrimaries(g.colorSpace),de=g.colorSpace===Kt||ve===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Te=g.isCompressedTexture||g.image[0].isCompressedTexture,ke=g.image[0]&&g.image[0].isDataTexture,ue=[];for(let ee=0;ee<6;ee++)!Te&&!ke?ue[ee]=E(g.image[ee],!1,!0,c):ue[ee]=ke?g.image[ee].image:g.image[ee],ue[ee]=Me(g,ue[ee]);const Ne=ue[0],Ae=T(Ne)||o,Ce=s.convert(g.format,g.colorSpace),we=s.convert(g.type),Ee=Z(g.internalFormat,Ce,we,g.colorSpace),Ye=o&&g.isVideoTexture!==!0,L=ne.__version===void 0||j===!0;let xe=y(g,Ne,Ae);Ue(n.TEXTURE_CUBE_MAP,g,Ae);let fe;if(Te){Ye&&L&&t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,Ee,Ne.width,Ne.height);for(let ee=0;ee<6;ee++){fe=ue[ee].mipmaps;for(let he=0;he<fe.length;he++){const Pe=fe[he];g.format!==en?Ce!==null?Ye?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he,0,0,Pe.width,Pe.height,Ce,Pe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he,Ee,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he,0,0,Pe.width,Pe.height,Ce,we,Pe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he,Ee,Pe.width,Pe.height,0,Ce,we,Pe.data)}}}else{fe=g.mipmaps,Ye&&L&&(fe.length>0&&xe++,t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,Ee,ue[0].width,ue[0].height));for(let ee=0;ee<6;ee++)if(ke){Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,ue[ee].width,ue[ee].height,Ce,we,ue[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ee,ue[ee].width,ue[ee].height,0,Ce,we,ue[ee].data);for(let he=0;he<fe.length;he++){const Ke=fe[he].image[ee].image;Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he+1,0,0,Ke.width,Ke.height,Ce,we,Ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he+1,Ee,Ke.width,Ke.height,0,Ce,we,Ke.data)}}else{Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ce,we,ue[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ee,Ce,we,ue[ee]);for(let he=0;he<fe.length;he++){const Pe=fe[he];Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he+1,0,0,Ce,we,Pe.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he+1,Ee,Ce,we,Pe.image[ee])}}}U(g,Ae)&&R(n.TEXTURE_CUBE_MAP),ne.__version=$.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function Ge(M,g,D,j,$,ne){const ve=s.convert(D.format,D.colorSpace),ce=s.convert(D.type),de=Z(D.internalFormat,ve,ce,D.colorSpace);if(!i.get(g).__hasExternalTextures){const ke=Math.max(1,g.width>>ne),ue=Math.max(1,g.height>>ne);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,ne,de,ke,ue,g.depth,0,ve,ce,null):t.texImage2D($,ne,de,ke,ue,0,ve,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,$,i.get(D).__webglTexture,0,te(g)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,$,i.get(D).__webglTexture,ne),t.bindFramebuffer(n.FRAMEBUFFER,null)}function _(M,g,D){if(n.bindRenderbuffer(n.RENDERBUFFER,M),g.depthBuffer&&!g.stencilBuffer){let j=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(D||oe(g)){const $=g.depthTexture;$&&$.isDepthTexture&&($.type===Kn?j=n.DEPTH_COMPONENT32F:$.type===Yn&&(j=n.DEPTH_COMPONENT24));const ne=te(g);oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ne,j,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,ne,j,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,j,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(g.depthBuffer&&g.stencilBuffer){const j=te(g);D&&oe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,g.width,g.height):oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const j=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let $=0;$<j.length;$++){const ne=j[$],ve=s.convert(ne.format,ne.colorSpace),ce=s.convert(ne.type),de=Z(ne.internalFormat,ve,ce,ne.colorSpace),Te=te(g);D&&oe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Te,de,g.width,g.height):oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Te,de,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,de,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function C(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),se(g.depthTexture,0);const j=i.get(g.depthTexture).__webglTexture,$=te(g);if(g.depthTexture.format===xi)oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0);else if(g.depthTexture.format===ir)oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function I(M){const g=i.get(M),D=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");C(g.__webglFramebuffer,M)}else if(D){g.__webglDepthbuffer=[];for(let j=0;j<6;j++)t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[j]),g.__webglDepthbuffer[j]=n.createRenderbuffer(),_(g.__webglDepthbuffer[j],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),_(g.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function W(M,g,D){const j=i.get(M);g!==void 0&&Ge(j.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),D!==void 0&&I(M)}function H(M){const g=M.texture,D=i.get(M),j=i.get(g);M.addEventListener("dispose",J),M.isWebGLMultipleRenderTargets!==!0&&(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=g.version,a.memory.textures++);const $=M.isWebGLCubeRenderTarget===!0,ne=M.isWebGLMultipleRenderTargets===!0,ve=T(M)||o;if($){D.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(o&&g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer[ce]=[];for(let de=0;de<g.mipmaps.length;de++)D.__webglFramebuffer[ce][de]=n.createFramebuffer()}else D.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(o&&g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer=[];for(let ce=0;ce<g.mipmaps.length;ce++)D.__webglFramebuffer[ce]=n.createFramebuffer()}else D.__webglFramebuffer=n.createFramebuffer();if(ne)if(r.drawBuffers){const ce=M.texture;for(let de=0,Te=ce.length;de<Te;de++){const ke=i.get(ce[de]);ke.__webglTexture===void 0&&(ke.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&oe(M)===!1){const ce=ne?g:[g];D.__webglMultisampledFramebuffer=n.createFramebuffer(),D.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let de=0;de<ce.length;de++){const Te=ce[de];D.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,D.__webglColorRenderbuffer[de]);const ke=s.convert(Te.format,Te.colorSpace),ue=s.convert(Te.type),Ne=Z(Te.internalFormat,ke,ue,Te.colorSpace,M.isXRRenderTarget===!0),Ae=te(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ae,Ne,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,D.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(D.__webglDepthRenderbuffer=n.createRenderbuffer(),_(D.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if($){t.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Ue(n.TEXTURE_CUBE_MAP,g,ve);for(let ce=0;ce<6;ce++)if(o&&g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)Ge(D.__webglFramebuffer[ce][de],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,de);else Ge(D.__webglFramebuffer[ce],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);U(g,ve)&&R(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ne){const ce=M.texture;for(let de=0,Te=ce.length;de<Te;de++){const ke=ce[de],ue=i.get(ke);t.bindTexture(n.TEXTURE_2D,ue.__webglTexture),Ue(n.TEXTURE_2D,ke,ve),Ge(D.__webglFramebuffer,M,ke,n.COLOR_ATTACHMENT0+de,n.TEXTURE_2D,0),U(ke,ve)&&R(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?ce=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ce,j.__webglTexture),Ue(ce,g,ve),o&&g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)Ge(D.__webglFramebuffer[de],M,g,n.COLOR_ATTACHMENT0,ce,de);else Ge(D.__webglFramebuffer,M,g,n.COLOR_ATTACHMENT0,ce,0);U(g,ve)&&R(ce),t.unbindTexture()}M.depthBuffer&&I(M)}function Y(M){const g=T(M)||o,D=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let j=0,$=D.length;j<$;j++){const ne=D[j];if(U(ne,g)){const ve=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ce=i.get(ne).__webglTexture;t.bindTexture(ve,ce),R(ve),t.unbindTexture()}}}function ie(M){if(o&&M.samples>0&&oe(M)===!1){const g=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],D=M.width,j=M.height;let $=n.COLOR_BUFFER_BIT;const ne=[],ve=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=i.get(M),de=M.isWebGLMultipleRenderTargets===!0;if(de)for(let Te=0;Te<g.length;Te++)t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let Te=0;Te<g.length;Te++){ne.push(n.COLOR_ATTACHMENT0+Te),M.depthBuffer&&ne.push(ve);const ke=ce.__ignoreDepthValues!==void 0?ce.__ignoreDepthValues:!1;if(ke===!1&&(M.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),de&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ce.__webglColorRenderbuffer[Te]),ke===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[ve]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[ve])),de){const ue=i.get(g[Te]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ue,0)}n.blitFramebuffer(0,0,D,j,0,0,D,j,$,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ne)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Te=0;Te<g.length;Te++){t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.RENDERBUFFER,ce.__webglColorRenderbuffer[Te]);const ke=i.get(g[Te]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.TEXTURE_2D,ke,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}}function te(M){return Math.min(f,M.samples)}function oe(M){const g=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Q(M){const g=a.render.frame;x.get(M)!==g&&(x.set(M,g),M.update())}function Me(M,g){const D=M.colorSpace,j=M.format,$=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===da||D!==Bn&&D!==Kt&&(et.getTransfer(D)===rt?o===!1?e.has("EXT_sRGB")===!0&&j===en?(M.format=da,M.minFilter=Xt,M.generateMipmaps=!1):g=mf.sRGBToLinear(g):(j!==en||$!==Zn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),g}this.allocateTextureUnit=K,this.resetTextureUnits=B,this.setTexture2D=se,this.setTexture2DArray=N,this.setTexture3D=G,this.setTextureCube=_e,this.rebindTextures=W,this.setupRenderTarget=H,this.updateRenderTargetMipmap=Y,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=I,this.setupFrameBufferTexture=Ge,this.useMultisampledRTT=oe}function U0(n,e,t){const i=t.isWebGL2;function r(s,a=Kt){let o;const l=et.getTransfer(a);if(s===Zn)return n.UNSIGNED_BYTE;if(s===lf)return n.UNSIGNED_SHORT_4_4_4_4;if(s===cf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Qp)return n.BYTE;if(s===em)return n.SHORT;if(s===za)return n.UNSIGNED_SHORT;if(s===af)return n.INT;if(s===Yn)return n.UNSIGNED_INT;if(s===Kn)return n.FLOAT;if(s===zr)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===tm)return n.ALPHA;if(s===en)return n.RGBA;if(s===nm)return n.LUMINANCE;if(s===im)return n.LUMINANCE_ALPHA;if(s===xi)return n.DEPTH_COMPONENT;if(s===ir)return n.DEPTH_STENCIL;if(s===da)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===rm)return n.RED;if(s===uf)return n.RED_INTEGER;if(s===sm)return n.RG;if(s===ff)return n.RG_INTEGER;if(s===hf)return n.RGBA_INTEGER;if(s===Mo||s===So||s===Eo||s===yo)if(l===rt)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Mo)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===So)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Eo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===yo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Mo)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===So)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Eo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===yo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===zl||s===Hl||s===Gl||s===Vl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===zl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Hl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Gl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Vl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===om)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Wl||s===kl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===Wl)return l===rt?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===kl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Xl||s===ql||s===Yl||s===Kl||s===jl||s===$l||s===Zl||s===Jl||s===Ql||s===ec||s===tc||s===nc||s===ic||s===rc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Xl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===ql)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Yl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Kl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===jl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===$l)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Zl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Jl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ql)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ec)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===tc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===nc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===ic)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===rc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===To||s===sc||s===oc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===To)return l===rt?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===sc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===oc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===am||s===ac||s===lc||s===cc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===To)return o.COMPRESSED_RED_RGTC1_EXT;if(s===ac)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===lc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===cc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===vi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class I0 extends Yt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ss extends Ot{constructor(){super(),this.isGroup=!0,this.type="Group"}}const N0={type:"move"};class Yo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ss,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ss,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ss,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,i),h=this._getHandJoint(c,v);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&d>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(N0)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Ss;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class F0 extends Ft{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:xi,u!==xi&&u!==ir)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===xi&&(i=Yn),i===void 0&&u===ir&&(i=vi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Ct,this.minFilter=l!==void 0?l:Ct,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class O0 extends sr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,d=null,m=null,x=null;const v=t.getContextAttributes();let p=null,h=null;const b=[],E=[],T=new Yt;T.layers.enable(1),T.viewport=new vt;const w=new Yt;w.layers.enable(2),w.viewport=new vt;const U=[T,w],R=new I0;R.layers.enable(1),R.layers.enable(2);let Z=null,y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let G=b[N];return G===void 0&&(G=new Yo,b[N]=G),G.getTargetRaySpace()},this.getControllerGrip=function(N){let G=b[N];return G===void 0&&(G=new Yo,b[N]=G),G.getGripSpace()},this.getHand=function(N){let G=b[N];return G===void 0&&(G=new Yo,b[N]=G),G.getHandSpace()};function A(N){const G=E.indexOf(N.inputSource);if(G===-1)return;const _e=b[G];_e!==void 0&&(_e.update(N.inputSource,N.frame,c||a),_e.dispatchEvent({type:N.type,data:N.inputSource}))}function re(){r.removeEventListener("select",A),r.removeEventListener("selectstart",A),r.removeEventListener("selectend",A),r.removeEventListener("squeeze",A),r.removeEventListener("squeezestart",A),r.removeEventListener("squeezeend",A),r.removeEventListener("end",re),r.removeEventListener("inputsourceschange",J);for(let N=0;N<b.length;N++){const G=E[N];G!==null&&(E[N]=null,b[N].disconnect(G))}Z=null,y=null,e.setRenderTarget(p),m=null,d=null,f=null,r=null,h=null,se.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){s=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){o=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(N){c=N},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(N){if(r=N,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",A),r.addEventListener("selectstart",A),r.addEventListener("selectend",A),r.addEventListener("squeeze",A),r.addEventListener("squeezestart",A),r.addEventListener("squeezeend",A),r.addEventListener("end",re),r.addEventListener("inputsourceschange",J),v.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const G={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,G),r.updateRenderState({baseLayer:m}),h=new Si(m.framebufferWidth,m.framebufferHeight,{format:en,type:Zn,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let G=null,_e=null,ge=null;v.depth&&(ge=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,G=v.stencil?ir:xi,_e=v.stencil?vi:Yn);const pe={colorFormat:t.RGBA8,depthFormat:ge,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(pe),r.updateRenderState({layers:[d]}),h=new Si(d.textureWidth,d.textureHeight,{format:en,type:Zn,depthTexture:new F0(d.textureWidth,d.textureHeight,_e,void 0,void 0,void 0,void 0,void 0,void 0,G),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const ye=e.properties.get(h);ye.__ignoreDepthValues=d.ignoreDepthValues}h.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function J(N){for(let G=0;G<N.removed.length;G++){const _e=N.removed[G],ge=E.indexOf(_e);ge>=0&&(E[ge]=null,b[ge].disconnect(_e))}for(let G=0;G<N.added.length;G++){const _e=N.added[G];let ge=E.indexOf(_e);if(ge===-1){for(let ye=0;ye<b.length;ye++)if(ye>=E.length){E.push(_e),ge=ye;break}else if(E[ye]===null){E[ye]=_e,ge=ye;break}if(ge===-1)break}const pe=b[ge];pe&&pe.connect(_e)}}const ae=new O,P=new O;function V(N,G,_e){ae.setFromMatrixPosition(G.matrixWorld),P.setFromMatrixPosition(_e.matrixWorld);const ge=ae.distanceTo(P),pe=G.projectionMatrix.elements,ye=_e.projectionMatrix.elements,Ue=pe[14]/(pe[10]-1),Re=pe[14]/(pe[10]+1),Ie=(pe[9]+1)/pe[5],Je=(pe[9]-1)/pe[5],Ge=(pe[8]-1)/pe[0],_=(ye[8]+1)/ye[0],C=Ue*Ge,I=Ue*_,W=ge/(-Ge+_),H=W*-Ge;G.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(H),N.translateZ(W),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert();const Y=Ue+W,ie=Re+W,te=C-H,oe=I+(ge-H),Q=Ie*Re/ie*Y,Me=Je*Re/ie*Y;N.projectionMatrix.makePerspective(te,oe,Q,Me,Y,ie),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}function z(N,G){G===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(G.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(r===null)return;R.near=w.near=T.near=N.near,R.far=w.far=T.far=N.far,(Z!==R.near||y!==R.far)&&(r.updateRenderState({depthNear:R.near,depthFar:R.far}),Z=R.near,y=R.far);const G=N.parent,_e=R.cameras;z(R,G);for(let ge=0;ge<_e.length;ge++)z(_e[ge],G);_e.length===2?V(R,T,w):R.projectionMatrix.copy(T.projectionMatrix),B(N,R,G)};function B(N,G,_e){_e===null?N.matrix.copy(G.matrixWorld):(N.matrix.copy(_e.matrixWorld),N.matrix.invert(),N.matrix.multiply(G.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(G.projectionMatrix),N.projectionMatrixInverse.copy(G.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=Hr*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(N){l=N,d!==null&&(d.fixedFoveation=N),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=N)};let K=null;function le(N,G){if(u=G.getViewerPose(c||a),x=G,u!==null){const _e=u.views;m!==null&&(e.setRenderTargetFramebuffer(h,m.framebuffer),e.setRenderTarget(h));let ge=!1;_e.length!==R.cameras.length&&(R.cameras.length=0,ge=!0);for(let pe=0;pe<_e.length;pe++){const ye=_e[pe];let Ue=null;if(m!==null)Ue=m.getViewport(ye);else{const Ie=f.getViewSubImage(d,ye);Ue=Ie.viewport,pe===0&&(e.setRenderTargetTextures(h,Ie.colorTexture,d.ignoreDepthValues?void 0:Ie.depthStencilTexture),e.setRenderTarget(h))}let Re=U[pe];Re===void 0&&(Re=new Yt,Re.layers.enable(pe),Re.viewport=new vt,U[pe]=Re),Re.matrix.fromArray(ye.transform.matrix),Re.matrix.decompose(Re.position,Re.quaternion,Re.scale),Re.projectionMatrix.fromArray(ye.projectionMatrix),Re.projectionMatrixInverse.copy(Re.projectionMatrix).invert(),Re.viewport.set(Ue.x,Ue.y,Ue.width,Ue.height),pe===0&&(R.matrix.copy(Re.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),ge===!0&&R.cameras.push(Re)}}for(let _e=0;_e<b.length;_e++){const ge=E[_e],pe=b[_e];ge!==null&&pe!==void 0&&pe.update(ge,G,c||a)}K&&K(N,G),G.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:G}),x=null}const se=new Af;se.setAnimationLoop(le),this.setAnimationLoop=function(N){K=N},this.dispose=function(){}}}function B0(n,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function i(p,h){h.color.getRGB(p.fogColor.value,Ef(n)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,b,E,T){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),f(p,h)):h.isMeshPhongMaterial?(s(p,h),u(p,h)):h.isMeshStandardMaterial?(s(p,h),d(p,h),h.isMeshPhysicalMaterial&&m(p,h,T)):h.isMeshMatcapMaterial?(s(p,h),x(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),v(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,b,E):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===Nt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===Nt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=e.get(h).envMap;if(b&&(p.envMap.value=b,p.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap){p.lightMap.value=h.lightMap;const E=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=h.lightMapIntensity*E,t(h.lightMap,p.lightMapTransform)}h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,b,E){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=E*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function f(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function d(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),e.get(h).envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Nt&&p.clearcoatNormalScale.value.negate())),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,h){h.matcap&&(p.matcap.value=h.matcap)}function v(p,h){const b=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function z0(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(b,E){const T=E.program;i.uniformBlockBinding(b,T)}function c(b,E){let T=r[b.id];T===void 0&&(x(b),T=u(b),r[b.id]=T,b.addEventListener("dispose",p));const w=E.program;i.updateUBOMapping(b,w);const U=e.render.frame;s[b.id]!==U&&(d(b),s[b.id]=U)}function u(b){const E=f();b.__bindingPointIndex=E;const T=n.createBuffer(),w=b.__size,U=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,T),n.bufferData(n.UNIFORM_BUFFER,w,U),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,E,T),T}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const E=r[b.id],T=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,E);for(let U=0,R=T.length;U<R;U++){const Z=T[U];if(m(Z,U,w)===!0){const y=Z.__offset,A=Array.isArray(Z.value)?Z.value:[Z.value];let re=0;for(let J=0;J<A.length;J++){const ae=A[J],P=v(ae);typeof ae=="number"?(Z.__data[0]=ae,n.bufferSubData(n.UNIFORM_BUFFER,y+re,Z.__data)):ae.isMatrix3?(Z.__data[0]=ae.elements[0],Z.__data[1]=ae.elements[1],Z.__data[2]=ae.elements[2],Z.__data[3]=ae.elements[0],Z.__data[4]=ae.elements[3],Z.__data[5]=ae.elements[4],Z.__data[6]=ae.elements[5],Z.__data[7]=ae.elements[0],Z.__data[8]=ae.elements[6],Z.__data[9]=ae.elements[7],Z.__data[10]=ae.elements[8],Z.__data[11]=ae.elements[0]):(ae.toArray(Z.__data,re),re+=P.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,y,Z.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(b,E,T){const w=b.value;if(T[E]===void 0){if(typeof w=="number")T[E]=w;else{const U=Array.isArray(w)?w:[w],R=[];for(let Z=0;Z<U.length;Z++)R.push(U[Z].clone());T[E]=R}return!0}else if(typeof w=="number"){if(T[E]!==w)return T[E]=w,!0}else{const U=Array.isArray(T[E])?T[E]:[T[E]],R=Array.isArray(w)?w:[w];for(let Z=0;Z<U.length;Z++){const y=U[Z];if(y.equals(R[Z])===!1)return y.copy(R[Z]),!0}}return!1}function x(b){const E=b.uniforms;let T=0;const w=16;let U=0;for(let R=0,Z=E.length;R<Z;R++){const y=E[R],A={boundary:0,storage:0},re=Array.isArray(y.value)?y.value:[y.value];for(let J=0,ae=re.length;J<ae;J++){const P=re[J],V=v(P);A.boundary+=V.boundary,A.storage+=V.storage}if(y.__data=new Float32Array(A.storage/Float32Array.BYTES_PER_ELEMENT),y.__offset=T,R>0){U=T%w;const J=w-U;U!==0&&J-A.boundary<0&&(T+=w-U,y.__offset=T)}T+=A.storage}return U=T%w,U>0&&(T+=w-U),b.__size=T,b.__cache={},this}function v(b){const E={boundary:0,storage:0};return typeof b=="number"?(E.boundary=4,E.storage=4):b.isVector2?(E.boundary=8,E.storage=8):b.isVector3||b.isColor?(E.boundary=16,E.storage=12):b.isVector4?(E.boundary=16,E.storage=16):b.isMatrix3?(E.boundary=48,E.storage=48):b.isMatrix4?(E.boundary=64,E.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),E}function p(b){const E=b.target;E.removeEventListener("dispose",p);const T=a.indexOf(E.__bindingPointIndex);a.splice(T,1),n.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function h(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:h}}class Lf{constructor(e={}){const{canvas:t=Nm(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=a;const m=new Uint32Array(4),x=new Int32Array(4);let v=null,p=null;const h=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=gt,this._useLegacyLights=!1,this.toneMapping=$n,this.toneMappingExposure=1;const E=this;let T=!1,w=0,U=0,R=null,Z=-1,y=null;const A=new vt,re=new vt;let J=null;const ae=new Ze(0);let P=0,V=t.width,z=t.height,B=1,K=null,le=null;const se=new vt(0,0,V,z),N=new vt(0,0,V,z);let G=!1;const _e=new bf;let ge=!1,pe=!1,ye=null;const Ue=new ot,Re=new qe,Ie=new O,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ge(){return R===null?B:1}let _=i;function C(S,F){for(let k=0;k<S.length;k++){const X=S[k],q=t.getContext(X,F);if(q!==null)return q}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ba}`),t.addEventListener("webglcontextlost",Ye,!1),t.addEventListener("webglcontextrestored",L,!1),t.addEventListener("webglcontextcreationerror",xe,!1),_===null){const F=["webgl2","webgl","experimental-webgl"];if(E.isWebGL1Renderer===!0&&F.shift(),_=C(F,S),_===null)throw C(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&_ instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),_.getShaderPrecisionFormat===void 0&&(_.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let I,W,H,Y,ie,te,oe,Q,Me,M,g,D,j,$,ne,ve,ce,de,Te,ke,ue,Ne,Ae,Ce;function we(){I=new jv(_),W=new Vv(_,I,e),I.init(W),Ne=new U0(_,I,W),H=new L0(_,I,W),Y=new Jv(_),ie=new g0,te=new D0(_,I,H,ie,W,Ne,Y),oe=new kv(E),Q=new Kv(E),Me=new a_(_,W),Ae=new Hv(_,I,Me,W),M=new $v(_,Me,Y,Ae),g=new nx(_,M,Me,Y),Te=new tx(_,W,te),ve=new Wv(ie),D=new _0(E,oe,Q,I,W,Ae,ve),j=new B0(E,ie),$=new x0,ne=new b0(I,W),de=new zv(E,oe,Q,H,g,d,l),ce=new P0(E,g,W),Ce=new z0(_,Y,W,H),ke=new Gv(_,I,Y,W),ue=new Zv(_,I,Y,W),Y.programs=D.programs,E.capabilities=W,E.extensions=I,E.properties=ie,E.renderLists=$,E.shadowMap=ce,E.state=H,E.info=Y}we();const Ee=new O0(E,_);this.xr=Ee,this.getContext=function(){return _},this.getContextAttributes=function(){return _.getContextAttributes()},this.forceContextLoss=function(){const S=I.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=I.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return B},this.setPixelRatio=function(S){S!==void 0&&(B=S,this.setSize(V,z,!1))},this.getSize=function(S){return S.set(V,z)},this.setSize=function(S,F,k=!0){if(Ee.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=S,z=F,t.width=Math.floor(S*B),t.height=Math.floor(F*B),k===!0&&(t.style.width=S+"px",t.style.height=F+"px"),this.setViewport(0,0,S,F)},this.getDrawingBufferSize=function(S){return S.set(V*B,z*B).floor()},this.setDrawingBufferSize=function(S,F,k){V=S,z=F,B=k,t.width=Math.floor(S*k),t.height=Math.floor(F*k),this.setViewport(0,0,S,F)},this.getCurrentViewport=function(S){return S.copy(A)},this.getViewport=function(S){return S.copy(se)},this.setViewport=function(S,F,k,X){S.isVector4?se.set(S.x,S.y,S.z,S.w):se.set(S,F,k,X),H.viewport(A.copy(se).multiplyScalar(B).floor())},this.getScissor=function(S){return S.copy(N)},this.setScissor=function(S,F,k,X){S.isVector4?N.set(S.x,S.y,S.z,S.w):N.set(S,F,k,X),H.scissor(re.copy(N).multiplyScalar(B).floor())},this.getScissorTest=function(){return G},this.setScissorTest=function(S){H.setScissorTest(G=S)},this.setOpaqueSort=function(S){K=S},this.setTransparentSort=function(S){le=S},this.getClearColor=function(S){return S.copy(de.getClearColor())},this.setClearColor=function(){de.setClearColor.apply(de,arguments)},this.getClearAlpha=function(){return de.getClearAlpha()},this.setClearAlpha=function(){de.setClearAlpha.apply(de,arguments)},this.clear=function(S=!0,F=!0,k=!0){let X=0;if(S){let q=!1;if(R!==null){const Se=R.texture.format;q=Se===hf||Se===ff||Se===uf}if(q){const Se=R.texture.type,be=Se===Zn||Se===Yn||Se===za||Se===vi||Se===lf||Se===cf,Le=de.getClearColor(),De=de.getClearAlpha(),Ve=Le.r,Fe=Le.g,Be=Le.b;be?(m[0]=Ve,m[1]=Fe,m[2]=Be,m[3]=De,_.clearBufferuiv(_.COLOR,0,m)):(x[0]=Ve,x[1]=Fe,x[2]=Be,x[3]=De,_.clearBufferiv(_.COLOR,0,x))}else X|=_.COLOR_BUFFER_BIT}F&&(X|=_.DEPTH_BUFFER_BIT),k&&(X|=_.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),_.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ye,!1),t.removeEventListener("webglcontextrestored",L,!1),t.removeEventListener("webglcontextcreationerror",xe,!1),$.dispose(),ne.dispose(),ie.dispose(),oe.dispose(),Q.dispose(),g.dispose(),Ae.dispose(),Ce.dispose(),D.dispose(),Ee.dispose(),Ee.removeEventListener("sessionstart",Wt),Ee.removeEventListener("sessionend",nt),ye&&(ye.dispose(),ye=null),Tt.stop()};function Ye(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function L(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const S=Y.autoReset,F=ce.enabled,k=ce.autoUpdate,X=ce.needsUpdate,q=ce.type;we(),Y.autoReset=S,ce.enabled=F,ce.autoUpdate=k,ce.needsUpdate=X,ce.type=q}function xe(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function fe(S){const F=S.target;F.removeEventListener("dispose",fe),ee(F)}function ee(S){he(S),ie.remove(S)}function he(S){const F=ie.get(S).programs;F!==void 0&&(F.forEach(function(k){D.releaseProgram(k)}),S.isShaderMaterial&&D.releaseShaderCache(S))}this.renderBufferDirect=function(S,F,k,X,q,Se){F===null&&(F=Je);const be=q.isMesh&&q.matrixWorld.determinant()<0,Le=Nf(S,F,k,X,q);H.setMaterial(X,be);let De=k.index,Ve=1;if(X.wireframe===!0){if(De=M.getWireframeAttribute(k),De===void 0)return;Ve=2}const Fe=k.drawRange,Be=k.attributes.position;let lt=Fe.start*Ve,Bt=(Fe.start+Fe.count)*Ve;Se!==null&&(lt=Math.max(lt,Se.start*Ve),Bt=Math.min(Bt,(Se.start+Se.count)*Ve)),De!==null?(lt=Math.max(lt,0),Bt=Math.min(Bt,De.count)):Be!=null&&(lt=Math.max(lt,0),Bt=Math.min(Bt,Be.count));const pt=Bt-lt;if(pt<0||pt===1/0)return;Ae.setup(q,X,Le,k,De);let vn,at=ke;if(De!==null&&(vn=Me.get(De),at=ue,at.setIndex(vn)),q.isMesh)X.wireframe===!0?(H.setLineWidth(X.wireframeLinewidth*Ge()),at.setMode(_.LINES)):at.setMode(_.TRIANGLES);else if(q.isLine){let Xe=X.linewidth;Xe===void 0&&(Xe=1),H.setLineWidth(Xe*Ge()),q.isLineSegments?at.setMode(_.LINES):q.isLineLoop?at.setMode(_.LINE_LOOP):at.setMode(_.LINE_STRIP)}else q.isPoints?at.setMode(_.POINTS):q.isSprite&&at.setMode(_.TRIANGLES);if(q.isInstancedMesh)at.renderInstances(lt,pt,q.count);else if(k.isInstancedBufferGeometry){const Xe=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,no=Math.min(k.instanceCount,Xe);at.renderInstances(lt,pt,no)}else at.render(lt,pt)};function Pe(S,F,k){S.transparent===!0&&S.side===Pn&&S.forceSinglePass===!1?(S.side=Nt,S.needsUpdate=!0,Kr(S,F,k),S.side=ti,S.needsUpdate=!0,Kr(S,F,k),S.side=Pn):Kr(S,F,k)}this.compile=function(S,F,k=null){k===null&&(k=S),p=ne.get(k),p.init(),b.push(p),k.traverseVisible(function(q){q.isLight&&q.layers.test(F.layers)&&(p.pushLight(q),q.castShadow&&p.pushShadow(q))}),S!==k&&S.traverseVisible(function(q){q.isLight&&q.layers.test(F.layers)&&(p.pushLight(q),q.castShadow&&p.pushShadow(q))}),p.setupLights(E._useLegacyLights);const X=new Set;return S.traverse(function(q){const Se=q.material;if(Se)if(Array.isArray(Se))for(let be=0;be<Se.length;be++){const Le=Se[be];Pe(Le,k,q),X.add(Le)}else Pe(Se,k,q),X.add(Se)}),b.pop(),p=null,X},this.compileAsync=function(S,F,k=null){const X=this.compile(S,F,k);return new Promise(q=>{function Se(){if(X.forEach(function(be){ie.get(be).currentProgram.isReady()&&X.delete(be)}),X.size===0){q(S);return}setTimeout(Se,10)}I.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let Ke=null;function ct(S){Ke&&Ke(S)}function Wt(){Tt.stop()}function nt(){Tt.start()}const Tt=new Af;Tt.setAnimationLoop(ct),typeof self<"u"&&Tt.setContext(self),this.setAnimationLoop=function(S){Ke=S,Ee.setAnimationLoop(S),S===null?Tt.stop():Tt.start()},Ee.addEventListener("sessionstart",Wt),Ee.addEventListener("sessionend",nt),this.render=function(S,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Ee.enabled===!0&&Ee.isPresenting===!0&&(Ee.cameraAutoUpdate===!0&&Ee.updateCamera(F),F=Ee.getCamera()),S.isScene===!0&&S.onBeforeRender(E,S,F,R),p=ne.get(S,b.length),p.init(),b.push(p),Ue.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),_e.setFromProjectionMatrix(Ue),pe=this.localClippingEnabled,ge=ve.init(this.clippingPlanes,pe),v=$.get(S,h.length),v.init(),h.push(v),on(S,F,0,E.sortObjects),v.finish(),E.sortObjects===!0&&v.sort(K,le),this.info.render.frame++,ge===!0&&ve.beginShadows();const k=p.state.shadowsArray;if(ce.render(k,S,F),ge===!0&&ve.endShadows(),this.info.autoReset===!0&&this.info.reset(),de.render(v,S),p.setupLights(E._useLegacyLights),F.isArrayCamera){const X=F.cameras;for(let q=0,Se=X.length;q<Se;q++){const be=X[q];Ya(v,S,be,be.viewport)}}else Ya(v,S,F);R!==null&&(te.updateMultisampleRenderTarget(R),te.updateRenderTargetMipmap(R)),S.isScene===!0&&S.onAfterRender(E,S,F),Ae.resetDefaultState(),Z=-1,y=null,b.pop(),b.length>0?p=b[b.length-1]:p=null,h.pop(),h.length>0?v=h[h.length-1]:v=null};function on(S,F,k,X){if(S.visible===!1)return;if(S.layers.test(F.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(F);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||_e.intersectsSprite(S)){X&&Ie.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Ue);const be=g.update(S),Le=S.material;Le.visible&&v.push(S,be,Le,k,Ie.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||_e.intersectsObject(S))){const be=g.update(S),Le=S.material;if(X&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ie.copy(S.boundingSphere.center)):(be.boundingSphere===null&&be.computeBoundingSphere(),Ie.copy(be.boundingSphere.center)),Ie.applyMatrix4(S.matrixWorld).applyMatrix4(Ue)),Array.isArray(Le)){const De=be.groups;for(let Ve=0,Fe=De.length;Ve<Fe;Ve++){const Be=De[Ve],lt=Le[Be.materialIndex];lt&&lt.visible&&v.push(S,be,lt,k,Ie.z,Be)}}else Le.visible&&v.push(S,be,Le,k,Ie.z,null)}}const Se=S.children;for(let be=0,Le=Se.length;be<Le;be++)on(Se[be],F,k,X)}function Ya(S,F,k,X){const q=S.opaque,Se=S.transmissive,be=S.transparent;p.setupLightsView(k),ge===!0&&ve.setGlobalState(E.clippingPlanes,k),Se.length>0&&If(q,Se,F,k),X&&H.viewport(A.copy(X)),q.length>0&&Yr(q,F,k),Se.length>0&&Yr(Se,F,k),be.length>0&&Yr(be,F,k),H.buffers.depth.setTest(!0),H.buffers.depth.setMask(!0),H.buffers.color.setMask(!0),H.setPolygonOffset(!1)}function If(S,F,k,X){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;const Se=W.isWebGL2;ye===null&&(ye=new Si(1,1,{generateMipmaps:!0,type:I.has("EXT_color_buffer_half_float")?zr:Zn,minFilter:Br,samples:Se?4:0})),E.getDrawingBufferSize(Re),Se?ye.setSize(Re.x,Re.y):ye.setSize(Gs(Re.x),Gs(Re.y));const be=E.getRenderTarget();E.setRenderTarget(ye),E.getClearColor(ae),P=E.getClearAlpha(),P<1&&E.setClearColor(16777215,.5),E.clear();const Le=E.toneMapping;E.toneMapping=$n,Yr(S,k,X),te.updateMultisampleRenderTarget(ye),te.updateRenderTargetMipmap(ye);let De=!1;for(let Ve=0,Fe=F.length;Ve<Fe;Ve++){const Be=F[Ve],lt=Be.object,Bt=Be.geometry,pt=Be.material,vn=Be.group;if(pt.side===Pn&&lt.layers.test(X.layers)){const at=pt.side;pt.side=Nt,pt.needsUpdate=!0,Ka(lt,k,X,Bt,pt,vn),pt.side=at,pt.needsUpdate=!0,De=!0}}De===!0&&(te.updateMultisampleRenderTarget(ye),te.updateRenderTargetMipmap(ye)),E.setRenderTarget(be),E.setClearColor(ae,P),E.toneMapping=Le}function Yr(S,F,k){const X=F.isScene===!0?F.overrideMaterial:null;for(let q=0,Se=S.length;q<Se;q++){const be=S[q],Le=be.object,De=be.geometry,Ve=X===null?be.material:X,Fe=be.group;Le.layers.test(k.layers)&&Ka(Le,F,k,De,Ve,Fe)}}function Ka(S,F,k,X,q,Se){S.onBeforeRender(E,F,k,X,q,Se),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),q.onBeforeRender(E,F,k,X,S,Se),q.transparent===!0&&q.side===Pn&&q.forceSinglePass===!1?(q.side=Nt,q.needsUpdate=!0,E.renderBufferDirect(k,F,X,q,S,Se),q.side=ti,q.needsUpdate=!0,E.renderBufferDirect(k,F,X,q,S,Se),q.side=Pn):E.renderBufferDirect(k,F,X,q,S,Se),S.onAfterRender(E,F,k,X,q,Se)}function Kr(S,F,k){F.isScene!==!0&&(F=Je);const X=ie.get(S),q=p.state.lights,Se=p.state.shadowsArray,be=q.state.version,Le=D.getParameters(S,q.state,Se,F,k),De=D.getProgramCacheKey(Le);let Ve=X.programs;X.environment=S.isMeshStandardMaterial?F.environment:null,X.fog=F.fog,X.envMap=(S.isMeshStandardMaterial?Q:oe).get(S.envMap||X.environment),Ve===void 0&&(S.addEventListener("dispose",fe),Ve=new Map,X.programs=Ve);let Fe=Ve.get(De);if(Fe!==void 0){if(X.currentProgram===Fe&&X.lightsStateVersion===be)return $a(S,Le),Fe}else Le.uniforms=D.getUniforms(S),S.onBuild(k,Le,E),S.onBeforeCompile(Le,E),Fe=D.acquireProgram(Le,De),Ve.set(De,Fe),X.uniforms=Le.uniforms;const Be=X.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Be.clippingPlanes=ve.uniform),$a(S,Le),X.needsLights=Of(S),X.lightsStateVersion=be,X.needsLights&&(Be.ambientLightColor.value=q.state.ambient,Be.lightProbe.value=q.state.probe,Be.directionalLights.value=q.state.directional,Be.directionalLightShadows.value=q.state.directionalShadow,Be.spotLights.value=q.state.spot,Be.spotLightShadows.value=q.state.spotShadow,Be.rectAreaLights.value=q.state.rectArea,Be.ltc_1.value=q.state.rectAreaLTC1,Be.ltc_2.value=q.state.rectAreaLTC2,Be.pointLights.value=q.state.point,Be.pointLightShadows.value=q.state.pointShadow,Be.hemisphereLights.value=q.state.hemi,Be.directionalShadowMap.value=q.state.directionalShadowMap,Be.directionalShadowMatrix.value=q.state.directionalShadowMatrix,Be.spotShadowMap.value=q.state.spotShadowMap,Be.spotLightMatrix.value=q.state.spotLightMatrix,Be.spotLightMap.value=q.state.spotLightMap,Be.pointShadowMap.value=q.state.pointShadowMap,Be.pointShadowMatrix.value=q.state.pointShadowMatrix),X.currentProgram=Fe,X.uniformsList=null,Fe}function ja(S){if(S.uniformsList===null){const F=S.currentProgram.getUniforms();S.uniformsList=Cs.seqWithValue(F.seq,S.uniforms)}return S.uniformsList}function $a(S,F){const k=ie.get(S);k.outputColorSpace=F.outputColorSpace,k.instancing=F.instancing,k.instancingColor=F.instancingColor,k.skinning=F.skinning,k.morphTargets=F.morphTargets,k.morphNormals=F.morphNormals,k.morphColors=F.morphColors,k.morphTargetsCount=F.morphTargetsCount,k.numClippingPlanes=F.numClippingPlanes,k.numIntersection=F.numClipIntersection,k.vertexAlphas=F.vertexAlphas,k.vertexTangents=F.vertexTangents,k.toneMapping=F.toneMapping}function Nf(S,F,k,X,q){F.isScene!==!0&&(F=Je),te.resetTextureUnits();const Se=F.fog,be=X.isMeshStandardMaterial?F.environment:null,Le=R===null?E.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Bn,De=(X.isMeshStandardMaterial?Q:oe).get(X.envMap||be),Ve=X.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Fe=!!k.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Be=!!k.morphAttributes.position,lt=!!k.morphAttributes.normal,Bt=!!k.morphAttributes.color;let pt=$n;X.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(pt=E.toneMapping);const vn=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,at=vn!==void 0?vn.length:0,Xe=ie.get(X),no=p.state.lights;if(ge===!0&&(pe===!0||S!==y)){const zt=S===y&&X.id===Z;ve.setState(X,S,zt)}let ut=!1;X.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==no.state.version||Xe.outputColorSpace!==Le||q.isInstancedMesh&&Xe.instancing===!1||!q.isInstancedMesh&&Xe.instancing===!0||q.isSkinnedMesh&&Xe.skinning===!1||!q.isSkinnedMesh&&Xe.skinning===!0||q.isInstancedMesh&&Xe.instancingColor===!0&&q.instanceColor===null||q.isInstancedMesh&&Xe.instancingColor===!1&&q.instanceColor!==null||Xe.envMap!==De||X.fog===!0&&Xe.fog!==Se||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==ve.numPlanes||Xe.numIntersection!==ve.numIntersection)||Xe.vertexAlphas!==Ve||Xe.vertexTangents!==Fe||Xe.morphTargets!==Be||Xe.morphNormals!==lt||Xe.morphColors!==Bt||Xe.toneMapping!==pt||W.isWebGL2===!0&&Xe.morphTargetsCount!==at)&&(ut=!0):(ut=!0,Xe.__version=X.version);let ii=Xe.currentProgram;ut===!0&&(ii=Kr(X,F,q));let Za=!1,lr=!1,io=!1;const bt=ii.getUniforms(),ri=Xe.uniforms;if(H.useProgram(ii.program)&&(Za=!0,lr=!0,io=!0),X.id!==Z&&(Z=X.id,lr=!0),Za||y!==S){bt.setValue(_,"projectionMatrix",S.projectionMatrix),bt.setValue(_,"viewMatrix",S.matrixWorldInverse);const zt=bt.map.cameraPosition;zt!==void 0&&zt.setValue(_,Ie.setFromMatrixPosition(S.matrixWorld)),W.logarithmicDepthBuffer&&bt.setValue(_,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&bt.setValue(_,"isOrthographic",S.isOrthographicCamera===!0),y!==S&&(y=S,lr=!0,io=!0)}if(q.isSkinnedMesh){bt.setOptional(_,q,"bindMatrix"),bt.setOptional(_,q,"bindMatrixInverse");const zt=q.skeleton;zt&&(W.floatVertexTextures?(zt.boneTexture===null&&zt.computeBoneTexture(),bt.setValue(_,"boneTexture",zt.boneTexture,te),bt.setValue(_,"boneTextureSize",zt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const ro=k.morphAttributes;if((ro.position!==void 0||ro.normal!==void 0||ro.color!==void 0&&W.isWebGL2===!0)&&Te.update(q,k,ii),(lr||Xe.receiveShadow!==q.receiveShadow)&&(Xe.receiveShadow=q.receiveShadow,bt.setValue(_,"receiveShadow",q.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(ri.envMap.value=De,ri.flipEnvMap.value=De.isCubeTexture&&De.isRenderTargetTexture===!1?-1:1),lr&&(bt.setValue(_,"toneMappingExposure",E.toneMappingExposure),Xe.needsLights&&Ff(ri,io),Se&&X.fog===!0&&j.refreshFogUniforms(ri,Se),j.refreshMaterialUniforms(ri,X,B,z,ye),Cs.upload(_,ja(Xe),ri,te)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(Cs.upload(_,ja(Xe),ri,te),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&bt.setValue(_,"center",q.center),bt.setValue(_,"modelViewMatrix",q.modelViewMatrix),bt.setValue(_,"normalMatrix",q.normalMatrix),bt.setValue(_,"modelMatrix",q.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const zt=X.uniformsGroups;for(let so=0,Bf=zt.length;so<Bf;so++)if(W.isWebGL2){const Ja=zt[so];Ce.update(Ja,ii),Ce.bind(Ja,ii)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return ii}function Ff(S,F){S.ambientLightColor.needsUpdate=F,S.lightProbe.needsUpdate=F,S.directionalLights.needsUpdate=F,S.directionalLightShadows.needsUpdate=F,S.pointLights.needsUpdate=F,S.pointLightShadows.needsUpdate=F,S.spotLights.needsUpdate=F,S.spotLightShadows.needsUpdate=F,S.rectAreaLights.needsUpdate=F,S.hemisphereLights.needsUpdate=F}function Of(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(S,F,k){ie.get(S.texture).__webglTexture=F,ie.get(S.depthTexture).__webglTexture=k;const X=ie.get(S);X.__hasExternalTextures=!0,X.__hasExternalTextures&&(X.__autoAllocateDepthBuffer=k===void 0,X.__autoAllocateDepthBuffer||I.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),X.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,F){const k=ie.get(S);k.__webglFramebuffer=F,k.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(S,F=0,k=0){R=S,w=F,U=k;let X=!0,q=null,Se=!1,be=!1;if(S){const De=ie.get(S);De.__useDefaultFramebuffer!==void 0?(H.bindFramebuffer(_.FRAMEBUFFER,null),X=!1):De.__webglFramebuffer===void 0?te.setupRenderTarget(S):De.__hasExternalTextures&&te.rebindTextures(S,ie.get(S.texture).__webglTexture,ie.get(S.depthTexture).__webglTexture);const Ve=S.texture;(Ve.isData3DTexture||Ve.isDataArrayTexture||Ve.isCompressedArrayTexture)&&(be=!0);const Fe=ie.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Fe[F])?q=Fe[F][k]:q=Fe[F],Se=!0):W.isWebGL2&&S.samples>0&&te.useMultisampledRTT(S)===!1?q=ie.get(S).__webglMultisampledFramebuffer:Array.isArray(Fe)?q=Fe[k]:q=Fe,A.copy(S.viewport),re.copy(S.scissor),J=S.scissorTest}else A.copy(se).multiplyScalar(B).floor(),re.copy(N).multiplyScalar(B).floor(),J=G;if(H.bindFramebuffer(_.FRAMEBUFFER,q)&&W.drawBuffers&&X&&H.drawBuffers(S,q),H.viewport(A),H.scissor(re),H.setScissorTest(J),Se){const De=ie.get(S.texture);_.framebufferTexture2D(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,_.TEXTURE_CUBE_MAP_POSITIVE_X+F,De.__webglTexture,k)}else if(be){const De=ie.get(S.texture),Ve=F||0;_.framebufferTextureLayer(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,De.__webglTexture,k||0,Ve)}Z=-1},this.readRenderTargetPixels=function(S,F,k,X,q,Se,be){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Le=ie.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&be!==void 0&&(Le=Le[be]),Le){H.bindFramebuffer(_.FRAMEBUFFER,Le);try{const De=S.texture,Ve=De.format,Fe=De.type;if(Ve!==en&&Ne.convert(Ve)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Be=Fe===zr&&(I.has("EXT_color_buffer_half_float")||W.isWebGL2&&I.has("EXT_color_buffer_float"));if(Fe!==Zn&&Ne.convert(Fe)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Fe===Kn&&(W.isWebGL2||I.has("OES_texture_float")||I.has("WEBGL_color_buffer_float")))&&!Be){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=S.width-X&&k>=0&&k<=S.height-q&&_.readPixels(F,k,X,q,Ne.convert(Ve),Ne.convert(Fe),Se)}finally{const De=R!==null?ie.get(R).__webglFramebuffer:null;H.bindFramebuffer(_.FRAMEBUFFER,De)}}},this.copyFramebufferToTexture=function(S,F,k=0){const X=Math.pow(2,-k),q=Math.floor(F.image.width*X),Se=Math.floor(F.image.height*X);te.setTexture2D(F,0),_.copyTexSubImage2D(_.TEXTURE_2D,k,0,0,S.x,S.y,q,Se),H.unbindTexture()},this.copyTextureToTexture=function(S,F,k,X=0){const q=F.image.width,Se=F.image.height,be=Ne.convert(k.format),Le=Ne.convert(k.type);te.setTexture2D(k,0),_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,k.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,k.unpackAlignment),F.isDataTexture?_.texSubImage2D(_.TEXTURE_2D,X,S.x,S.y,q,Se,be,Le,F.image.data):F.isCompressedTexture?_.compressedTexSubImage2D(_.TEXTURE_2D,X,S.x,S.y,F.mipmaps[0].width,F.mipmaps[0].height,be,F.mipmaps[0].data):_.texSubImage2D(_.TEXTURE_2D,X,S.x,S.y,be,Le,F.image),X===0&&k.generateMipmaps&&_.generateMipmap(_.TEXTURE_2D),H.unbindTexture()},this.copyTextureToTexture3D=function(S,F,k,X,q=0){if(E.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Se=S.max.x-S.min.x+1,be=S.max.y-S.min.y+1,Le=S.max.z-S.min.z+1,De=Ne.convert(X.format),Ve=Ne.convert(X.type);let Fe;if(X.isData3DTexture)te.setTexture3D(X,0),Fe=_.TEXTURE_3D;else if(X.isDataArrayTexture)te.setTexture2DArray(X,0),Fe=_.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,X.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,X.unpackAlignment);const Be=_.getParameter(_.UNPACK_ROW_LENGTH),lt=_.getParameter(_.UNPACK_IMAGE_HEIGHT),Bt=_.getParameter(_.UNPACK_SKIP_PIXELS),pt=_.getParameter(_.UNPACK_SKIP_ROWS),vn=_.getParameter(_.UNPACK_SKIP_IMAGES),at=k.isCompressedTexture?k.mipmaps[0]:k.image;_.pixelStorei(_.UNPACK_ROW_LENGTH,at.width),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,at.height),_.pixelStorei(_.UNPACK_SKIP_PIXELS,S.min.x),_.pixelStorei(_.UNPACK_SKIP_ROWS,S.min.y),_.pixelStorei(_.UNPACK_SKIP_IMAGES,S.min.z),k.isDataTexture||k.isData3DTexture?_.texSubImage3D(Fe,q,F.x,F.y,F.z,Se,be,Le,De,Ve,at.data):k.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),_.compressedTexSubImage3D(Fe,q,F.x,F.y,F.z,Se,be,Le,De,at.data)):_.texSubImage3D(Fe,q,F.x,F.y,F.z,Se,be,Le,De,Ve,at),_.pixelStorei(_.UNPACK_ROW_LENGTH,Be),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,lt),_.pixelStorei(_.UNPACK_SKIP_PIXELS,Bt),_.pixelStorei(_.UNPACK_SKIP_ROWS,pt),_.pixelStorei(_.UNPACK_SKIP_IMAGES,vn),q===0&&X.generateMipmaps&&_.generateMipmap(Fe),H.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?te.setTextureCube(S,0):S.isData3DTexture?te.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?te.setTexture2DArray(S,0):te.setTexture2D(S,0),H.unbindTexture()},this.resetState=function(){w=0,U=0,R=null,H.reset(),Ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ha?"display-p3":"srgb",t.unpackColorSpace=et.workingColorSpace===Qs?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===gt?Mi:df}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Mi?gt:Bn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class H0 extends Lf{}H0.prototype.isWebGL1Renderer=!0;class G0 extends Ot{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class V0{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=ha,this.updateRange={offset:0,count:-1},this.version=0,this.uuid=In()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=t.array[i+r];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=In()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=In()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const At=new O;class Ws{constructor(e,t,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)At.fromBufferAttribute(this,t),At.applyMatrix4(e),this.setXYZ(t,At.x,At.y,At.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)At.fromBufferAttribute(this,t),At.applyNormalMatrix(e),this.setXYZ(t,At.x,At.y,At.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)At.fromBufferAttribute(this,t),At.transformDirection(e),this.setXYZ(t,At.x,At.y,At.z);return this}setX(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=pn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=pn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=pn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=pn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array),r=Qe(r,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,t,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array),r=Qe(r,this.array),s=Qe(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return new sn(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ws(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class Df extends Xr{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ze(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Hi;const _r=new O,Gi=new O,Vi=new O,Wi=new qe,gr=new qe,Uf=new ot,Es=new O,vr=new O,ys=new O,Zc=new qe,Ko=new qe,Jc=new qe;class W0 extends Ot{constructor(e=new Df){if(super(),this.isSprite=!0,this.type="Sprite",Hi===void 0){Hi=new Hn;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new V0(t,5);Hi.setIndex([0,1,2,0,2,3]),Hi.setAttribute("position",new Ws(i,3,0,!1)),Hi.setAttribute("uv",new Ws(i,2,3,!1))}this.geometry=Hi,this.material=e,this.center=new qe(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Gi.setFromMatrixScale(this.matrixWorld),Uf.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Vi.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Gi.multiplyScalar(-Vi.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const a=this.center;Ts(Es.set(-.5,-.5,0),Vi,a,Gi,r,s),Ts(vr.set(.5,-.5,0),Vi,a,Gi,r,s),Ts(ys.set(.5,.5,0),Vi,a,Gi,r,s),Zc.set(0,0),Ko.set(1,0),Jc.set(1,1);let o=e.ray.intersectTriangle(Es,vr,ys,!1,_r);if(o===null&&(Ts(vr.set(-.5,.5,0),Vi,a,Gi,r,s),Ko.set(0,1),o=e.ray.intersectTriangle(Es,ys,vr,!1,_r),o===null))return;const l=e.ray.origin.distanceTo(_r);l<e.near||l>e.far||t.push({distance:l,point:_r.clone(),uv:qt.getInterpolation(_r,Es,vr,ys,Zc,Ko,Jc,new qe),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ts(n,e,t,i,r,s){Wi.subVectors(n,t).addScalar(.5).multiply(i),r!==void 0?(gr.x=s*Wi.x-r*Wi.y,gr.y=r*Wi.x+s*Wi.y):gr.copy(Wi),n.copy(e),n.x+=gr.x,n.y+=gr.y,n.applyMatrix4(Uf)}class k0 extends Ft{constructor(e,t,i,r,s,a,o,l,c){super(e,t,i,r,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class qa extends Hn{constructor(e=.5,t=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],u=[];let f=e;const d=(t-e)/r,m=new O,x=new qe;for(let v=0;v<=r;v++){for(let p=0;p<=i;p++){const h=s+p/i*a;m.x=f*Math.cos(h),m.y=f*Math.sin(h),l.push(m.x,m.y,m.z),c.push(0,0,1),x.x=(m.x/t+1)/2,x.y=(m.y/t+1)/2,u.push(x.x,x.y)}f+=d}for(let v=0;v<r;v++){const p=v*(i+1);for(let h=0;h<i;h++){const b=h+p,E=b,T=b+i+1,w=b+i+2,U=b+1;o.push(E,T,U),o.push(T,w,U)}}this.setIndex(o),this.setAttribute("position",new _n(l,3)),this.setAttribute("normal",new _n(c,3)),this.setAttribute("uv",new _n(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new qa(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ba}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ba);const X0={key:1},q0={key:2,class:"tag-input-overlay"},Y0={class:"tag-input-box"},K0={class:"tag-input-div"},j0=["onKeydown"],$0=5,Z0=.1,J0=Au({__name:"ARComponent",setup(n){const e=ur(),t=ur(!1),i=ur(null),r=ur(!1),s=ur("");let a,o,l,c,u,f,d=null,m=null,x=null,v=[],p=new ot,h=new ot,b=.1,E=[];const T=J=>{for(const ae of v){const P=new O;if(P.setFromMatrixPosition(ae.sprite.matrixWorld),P.distanceTo(J)<Z0)return!0}return!1};Pu(()=>{w()});const w=async()=>{if("xr"in navigator){const J=await navigator.xr.isSessionSupported("immersive-ar");i.value=J}else i.value=!1},U=async()=>{var V;if(!i.value)return;const J=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:document.body}});l=new Lf({antialias:!0,alpha:!0}),l.setSize(window.innerWidth,window.innerHeight),l.xr.enabled=!0,l.xr.setReferenceSpaceType("local"),l.xr.setSession(J),(V=e.value)==null||V.appendChild(l.domElement);const ae=()=>{var z;l.setAnimationLoop(null),t.value=!1,r.value=!1,d!=null&&d.cancel&&d.cancel(),d=null,m=null,(z=e.value)!=null&&z.contains(l.domElement)&&e.value.removeChild(l.domElement);for(const B of v){if(B.anchor&&B.anchor.delete)try{B.anchor.delete()}catch{}a.remove(B.sprite)}v=[],l.dispose()};J.addEventListener("end",ae),a=new G0,o=new Yt(70,window.innerWidth/window.innerHeight,.01,20);const P=new qa(.15,.2,32).rotateX(-Math.PI/2);f=new Wa({color:16777215}),u=new Dn(P,f),u.matrixAutoUpdate=!1,u.visible=!1,a.add(u),h.identity(),c=l.xr.getController(0),c.addEventListener("select",Z),a.add(c),J.requestReferenceSpace("viewer").then(z=>{J.requestHitTestSource({space:z}).then(B=>{d=B})}),J.requestReferenceSpace("local").then(z=>{m=z}),l.setAnimationLoop(re),t.value=!0},R=J=>{const V=document.createElement("canvas"),z=V.getContext("2d");z.font="64px Arial";const B=z.measureText(J),K=Math.ceil(B.width),le=64;V.width=K+20*2,V.height=le+20*2,z.font="64px Arial",z.textAlign="center",z.textBaseline="middle",z.fillStyle="rgba(0, 0, 0, 0.6)",z.fillRect(0,0,V.width,V.height),z.fillStyle="white",z.fillText(J,V.width/2,V.height/2);const se=new k0(V);se.needsUpdate=!0;const N=new Df({map:se,transparent:!0}),G=new W0(N),_e=.001;return G.scale.set(V.width*_e,V.height*_e,1),G},Z=()=>{u.visible&&(p.copy(u.matrix),s.value="",r.value=!0)},y=()=>{const J=s.value.trim();if(!J){A();return}const ae=new O;if(ae.setFromMatrixPosition(p),T(ae)){alert("Position trop proche d'un tag existant. Veuillez choisir un autre emplacement."),A();return}const P=(z,B)=>{const K=R(J);K.position.setFromMatrixPosition(z),a.add(K),v.push({sprite:K,anchor:B,baseMatrix:z.clone()})};(async()=>{if(x!=null&&x.createAnchor)try{const z=await x.createAnchor();P(p,z);return}catch(z){console.warn("WebXR anchor creation failed, fallback on position only",z)}P(p)})().catch(()=>P(p)),r.value=!1,s.value=""},A=()=>{r.value=!1,s.value=""},re=(J,ae)=>{if(ae){if(d&&m){const P=ae.getHitTestResults(d);if(P.length){const V=P[0];x=V;const z=V.getPose(m);if(z){u.visible=!0;const B=new ot().fromArray(z.transform.matrix);if(E.push(B),E.length>$0&&E.shift(),E.length>0){const K=[],le=[];E.forEach(pe=>{const ye=new O,Ue=new or,Re=new O;pe.decompose(ye,Ue,Re),K.push(ye),le.push(Ue)});const se=K.reduce((pe,ye)=>pe.add(ye),new O).divideScalar(K.length);let N=le[0].clone();for(let pe=1;pe<le.length;pe++)N.slerp(le[pe],.5);const G=new ot;G.compose(se,N,new O(1,1,1));const _e=b;for(let pe=0;pe<16;pe++)h.elements[pe]=Im.lerp(h.elements[pe],G.elements[pe],_e);u.matrix.copy(h);const ge=new O;ge.setFromMatrixPosition(h),T(ge)?f.color.setHex(16711680):f.color.setHex(16777215)}}}else u.visible=!1,E=[]}for(const P of v)if(P.anchor&&m){const V=P.anchor.anchorSpace||P.anchor,z=ae.getPose(V,m);if(z){const B=new ot().fromArray(z.transform.matrix);P.sprite.position.setFromMatrixPosition(B)}}else P.baseMatrix&&P.sprite.position.setFromMatrixPosition(P.baseMatrix)}l.render(a,o)};return(J,ae)=>(qi(),Jr(un,null,[pi("div",{id:"ar-container",ref_key:"container",ref:e},null,512),t.value?mo("",!0):(qi(),Jr("button",{key:0,class:"btnStart",onClick:U},"Démarrer AR")),i.value===!1?(qi(),Jr("p",X0,"Votre navigateur ne supporte pas WebXR AR.")):mo("",!0),r.value?(qi(),Jr("div",q0,[pi("div",Y0,[pi("label",null,[pi("div",K0,[ae[1]||(ae[1]=Qu(" Nom : ",-1)),Ih(pi("input",{"onUpdate:modelValue":ae[0]||(ae[0]=P=>s.value=P),onKeydown:dp(fp(y,["prevent"]),["enter"]),placeholder:"Entrez le nom...",autofocus:""},null,40,j0),[[lp,s.value]])])])])])):mo("",!0)],64))}}),Q0=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},eM=Q0(J0,[["__scopeId","data-v-2ecc5677"]]),tM=Au({__name:"App",setup(n){return(e,t)=>(qi(),$u(eM))}});_p(tM).mount("#app");
