...
}`;function P0(n,e,t){let i=new bf;const r=new qe,s=new qe,a=new vt,o=new A0({depthPacking:cm}),l=new w0,c={},u=t.maxTextureSize,f={[ti]:Nt,[Nt]:ti,[Pn]:Pn},d=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:R0,fragmentShader:C0}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new Hn;x.setAttribute("position",new sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Dn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rf;let h=this.type;this.render=function(w,U,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const Z=n.getRenderTarget(),y=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),q=n.state;q.setBlending(jn),q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);const ne=h!==bn&&this.type===bn,le=h===bn&&this.type!==bn;for(let L=0,G=w.length;L<G;L++){const Y=w[L],H=Y.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const ee=H.getFrameExtents();if(r.multiply(ee),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ee.x),r.x=s.x*ee.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ee.y),r.y=s.y*ee.y,H.mapSize.y=s.y)),H.map===null||ne===!0||le===!0){const se=this.type!==bn?{minFilter:Ct,magFilter:Ct}:{};H.map!==null&&H.map.dispose(),H.map=new Si(r.x,r.y,se),H.map.texture.name=Y.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const ae=H.getViewportCount();for(let se=0;se<ae;se++){const N=H.getViewport(se);a.set(s.x*N.x,s.y*N.y,s.x*N.z,s.y*N.w),q.viewport(a),H.updateMatrices(Y,se),i=H.getFrustum(),T(U,R,H.camera,Y,this.type)}H.isPointLightShadow!==!0&&this.type===bn&&b(H,R),H.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget(Z,y,A)};function b(w,U){const R=e.update(v);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Si(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,n.setRenderTarget(w.mapPass),n.clear(),n.renderBufferDirect(U,null,R,d,v,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,n.setRenderTarget(w.map),n.clear(),n.renderBufferDirect(U,null,R,m,v,null)}function E(w,U,R,Z){let y=null;const A=R.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)y=A;else if(y=R.isPointLight===!0?l:o,n.localClippingEnabled&&U.clipShadows===!0&&Array.isArray(U.clippingPlanes)&&U.clippingPlanes.length!==0||U.displacementMap&&U.displacementScale!==0||U.alphaMap&&U.alphaTest>0||U.map&&U.alphaTest>0){const q=y.uuid,ne=U.uuid;let le=c[q];le===void 0&&(le={},c[q]=le);let L=le[ne];L===void 0&&(L=y.clone(),le[ne]=L),y=L}if(y.visible=U.visible,y.wireframe=U.wireframe,Z===bn?y.side=U.shadowSide!==null?U.shadowSide:U.side:y.side=U.shadowSide!==null?U.shadowSide:f[U.side],y.alphaMap=U.alphaMap,y.alphaTest=U.alphaTest,y.map=U.map,y.clipShadows=U.clipShadows,y.clippingPlanes=U.clippingPlanes,y.clipIntersection=U.clipIntersection,y.displacementMap=U.displacementMap,y.displacementScale=U.displacementScale,y.displacementBias=U.displacementBias,y.wireframeLinewidth=U.wireframeLinewidth,y.linewidth=U.linewidth,R.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const q=n.properties.get(y);q.light=R}return y}function T(w,U,R,Z,y){if(w.visible===!1)return;if(w.layers.test(U.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===bn)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,w.matrixWorld);const ne=e.update(w),le=w.material;if(Array.isArray(le)){const L=ne.groups;for(let G=0,Y=L.length;G<Y;G++){const H=L[G],ee=le[H.materialIndex];if(ee&&ee.visible){const ae=E(w,ee,Z,y);n.renderBufferDirect(R,null,ne,ae,w,H)}}}else if(le.visible){const L=E(w,le,Z,y);n.renderBufferDirect(R,null,ne,L,w,null)}}const q=w.children;for(let ne=0,le=q.length;ne<le;ne++)T(q[ne],U,R,Z,y)}}function L0(n,e,t){const i=t.isWebGL2;function r(){let P=!1;const ve=new vt;let fe=null;const Q=new vt(0,0,0,0);return{setMask:function(de){fe!==de&&!P&&(n.colorMask(de,de,de,de),fe=de)},setLocked:function(de){P=de},setClear:function(de,Ce,Ke,ct,Wt){Wt===!0&&(de*=ct,Ce*=ct,Ke*=ct),ve.set(de,Ce,Ke,ct),Q.equals(ve)===!1&&(n.clearColor(de,Ce,Ke,ct),Q.copy(ve))},reset:function(){P=!1,fe=null,Q.set(-1,0,0,0)}}}function s(){let P=!1,ve=null,fe=null,Q=null;return{setTest:function(de){de?Ue(n.DEPTH_TEST):Je(n.DEPTH_TEST)},setMask:function(de){ve!==de&&!P&&(n.depthMask(de),ve=de)},setFunc:function(de){if(fe!==de){switch(de){case Bp:n.depthFunc(n.NEVER);break;case zp:n.depthFunc(n.ALWAYS);break;case Hp:n.depthFunc(n.LESS);break;case Fs:n.depthFunc(n.LEQUAL);break;case Gp:n.depthFunc(n.EQUAL);break;case Vp:n.depthFunc(n.GEQUAL);break;case Wp:n.depthFunc(n.GREATER);break;case kp:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}fe=de}},setLocked:function(de){P=de},setClear:function(de){Q!==de&&(n.clearDepth(de),Q=de)},reset:function(){P=!1,ve=null,fe=null,Q=null}}}function a(){let P=!1,ve=null,fe=null,Q=null,de=null,Ce=null,Ke=null,ct=null,Wt=null;return{setTest:function(nt){P||(nt?Ue(n.STENCIL_TEST):Je(n.STENCIL_TEST))},setMask:function(nt){ve!==nt&&!P&&(n.stencilMask(nt),ve=nt)},setFunc:function(nt,Tt,on){(fe!==nt||Q!==Tt||de!==on)&&(n.stencilFunc(nt,Tt,on),fe=nt,Q=Tt,de=on)},setOp:function(nt,Tt,on){(Ce!==nt||Ke!==Tt||ct!==on)&&(n.stencilOp(nt,Tt,on),Ce=nt,Ke=Tt,ct=on)},setLocked:function(nt){P=nt},setClear:function(nt){Wt!==nt&&(n.clearStencil(nt),Wt=nt)},reset:function(){P=!1,ve=null,fe=null,Q=null,de=null,Ce=null,Ke=null,ct=null,Wt=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let d={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,E=null,T=null,w=null,U=null,R=null,Z=null,y=new Ze(0,0,0),A=0,q=!1,ne=null,le=null,L=null,G=null,Y=null;const H=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,ae=0;const se=n.getParameter(n.VERSION);se.indexOf("WebGL")!==-1?(ae=parseFloat(/^WebGL (\d)/.exec(se)[1]),ee=ae>=1):se.indexOf("OpenGL ES")!==-1&&(ae=parseFloat(/^OpenGL ES (\d)/.exec(se)[1]),ee=ae>=2);let N=null,z={};const _e=n.getParameter(n.SCISSOR_BOX),he=n.getParameter(n.VIEWPORT),xe=new vt().fromArray(_e),be=new vt().fromArray(he);function Ie(P,ve,fe,Q){const de=new Uint8Array(4),Ce=n.createTexture();n.bindTexture(P,Ce),n.texParameteri(P,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(P,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ke=0;Ke<fe;Ke++)i&&(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)?n.texImage3D(ve,0,n.RGBA,1,1,Q,0,n.RGBA,n.UNSIGNED_BYTE,de):n.texImage2D(ve+Ke,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,de);return Ce}const Le={};Le[n.TEXTURE_2D]=Ie(n.TEXTURE_2D,n.TEXTURE_2D,1),Le[n.TEXTURE_CUBE_MAP]=Ie(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Le[n.TEXTURE_2D_ARRAY]=Ie(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Le[n.TEXTURE_3D]=Ie(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Ue(n.DEPTH_TEST),l.setFunc(Fs),re(!1),te(Dl),Ue(n.CULL_FACE),B(jn);function Ue(P){d[P]!==!0&&(n.enable(P),d[P]=!0)}function Je(P){d[P]!==!1&&(n.disable(P),d[P]=!1)}function Ge(P,ve){return m[P]!==ve?(n.bindFramebuffer(P,ve),m[P]=ve,i&&(P===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=ve),P===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=ve)),!0):!1}function _(P,ve){let fe=v,Q=!1;if(P)if(fe=x.get(ve),fe===void 0&&(fe=[],x.set(ve,fe)),P.isWebGLMultipleRenderTargets){const de=P.texture;if(fe.length!==de.length||fe[0]!==n.COLOR_ATTACHMENT0){for(let Ce=0,Ke=de.length;Ce<Ke;Ce++)fe[Ce]=n.COLOR_ATTACHMENT0+Ce;fe.length=de.length,Q=!0}}else fe[0]!==n.COLOR_ATTACHMENT0&&(fe[0]=n.COLOR_ATTACHMENT0,Q=!0);else fe[0]!==n.BACK&&(fe[0]=n.BACK,Q=!0);Q&&(t.isWebGL2?n.drawBuffers(fe):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(fe))}function C(P){return p!==P?(n.useProgram(P),p=P,!0):!1}const I={[mi]:n.FUNC_ADD,[yp]:n.FUNC_SUBTRACT,[Tp]:n.FUNC_REVERSE_SUBTRACT};if(i)I[Fl]=n.MIN,I[Ol]=n.MAX;else{const P=e.get("EXT_blend_minmax");P!==null&&(I[Fl]=P.MIN_EXT,I[Ol]=P.MAX_EXT)}const V={[bp]:n.ZERO,[Ap]:n.ONE,[wp]:n.SRC_COLOR,[oa]:n.SRC_ALPHA,[Up]:n.SRC_ALPHA_SATURATE,[Lp]:n.DST_COLOR,[Cp]:n.DST_ALPHA,[Rp]:n.ONE_MINUS_SRC_COLOR,[aa]:n.ONE_MINUS_SRC_ALPHA,[Dp]:n.ONE_MINUS_DST_COLOR,[Pp]:n.ONE_MINUS_DST_ALPHA,[Ip]:n.CONSTANT_COLOR,[Np]:n.ONE_MINUS_CONSTANT_COLOR,[Fp]:n.CONSTANT_ALPHA,[Op]:n.ONE_MINUS_CONSTANT_ALPHA};function B(P,ve,fe,Q,de,Ce,Ke,ct,Wt,nt){if(P===jn){h===!0&&(Je(n.BLEND),h=!1);return}if(h===!1&&(Ue(n.BLEND),h=!0),P!==Ep){if(P!==b||nt!==q){if((E!==mi||U!==mi)&&(n.blendEquation(n.FUNC_ADD),E=mi,U=mi),nt)switch(P){case Ji:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFunc(n.ONE,n.ONE);break;case Il:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case Ji:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Il:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}T=null,w=null,R=null,Z=null,y.set(0,0,0),A=0,b=P,q=nt}return}de=de||ve,Ce=Ce||fe,Ke=Ke||Q,(ve!==E||de!==U)&&(n.blendEquationSeparate(I[ve],I[de]),E=ve,U=de),(fe!==T||Q!==w||Ce!==R||Ke!==Z)&&(n.blendFuncSeparate(V[fe],V[Q],V[Ce],V[Ke]),T=fe,w=Q,R=Ce,Z=Ke),(ct.equals(y)===!1||Wt!==A)&&(n.blendColor(ct.r,ct.g,ct.b,Wt),y.copy(ct),A=Wt),b=P,q=!1}function K(P,ve){P.side===Pn?Je(n.CULL_FACE):Ue(n.CULL_FACE);let fe=P.side===Nt;ve&&(fe=!fe),re(fe),P.blending===Ji&&P.transparent===!1?B(jn):B(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),l.setFunc(P.depthFunc),l.setTest(P.depthTest),l.setMask(P.depthWrite),o.setMask(P.colorWrite);const Q=P.stencilWrite;c.setTest(Q),Q&&(c.setMask(P.stencilWriteMask),c.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),c.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),J(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?Ue(n.SAMPLE_ALPHA_TO_COVERAGE):Je(n.SAMPLE_ALPHA_TO_COVERAGE)}function re(P){ne!==P&&(P?n.frontFace(n.CW):n.frontFace(n.CCW),ne=P)}function te(P){P!==xp?(Ue(n.CULL_FACE),P!==le&&(P===Dl?n.cullFace(n.BACK):P===Mp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Je(n.CULL_FACE),le=P}function oe(P){P!==L&&(ee&&n.lineWidth(P),L=P)}function J(P,ve,fe){P?(Ue(n.POLYGON_OFFSET_FILL),(G!==ve||Y!==fe)&&(n.polygonOffset(ve,fe),G=ve,Y=fe)):Je(n.POLYGON_OFFSET_FILL)}function Me(P){P?Ue(n.SCISSOR_TEST):Je(n.SCISSOR_TEST)}function M(P){P===void 0&&(P=n.TEXTURE0+H-1),N!==P&&(n.activeTexture(P),N=P)}function g(P,ve,fe){fe===void 0&&(N===null?fe=n.TEXTURE0+H-1:fe=N);let Q=z[fe];Q===void 0&&(Q={type:void 0,texture:void 0},z[fe]=Q),(Q.type!==P||Q.texture!==ve)&&(N!==fe&&(n.activeTexture(fe),N=fe),n.bindTexture(P,ve||Le[P]),Q.type=P,Q.texture=ve)}function D(){const P=z[N];P!==void 0&&P.type!==void 0&&(n.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function j(){try{n.compressedTexImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{n.compressedTexImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ie(){try{n.texSubImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ge(){try{n.texSubImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ye(){try{n.texStorage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ke(){try{n.texStorage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ue(){try{n.texImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ne(){try{n.texImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ae(P){xe.equals(P)===!1&&(n.scissor(P.x,P.y,P.z,P.w),xe.copy(P))}function Re(P){be.equals(P)===!1&&(n.viewport(P.x,P.y,P.z,P.w),be.copy(P))}function we(P,ve){let fe=f.get(ve);fe===void 0&&(fe=new WeakMap,f.set(ve,fe));let Q=fe.get(P);Q===void 0&&(Q=n.getUniformBlockIndex(ve,P.name),fe.set(P,Q))}function Ee(P,ve){const Q=f.get(ve).get(P);u.get(ve)!==Q&&(n.uniformBlockBinding(ve,Q,P.__bindingPointIndex),u.set(ve,Q))}function Ye(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},N=null,z={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,E=null,T=null,w=null,U=null,R=null,Z=null,y=new Ze(0,0,0),A=0,q=!1,ne=null,le=null,L=null,G=null,Y=null,xe.set(0,0,n.canvas.width,n.canvas.height),be.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Ue,disable:Je,bindFramebuffer:Ge,drawBuffers:_,useProgram:C,setBlending:B,setMaterial:K,setFlipSided:re,setCullFace:te,setLineWidth:oe,setPolygonOffset:J,setScissorTest:Me,activeTexture:M,bindTexture:g,unbindTexture:D,compressedTexImage2D:j,compressedTexImage3D:$,texImage2D:ue,texImage3D:Ne,updateUBOMapping:we,uniformBlockBinding:Ee,texStorage2D:ye,texStorage3D:ke,texSubImage2D:ie,texSubImage3D:ge,compressedTexSubImage2D:ce,compressedTexSubImage3D:pe,scissor:Ae,viewport:Re,reset:Ye}}function D0(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),x=new WeakMap;let v;const p=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(M,g){return h?new OffscreenCanvas(M,g):Vs("canvas")}function E(M,g,D,j){let $=1;if((M.width>j||M.height>j)&&($=j/Math.max(M.width,M.height)),$<1||g===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const ie=g?Gs:Math.floor,ge=ie($*M.width),ce=ie($*M.height);v===void 0&&(v=b(ge,ce));const pe=D?b(ge,ce):v;return pe.width=ge,pe.height=ce,pe.getContext("2d").drawImage(M,0,0,ge,ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+ge+"x"+ce+")."),pe}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function T(M){return pa(M.width)&&pa(M.height)}function w(M){return o?!1:M.wrapS!==Qt||M.wrapT!==Qt||M.minFilter!==Ct&&M.minFilter!==Xt}function U(M,g){return M.generateMipmaps&&g&&M.minFilter!==Ct&&M.minFilter!==Xt}function R(M){n.generateMipmap(M)}function Z(M,g,D,j,$=!1){if(o===!1)return g;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ie=g;if(g===n.RED&&(D===n.FLOAT&&(ie=n.R32F),D===n.HALF_FLOAT&&(ie=n.R16F),D===n.UNSIGNED_BYTE&&(ie=n.R8)),g===n.RED_INTEGER&&(D===n.UNSIGNED_BYTE&&(ie=n.R8UI),D===n.UNSIGNED_SHORT&&(ie=n.R16UI),D===n.UNSIGNED_INT&&(ie=n.R32UI),D===n.BYTE&&(ie=n.R8I),D===n.SHORT&&(ie=n.R16I),D===n.INT&&(ie=n.R32I)),g===n.RG&&(D===n.FLOAT&&(ie=n.RG32F),D===n.HALF_FLOAT&&(ie=n.RG16F),D===n.UNSIGNED_BYTE&&(ie=n.RG8)),g===n.RGBA){const ge=$?Os:et.getTransfer(j);D===n.FLOAT&&(ie=n.RGBA32F),D===n.HALF_FLOAT&&(ie=n.RGBA16F),D===n.UNSIGNED_BYTE&&(ie=ge===rt?n.SRGB8_ALPHA8:n.RGBA8),D===n.UNSIGNED_SHORT_4_4_4_4&&(ie=n.RGBA4),D===n.UNSIGNED_SHORT_5_5_5_1&&(ie=n.RGB5_A1)}return(ie===n.R16F||ie===n.R32F||ie===n.RG16F||ie===n.RG32F||ie===n.RGBA16F||ie===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ie}function y(M,g,D){return U(M,D)===!0||M.isFramebufferTexture&&M.minFilter!==Ct&&M.minFilter!==Xt?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function A(M){return M===Ct||M===Bl||M===xo?n.NEAREST:n.LINEAR}function q(M){const g=M.target;g.removeEventListener("dispose",q),le(g),g.isVideoTexture&&x.delete(g)}function ne(M){const g=M.target;g.removeEventListener("dispose",ne),G(g)}function le(M){const g=i.get(M);if(g.__webglInit===void 0)return;const D=M.source,j=p.get(D);if(j){const $=j[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&L(M),Object.keys(j).length===0&&p.delete(D)}i.remove(M)}function L(M){const g=i.get(M);n.deleteTexture(g.__webglTexture);const D=M.source,j=p.get(D);delete j[g.__cacheKey],a.memory.textures--}function G(M){const g=M.texture,D=i.get(M),j=i.get(g);if(j.__webglTexture!==void 0&&(n.deleteTexture(j.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(D.__webglFramebuffer[$]))for(let ie=0;ie<D.__webglFramebuffer[$].length;ie++)n.deleteFramebuffer(D.__webglFramebuffer[$][ie]);else n.deleteFramebuffer(D.__webglFramebuffer[$]);D.__webglDepthbuffer&&n.deleteRenderbuffer(D.__webglDepthbuffer[$])}else{if(Array.isArray(D.__webglFramebuffer))for(let $=0;$<D.__webglFramebuffer.length;$++)n.deleteFramebuffer(D.__webglFramebuffer[$]);else n.deleteFramebuffer(D.__webglFramebuffer);if(D.__webglDepthbuffer&&n.deleteRenderbuffer(D.__webglDepthbuffer),D.__webglMultisampledFramebuffer&&n.deleteFramebuffer(D.__webglMultisampledFramebuffer),D.__webglColorRenderbuffer)for(let $=0;$<D.__webglColorRenderbuffer.length;$++)D.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(D.__webglColorRenderbuffer[$]);D.__webglDepthRenderbuffer&&n.deleteRenderbuffer(D.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let $=0,ie=g.length;$<ie;$++){const ge=i.get(g[$]);ge.__webglTexture&&(n.deleteTexture(ge.__webglTexture),a.memory.textures--),i.remove(g[$])}i.remove(g),i.remove(M)}let Y=0;function H(){Y=0}function ee(){const M=Y;return M>=l&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+l),Y+=1,M}function ae(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function se(M,g){const D=i.get(M);if(M.isVideoTexture&&J(M),M.isRenderTargetTexture===!1&&M.version>0&&D.__version!==M.version){const j=M.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ue(D,M,g);return}}t.bindTexture(n.TEXTURE_2D,D.__webglTexture,n.TEXTURE0+g)}function N(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Ue(D,M,g);return}t.bindTexture(n.TEXTURE_2D_ARRAY,D.__webglTexture,n.TEXTURE0+g)}function z(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Ue(D,M,g);return}t.bindTexture(n.TEXTURE_3D,D.__webglTexture,n.TEXTURE0+g)}function _e(M,g){const D=i.get(M);if(M.version>0&&D.__version!==M.version){Je(D,M,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,D.__webglTexture,n.TEXTURE0+g)}const he={[ua]:n.REPEAT,[Qt]:n.CLAMP_TO_EDGE,[fa]:n.MIRRORED_REPEAT},xe={[Ct]:n.NEAREST,[Bl]:n.NEAREST_MIPMAP_NEAREST,[xo]:n.NEAREST_MIPMAP_LINEAR,[Xt]:n.LINEAR,[Jp]:n.LINEAR_MIPMAP_NEAREST,[Br]:n.LINEAR_MIPMAP_LINEAR},be={[hm]:n.NEVER,[xm]:n.ALWAYS,[dm]:n.LESS,[mm]:n.LEQUAL,[pm]:n.EQUAL,[vm]:n.GEQUAL,[_m]:n.GREATER,[gm]:n.NOTEQUAL};function Ie(M,g,D){if(D?(n.texParameteri(M,n.TEXTURE_WRAP_S,he[g.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,he[g.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,he[g.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,xe[g.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,xe[g.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(g.wrapS!==Qt||g.wrapT!==Qt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,A(g.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,A(g.minFilter)),g.minFilter!==Ct&&g.minFilter!==Xt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,be[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const j=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Ct||g.minFilter!==xo&&g.minFilter!==Br||g.type===Kn&&e.has("OES_texture_float_linear")===!1||o===!1&&g.type===zr&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||i.get(g).__currentAnisotropy)&&(n.texParameterf(M,j.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy)}}function Le(M,g){let D=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",q));const j=g.source;let $=p.get(j);$===void 0&&($={},p.set(j,$));const ie=ae(g);if(ie!==M.__cacheKey){$[ie]===void 0&&($[ie]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,D=!0),$[ie].usedTimes++;const ge=$[M.__cacheKey];ge!==void 0&&($[M.__cacheKey].usedTimes--,ge.usedTimes===0&&L(g)),M.__cacheKey=ie,M.__webglTexture=$[ie].texture}return D}function Ue(M,g,D){let j=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(j=n.TEXTURE_3D);const $=Le(M,g),ie=g.source;t.bindTexture(j,M.__webglTexture,n.TEXTURE0+D);const ge=i.get(ie);if(ie.version!==ge.__version||$===!0){t.activeTexture(n.TEXTURE0+D);const ce=et.getPrimaries(et.workingColorSpace),pe=g.colorSpace===Kt?null:et.getPrimaries(g.colorSpace),ye=g.colorSpace===Kt||ce===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const ke=w(g)&&T(g.image)===!1;let ue=E(g.image,ke,!1,u);ue=Me(g,ue);const Ne=T(ue)||o,Ae=s.convert(g.format,g.colorSpace);let Re=s.convert(g.type),we=Z(g.internalFormat,Ae,Re,g.colorSpace,g.isVideoTexture);Ie(j,g,Ne);let Ee;const Ye=g.mipmaps,P=o&&g.isVideoTexture!==!0,ve=ge.__version===void 0||$===!0,fe=y(g,ue,Ne);if(g.isDepthTexture)we=n.DEPTH_COMPONENT,o?g.type===Kn?we=n.DEPTH_COMPONENT32F:g.type===Yn?we=n.DEPTH_COMPONENT24:g.type===vi?we=n.DEPTH24_STENCIL8:we=n.DEPTH_COMPONENT16:g.type===Kn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===xi&&we===n.DEPTH_COMPONENT&&g.type!==za&&g.type!==Yn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=Yn,Re=s.convert(g.type)),g.format===ir&&we===n.DEPTH_COMPONENT&&(we=n.DEPTH_STENCIL,g.type!==vi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=vi,Re=s.convert(g.type))),ve&&(P?t.texStorage2D(n.TEXTURE_2D,1,we,ue.width,ue.height):t.texImage2D(n.TEXTURE_2D,0,we,ue.width,ue.height,0,Ae,Re,null));else if(g.isDataTexture)if(Ye.length>0&&Ne){P&&ve&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let Q=0,de=Ye.length;Q<de;Q++)Ee=Ye[Q],P?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,Ee.width,Ee.height,Ae,Re,Ee.data):t.texImage2D(n.TEXTURE_2D,Q,we,Ee.width,Ee.height,0,Ae,Re,Ee.data);g.generateMipmaps=!1}else P?(ve&&t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,ue.width,ue.height,Ae,Re,ue.data)):t.texImage2D(n.TEXTURE_2D,0,we,ue.width,ue.height,0,Ae,Re,ue.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){P&&ve&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,we,Ye[0].width,Ye[0].height,ue.depth);for(let Q=0,de=Ye.length;Q<de;Q++)Ee=Ye[Q],g.format!==en?Ae!==null?P?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,Ee.width,Ee.height,ue.depth,Ae,Ee.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Q,we,Ee.width,Ee.height,ue.depth,0,Ee.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?t.texSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,Ee.width,Ee.height,ue.depth,Ae,Re,Ee.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Q,we,Ee.width,Ee.height,ue.depth,0,Ae,Re,Ee.data)}else{P&&ve&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let Q=0,de=Ye.length;Q<de;Q++)Ee=Ye[Q],g.format!==en?Ae!==null?P?t.compressedTexSubImage2D(n.TEXTURE_2D,Q,0,0,Ee.width,Ee.height,Ae,Ee.data):t.compressedTexImage2D(n.TEXTURE_2D,Q,we,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,Ee.width,Ee.height,Ae,Re,Ee.data):t.texImage2D(n.TEXTURE_2D,Q,we,Ee.width,Ee.height,0,Ae,Re,Ee.data)}else if(g.isDataArrayTexture)P?(ve&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,we,ue.width,ue.height,ue.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,Ae,Re,ue.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,we,ue.width,ue.height,ue.depth,0,Ae,Re,ue.data);else if(g.isData3DTexture)P?(ve&&t.texStorage3D(n.TEXTURE_3D,fe,we,ue.width,ue.height,ue.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,Ae,Re,ue.data)):t.texImage3D(n.TEXTURE_3D,0,we,ue.width,ue.height,ue.depth,0,Ae,Re,ue.data);else if(g.isFramebufferTexture){if(ve)if(P)t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height);else{let Q=ue.width,de=ue.height;for(let Ce=0;Ce<fe;Ce++)t.texImage2D(n.TEXTURE_2D,Ce,we,Q,de,0,Ae,Re,null),Q>>=1,de>>=1}}else if(Ye.length>0&&Ne){P&&ve&&t.texStorage2D(n.TEXTURE_2D,fe,we,Ye[0].width,Ye[0].height);for(let Q=0,de=Ye.length;Q<de;Q++)Ee=Ye[Q],P?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,Ae,Re,Ee):t.texImage2D(n.TEXTURE_2D,Q,we,Ae,Re,Ee);g.generateMipmaps=!1}else P?(ve&&t.texStorage2D(n.TEXTURE_2D,fe,we,ue.width,ue.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ae,Re,ue)):t.texImage2D(n.TEXTURE_2D,0,we,Ae,Re,ue);U(g,Ne)&&R(j),ge.__version=ie.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function Je(M,g,D){if(g.image.length!==6)return;const j=Le(M,g),$=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+D);const ie=i.get($);if($.version!==ie.__version||j===!0){t.activeTexture(n.TEXTURE0+D);const ge=et.getPrimaries(et.workingColorSpace),ce=g.colorSpace===Kt?null:et.getPrimaries(g.colorSpace),pe=g.colorSpace===Kt||ge===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const ye=g.isCompressedTexture||g.image[0].isCompressedTexture,ke=g.image[0]&&g.image[0].isDataTexture,ue=[];for(let Q=0;Q<6;Q++)!ye&&!ke?ue[Q]=E(g.image[Q],!1,!0,c):ue[Q]=ke?g.image[Q].image:g.image[Q],ue[Q]=Me(g,ue[Q]);const Ne=ue[0],Ae=T(Ne)||o,Re=s.convert(g.format,g.colorSpace),we=s.convert(g.type),Ee=Z(g.internalFormat,Re,we,g.colorSpace),Ye=o&&g.isVideoTexture!==!0,P=ie.__version===void 0||j===!0;let ve=y(g,Ne,Ae);Ie(n.TEXTURE_CUBE_MAP,g,Ae);let fe;if(ye){Ye&&P&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ve,Ee,Ne.width,Ne.height);for(let Q=0;Q<6;Q++){fe=ue[Q].mipmaps;for(let de=0;de<fe.length;de++){const Ce=fe[de];g.format!==en?Re!==null?Ye?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,0,0,Ce.width,Ce.height,Re,Ce.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,Ee,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,0,0,Ce.width,Ce.height,Re,we,Ce.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,Ee,Ce.width,Ce.height,0,Re,we,Ce.data)}}}else{fe=g.mipmaps,Ye&&P&&(fe.length>0&&ve++,t.texStorage2D(n.TEXTURE_CUBE_MAP,ve,Ee,ue[0].width,ue[0].height));for(let Q=0;Q<6;Q++)if(ke){Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ue[Q].width,ue[Q].height,Re,we,ue[Q].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ee,ue[Q].width,ue[Q].height,0,Re,we,ue[Q].data);for(let de=0;de<fe.length;de++){const Ke=fe[de].image[Q].image;Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,0,0,Ke.width,Ke.height,Re,we,Ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,Ee,Ke.width,Ke.height,0,Re,we,Ke.data)}}else{Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Re,we,ue[Q]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ee,Re,we,ue[Q]);for(let de=0;de<fe.length;de++){const Ce=fe[de];Ye?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,0,0,Re,we,Ce.image[Q]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,Ee,Re,we,Ce.image[Q])}}}U(g,Ae)&&R(n.TEXTURE_CUBE_MAP),ie.__version=$.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function Ge(M,g,D,j,$,ie){const ge=s.convert(D.format,D.colorSpace),ce=s.convert(D.type),pe=Z(D.internalFormat,ge,ce,D.colorSpace);if(!i.get(g).__hasExternalTextures){const ke=Math.max(1,g.width>>ie),ue=Math.max(1,g.height>>ie);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,ie,pe,ke,ue,g.depth,0,ge,ce,null):t.texImage2D($,ie,pe,ke,ue,0,ge,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,$,i.get(D).__webglTexture,0,te(g)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,$,i.get(D).__webglTexture,ie),t.bindFramebuffer(n.FRAMEBUFFER,null)}function _(M,g,D){if(n.bindRenderbuffer(n.RENDERBUFFER,M),g.depthBuffer&&!g.stencilBuffer){let j=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(D||oe(g)){const $=g.depthTexture;$&&$.isDepthTexture&&($.type===Kn?j=n.DEPTH_COMPONENT32F:$.type===Yn&&(j=n.DEPTH_COMPONENT24));const ie=te(g);oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ie,j,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,ie,j,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,j,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(g.depthBuffer&&g.stencilBuffer){const j=te(g);D&&oe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,g.width,g.height):oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const j=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let $=0;$<j.length;$++){const ie=j[$],ge=s.convert(ie.format,ie.colorSpace),ce=s.convert(ie.type),pe=Z(ie.internalFormat,ge,ce,ie.colorSpace),ye=te(g);D&&oe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,ye,pe,g.width,g.height):oe(g)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ye,pe,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,pe,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function C(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),se(g.depthTexture,0);const j=i.get(g.depthTexture).__webglTexture,$=te(g);if(g.depthTexture.format===xi)oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0);else if(g.depthTexture.format===ir)oe(g)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function I(M){const g=i.get(M),D=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");C(g.__webglFramebuffer,M)}else if(D){g.__webglDepthbuffer=[];for(let j=0;j<6;j++)t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[j]),g.__webglDepthbuffer[j]=n.createRenderbuffer(),_(g.__webglDepthbuffer[j],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),_(g.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function V(M,g,D){const j=i.get(M);g!==void 0&&Ge(j.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),D!==void 0&&I(M)}function B(M){const g=M.texture,D=i.get(M),j=i.get(g);M.addEventListener("dispose",ne),M.isWebGLMultipleRenderTargets!==!0&&(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=g.version,a.memory.textures++);const $=M.isWebGLCubeRenderTarget===!0,ie=M.isWebGLMultipleRenderTargets===!0,ge=T(M)||o;if($){D.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(o&&g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer[ce]=[];for(let pe=0;pe<g.mipmaps.length;pe++)D.__webglFramebuffer[ce][pe]=n.createFramebuffer()}else D.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(o&&g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer=[];for(let ce=0;ce<g.mipmaps.length;ce++)D.__webglFramebuffer[ce]=n.createFramebuffer()}else D.__webglFramebuffer=n.createFramebuffer();if(ie)if(r.drawBuffers){const ce=M.texture;for(let pe=0,ye=ce.length;pe<ye;pe++){const ke=i.get(ce[pe]);ke.__webglTexture===void 0&&(ke.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&oe(M)===!1){const ce=ie?g:[g];D.__webglMultisampledFramebuffer=n.createFramebuffer(),D.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let pe=0;pe<ce.length;pe++){const ye=ce[pe];D.__webglColorRenderbuffer[pe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,D.__webglColorRenderbuffer[pe]);const ke=s.convert(ye.format,ye.colorSpace),ue=s.convert(ye.type),Ne=Z(ye.internalFormat,ke,ue,ye.colorSpace,M.isXRRenderTarget===!0),Ae=te(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ae,Ne,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,D.__webglColorRenderbuffer[pe])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(D.__webglDepthRenderbuffer=n.createRenderbuffer(),_(D.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if($){t.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Ie(n.TEXTURE_CUBE_MAP,g,ge);for(let ce=0;ce<6;ce++)if(o&&g.mipmaps&&g.mipmaps.length>0)for(let pe=0;pe<g.mipmaps.length;pe++)Ge(D.__webglFramebuffer[ce][pe],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe);else Ge(D.__webglFramebuffer[ce],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);U(g,ge)&&R(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ie){const ce=M.texture;for(let pe=0,ye=ce.length;pe<ye;pe++){const ke=ce[pe],ue=i.get(ke);t.bindTexture(n.TEXTURE_2D,ue.__webglTexture),Ie(n.TEXTURE_2D,ke,ge),Ge(D.__webglFramebuffer,M,ke,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,0),U(ke,ge)&&R(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?ce=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ce,j.__webglTexture),Ie(ce,g,ge),o&&g.mipmaps&&g.mipmaps.length>0)for(let pe=0;pe<g.mipmaps.length;pe++)Ge(D.__webglFramebuffer[pe],M,g,n.COLOR_ATTACHMENT0,ce,pe);else Ge(D.__webglFramebuffer,M,g,n.COLOR_ATTACHMENT0,ce,0);U(g,ge)&&R(ce),t.unbindTexture()}M.depthBuffer&&I(M)}function K(M){const g=T(M)||o,D=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let j=0,$=D.length;j<$;j++){const ie=D[j];if(U(ie,g)){const ge=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ce=i.get(ie).__webglTexture;t.bindTexture(ge,ce),R(ge),t.unbindTexture()}}}function re(M){if(o&&M.samples>0&&oe(M)===!1){const g=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],D=M.width,j=M.height;let $=n.COLOR_BUFFER_BIT;const ie=[],ge=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=i.get(M),pe=M.isWebGLMultipleRenderTargets===!0;if(pe)for(let ye=0;ye<g.length;ye++)t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ye,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ye,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let ye=0;ye<g.length;ye++){ie.push(n.COLOR_ATTACHMENT0+ye),M.depthBuffer&&ie.push(ge);const ke=ce.__ignoreDepthValues!==void 0?ce.__ignoreDepthValues:!1;if(ke===!1&&(M.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),pe&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ce.__webglColorRenderbuffer[ye]),ke===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[ge]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[ge])),pe){const ue=i.get(g[ye]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ue,0)}n.blitFramebuffer(0,0,D,j,0,0,D,j,$,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ie)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),pe)for(let ye=0;ye<g.length;ye++){t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ye,n.RENDERBUFFER,ce.__webglColorRenderbuffer[ye]);const ke=i.get(g[ye]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ye,n.TEXTURE_2D,ke,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}}function te(M){return Math.min(f,M.samples)}function oe(M){const g=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function J(M){const g=a.render.frame;x.get(M)!==g&&(x.set(M,g),M.update())}function Me(M,g){const D=M.colorSpace,j=M.format,$=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===da||D!==Bn&&D!==Kt&&(et.getTransfer(D)===rt?o===!1?e.has("EXT_sRGB")===!0&&j===en?(M.format=da,M.minFilter=Xt,M.generateMipmaps=!1):g=mf.sRGBToLinear(g):(j!==en||$!==Zn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),g}this.allocateTextureUnit=ee,this.resetTextureUnits=H,this.setTexture2D=se,this.setTexture2DArray=N,this.setTexture3D=z,this.setTextureCube=_e,this.rebindTextures=V,this.setupRenderTarget=B,this.updateRenderTargetMipmap=K,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=I,this.setupFrameBufferTexture=Ge,this.useMultisampledRTT=oe}function U0(n,e,t){const i=t.isWebGL2;function r(s,a=Kt){let o;const l=et.getTransfer(a);if(s===Zn)return n.UNSIGNED_BYTE;if(s===lf)return n.UNSIGNED_SHORT_4_4_4_4;if(s===cf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Qp)return n.BYTE;if(s===em)return n.SHORT;if(s===za)return n.UNSIGNED_SHORT;if(s===af)return n.INT;if(s===Yn)return n.UNSIGNED_INT;if(s===Kn)return n.FLOAT;if(s===zr)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===tm)return n.ALPHA;if(s===en)return n.RGBA;if(s===nm)return n.LUMINANCE;if(s===im)return n.LUMINANCE_ALPHA;if(s===xi)return n.DEPTH_COMPONENT;if(s===ir)return n.DEPTH_STENCIL;if(s===da)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===rm)return n.RED;if(s===uf)return n.RED_INTEGER;if(s===sm)return n.RG;if(s===ff)return n.RG_INTEGER;if(s===hf)return n.RGBA_INTEGER;if(s===Mo||s===So||s===Eo||s===yo)if(l===rt)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Mo)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===So)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Eo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===yo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Mo)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===So)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Eo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===yo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===zl||s===Hl||s===Gl||s===Vl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===zl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Hl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Gl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Vl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===om)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Wl||s===kl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===Wl)return l===rt?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===kl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Xl||s===ql||s===Yl||s===Kl||s===jl||s===$l||s===Zl||s===Jl||s===Ql||s===ec||s===tc||s===nc||s===ic||s===rc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Xl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===ql)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Yl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Kl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===jl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===$l)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Zl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Jl)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ql)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ec)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===tc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===nc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===ic)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===rc)return l===rt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===To||s===sc||s===oc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===To)return l===rt?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===sc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===oc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===am||s===ac||s===lc||s===cc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===To)return o.COMPRESSED_RED_RGTC1_EXT;if(s===ac)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===lc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===cc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===vi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class I0 extends Yt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ss extends Ot{constructor(){super(),this.isGroup=!0,this.type="Group"}}const N0={type:"move"};class Yo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ss,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ss,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ss,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,i),h=this._getHandJoint(c,v);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&d>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(N0)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Ss;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class F0 extends Ft{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:xi,u!==xi&&u!==ir)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===xi&&(i=Yn),i===void 0&&u===ir&&(i=vi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Ct,this.minFilter=l!==void 0?l:Ct,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class O0 extends sr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,d=null,m=null,x=null;const v=t.getContextAttributes();let p=null,h=null;const b=[],E=[],T=new Yt;T.layers.enable(1),T.viewport=new vt;const w=new Yt;w.layers.enable(2),w.viewport=new vt;const U=[T,w],R=new I0;R.layers.enable(1),R.layers.enable(2);let Z=null,y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let z=b[N];return z===void 0&&(z=new Yo,b[N]=z),z.getTargetRaySpace()},this.getControllerGrip=function(N){let z=b[N];return z===void 0&&(z=new Yo,b[N]=z),z.getGripSpace()},this.getHand=function(N){let z=b[N];return z===void 0&&(z=new Yo,b[N]=z),z.getHandSpace()};function A(N){const z=E.indexOf(N.inputSource);if(z===-1)return;const _e=b[z];_e!==void 0&&(_e.update(N.inputSource,N.frame,c||a),_e.dispatchEvent({type:N.type,data:N.inputSource}))}function q(){r.removeEventListener("select",A),r.removeEventListener("selectstart",A),r.removeEventListener("selectend",A),r.removeEventListener("squeeze",A),r.removeEventListener("squeezestart",A),r.removeEventListener("squeezeend",A),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",ne);for(let N=0;N<b.length;N++){const z=E[N];z!==null&&(E[N]=null,b[N].disconnect(z))}Z=null,y=null,e.setRenderTarget(p),m=null,d=null,f=null,r=null,h=null,se.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){s=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){o=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(N){c=N},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(N){if(r=N,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",A),r.addEventListener("selectstart",A),r.addEventListener("selectend",A),r.addEventListener("squeeze",A),r.addEventListener("squeezestart",A),r.addEventListener("squeezeend",A),r.addEventListener("end",q),r.addEventListener("inputsourceschange",ne),v.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const z={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,z),r.updateRenderState({baseLayer:m}),h=new Si(m.framebufferWidth,m.framebufferHeight,{format:en,type:Zn,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let z=null,_e=null,he=null;v.depth&&(he=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,z=v.stencil?ir:xi,_e=v.stencil?vi:Yn);const xe={colorFormat:t.RGBA8,depthFormat:he,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(xe),r.updateRenderState({layers:[d]}),h=new Si(d.textureWidth,d.textureHeight,{format:en,type:Zn,depthTexture:new F0(d.textureWidth,d.textureHeight,_e,void 0,void 0,void 0,void 0,void 0,void 0,z),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const be=e.properties.get(h);be.__ignoreDepthValues=d.ignoreDepthValues}h.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function ne(N){for(let z=0;z<N.removed.length;z++){const _e=N.removed[z],he=E.indexOf(_e);he>=0&&(E[he]=null,b[he].disconnect(_e))}for(let z=0;z<N.added.length;z++){const _e=N.added[z];let he=E.indexOf(_e);if(he===-1){for(let be=0;be<b.length;be++)if(be>=E.length){E.push(_e),he=be;break}else if(E[be]===null){E[be]=_e,he=be;break}if(he===-1)break}const xe=b[he];xe&&xe.connect(_e)}}const le=new O,L=new O;function G(N,z,_e){le.setFromMatrixPosition(z.matrixWorld),L.setFromMatrixPosition(_e.matrixWorld);const he=le.distanceTo(L),xe=z.projectionMatrix.elements,be=_e.projectionMatrix.elements,Ie=xe[14]/(xe[10]-1),Le=xe[14]/(xe[10]+1),Ue=(xe[9]+1)/xe[5],Je=(xe[9]-1)/xe[5],Ge=(xe[8]-1)/xe[0],_=(be[8]+1)/be[0],C=Ie*Ge,I=Ie*_,V=he/(-Ge+_),B=V*-Ge;z.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(B),N.translateZ(V),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert();const K=Ie+V,re=Le+V,te=C-B,oe=I+(he-B),J=Ue*Le/re*K,Me=Je*Le/re*K;N.projectionMatrix.makePerspective(te,oe,J,Me,K,re),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}function Y(N,z){z===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(z.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(r===null)return;R.near=w.near=T.near=N.near,R.far=w.far=T.far=N.far,(Z!==R.near||y!==R.far)&&(r.updateRenderState({depthNear:R.near,depthFar:R.far}),Z=R.near,y=R.far);const z=N.parent,_e=R.cameras;Y(R,z);for(let he=0;he<_e.length;he++)Y(_e[he],z);_e.length===2?G(R,T,w):R.projectionMatrix.copy(T.projectionMatrix),H(N,R,z)};function H(N,z,_e){_e===null?N.matrix.copy(z.matrixWorld):(N.matrix.copy(_e.matrixWorld),N.matrix.invert(),N.matrix.multiply(z.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(z.projectionMatrix),N.projectionMatrixInverse.copy(z.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=Hr*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(N){l=N,d!==null&&(d.fixedFoveation=N),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=N)};let ee=null;function ae(N,z){if(u=z.getViewerPose(c||a),x=z,u!==null){const _e=u.views;m!==null&&(e.setRenderTargetFramebuffer(h,m.framebuffer),e.setRenderTarget(h));let he=!1;_e.length!==R.cameras.length&&(R.cameras.length=0,he=!0);for(let xe=0;xe<_e.length;xe++){const be=_e[xe];let Ie=null;if(m!==null)Ie=m.getViewport(be);else{const Ue=f.getViewSubImage(d,be);Ie=Ue.viewport,xe===0&&(e.setRenderTargetTextures(h,Ue.colorTexture,d.ignoreDepthValues?void 0:Ue.depthStencilTexture),e.setRenderTarget(h))}let Le=U[xe];Le===void 0&&(Le=new Yt,Le.layers.enable(xe),Le.viewport=new vt,U[xe]=Le),Le.matrix.fromArray(be.transform.matrix),Le.matrix.decompose(Le.position,Le.quaternion,Le.scale),Le.projectionMatrix.fromArray(be.projectionMatrix),Le.projectionMatrixInverse.copy(Le.projectionMatrix).invert(),Le.viewport.set(Ie.x,Ie.y,Ie.width,Ie.height),xe===0&&(R.matrix.copy(Le.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),he===!0&&R.cameras.push(Le)}}for(let _e=0;_e<b.length;_e++){const he=E[_e],xe=b[_e];he!==null&&xe!==void 0&&xe.update(he,z,c||a)}ee&&ee(N,z),z.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:z}),x=null}const se=new Af;se.setAnimationLoop(ae),this.setAnimationLoop=function(N){ee=N},this.dispose=function(){}}}function B0(n,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function i(p,h){h.color.getRGB(p.fogColor.value,Ef(n)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,b,E,T){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),f(p,h)):h.isMeshPhongMaterial?(s(p,h),u(p,h)):h.isMeshStandardMaterial?(s(p,h),d(p,h),h.isMeshPhysicalMaterial&&m(p,h,T)):h.isMeshMatcapMaterial?(s(p,h),x(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),v(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,b,E):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===Nt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===Nt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=e.get(h).envMap;if(b&&(p.envMap.value=b,p.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap){p.lightMap.value=h.lightMap;const E=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=h.lightMapIntensity*E,t(h.lightMap,p.lightMapTransform)}h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,b,E){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=E*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function f(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function d(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),e.get(h).envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Nt&&p.clearcoatNormalScale.value.negate())),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,h){h.matcap&&(p.matcap.value=h.matcap)}function v(p,h){const b=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function z0(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(b,E){const T=E.program;i.uniformBlockBinding(b,T)}function c(b,E){let T=r[b.id];T===void 0&&(x(b),T=u(b),r[b.id]=T,b.addEventListener("dispose",p));const w=E.program;i.updateUBOMapping(b,w);const U=e.render.frame;s[b.id]!==U&&(d(b),s[b.id]=U)}function u(b){const E=f();b.__bindingPointIndex=E;const T=n.createBuffer(),w=b.__size,U=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,T),n.bufferData(n.UNIFORM_BUFFER,w,U),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,E,T),T}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const E=r[b.id],T=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,E);for(let U=0,R=T.length;U<R;U++){const Z=T[U];if(m(Z,U,w)===!0){const y=Z.__offset,A=Array.isArray(Z.value)?Z.value:[Z.value];let q=0;for(let ne=0;ne<A.length;ne++){const le=A[ne],L=v(le);typeof le=="number"?(Z.__data[0]=le,n.bufferSubData(n.UNIFORM_BUFFER,y+q,Z.__data)):le.isMatrix3?(Z.__data[0]=le.elements[0],Z.__data[1]=le.elements[1],Z.__data[2]=le.elements[2],Z.__data[3]=le.elements[0],Z.__data[4]=le.elements[3],Z.__data[5]=le.elements[4],Z.__data[6]=le.elements[5],Z.__data[7]=le.elements[0],Z.__data[8]=le.elements[6],Z.__data[9]=le.elements[7],Z.__data[10]=le.elements[8],Z.__data[11]=le.elements[0]):(le.toArray(Z.__data,q),q+=L.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,y,Z.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(b,E,T){const w=b.value;if(T[E]===void 0){if(typeof w=="number")T[E]=w;else{const U=Array.isArray(w)?w:[w],R=[];for(let Z=0;Z<U.length;Z++)R.push(U[Z].clone());T[E]=R}return!0}else if(typeof w=="number"){if(T[E]!==w)return T[E]=w,!0}else{const U=Array.isArray(T[E])?T[E]:[T[E]],R=Array.isArray(w)?w:[w];for(let Z=0;Z<U.length;Z++){const y=U[Z];if(y.equals(R[Z])===!1)return y.copy(R[Z]),!0}}return!1}function x(b){const E=b.uniforms;let T=0;const w=16;let U=0;for(let R=0,Z=E.length;R<Z;R++){const y=E[R],A={boundary:0,storage:0},q=Array.isArray(y.value)?y.value:[y.value];for(let ne=0,le=q.length;ne<le;ne++){const L=q[ne],G=v(L);A.boundary+=G.boundary,A.storage+=G.storage}if(y.__data=new Float32Array(A.storage/Float32Array.BYTES_PER_ELEMENT),y.__offset=T,R>0){U=T%w;const ne=w-U;U!==0&&ne-A.boundary<0&&(T+=w-U,y.__offset=T)}T+=A.storage}return U=T%w,U>0&&(T+=w-U),b.__size=T,b.__cache={},this}function v(b){const E={boundary:0,storage:0};return typeof b=="number"?(E.boundary=4,E.storage=4):b.isVector2?(E.boundary=8,E.storage=8):b.isVector3||b.isColor?(E.boundary=16,E.storage=12):b.isVector4?(E.boundary=16,E.storage=16):b.isMatrix3?(E.boundary=48,E.storage=48):b.isMatrix4?(E.boundary=64,E.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),E}function p(b){const E=b.target;E.removeEventListener("dispose",p);const T=a.indexOf(E.__bindingPointIndex);a.splice(T,1),n.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function h(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:h}}class Lf{constructor(e={}){const{canvas:t=Nm(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=a;const m=new Uint32Array(4),x=new Int32Array(4);let v=null,p=null;const h=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=gt,this._useLegacyLights=!1,this.toneMapping=$n,this.toneMappingExposure=1;const E=this;let T=!1,w=0,U=0,R=null,Z=-1,y=null;const A=new vt,q=new vt;let ne=null;const le=new Ze(0);let L=0,G=t.width,Y=t.height,H=1,ee=null,ae=null;const se=new vt(0,0,G,Y),N=new vt(0,0,G,Y);let z=!1;const _e=new bf;let he=!1,xe=!1,be=null;const Ie=new at,Le=new qe,Ue=new O,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ge(){return R===null?H:1}let _=i;function C(S,F){for(let W=0;W<S.length;W++){const k=S[W],X=t.getContext(k,F);if(X!==null)return X}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ba}`),t.addEventListener("webglcontextlost",Ye,!1),t.addEventListener("webglcontextrestored",P,!1),t.addEventListener("webglcontextcreationerror",ve,!1),_===null){const F=["webgl2","webgl","experimental-webgl"];if(E.isWebGL1Renderer===!0&&F.shift(),_=C(F,S),_===null)throw C(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&_ instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),_.getShaderPrecisionFormat===void 0&&(_.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let I,V,B,K,re,te,oe,J,Me,M,g,D,j,$,ie,ge,ce,pe,ye,ke,ue,Ne,Ae,Re;function we(){I=new jv(_),V=new Vv(_,I,e),I.init(V),Ne=new U0(_,I,V),B=new L0(_,I,V),K=new Jv(_),re=new g0,te=new D0(_,I,B,re,V,Ne,K),oe=new kv(E),J=new Kv(E),Me=new a_(_,V),Ae=new Hv(_,I,Me,V),M=new $v(_,Me,K,Ae),g=new nx(_,M,Me,K),ye=new tx(_,V,te),ge=new Wv(re),D=new _0(E,oe,J,I,V,Ae,ge),j=new B0(E,re),$=new x0,ie=new b0(I,V),pe=new zv(E,oe,J,B,g,d,l),ce=new P0(E,g,V),Re=new z0(_,K,V,B),ke=new Gv(_,I,K,V),ue=new Zv(_,I,K,V),K.programs=D.programs,E.capabilities=V,E.extensions=I,E.properties=re,E.renderLists=$,E.shadowMap=ce,E.state=B,E.info=K}we();const Ee=new O0(E,_);this.xr=Ee,this.getContext=function(){return _},this.getContextAttributes=function(){return _.getContextAttributes()},this.forceContextLoss=function(){const S=I.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=I.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return H},this.setPixelRatio=function(S){S!==void 0&&(H=S,this.setSize(G,Y,!1))},this.getSize=function(S){return S.set(G,Y)},this.setSize=function(S,F,W=!0){if(Ee.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=S,Y=F,t.width=Math.floor(S*H),t.height=Math.floor(F*H),W===!0&&(t.style.width=S+"px",t.style.height=F+"px"),this.setViewport(0,0,S,F)},this.getDrawingBufferSize=function(S){return S.set(G*H,Y*H).floor()},this.setDrawingBufferSize=function(S,F,W){G=S,Y=F,H=W,t.width=Math.floor(S*W),t.height=Math.floor(F*W),this.setViewport(0,0,S,F)},this.getCurrentViewport=function(S){return S.copy(A)},this.getViewport=function(S){return S.copy(se)},this.setViewport=function(S,F,W,k){S.isVector4?se.set(S.x,S.y,S.z,S.w):se.set(S,F,W,k),B.viewport(A.copy(se).multiplyScalar(H).floor())},this.getScissor=function(S){return S.copy(N)},this.setScissor=function(S,F,W,k){S.isVector4?N.set(S.x,S.y,S.z,S.w):N.set(S,F,W,k),B.scissor(q.copy(N).multiplyScalar(H).floor())},this.getScissorTest=function(){return z},this.setScissorTest=function(S){B.setScissorTest(z=S)},this.setOpaqueSort=function(S){ee=S},this.setTransparentSort=function(S){ae=S},this.getClearColor=function(S){return S.copy(pe.getClearColor())},this.setClearColor=function(){pe.setClearColor.apply(pe,arguments)},this.getClearAlpha=function(){return pe.getClearAlpha()},this.setClearAlpha=function(){pe.setClearAlpha.apply(pe,arguments)},this.clear=function(S=!0,F=!0,W=!0){let k=0;if(S){let X=!1;if(R!==null){const Se=R.texture.format;X=Se===hf||Se===ff||Se===uf}if(X){const Se=R.texture.type,Te=Se===Zn||Se===Yn||Se===za||Se===vi||Se===lf||Se===cf,Pe=pe.getClearColor(),De=pe.getClearAlpha(),Ve=Pe.r,Fe=Pe.g,Be=Pe.b;Te?(m[0]=Ve,m[1]=Fe,m[2]=Be,m[3]=De,_.clearBufferuiv(_.COLOR,0,m)):(x[0]=Ve,x[1]=Fe,x[2]=Be,x[3]=De,_.clearBufferiv(_.COLOR,0,x))}else k|=_.COLOR_BUFFER_BIT}F&&(k|=_.DEPTH_BUFFER_BIT),W&&(k|=_.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),_.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ye,!1),t.removeEventListener("webglcontextrestored",P,!1),t.removeEventListener("webglcontextcreationerror",ve,!1),$.dispose(),ie.dispose(),re.dispose(),oe.dispose(),J.dispose(),g.dispose(),Ae.dispose(),Re.dispose(),D.dispose(),Ee.dispose(),Ee.removeEventListener("sessionstart",Wt),Ee.removeEventListener("sessionend",nt),be&&(be.dispose(),be=null),Tt.stop()};function Ye(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function P(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const S=K.autoReset,F=ce.enabled,W=ce.autoUpdate,k=ce.needsUpdate,X=ce.type;we(),K.autoReset=S,ce.enabled=F,ce.autoUpdate=W,ce.needsUpdate=k,ce.type=X}function ve(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function fe(S){const F=S.target;F.removeEventListener("dispose",fe),Q(F)}function Q(S){de(S),re.remove(S)}function de(S){const F=re.get(S).programs;F!==void 0&&(F.forEach(function(W){D.releaseProgram(W)}),S.isShaderMaterial&&D.releaseShaderCache(S))}this.renderBufferDirect=function(S,F,W,k,X,Se){F===null&&(F=Je);const Te=X.isMesh&&X.matrixWorld.determinant()<0,Pe=Nf(S,F,W,k,X);B.setMaterial(k,Te);let De=W.index,Ve=1;if(k.wireframe===!0){if(De=M.getWireframeAttribute(W),De===void 0)return;Ve=2}const Fe=W.drawRange,Be=W.attributes.position;let lt=Fe.start*Ve,Bt=(Fe.start+Fe.count)*Ve;Se!==null&&(lt=Math.max(lt,Se.start*Ve),Bt=Math.min(Bt,(Se.start+Se.count)*Ve)),De!==null?(lt=Math.max(lt,0),Bt=Math.min(Bt,De.count)):Be!=null&&(lt=Math.max(lt,0),Bt=Math.min(Bt,Be.count));const pt=Bt-lt;if(pt<0||pt===1/0)return;Ae.setup(X,k,Pe,W,De);let vn,ot=ke;if(De!==null&&(vn=Me.get(De),ot=ue,ot.setIndex(vn)),X.isMesh)k.wireframe===!0?(B.setLineWidth(k.wireframeLinewidth*Ge()),ot.setMode(_.LINES)):ot.setMode(_.TRIANGLES);else if(X.isLine){let Xe=k.linewidth;Xe===void 0&&(Xe=1),B.setLineWidth(Xe*Ge()),X.isLineSegments?ot.setMode(_.LINES):X.isLineLoop?ot.setMode(_.LINE_LOOP):ot.setMode(_.LINE_STRIP)}else X.isPoints?ot.setMode(_.POINTS):X.isSprite&&ot.setMode(_.TRIANGLES);if(X.isInstancedMesh)ot.renderInstances(lt,pt,X.count);else if(W.isInstancedBufferGeometry){const Xe=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,no=Math.min(W.instanceCount,Xe);ot.renderInstances(lt,pt,no)}else ot.render(lt,pt)};function Ce(S,F,W){S.transparent===!0&&S.side===Pn&&S.forceSinglePass===!1?(S.side=Nt,S.needsUpdate=!0,Kr(S,F,W),S.side=ti,S.needsUpdate=!0,Kr(S,F,W),S.side=Pn):Kr(S,F,W)}this.compile=function(S,F,W=null){W===null&&(W=S),p=ie.get(W),p.init(),b.push(p),W.traverseVisible(function(X){X.isLight&&X.layers.test(F.layers)&&(p.pushLight(X),X.castShadow&&p.pushShadow(X))}),S!==W&&S.traverseVisible(function(X){X.isLight&&X.layers.test(F.layers)&&(p.pushLight(X),X.castShadow&&p.pushShadow(X))}),p.setupLights(E._useLegacyLights);const k=new Set;return S.traverse(function(X){const Se=X.material;if(Se)if(Array.isArray(Se))for(let Te=0;Te<Se.length;Te++){const Pe=Se[Te];Ce(Pe,W,X),k.add(Pe)}else Ce(Se,W,X),k.add(Se)}),b.pop(),p=null,k},this.compileAsync=function(S,F,W=null){const k=this.compile(S,F,W);return new Promise(X=>{function Se(){if(k.forEach(function(Te){re.get(Te).currentProgram.isReady()&&k.delete(Te)}),k.size===0){X(S);return}setTimeout(Se,10)}I.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let Ke=null;function ct(S){Ke&&Ke(S)}function Wt(){Tt.stop()}function nt(){Tt.start()}const Tt=new Af;Tt.setAnimationLoop(ct),typeof self<"u"&&Tt.setContext(self),this.setAnimationLoop=function(S){Ke=S,Ee.setAnimationLoop(S),S===null?Tt.stop():Tt.start()},Ee.addEventListener("sessionstart",Wt),Ee.addEventListener("sessionend",nt),this.render=function(S,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Ee.enabled===!0&&Ee.isPresenting===!0&&(Ee.cameraAutoUpdate===!0&&Ee.updateCamera(F),F=Ee.getCamera()),S.isScene===!0&&S.onBeforeRender(E,S,F,R),p=ie.get(S,b.length),p.init(),b.push(p),Ie.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),_e.setFromProjectionMatrix(Ie),xe=this.localClippingEnabled,he=ge.init(this.clippingPlanes,xe),v=$.get(S,h.length),v.init(),h.push(v),on(S,F,0,E.sortObjects),v.finish(),E.sortObjects===!0&&v.sort(ee,ae),this.info.render.frame++,he===!0&&ge.beginShadows();const W=p.state.shadowsArray;if(ce.render(W,S,F),he===!0&&ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),pe.render(v,S),p.setupLights(E._useLegacyLights),F.isArrayCamera){const k=F.cameras;for(let X=0,Se=k.length;X<Se;X++){const Te=k[X];Ya(v,S,Te,Te.viewport)}}else Ya(v,S,F);R!==null&&(te.updateMultisampleRenderTarget(R),te.updateRenderTargetMipmap(R)),S.isScene===!0&&S.onAfterRender(E,S,F),Ae.resetDefaultState(),Z=-1,y=null,b.pop(),b.length>0?p=b[b.length-1]:p=null,h.pop(),h.length>0?v=h[h.length-1]:v=null};function on(S,F,W,k){if(S.visible===!1)return;if(S.layers.test(F.layers)){if(S.isGroup)W=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(F);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||_e.intersectsSprite(S)){k&&Ue.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Ie);const Te=g.update(S),Pe=S.material;Pe.visible&&v.push(S,Te,Pe,W,Ue.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||_e.intersectsObject(S))){const Te=g.update(S),Pe=S.material;if(k&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ue.copy(S.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),Ue.copy(Te.boundingSphere.center)),Ue.applyMatrix4(S.matrixWorld).applyMatrix4(Ie)),Array.isArray(Pe)){const De=Te.groups;for(let Ve=0,Fe=De.length;Ve<Fe;Ve++){const Be=De[Ve],lt=Pe[Be.materialIndex];lt&&lt.visible&&v.push(S,Te,lt,W,Ue.z,Be)}}else Pe.visible&&v.push(S,Te,Pe,W,Ue.z,null)}}const Se=S.children;for(let Te=0,Pe=Se.length;Te<Pe;Te++)on(Se[Te],F,W,k)}function Ya(S,F,W,k){const X=S.opaque,Se=S.transmissive,Te=S.transparent;p.setupLightsView(W),he===!0&&ge.setGlobalState(E.clippingPlanes,W),Se.length>0&&If(X,Se,F,W),k&&B.viewport(A.copy(k)),X.length>0&&Yr(X,F,W),Se.length>0&&Yr(Se,F,W),Te.length>0&&Yr(Te,F,W),B.buffers.depth.setTest(!0),B.buffers.depth.setMask(!0),B.buffers.color.setMask(!0),B.setPolygonOffset(!1)}function If(S,F,W,k){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;const Se=V.isWebGL2;be===null&&(be=new Si(1,1,{generateMipmaps:!0,type:I.has("EXT_color_buffer_half_float")?zr:Zn,minFilter:Br,samples:Se?4:0})),E.getDrawingBufferSize(Le),Se?be.setSize(Le.x,Le.y):be.setSize(Gs(Le.x),Gs(Le.y));const Te=E.getRenderTarget();E.setRenderTarget(be),E.getClearColor(le),L=E.getClearAlpha(),L<1&&E.setClearColor(16777215,.5),E.clear();const Pe=E.toneMapping;E.toneMapping=$n,Yr(S,W,k),te.updateMultisampleRenderTarget(be),te.updateRenderTargetMipmap(be);let De=!1;for(let Ve=0,Fe=F.length;Ve<Fe;Ve++){const Be=F[Ve],lt=Be.object,Bt=Be.geometry,pt=Be.material,vn=Be.group;if(pt.side===Pn&&lt.layers.test(k.layers)){const ot=pt.side;pt.side=Nt,pt.needsUpdate=!0,Ka(lt,W,k,Bt,pt,vn),pt.side=ot,pt.needsUpdate=!0,De=!0}}De===!0&&(te.updateMultisampleRenderTarget(be),te.updateRenderTargetMipmap(be)),E.setRenderTarget(Te),E.setClearColor(le,L),E.toneMapping=Pe}function Yr(S,F,W){const k=F.isScene===!0?F.overrideMaterial:null;for(let X=0,Se=S.length;X<Se;X++){const Te=S[X],Pe=Te.object,De=Te.geometry,Ve=k===null?Te.material:k,Fe=Te.group;Pe.layers.test(W.layers)&&Ka(Pe,F,W,De,Ve,Fe)}}function Ka(S,F,W,k,X,Se){S.onBeforeRender(E,F,W,k,X,Se),S.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),X.onBeforeRender(E,F,W,k,S,Se),X.transparent===!0&&X.side===Pn&&X.forceSinglePass===!1?(X.side=Nt,X.needsUpdate=!0,E.renderBufferDirect(W,F,k,X,S,Se),X.side=ti,X.needsUpdate=!0,E.renderBufferDirect(W,F,k,X,S,Se),X.side=Pn):E.renderBufferDirect(W,F,k,X,S,Se),S.onAfterRender(E,F,W,k,X,Se)}function Kr(S,F,W){F.isScene!==!0&&(F=Je);const k=re.get(S),X=p.state.lights,Se=p.state.shadowsArray,Te=X.state.version,Pe=D.getParameters(S,X.state,Se,F,W),De=D.getProgramCacheKey(Pe);let Ve=k.programs;k.environment=S.isMeshStandardMaterial?F.environment:null,k.fog=F.fog,k.envMap=(S.isMeshStandardMaterial?J:oe).get(S.envMap||k.environment),Ve===void 0&&(S.addEventListener("dispose",fe),Ve=new Map,k.programs=Ve);let Fe=Ve.get(De);if(Fe!==void 0){if(k.currentProgram===Fe&&k.lightsStateVersion===Te)return $a(S,Pe),Fe}else Pe.uniforms=D.getUniforms(S),S.onBuild(W,Pe,E),S.onBeforeCompile(Pe,E),Fe=D.acquireProgram(Pe,De),Ve.set(De,Fe),k.uniforms=Pe.uniforms;const Be=k.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Be.clippingPlanes=ge.uniform),$a(S,Pe),k.needsLights=Of(S),k.lightsStateVersion=Te,k.needsLights&&(Be.ambientLightColor.value=X.state.ambient,Be.lightProbe.value=X.state.probe,Be.directionalLights.value=X.state.directional,Be.directionalLightShadows.value=X.state.directionalShadow,Be.spotLights.value=X.state.spot,Be.spotLightShadows.value=X.state.spotShadow,Be.rectAreaLights.value=X.state.rectArea,Be.ltc_1.value=X.state.rectAreaLTC1,Be.ltc_2.value=X.state.rectAreaLTC2,Be.pointLights.value=X.state.point,Be.pointLightShadows.value=X.state.pointShadow,Be.hemisphereLights.value=X.state.hemi,Be.directionalShadowMap.value=X.state.directionalShadowMap,Be.directionalShadowMatrix.value=X.state.directionalShadowMatrix,Be.spotShadowMap.value=X.state.spotShadowMap,Be.spotLightMatrix.value=X.state.spotLightMatrix,Be.spotLightMap.value=X.state.spotLightMap,Be.pointShadowMap.value=X.state.pointShadowMap,Be.pointShadowMatrix.value=X.state.pointShadowMatrix),k.currentProgram=Fe,k.uniformsList=null,Fe}function ja(S){if(S.uniformsList===null){const F=S.currentProgram.getUniforms();S.uniformsList=Cs.seqWithValue(F.seq,S.uniforms)}return S.uniformsList}function $a(S,F){const W=re.get(S);W.outputColorSpace=F.outputColorSpace,W.instancing=F.instancing,W.instancingColor=F.instancingColor,W.skinning=F.skinning,W.morphTargets=F.morphTargets,W.morphNormals=F.morphNormals,W.morphColors=F.morphColors,W.morphTargetsCount=F.morphTargetsCount,W.numClippingPlanes=F.numClippingPlanes,W.numIntersection=F.numClipIntersection,W.vertexAlphas=F.vertexAlphas,W.vertexTangents=F.vertexTangents,W.toneMapping=F.toneMapping}function Nf(S,F,W,k,X){F.isScene!==!0&&(F=Je),te.resetTextureUnits();const Se=F.fog,Te=k.isMeshStandardMaterial?F.environment:null,Pe=R===null?E.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Bn,De=(k.isMeshStandardMaterial?J:oe).get(k.envMap||Te),Ve=k.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Fe=!!W.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Be=!!W.morphAttributes.position,lt=!!W.morphAttributes.normal,Bt=!!W.morphAttributes.color;let pt=$n;k.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(pt=E.toneMapping);const vn=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,ot=vn!==void 0?vn.length:0,Xe=re.get(k),no=p.state.lights;if(he===!0&&(xe===!0||S!==y)){const zt=S===y&&k.id===Z;ge.setState(k,S,zt)}let ut=!1;k.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==no.state.version||Xe.outputColorSpace!==Pe||X.isInstancedMesh&&Xe.instancing===!1||!X.isInstancedMesh&&Xe.instancing===!0||X.isSkinnedMesh&&Xe.skinning===!1||!X.isSkinnedMesh&&Xe.skinning===!0||X.isInstancedMesh&&Xe.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&Xe.instancingColor===!1&&X.instanceColor!==null||Xe.envMap!==De||k.fog===!0&&Xe.fog!==Se||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==ge.numPlanes||Xe.numIntersection!==ge.numIntersection)||Xe.vertexAlphas!==Ve||Xe.vertexTangents!==Fe||Xe.morphTargets!==Be||Xe.morphNormals!==lt||Xe.morphColors!==Bt||Xe.toneMapping!==pt||V.isWebGL2===!0&&Xe.morphTargetsCount!==ot)&&(ut=!0):(ut=!0,Xe.__version=k.version);let ii=Xe.currentProgram;ut===!0&&(ii=Kr(k,F,X));let Za=!1,lr=!1,io=!1;const bt=ii.getUniforms(),ri=Xe.uniforms;if(B.useProgram(ii.program)&&(Za=!0,lr=!0,io=!0),k.id!==Z&&(Z=k.id,lr=!0),Za||y!==S){bt.setValue(_,"projectionMatrix",S.projectionMatrix),bt.setValue(_,"viewMatrix",S.matrixWorldInverse);const zt=bt.map.cameraPosition;zt!==void 0&&zt.setValue(_,Ue.setFromMatrixPosition(S.matrixWorld)),V.logarithmicDepthBuffer&&bt.setValue(_,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&bt.setValue(_,"isOrthographic",S.isOrthographicCamera===!0),y!==S&&(y=S,lr=!0,io=!0)}if(X.isSkinnedMesh){bt.setOptional(_,X,"bindMatrix"),bt.setOptional(_,X,"bindMatrixInverse");const zt=X.skeleton;zt&&(V.floatVertexTextures?(zt.boneTexture===null&&zt.computeBoneTexture(),bt.setValue(_,"boneTexture",zt.boneTexture,te),bt.setValue(_,"boneTextureSize",zt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const ro=W.morphAttributes;if((ro.position!==void 0||ro.normal!==void 0||ro.color!==void 0&&V.isWebGL2===!0)&&ye.update(X,W,ii),(lr||Xe.receiveShadow!==X.receiveShadow)&&(Xe.receiveShadow=X.receiveShadow,bt.setValue(_,"receiveShadow",X.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(ri.envMap.value=De,ri.flipEnvMap.value=De.isCubeTexture&&De.isRenderTargetTexture===!1?-1:1),lr&&(bt.setValue(_,"toneMappingExposure",E.toneMappingExposure),Xe.needsLights&&Ff(ri,io),Se&&k.fog===!0&&j.refreshFogUniforms(ri,Se),j.refreshMaterialUniforms(ri,k,H,Y,be),Cs.upload(_,ja(Xe),ri,te)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Cs.upload(_,ja(Xe),ri,te),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&bt.setValue(_,"center",X.center),bt.setValue(_,"modelViewMatrix",X.modelViewMatrix),bt.setValue(_,"normalMatrix",X.normalMatrix),bt.setValue(_,"modelMatrix",X.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const zt=k.uniformsGroups;for(let so=0,Bf=zt.length;so<Bf;so++)if(V.isWebGL2){const Ja=zt[so];Re.update(Ja,ii),Re.bind(Ja,ii)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return ii}function Ff(S,F){S.ambientLightColor.needsUpdate=F,S.lightProbe.needsUpdate=F,S.directionalLights.needsUpdate=F,S.directionalLightShadows.needsUpdate=F,S.pointLights.needsUpdate=F,S.pointLightShadows.needsUpdate=F,S.spotLights.needsUpdate=F,S.spotLightShadows.needsUpdate=F,S.rectAreaLights.needsUpdate=F,S.hemisphereLights.needsUpdate=F}function Of(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(S,F,W){re.get(S.texture).__webglTexture=F,re.get(S.depthTexture).__webglTexture=W;const k=re.get(S);k.__hasExternalTextures=!0,k.__hasExternalTextures&&(k.__autoAllocateDepthBuffer=W===void 0,k.__autoAllocateDepthBuffer||I.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,F){const W=re.get(S);W.__webglFramebuffer=F,W.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(S,F=0,W=0){R=S,w=F,U=W;let k=!0,X=null,Se=!1,Te=!1;if(S){const De=re.get(S);De.__useDefaultFramebuffer!==void 0?(B.bindFramebuffer(_.FRAMEBUFFER,null),k=!1):De.__webglFramebuffer===void 0?te.setupRenderTarget(S):De.__hasExternalTextures&&te.rebindTextures(S,re.get(S.texture).__webglTexture,re.get(S.depthTexture).__webglTexture);const Ve=S.texture;(Ve.isData3DTexture||Ve.isDataArrayTexture||Ve.isCompressedArrayTexture)&&(Te=!0);const Fe=re.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Fe[F])?X=Fe[F][W]:X=Fe[F],Se=!0):V.isWebGL2&&S.samples>0&&te.useMultisampledRTT(S)===!1?X=re.get(S).__webglMultisampledFramebuffer:Array.isArray(Fe)?X=Fe[W]:X=Fe,A.copy(S.viewport),q.copy(S.scissor),ne=S.scissorTest}else A.copy(se).multiplyScalar(H).floor(),q.copy(N).multiplyScalar(H).floor(),ne=z;if(B.bindFramebuffer(_.FRAMEBUFFER,X)&&V.drawBuffers&&k&&B.drawBuffers(S,X),B.viewport(A),B.scissor(q),B.setScissorTest(ne),Se){const De=re.get(S.texture);_.framebufferTexture2D(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,_.TEXTURE_CUBE_MAP_POSITIVE_X+F,De.__webglTexture,W)}else if(Te){const De=re.get(S.texture),Ve=F||0;_.framebufferTextureLayer(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,De.__webglTexture,W||0,Ve)}Z=-1},this.readRenderTargetPixels=function(S,F,W,k,X,Se,Te){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=re.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Te!==void 0&&(Pe=Pe[Te]),Pe){B.bindFramebuffer(_.FRAMEBUFFER,Pe);try{const De=S.texture,Ve=De.format,Fe=De.type;if(Ve!==en&&Ne.convert(Ve)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Be=Fe===zr&&(I.has("EXT_color_buffer_half_float")||V.isWebGL2&&I.has("EXT_color_buffer_float"));if(Fe!==Zn&&Ne.convert(Fe)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Fe===Kn&&(V.isWebGL2||I.has("OES_texture_float")||I.has("WEBGL_color_buffer_float")))&&!Be){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=S.width-k&&W>=0&&W<=S.height-X&&_.readPixels(F,W,k,X,Ne.convert(Ve),Ne.convert(Fe),Se)}finally{const De=R!==null?re.get(R).__webglFramebuffer:null;B.bindFramebuffer(_.FRAMEBUFFER,De)}}},this.copyFramebufferToTexture=function(S,F,W=0){const k=Math.pow(2,-W),X=Math.floor(F.image.width*k),Se=Math.floor(F.image.height*k);te.setTexture2D(F,0),_.copyTexSubImage2D(_.TEXTURE_2D,W,0,0,S.x,S.y,X,Se),B.unbindTexture()},this.copyTextureToTexture=function(S,F,W,k=0){const X=F.image.width,Se=F.image.height,Te=Ne.convert(W.format),Pe=Ne.convert(W.type);te.setTexture2D(W,0),_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,W.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,W.unpackAlignment),F.isDataTexture?_.texSubImage2D(_.TEXTURE_2D,k,S.x,S.y,X,Se,Te,Pe,F.image.data):F.isCompressedTexture?_.compressedTexSubImage2D(_.TEXTURE_2D,k,S.x,S.y,F.mipmaps[0].width,F.mipmaps[0].height,Te,F.mipmaps[0].data):_.texSubImage2D(_.TEXTURE_2D,k,S.x,S.y,Te,Pe,F.image),k===0&&W.generateMipmaps&&_.generateMipmap(_.TEXTURE_2D),B.unbindTexture()},this.copyTextureToTexture3D=function(S,F,W,k,X=0){if(E.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Se=S.max.x-S.min.x+1,Te=S.max.y-S.min.y+1,Pe=S.max.z-S.min.z+1,De=Ne.convert(k.format),Ve=Ne.convert(k.type);let Fe;if(k.isData3DTexture)te.setTexture3D(k,0),Fe=_.TEXTURE_3D;else if(k.isDataArrayTexture)te.setTexture2DArray(k,0),Fe=_.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,k.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,k.unpackAlignment);const Be=_.getParameter(_.UNPACK_ROW_LENGTH),lt=_.getParameter(_.UNPACK_IMAGE_HEIGHT),Bt=_.getParameter(_.UNPACK_SKIP_PIXELS),pt=_.getParameter(_.UNPACK_SKIP_ROWS),vn=_.getParameter(_.UNPACK_SKIP_IMAGES),ot=W.isCompressedTexture?W.mipmaps[0]:W.image;_.pixelStorei(_.UNPACK_ROW_LENGTH,ot.width),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,ot.height),_.pixelStorei(_.UNPACK_SKIP_PIXELS,S.min.x),_.pixelStorei(_.UNPACK_SKIP_ROWS,S.min.y),_.pixelStorei(_.UNPACK_SKIP_IMAGES,S.min.z),W.isDataTexture||W.isData3DTexture?_.texSubImage3D(Fe,X,F.x,F.y,F.z,Se,Te,Pe,De,Ve,ot.data):W.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),_.compressedTexSubImage3D(Fe,X,F.x,F.y,F.z,Se,Te,Pe,De,ot.data)):_.texSubImage3D(Fe,X,F.x,F.y,F.z,Se,Te,Pe,De,Ve,ot),_.pixelStorei(_.UNPACK_ROW_LENGTH,Be),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,lt),_.pixelStorei(_.UNPACK_SKIP_PIXELS,Bt),_.pixelStorei(_.UNPACK_SKIP_ROWS,pt),_.pixelStorei(_.UNPACK_SKIP_IMAGES,vn),X===0&&k.generateMipmaps&&_.generateMipmap(Fe),B.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?te.setTextureCube(S,0):S.isData3DTexture?te.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?te.setTexture2DArray(S,0):te.setTexture2D(S,0),B.unbindTexture()},this.resetState=function(){w=0,U=0,R=null,B.reset(),Ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ha?"display-p3":"srgb",t.unpackColorSpace=et.workingColorSpace===Qs?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===gt?Mi:df}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Mi?gt:Bn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class H0 extends Lf{}H0.prototype.isWebGL1Renderer=!0;class G0 extends Ot{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class V0{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=ha,this.updateRange={offset:0,count:-1},this.version=0,this.uuid=In()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=t.array[i+r];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=In()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=In()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const At=new O;class Ws{constructor(e,t,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)At.fromBufferAttribute(this,t),At.applyMatrix4(e),this.setXYZ(t,At.x,At.y,At.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)At.fromBufferAttribute(this,t),At.applyNormalMatrix(e),this.setXYZ(t,At.x,At.y,At.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)At.fromBufferAttribute(this,t),At.transformDirection(e),this.setXYZ(t,At.x,At.y,At.z);return this}setX(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=Qe(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=pn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=pn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=pn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=pn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array),r=Qe(r,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,t,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=Qe(t,this.array),i=Qe(i,this.array),r=Qe(r,this.array),s=Qe(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return new sn(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ws(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class Df extends Xr{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ze(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Hi;const _r=new O,Gi=new O,Vi=new O,Wi=new qe,gr=new qe,Uf=new at,Es=new O,vr=new O,ys=new O,Zc=new qe,Ko=new qe,Jc=new qe;class W0 extends Ot{constructor(e=new Df){if(super(),this.isSprite=!0,this.type="Sprite",Hi===void 0){Hi=new Hn;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new V0(t,5);Hi.setIndex([0,1,2,0,2,3]),Hi.setAttribute("position",new Ws(i,3,0,!1)),Hi.setAttribute("uv",new Ws(i,2,3,!1))}this.geometry=Hi,this.material=e,this.center=new qe(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Gi.setFromMatrixScale(this.matrixWorld),Uf.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Vi.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Gi.multiplyScalar(-Vi.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const a=this.center;Ts(Es.set(-.5,-.5,0),Vi,a,Gi,r,s),Ts(vr.set(.5,-.5,0),Vi,a,Gi,r,s),Ts(ys.set(.5,.5,0),Vi,a,Gi,r,s),Zc.set(0,0),Ko.set(1,0),Jc.set(1,1);let o=e.ray.intersectTriangle(Es,vr,ys,!1,_r);if(o===null&&(Ts(vr.set(-.5,.5,0),Vi,a,Gi,r,s),Ko.set(0,1),o=e.ray.intersectTriangle(Es,ys,vr,!1,_r),o===null))return;const l=e.ray.origin.distanceTo(_r);l<e.near||l>e.far||t.push({distance:l,point:_r.clone(),uv:qt.getInterpolation(_r,Es,vr,ys,Zc,Ko,Jc,new qe),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ts(n,e,t,i,r,s){Wi.subVectors(n,t).addScalar(.5).multiply(i),r!==void 0?(gr.x=s*Wi.x-r*Wi.y,gr.y=r*Wi.x+s*Wi.y):gr.copy(Wi),n.copy(e),n.x+=gr.x,n.y+=gr.y,n.applyMatrix4(Uf)}class k0 extends Ft{constructor(e,t,i,r,s,a,o,l,c){super(e,t,i,r,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class qa extends Hn{constructor(e=.5,t=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],u=[];let f=e;const d=(t-e)/r,m=new O,x=new qe;for(let v=0;v<=r;v++){for(let p=0;p<=i;p++){const h=s+p/i*a;m.x=f*Math.cos(h),m.y=f*Math.sin(h),l.push(m.x,m.y,m.z),c.push(0,0,1),x.x=(m.x/t+1)/2,x.y=(m.y/t+1)/2,u.push(x.x,x.y)}f+=d}for(let v=0;v<r;v++){const p=v*(i+1);for(let h=0;h<i;h++){const b=h+p,E=b,T=b+i+1,w=b+i+2,U=b+1;o.push(E,T,U),o.push(T,w,U)}}this.setIndex(o),this.setAttribute("position",new _n(l,3)),this.setAttribute("normal",new _n(c,3)),this.setAttribute("uv",new _n(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new qa(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ba}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ba);const X0={key:1},q0={key:2,class:"tag-input-overlay"},Y0={class:"tag-input-box"},K0={class:"tag-input-div"},j0=["onKeydown"],$0=5,Z0=.1,J0=Au({__name:"ARComponent",setup(n){const e=ur(),t=ur(!1),i=ur(null),r=ur(!1),s=ur("");let a,o,l,c,u,f,d=null,m=null,x=[],v=new at,p=new at,h=.1,b=[];const E=q=>{for(const ne of x)if(ne.position.distanceTo(q)<Z0)return!0;return!1};Pu(()=>{T()});const T=async()=>{if("xr"in navigator){const q=await navigator.xr.isSessionSupported("immersive-ar");i.value=q}else i.value=!1},w=async()=>{var L;if(!i.value)return;const q=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:document.body}});l=new Lf({antialias:!0,alpha:!0}),l.setSize(window.innerWidth,window.innerHeight),l.xr.enabled=!0,l.xr.setReferenceSpaceType("local"),l.xr.setSession(q),(L=e.value)==null||L.appendChild(l.domElement);const ne=()=>{var G;l.setAnimationLoop(null),t.value=!1,r.value=!1,d!=null&&d.cancel&&d.cancel(),d=null,m=null,(G=e.value)!=null&&G.contains(l.domElement)&&e.value.removeChild(l.domElement),l.dispose()};q.addEventListener("end",ne),a=new G0,o=new Yt(70,window.innerWidth/window.innerHeight,.01,20);const le=new qa(.15,.2,32).rotateX(-Math.PI/2);f=new Wa({color:16777215}),u=new Dn(le,f),u.matrixAutoUpdate=!1,u.visible=!1,a.add(u),p.identity(),c=l.xr.getController(0),c.addEventListener("select",R),a.add(c),q.requestReferenceSpace("viewer").then(G=>{q.requestHitTestSource({space:G}).then(Y=>{d=Y})}),q.requestReferenceSpace("local").then(G=>{m=G}),l.setAnimationLoop(A),t.value=!0},U=q=>{const L=document.createElement("canvas"),G=L.getContext("2d");G.font="64px Arial";const Y=G.measureText(q),H=Math.ceil(Y.width),ee=64;L.width=H+20*2,L.height=ee+20*2,G.font="64px Arial",G.textAlign="center",G.textBaseline="middle",G.fillStyle="rgba(0, 0, 0, 0.6)",G.fillRect(0,0,L.width,L.height),G.fillStyle="white",G.fillText(q,L.width/2,L.height/2);const ae=new k0(L);ae.needsUpdate=!0;const se=new Df({map:ae,transparent:!0}),N=new W0(se),z=.001;return N.scale.set(L.width*z,L.height*z,1),N},R=()=>{u.visible&&(v.copy(u.matrix),s.value="",r.value=!0)},Z=()=>{const q=s.value.trim();if(!q){y();return}const ne=new O;if(ne.setFromMatrixPosition(v),E(ne)){alert("Position trop proche d'un tag existant. Veuillez choisir un autre emplacement."),y();return}const le=U(q);le.position.setFromMatrixPosition(v),a.add(le),x.push(le),r.value=!1,s.value=""},y=()=>{r.value=!1,s.value=""},A=(q,ne)=>{if(ne&&d&&m){const le=ne.getHitTestResults(d);if(le.length){const G=le[0].getPose(m);u.visible=!0;const Y=new at().fromArray(G.transform.matrix);if(b.push(Y),b.length>$0&&b.shift(),b.length>0){const H=[],ee=[];b.forEach(he=>{const xe=new O,be=new or,Ie=new O;he.decompose(xe,be,Ie),H.push(xe),ee.push(be)});const ae=H.reduce((he,xe)=>he.add(xe),new O).divideScalar(H.length);let se=ee[0].clone();for(let he=1;he<ee.length;he++)se.slerp(ee[he],.5);const N=new at;N.compose(ae,se,new O(1,1,1));const z=h;for(let he=0;he<16;he++)p.elements[he]=Im.lerp(p.elements[he],N.elements[he],z);u.matrix.copy(p);const _e=new O;_e.setFromMatrixPosition(p),E(_e)?f.color.setHex(16711680):f.color.setHex(16777215)}}else u.visible=!1,b=[]}l.render(a,o)};return(q,ne)=>(qi(),Jr(un,null,[pi("div",{id:"ar-container",ref_key:"container",ref:e},null,512),t.value?mo("",!0):(qi(),Jr("button",{key:0,class:"btnStart",onClick:w},"Démarrer AR")),i.value===!1?(qi(),Jr("p",X0,"Votre navigateur ne supporte pas WebXR AR.")):mo("",!0),r.value?(qi(),Jr("div",q0,[pi("div",Y0,[pi("label",null,[pi("div",K0,[ne[1]||(ne[1]=Qu(" Nom : ",-1)),Ih(pi("input",{"onUpdate:modelValue":ne[0]||(ne[0]=le=>s.value=le),onKeydown:dp(fp(Z,["prevent"]),["enter"]),placeholder:"Entrez le nom...",autofocus:""},null,40,j0),[[lp,s.value]])])])])])):mo("",!0)],64))}}),Q0=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},eM=Q0(J0,[["__scopeId","data-v-04d8845c"]]),tM=Au({__name:"App",setup(n){return(e,t)=>(qi(),$u(eM))}});_p(tM).mount("#app");
