...
`)+`
`+h);const y=b+p+a,E=b+h+o,w=Kc(r,r.VERTEX_SHADER,y),D=Kc(r,r.FRAGMENT_SHADER,E);r.attachShader(v,w),r.attachShader(v,D),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(ie){if(n.debug.checkShaderErrors){const ae=r.getProgramInfoLog(v).trim(),ce=r.getShaderInfoLog(w).trim(),I=r.getShaderInfoLog(D).trim();let j=!0,J=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(j=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,w,D);else{const V=$c(r,w,"vertex"),re=$c(r,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`

Program Info Log: `+ae+`
`+V+`
`+re)}else ae!==""?console.warn("THREE.WebGLProgram: Program Info Log:",ae):(ce===""||I==="")&&(J=!1);J&&(ie.diagnostics={runnable:j,programLog:ae,vertexShader:{log:ce,prefix:p},fragmentShader:{log:I,prefix:h}})}r.deleteShader(w),r.deleteShader(D),$=new Is(r,v),T=y0(r,v)}let $;this.getUniforms=function(){return $===void 0&&P(this),$};let T;this.getAttributes=function(){return T===void 0&&P(this),T};let A=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return A===!1&&(A=r.getProgramParameter(v,m0)),A},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=g0++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=w,this.fragmentShader=D,this}let N0=0;class F0{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new O0(e),t.set(e,i)),i}}class O0{constructor(e){this.id=N0++,this.code=e,this.usedTimes=0}}function B0(n,e,t,i,r,s,a){const o=new If,l=new F0,c=[],u=r.isWebGL2,f=r.logarithmicDepthBuffer,d=r.vertexTextures;let m=r.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(T){return T===0?"uv":`uv${T}`}function p(T,A,ie,ae,ce){const I=ae.fog,j=ce.geometry,J=T.isMeshStandardMaterial?ae.environment:null,V=(T.isMeshStandardMaterial?t:e).get(T.envMap||J),re=V&&V.mapping===ao?V.image.height:null,oe=x[T.type];T.precision!==null&&(m=r.getMaxPrecision(T.precision),m!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",m,"instead."));const se=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,N=se!==void 0?se.length:0;let H=0;j.morphAttributes.position!==void 0&&(H=1),j.morphAttributes.normal!==void 0&&(H=2),j.morphAttributes.color!==void 0&&(H=3);let ge,ve,Ee,we;if(oe){const ut=vn[oe];ge=ut.vertexShader,ve=ut.fragmentShader}else ge=T.vertexShader,ve=T.fragmentShader,l.update(T),Ee=l.getVertexShaderID(T),we=l.getFragmentShaderID(T);const Be=n.getRenderTarget(),Le=ce.isInstancedMesh===!0,Ne=!!T.map,_e=!!T.matcap,le=!!V,g=!!T.aoMap,R=!!T.lightMap,C=!!T.bumpMap,F=!!T.normalMap,O=!!T.displacementMap,X=!!T.emissiveMap,W=!!T.metalnessMap,k=!!T.roughnessMap,Q=T.anisotropy>0,K=T.clearcoat>0,xe=T.iridescence>0,M=T.sheen>0,_=T.transmission>0,L=Q&&!!T.anisotropyMap,Z=K&&!!T.clearcoatMap,ee=K&&!!T.clearcoatNormalMap,ne=K&&!!T.clearcoatRoughnessMap,Me=xe&&!!T.iridescenceMap,ue=xe&&!!T.iridescenceThicknessMap,pe=M&&!!T.sheenColorMap,be=M&&!!T.sheenRoughnessMap,qe=!!T.specularMap,fe=!!T.specularColorMap,ze=!!T.specularIntensityMap,Re=_&&!!T.transmissionMap,De=_&&!!T.thicknessMap,Ce=!!T.gradientMap,Te=!!T.alphaMap,Ke=T.alphaTest>0,U=!!T.alphaHash,Se=!!T.extensions,he=!!j.attributes.uv1,te=!!j.attributes.uv2,de=!!j.attributes.uv3;let Ue=ri;return T.toneMapped&&(Be===null||Be.isXRRenderTarget===!0)&&(Ue=n.toneMapping),{isWebGL2:u,shaderID:oe,shaderType:T.type,shaderName:T.name,vertexShader:ge,fragmentShader:ve,defines:T.defines,customVertexShaderID:Ee,customFragmentShaderID:we,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:m,instancing:Le,instancingColor:Le&&ce.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:Be===null?n.outputColorSpace:Be.isXRRenderTarget===!0?Be.texture.colorSpace:Wn,map:Ne,matcap:_e,envMap:le,envMapMode:le&&V.mapping,envMapCubeUVHeight:re,aoMap:g,lightMap:R,bumpMap:C,normalMap:F,displacementMap:d&&O,emissiveMap:X,normalMapObjectSpace:F&&T.normalMapType===Um,normalMapTangentSpace:F&&T.normalMapType===Dm,metalnessMap:W,roughnessMap:k,anisotropy:Q,anisotropyMap:L,clearcoat:K,clearcoatMap:Z,clearcoatNormalMap:ee,clearcoatRoughnessMap:ne,iridescence:xe,iridescenceMap:Me,iridescenceThicknessMap:ue,sheen:M,sheenColorMap:pe,sheenRoughnessMap:be,specularMap:qe,specularColorMap:fe,specularIntensityMap:ze,transmission:_,transmissionMap:Re,thicknessMap:De,gradientMap:Ce,opaque:T.transparent===!1&&T.blending===sr,alphaMap:Te,alphaTest:Ke,alphaHash:U,combine:T.combine,mapUv:Ne&&v(T.map.channel),aoMapUv:g&&v(T.aoMap.channel),lightMapUv:R&&v(T.lightMap.channel),bumpMapUv:C&&v(T.bumpMap.channel),normalMapUv:F&&v(T.normalMap.channel),displacementMapUv:O&&v(T.displacementMap.channel),emissiveMapUv:X&&v(T.emissiveMap.channel),metalnessMapUv:W&&v(T.metalnessMap.channel),roughnessMapUv:k&&v(T.roughnessMap.channel),anisotropyMapUv:L&&v(T.anisotropyMap.channel),clearcoatMapUv:Z&&v(T.clearcoatMap.channel),clearcoatNormalMapUv:ee&&v(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ne&&v(T.clearcoatRoughnessMap.channel),iridescenceMapUv:Me&&v(T.iridescenceMap.channel),iridescenceThicknessMapUv:ue&&v(T.iridescenceThicknessMap.channel),sheenColorMapUv:pe&&v(T.sheenColorMap.channel),sheenRoughnessMapUv:be&&v(T.sheenRoughnessMap.channel),specularMapUv:qe&&v(T.specularMap.channel),specularColorMapUv:fe&&v(T.specularColorMap.channel),specularIntensityMapUv:ze&&v(T.specularIntensityMap.channel),transmissionMapUv:Re&&v(T.transmissionMap.channel),thicknessMapUv:De&&v(T.thicknessMap.channel),alphaMapUv:Te&&v(T.alphaMap.channel),vertexTangents:!!j.attributes.tangent&&(F||Q),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,vertexUv1s:he,vertexUv2s:te,vertexUv3s:de,pointsUvs:ce.isPoints===!0&&!!j.attributes.uv&&(Ne||Te),fog:!!I,useFog:T.fog===!0,fogExp2:I&&I.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:f,skinning:ce.isSkinnedMesh===!0,morphTargets:j.morphAttributes.position!==void 0,morphNormals:j.morphAttributes.normal!==void 0,morphColors:j.morphAttributes.color!==void 0,morphTargetsCount:N,morphTextureStride:H,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:T.dithering,shadowMapEnabled:n.shadowMap.enabled&&ie.length>0,shadowMapType:n.shadowMap.type,toneMapping:Ue,useLegacyLights:n._useLegacyLights,decodeVideoTexture:Ne&&T.map.isVideoTexture===!0&&tt.getTransfer(T.map.colorSpace)===at,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===On,flipSided:T.side===zt,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionDerivatives:Se&&T.extensions.derivatives===!0,extensionFragDepth:Se&&T.extensions.fragDepth===!0,extensionDrawBuffers:Se&&T.extensions.drawBuffers===!0,extensionShaderTextureLOD:Se&&T.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:u||i.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||i.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||i.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()}}function h(T){const A=[];if(T.shaderID?A.push(T.shaderID):(A.push(T.customVertexShaderID),A.push(T.customFragmentShaderID)),T.defines!==void 0)for(const ie in T.defines)A.push(ie),A.push(T.defines[ie]);return T.isRawShaderMaterial===!1&&(b(A,T),y(A,T),A.push(n.outputColorSpace)),A.push(T.customProgramCacheKey),A.join()}function b(T,A){T.push(A.precision),T.push(A.outputColorSpace),T.push(A.envMapMode),T.push(A.envMapCubeUVHeight),T.push(A.mapUv),T.push(A.alphaMapUv),T.push(A.lightMapUv),T.push(A.aoMapUv),T.push(A.bumpMapUv),T.push(A.normalMapUv),T.push(A.displacementMapUv),T.push(A.emissiveMapUv),T.push(A.metalnessMapUv),T.push(A.roughnessMapUv),T.push(A.anisotropyMapUv),T.push(A.clearcoatMapUv),T.push(A.clearcoatNormalMapUv),T.push(A.clearcoatRoughnessMapUv),T.push(A.iridescenceMapUv),T.push(A.iridescenceThicknessMapUv),T.push(A.sheenColorMapUv),T.push(A.sheenRoughnessMapUv),T.push(A.specularMapUv),T.push(A.specularColorMapUv),T.push(A.specularIntensityMapUv),T.push(A.transmissionMapUv),T.push(A.thicknessMapUv),T.push(A.combine),T.push(A.fogExp2),T.push(A.sizeAttenuation),T.push(A.morphTargetsCount),T.push(A.morphAttributeCount),T.push(A.numDirLights),T.push(A.numPointLights),T.push(A.numSpotLights),T.push(A.numSpotLightMaps),T.push(A.numHemiLights),T.push(A.numRectAreaLights),T.push(A.numDirLightShadows),T.push(A.numPointLightShadows),T.push(A.numSpotLightShadows),T.push(A.numSpotLightShadowsWithMaps),T.push(A.numLightProbes),T.push(A.shadowMapType),T.push(A.toneMapping),T.push(A.numClippingPlanes),T.push(A.numClipIntersection),T.push(A.depthPacking)}function y(T,A){o.disableAll(),A.isWebGL2&&o.enable(0),A.supportsVertexTextures&&o.enable(1),A.instancing&&o.enable(2),A.instancingColor&&o.enable(3),A.matcap&&o.enable(4),A.envMap&&o.enable(5),A.normalMapObjectSpace&&o.enable(6),A.normalMapTangentSpace&&o.enable(7),A.clearcoat&&o.enable(8),A.iridescence&&o.enable(9),A.alphaTest&&o.enable(10),A.vertexColors&&o.enable(11),A.vertexAlphas&&o.enable(12),A.vertexUv1s&&o.enable(13),A.vertexUv2s&&o.enable(14),A.vertexUv3s&&o.enable(15),A.vertexTangents&&o.enable(16),A.anisotropy&&o.enable(17),A.alphaHash&&o.enable(18),T.push(o.mask),o.disableAll(),A.fog&&o.enable(0),A.useFog&&o.enable(1),A.flatShading&&o.enable(2),A.logarithmicDepthBuffer&&o.enable(3),A.skinning&&o.enable(4),A.morphTargets&&o.enable(5),A.morphNormals&&o.enable(6),A.morphColors&&o.enable(7),A.premultipliedAlpha&&o.enable(8),A.shadowMapEnabled&&o.enable(9),A.useLegacyLights&&o.enable(10),A.doubleSided&&o.enable(11),A.flipSided&&o.enable(12),A.useDepthPacking&&o.enable(13),A.dithering&&o.enable(14),A.transmission&&o.enable(15),A.sheen&&o.enable(16),A.opaque&&o.enable(17),A.pointsUvs&&o.enable(18),A.decodeVideoTexture&&o.enable(19),T.push(o.mask)}function E(T){const A=x[T.type];let ie;if(A){const ae=vn[A];ie=Eg.clone(ae.uniforms)}else ie=T.uniforms;return ie}function w(T,A){let ie;for(let ae=0,ce=c.length;ae<ce;ae++){const I=c[ae];if(I.cacheKey===A){ie=I,++ie.usedTimes;break}}return ie===void 0&&(ie=new I0(n,A,T,s),c.push(ie)),ie}function D(T){if(--T.usedTimes===0){const A=c.indexOf(T);c[A]=c[c.length-1],c.pop(),T.destroy()}}function P(T){l.remove(T)}function $(){l.dispose()}return{getParameters:p,getProgramCacheKey:h,getUniforms:E,acquireProgram:w,releaseProgram:D,releaseShaderCache:P,programs:c,dispose:$}}function z0(){let n=new WeakMap;function e(s){let a=n.get(s);return a===void 0&&(a={},n.set(s,a)),a}function t(s){n.delete(s)}function i(s,a,o){n.get(s)[a]=o}function r(){n=new WeakMap}return{get:e,remove:t,update:i,dispose:r}}function H0(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function tu(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function nu(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f,d,m,x,v,p){let h=n[e];return h===void 0?(h={id:f.id,object:f,geometry:d,material:m,groupOrder:x,renderOrder:f.renderOrder,z:v,group:p},n[e]=h):(h.id=f.id,h.object=f,h.geometry=d,h.material=m,h.groupOrder=x,h.renderOrder=f.renderOrder,h.z=v,h.group=p),e++,h}function o(f,d,m,x,v,p){const h=a(f,d,m,x,v,p);m.transmission>0?i.push(h):m.transparent===!0?r.push(h):t.push(h)}function l(f,d,m,x,v,p){const h=a(f,d,m,x,v,p);m.transmission>0?i.unshift(h):m.transparent===!0?r.unshift(h):t.unshift(h)}function c(f,d){t.length>1&&t.sort(f||H0),i.length>1&&i.sort(d||tu),r.length>1&&r.sort(d||tu)}function u(){for(let f=e,d=n.length;f<d;f++){const m=n[f];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function G0(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new nu,n.set(i,[a])):r>=s.length?(a=new nu,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function V0(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new z,color:new Qe};break;case"SpotLight":t={position:new z,direction:new z,color:new Qe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new z,color:new Qe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new z,skyColor:new Qe,groundColor:new Qe};break;case"RectAreaLight":t={color:new Qe,position:new z,halfWidth:new z,halfHeight:new z};break}return n[e.id]=t,t}}}function k0(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new je};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new je};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new je,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let W0=0;function X0(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function q0(n,e){const t=new V0,i=k0(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)r.probe.push(new z);const s=new z,a=new it,o=new it;function l(u,f){let d=0,m=0,x=0;for(let ae=0;ae<9;ae++)r.probe[ae].set(0,0,0);let v=0,p=0,h=0,b=0,y=0,E=0,w=0,D=0,P=0,$=0,T=0;u.sort(X0);const A=f===!0?Math.PI:1;for(let ae=0,ce=u.length;ae<ce;ae++){const I=u[ae],j=I.color,J=I.intensity,V=I.distance,re=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)d+=j.r*J*A,m+=j.g*J*A,x+=j.b*J*A;else if(I.isLightProbe){for(let oe=0;oe<9;oe++)r.probe[oe].addScaledVector(I.sh.coefficients[oe],J);T++}else if(I.isDirectionalLight){const oe=t.get(I);if(oe.color.copy(I.color).multiplyScalar(I.intensity*A),I.castShadow){const se=I.shadow,N=i.get(I);N.shadowBias=se.bias,N.shadowNormalBias=se.normalBias,N.shadowRadius=se.radius,N.shadowMapSize=se.mapSize,r.directionalShadow[v]=N,r.directionalShadowMap[v]=re,r.directionalShadowMatrix[v]=I.shadow.matrix,E++}r.directional[v]=oe,v++}else if(I.isSpotLight){const oe=t.get(I);oe.position.setFromMatrixPosition(I.matrixWorld),oe.color.copy(j).multiplyScalar(J*A),oe.distance=V,oe.coneCos=Math.cos(I.angle),oe.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),oe.decay=I.decay,r.spot[h]=oe;const se=I.shadow;if(I.map&&(r.spotLightMap[P]=I.map,P++,se.updateMatrices(I),I.castShadow&&$++),r.spotLightMatrix[h]=se.matrix,I.castShadow){const N=i.get(I);N.shadowBias=se.bias,N.shadowNormalBias=se.normalBias,N.shadowRadius=se.radius,N.shadowMapSize=se.mapSize,r.spotShadow[h]=N,r.spotShadowMap[h]=re,D++}h++}else if(I.isRectAreaLight){const oe=t.get(I);oe.color.copy(j).multiplyScalar(J),oe.halfWidth.set(I.width*.5,0,0),oe.halfHeight.set(0,I.height*.5,0),r.rectArea[b]=oe,b++}else if(I.isPointLight){const oe=t.get(I);if(oe.color.copy(I.color).multiplyScalar(I.intensity*A),oe.distance=I.distance,oe.decay=I.decay,I.castShadow){const se=I.shadow,N=i.get(I);N.shadowBias=se.bias,N.shadowNormalBias=se.normalBias,N.shadowRadius=se.radius,N.shadowMapSize=se.mapSize,N.shadowCameraNear=se.camera.near,N.shadowCameraFar=se.camera.far,r.pointShadow[p]=N,r.pointShadowMap[p]=re,r.pointShadowMatrix[p]=I.shadow.matrix,w++}r.point[p]=oe,p++}else if(I.isHemisphereLight){const oe=t.get(I);oe.skyColor.copy(I.color).multiplyScalar(J*A),oe.groundColor.copy(I.groundColor).multiplyScalar(J*A),r.hemi[y]=oe,y++}}b>0&&(e.isWebGL2||n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=me.LTC_FLOAT_1,r.rectAreaLTC2=me.LTC_FLOAT_2):n.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=me.LTC_HALF_1,r.rectAreaLTC2=me.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=d,r.ambient[1]=m,r.ambient[2]=x;const ie=r.hash;(ie.directionalLength!==v||ie.pointLength!==p||ie.spotLength!==h||ie.rectAreaLength!==b||ie.hemiLength!==y||ie.numDirectionalShadows!==E||ie.numPointShadows!==w||ie.numSpotShadows!==D||ie.numSpotMaps!==P||ie.numLightProbes!==T)&&(r.directional.length=v,r.spot.length=h,r.rectArea.length=b,r.point.length=p,r.hemi.length=y,r.directionalShadow.length=E,r.directionalShadowMap.length=E,r.pointShadow.length=w,r.pointShadowMap.length=w,r.spotShadow.length=D,r.spotShadowMap.length=D,r.directionalShadowMatrix.length=E,r.pointShadowMatrix.length=w,r.spotLightMatrix.length=D+P-$,r.spotLightMap.length=P,r.numSpotLightShadowsWithMaps=$,r.numLightProbes=T,ie.directionalLength=v,ie.pointLength=p,ie.spotLength=h,ie.rectAreaLength=b,ie.hemiLength=y,ie.numDirectionalShadows=E,ie.numPointShadows=w,ie.numSpotShadows=D,ie.numSpotMaps=P,ie.numLightProbes=T,r.version=W0++)}function c(u,f){let d=0,m=0,x=0,v=0,p=0;const h=f.matrixWorldInverse;for(let b=0,y=u.length;b<y;b++){const E=u[b];if(E.isDirectionalLight){const w=r.directional[d];w.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(h),d++}else if(E.isSpotLight){const w=r.spot[x];w.position.setFromMatrixPosition(E.matrixWorld),w.position.applyMatrix4(h),w.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(h),x++}else if(E.isRectAreaLight){const w=r.rectArea[v];w.position.setFromMatrixPosition(E.matrixWorld),w.position.applyMatrix4(h),o.identity(),a.copy(E.matrixWorld),a.premultiply(h),o.extractRotation(a),w.halfWidth.set(E.width*.5,0,0),w.halfHeight.set(0,E.height*.5,0),w.halfWidth.applyMatrix4(o),w.halfHeight.applyMatrix4(o),v++}else if(E.isPointLight){const w=r.point[m];w.position.setFromMatrixPosition(E.matrixWorld),w.position.applyMatrix4(h),m++}else if(E.isHemisphereLight){const w=r.hemi[p];w.direction.setFromMatrixPosition(E.matrixWorld),w.direction.transformDirection(h),p++}}}return{setup:l,setupView:c,state:r}}function iu(n,e){const t=new q0(n,e),i=[],r=[];function s(){i.length=0,r.length=0}function a(f){i.push(f)}function o(f){r.push(f)}function l(f){t.setup(i,f)}function c(f){t.setupView(i,f)}return{init:s,state:{lightsArray:i,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:a,pushShadow:o}}function Y0(n,e){let t=new WeakMap;function i(s,a=0){const o=t.get(s);let l;return o===void 0?(l=new iu(n,e),t.set(s,[l])):a>=o.length?(l=new iu(n,e),o.push(l)):l=o[a],l}function r(){t=new WeakMap}return{get:i,dispose:r}}class j0 extends $r{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Pm,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class K0 extends $r{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const $0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function J0(n,e,t){let i=new Gf;const r=new je,s=new je,a=new xt,o=new j0({depthPacking:Lm}),l=new K0,c={},u=t.maxTextureSize,f={[ai]:zt,[zt]:ai,[On]:On},d=new Ci({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:$0,fragmentShader:Z0}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new qn;x.setAttribute("position",new fn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new zn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mf;let h=this.type;this.render=function(w,D,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const $=n.getRenderTarget(),T=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),ie=n.state;ie.setBlending(ii),ie.buffers.color.setClear(1,1,1,1),ie.buffers.depth.setTest(!0),ie.setScissorTest(!1);const ae=h!==Dn&&this.type===Dn,ce=h===Dn&&this.type!==Dn;for(let I=0,j=w.length;I<j;I++){const J=w[I],V=J.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const re=V.getFrameExtents();if(r.multiply(re),s.copy(V.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/re.x),r.x=s.x*re.x,V.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/re.y),r.y=s.y*re.y,V.mapSize.y=s.y)),V.map===null||ae===!0||ce===!0){const se=this.type!==Dn?{minFilter:Dt,magFilter:Dt}:{};V.map!==null&&V.map.dispose(),V.map=new Ri(r.x,r.y,se),V.map.texture.name=J.name+".shadowMap",V.camera.updateProjectionMatrix()}n.setRenderTarget(V.map),n.clear();const oe=V.getViewportCount();for(let se=0;se<oe;se++){const N=V.getViewport(se);a.set(s.x*N.x,s.y*N.y,s.x*N.z,s.y*N.w),ie.viewport(a),V.updateMatrices(J,se),i=V.getFrustum(),E(D,P,V.camera,J,this.type)}V.isPointLightShadow!==!0&&this.type===Dn&&b(V,P),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget($,T,A)};function b(w,D){const P=e.update(v);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Ri(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,n.setRenderTarget(w.mapPass),n.clear(),n.renderBufferDirect(D,null,P,d,v,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,n.setRenderTarget(w.map),n.clear(),n.renderBufferDirect(D,null,P,m,v,null)}function y(w,D,P,$){let T=null;const A=P.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)T=A;else if(T=P.isPointLight===!0?l:o,n.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0){const ie=T.uuid,ae=D.uuid;let ce=c[ie];ce===void 0&&(ce={},c[ie]=ce);let I=ce[ae];I===void 0&&(I=T.clone(),ce[ae]=I),T=I}if(T.visible=D.visible,T.wireframe=D.wireframe,$===Dn?T.side=D.shadowSide!==null?D.shadowSide:D.side:T.side=D.shadowSide!==null?D.shadowSide:f[D.side],T.alphaMap=D.alphaMap,T.alphaTest=D.alphaTest,T.map=D.map,T.clipShadows=D.clipShadows,T.clippingPlanes=D.clippingPlanes,T.clipIntersection=D.clipIntersection,T.displacementMap=D.displacementMap,T.displacementScale=D.displacementScale,T.displacementBias=D.displacementBias,T.wireframeLinewidth=D.wireframeLinewidth,T.linewidth=D.linewidth,P.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const ie=n.properties.get(T);ie.light=P}return T}function E(w,D,P,$,T){if(w.visible===!1)return;if(w.layers.test(D.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&T===Dn)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,w.matrixWorld);const ae=e.update(w),ce=w.material;if(Array.isArray(ce)){const I=ae.groups;for(let j=0,J=I.length;j<J;j++){const V=I[j],re=ce[V.materialIndex];if(re&&re.visible){const oe=y(w,re,$,T);n.renderBufferDirect(P,null,ae,oe,w,V)}}}else if(ce.visible){const I=y(w,ce,$,T);n.renderBufferDirect(P,null,ae,I,w,null)}}const ie=w.children;for(let ae=0,ce=ie.length;ae<ce;ae++)E(ie[ae],D,P,$,T)}}function Q0(n,e,t){const i=t.isWebGL2;function r(){let U=!1;const Se=new xt;let he=null;const te=new xt(0,0,0,0);return{setMask:function(de){he!==de&&!U&&(n.colorMask(de,de,de,de),he=de)},setLocked:function(de){U=de},setClear:function(de,Ue,$e,ut,Yt){Yt===!0&&(de*=ut,Ue*=ut,$e*=ut),Se.set(de,Ue,$e,ut),te.equals(Se)===!1&&(n.clearColor(de,Ue,$e,ut),te.copy(Se))},reset:function(){U=!1,he=null,te.set(-1,0,0,0)}}}function s(){let U=!1,Se=null,he=null,te=null;return{setTest:function(de){de?Ne(n.DEPTH_TEST):_e(n.DEPTH_TEST)},setMask:function(de){Se!==de&&!U&&(n.depthMask(de),Se=de)},setFunc:function(de){if(he!==de){switch(de){case om:n.depthFunc(n.NEVER);break;case am:n.depthFunc(n.ALWAYS);break;case lm:n.depthFunc(n.LESS);break;case Vs:n.depthFunc(n.LEQUAL);break;case cm:n.depthFunc(n.EQUAL);break;case um:n.depthFunc(n.GEQUAL);break;case fm:n.depthFunc(n.GREATER);break;case hm:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}he=de}},setLocked:function(de){U=de},setClear:function(de){te!==de&&(n.clearDepth(de),te=de)},reset:function(){U=!1,Se=null,he=null,te=null}}}function a(){let U=!1,Se=null,he=null,te=null,de=null,Ue=null,$e=null,ut=null,Yt=null;return{setTest:function(st){U||(st?Ne(n.STENCIL_TEST):_e(n.STENCIL_TEST))},setMask:function(st){Se!==st&&!U&&(n.stencilMask(st),Se=st)},setFunc:function(st,At,dn){(he!==st||te!==At||de!==dn)&&(n.stencilFunc(st,At,dn),he=st,te=At,de=dn)},setOp:function(st,At,dn){(Ue!==st||$e!==At||ut!==dn)&&(n.stencilOp(st,At,dn),Ue=st,$e=At,ut=dn)},setLocked:function(st){U=st},setClear:function(st){Yt!==st&&(n.clearStencil(st),Yt=st)},reset:function(){U=!1,Se=null,he=null,te=null,de=null,Ue=null,$e=null,ut=null,Yt=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let d={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,y=null,E=null,w=null,D=null,P=null,$=null,T=new Qe(0,0,0),A=0,ie=!1,ae=null,ce=null,I=null,j=null,J=null;const V=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let re=!1,oe=0;const se=n.getParameter(n.VERSION);se.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(se)[1]),re=oe>=1):se.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(se)[1]),re=oe>=2);let N=null,H={};const ge=n.getParameter(n.SCISSOR_BOX),ve=n.getParameter(n.VIEWPORT),Ee=new xt().fromArray(ge),we=new xt().fromArray(ve);function Be(U,Se,he,te){const de=new Uint8Array(4),Ue=n.createTexture();n.bindTexture(U,Ue),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let $e=0;$e<he;$e++)i&&(U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY)?n.texImage3D(Se,0,n.RGBA,1,1,te,0,n.RGBA,n.UNSIGNED_BYTE,de):n.texImage2D(Se+$e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,de);return Ue}const Le={};Le[n.TEXTURE_2D]=Be(n.TEXTURE_2D,n.TEXTURE_2D,1),Le[n.TEXTURE_CUBE_MAP]=Be(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Le[n.TEXTURE_2D_ARRAY]=Be(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Le[n.TEXTURE_3D]=Be(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Ne(n.DEPTH_TEST),l.setFunc(Vs),W(!1),k(zl),Ne(n.CULL_FACE),O(ii);function Ne(U){d[U]!==!0&&(n.enable(U),d[U]=!0)}function _e(U){d[U]!==!1&&(n.disable(U),d[U]=!1)}function le(U,Se){return m[U]!==Se?(n.bindFramebuffer(U,Se),m[U]=Se,i&&(U===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=Se),U===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=Se)),!0):!1}function g(U,Se){let he=v,te=!1;if(U)if(he=x.get(Se),he===void 0&&(he=[],x.set(Se,he)),U.isWebGLMultipleRenderTargets){const de=U.texture;if(he.length!==de.length||he[0]!==n.COLOR_ATTACHMENT0){for(let Ue=0,$e=de.length;Ue<$e;Ue++)he[Ue]=n.COLOR_ATTACHMENT0+Ue;he.length=de.length,te=!0}}else he[0]!==n.COLOR_ATTACHMENT0&&(he[0]=n.COLOR_ATTACHMENT0,te=!0);else he[0]!==n.BACK&&(he[0]=n.BACK,te=!0);te&&(t.isWebGL2?n.drawBuffers(he):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(he))}function R(U){return p!==U?(n.useProgram(U),p=U,!0):!1}const C={[Si]:n.FUNC_ADD,[Xp]:n.FUNC_SUBTRACT,[qp]:n.FUNC_REVERSE_SUBTRACT};if(i)C[kl]=n.MIN,C[Wl]=n.MAX;else{const U=e.get("EXT_blend_minmax");U!==null&&(C[kl]=U.MIN_EXT,C[Wl]=U.MAX_EXT)}const F={[Yp]:n.ZERO,[jp]:n.ONE,[Kp]:n.SRC_COLOR,[pa]:n.SRC_ALPHA,[tm]:n.SRC_ALPHA_SATURATE,[Qp]:n.DST_COLOR,[Zp]:n.DST_ALPHA,[$p]:n.ONE_MINUS_SRC_COLOR,[ma]:n.ONE_MINUS_SRC_ALPHA,[em]:n.ONE_MINUS_DST_COLOR,[Jp]:n.ONE_MINUS_DST_ALPHA,[nm]:n.CONSTANT_COLOR,[im]:n.ONE_MINUS_CONSTANT_COLOR,[rm]:n.CONSTANT_ALPHA,[sm]:n.ONE_MINUS_CONSTANT_ALPHA};function O(U,Se,he,te,de,Ue,$e,ut,Yt,st){if(U===ii){h===!0&&(_e(n.BLEND),h=!1);return}if(h===!1&&(Ne(n.BLEND),h=!0),U!==Wp){if(U!==b||st!==ie){if((y!==Si||D!==Si)&&(n.blendEquation(n.FUNC_ADD),y=Si,D=Si),st)switch(U){case sr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Hl:n.blendFunc(n.ONE,n.ONE);break;case Gl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Vl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case sr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Hl:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Gl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Vl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}E=null,w=null,P=null,$=null,T.set(0,0,0),A=0,b=U,ie=st}return}de=de||Se,Ue=Ue||he,$e=$e||te,(Se!==y||de!==D)&&(n.blendEquationSeparate(C[Se],C[de]),y=Se,D=de),(he!==E||te!==w||Ue!==P||$e!==$)&&(n.blendFuncSeparate(F[he],F[te],F[Ue],F[$e]),E=he,w=te,P=Ue,$=$e),(ut.equals(T)===!1||Yt!==A)&&(n.blendColor(ut.r,ut.g,ut.b,Yt),T.copy(ut),A=Yt),b=U,ie=!1}function X(U,Se){U.side===On?_e(n.CULL_FACE):Ne(n.CULL_FACE);let he=U.side===zt;Se&&(he=!he),W(he),U.blending===sr&&U.transparent===!1?O(ii):O(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),l.setFunc(U.depthFunc),l.setTest(U.depthTest),l.setMask(U.depthWrite),o.setMask(U.colorWrite);const te=U.stencilWrite;c.setTest(te),te&&(c.setMask(U.stencilWriteMask),c.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),c.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),K(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Ne(n.SAMPLE_ALPHA_TO_COVERAGE):_e(n.SAMPLE_ALPHA_TO_COVERAGE)}function W(U){ae!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),ae=U)}function k(U){U!==Gp?(Ne(n.CULL_FACE),U!==ce&&(U===zl?n.cullFace(n.BACK):U===Vp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):_e(n.CULL_FACE),ce=U}function Q(U){U!==I&&(re&&n.lineWidth(U),I=U)}function K(U,Se,he){U?(Ne(n.POLYGON_OFFSET_FILL),(j!==Se||J!==he)&&(n.polygonOffset(Se,he),j=Se,J=he)):_e(n.POLYGON_OFFSET_FILL)}function xe(U){U?Ne(n.SCISSOR_TEST):_e(n.SCISSOR_TEST)}function M(U){U===void 0&&(U=n.TEXTURE0+V-1),N!==U&&(n.activeTexture(U),N=U)}function _(U,Se,he){he===void 0&&(N===null?he=n.TEXTURE0+V-1:he=N);let te=H[he];te===void 0&&(te={type:void 0,texture:void 0},H[he]=te),(te.type!==U||te.texture!==Se)&&(N!==he&&(n.activeTexture(he),N=he),n.bindTexture(U,Se||Le[U]),te.type=U,te.texture=Se)}function L(){const U=H[N];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Z(){try{n.compressedTexImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ee(){try{n.compressedTexImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ne(){try{n.texSubImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Me(){try{n.texSubImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ue(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function be(){try{n.texStorage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function qe(){try{n.texStorage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function fe(){try{n.texImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ze(){try{n.texImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Re(U){Ee.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),Ee.copy(U))}function De(U){we.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),we.copy(U))}function Ce(U,Se){let he=f.get(Se);he===void 0&&(he=new WeakMap,f.set(Se,he));let te=he.get(U);te===void 0&&(te=n.getUniformBlockIndex(Se,U.name),he.set(U,te))}function Te(U,Se){const te=f.get(Se).get(U);u.get(Se)!==te&&(n.uniformBlockBinding(Se,te,U.__bindingPointIndex),u.set(Se,te))}function Ke(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},N=null,H={},m={},x=new WeakMap,v=[],p=null,h=!1,b=null,y=null,E=null,w=null,D=null,P=null,$=null,T=new Qe(0,0,0),A=0,ie=!1,ae=null,ce=null,I=null,j=null,J=null,Ee.set(0,0,n.canvas.width,n.canvas.height),we.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Ne,disable:_e,bindFramebuffer:le,drawBuffers:g,useProgram:R,setBlending:O,setMaterial:X,setFlipSided:W,setCullFace:k,setLineWidth:Q,setPolygonOffset:K,setScissorTest:xe,activeTexture:M,bindTexture:_,unbindTexture:L,compressedTexImage2D:Z,compressedTexImage3D:ee,texImage2D:fe,texImage3D:ze,updateUBOMapping:Ce,uniformBlockBinding:Te,texStorage2D:be,texStorage3D:qe,texSubImage2D:ne,texSubImage3D:Me,compressedTexSubImage2D:ue,compressedTexSubImage3D:pe,scissor:Re,viewport:De,reset:Ke}}function eM(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),x=new WeakMap;let v;const p=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(M,_){return h?new OffscreenCanvas(M,_):js("canvas")}function y(M,_,L,Z){let ee=1;if((M.width>Z||M.height>Z)&&(ee=Z/Math.max(M.width,M.height)),ee<1||_===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const ne=_?Ys:Math.floor,Me=ne(ee*M.width),ue=ne(ee*M.height);v===void 0&&(v=b(Me,ue));const pe=L?b(Me,ue):v;return pe.width=Me,pe.height=ue,pe.getContext("2d").drawImage(M,0,0,Me,ue),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+Me+"x"+ue+")."),pe}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function E(M){return Ea(M.width)&&Ea(M.height)}function w(M){return o?!1:M.wrapS!==an||M.wrapT!==an||M.minFilter!==Dt&&M.minFilter!==$t}function D(M,_){return M.generateMipmaps&&_&&M.minFilter!==Dt&&M.minFilter!==$t}function P(M){n.generateMipmap(M)}function $(M,_,L,Z,ee=!1){if(o===!1)return _;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ne=_;if(_===n.RED&&(L===n.FLOAT&&(ne=n.R32F),L===n.HALF_FLOAT&&(ne=n.R16F),L===n.UNSIGNED_BYTE&&(ne=n.R8)),_===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(ne=n.R8UI),L===n.UNSIGNED_SHORT&&(ne=n.R16UI),L===n.UNSIGNED_INT&&(ne=n.R32UI),L===n.BYTE&&(ne=n.R8I),L===n.SHORT&&(ne=n.R16I),L===n.INT&&(ne=n.R32I)),_===n.RG&&(L===n.FLOAT&&(ne=n.RG32F),L===n.HALF_FLOAT&&(ne=n.RG16F),L===n.UNSIGNED_BYTE&&(ne=n.RG8)),_===n.RGBA){const Me=ee?ks:tt.getTransfer(Z);L===n.FLOAT&&(ne=n.RGBA32F),L===n.HALF_FLOAT&&(ne=n.RGBA16F),L===n.UNSIGNED_BYTE&&(ne=Me===at?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(ne=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(ne=n.RGB5_A1)}return(ne===n.R16F||ne===n.R32F||ne===n.RG16F||ne===n.RG32F||ne===n.RGBA16F||ne===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function T(M,_,L){return D(M,L)===!0||M.isFramebufferTexture&&M.minFilter!==Dt&&M.minFilter!==$t?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function A(M){return M===Dt||M===Xl||M===wo?n.NEAREST:n.LINEAR}function ie(M){const _=M.target;_.removeEventListener("dispose",ie),ce(_),_.isVideoTexture&&x.delete(_)}function ae(M){const _=M.target;_.removeEventListener("dispose",ae),j(_)}function ce(M){const _=i.get(M);if(_.__webglInit===void 0)return;const L=M.source,Z=p.get(L);if(Z){const ee=Z[_.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&I(M),Object.keys(Z).length===0&&p.delete(L)}i.remove(M)}function I(M){const _=i.get(M);n.deleteTexture(_.__webglTexture);const L=M.source,Z=p.get(L);delete Z[_.__cacheKey],a.memory.textures--}function j(M){const _=M.texture,L=i.get(M),Z=i.get(_);if(Z.__webglTexture!==void 0&&(n.deleteTexture(Z.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(L.__webglFramebuffer[ee]))for(let ne=0;ne<L.__webglFramebuffer[ee].length;ne++)n.deleteFramebuffer(L.__webglFramebuffer[ee][ne]);else n.deleteFramebuffer(L.__webglFramebuffer[ee]);L.__webglDepthbuffer&&n.deleteRenderbuffer(L.__webglDepthbuffer[ee])}else{if(Array.isArray(L.__webglFramebuffer))for(let ee=0;ee<L.__webglFramebuffer.length;ee++)n.deleteFramebuffer(L.__webglFramebuffer[ee]);else n.deleteFramebuffer(L.__webglFramebuffer);if(L.__webglDepthbuffer&&n.deleteRenderbuffer(L.__webglDepthbuffer),L.__webglMultisampledFramebuffer&&n.deleteFramebuffer(L.__webglMultisampledFramebuffer),L.__webglColorRenderbuffer)for(let ee=0;ee<L.__webglColorRenderbuffer.length;ee++)L.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(L.__webglColorRenderbuffer[ee]);L.__webglDepthRenderbuffer&&n.deleteRenderbuffer(L.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let ee=0,ne=_.length;ee<ne;ee++){const Me=i.get(_[ee]);Me.__webglTexture&&(n.deleteTexture(Me.__webglTexture),a.memory.textures--),i.remove(_[ee])}i.remove(_),i.remove(M)}let J=0;function V(){J=0}function re(){const M=J;return M>=l&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+l),J+=1,M}function oe(M){const _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function se(M,_){const L=i.get(M);if(M.isVideoTexture&&K(M),M.isRenderTargetTexture===!1&&M.version>0&&L.__version!==M.version){const Z=M.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ne(L,M,_);return}}t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+_)}function N(M,_){const L=i.get(M);if(M.version>0&&L.__version!==M.version){Ne(L,M,_);return}t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+_)}function H(M,_){const L=i.get(M);if(M.version>0&&L.__version!==M.version){Ne(L,M,_);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+_)}function ge(M,_){const L=i.get(M);if(M.version>0&&L.__version!==M.version){_e(L,M,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+_)}const ve={[va]:n.REPEAT,[an]:n.CLAMP_TO_EDGE,[xa]:n.MIRRORED_REPEAT},Ee={[Dt]:n.NEAREST,[Xl]:n.NEAREST_MIPMAP_NEAREST,[wo]:n.NEAREST_MIPMAP_LINEAR,[$t]:n.LINEAR,[Mm]:n.LINEAR_MIPMAP_NEAREST,[kr]:n.LINEAR_MIPMAP_LINEAR},we={[Im]:n.NEVER,[Gm]:n.ALWAYS,[Nm]:n.LESS,[Om]:n.LEQUAL,[Fm]:n.EQUAL,[Hm]:n.GEQUAL,[Bm]:n.GREATER,[zm]:n.NOTEQUAL};function Be(M,_,L){if(L?(n.texParameteri(M,n.TEXTURE_WRAP_S,ve[_.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,ve[_.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,ve[_.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,Ee[_.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,Ee[_.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(_.wrapS!==an||_.wrapT!==an)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,A(_.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,A(_.minFilter)),_.minFilter!==Dt&&_.minFilter!==$t&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),_.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,we[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Z=e.get("EXT_texture_filter_anisotropic");if(_.magFilter===Dt||_.minFilter!==wo&&_.minFilter!==kr||_.type===ti&&e.has("OES_texture_float_linear")===!1||o===!1&&_.type===Wr&&e.has("OES_texture_half_float_linear")===!1)return;(_.anisotropy>1||i.get(_).__currentAnisotropy)&&(n.texParameterf(M,Z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy)}}function Le(M,_){let L=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",ie));const Z=_.source;let ee=p.get(Z);ee===void 0&&(ee={},p.set(Z,ee));const ne=oe(_);if(ne!==M.__cacheKey){ee[ne]===void 0&&(ee[ne]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),ee[ne].usedTimes++;const Me=ee[M.__cacheKey];Me!==void 0&&(ee[M.__cacheKey].usedTimes--,Me.usedTimes===0&&I(_)),M.__cacheKey=ne,M.__webglTexture=ee[ne].texture}return L}function Ne(M,_,L){let Z=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Z=n.TEXTURE_3D);const ee=Le(M,_),ne=_.source;t.bindTexture(Z,M.__webglTexture,n.TEXTURE0+L);const Me=i.get(ne);if(ne.version!==Me.__version||ee===!0){t.activeTexture(n.TEXTURE0+L);const ue=tt.getPrimaries(tt.workingColorSpace),pe=_.colorSpace===Qt?null:tt.getPrimaries(_.colorSpace),be=_.colorSpace===Qt||ue===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const qe=w(_)&&E(_.image)===!1;let fe=y(_.image,qe,!1,u);fe=xe(_,fe);const ze=E(fe)||o,Re=s.convert(_.format,_.colorSpace);let De=s.convert(_.type),Ce=$(_.internalFormat,Re,De,_.colorSpace,_.isVideoTexture);Be(Z,_,ze);let Te;const Ke=_.mipmaps,U=o&&_.isVideoTexture!==!0,Se=Me.__version===void 0||ee===!0,he=T(_,fe,ze);if(_.isDepthTexture)Ce=n.DEPTH_COMPONENT,o?_.type===ti?Ce=n.DEPTH_COMPONENT32F:_.type===ei?Ce=n.DEPTH_COMPONENT24:_.type===bi?Ce=n.DEPTH24_STENCIL8:Ce=n.DEPTH_COMPONENT16:_.type===ti&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),_.format===Ai&&Ce===n.DEPTH_COMPONENT&&_.type!==qa&&_.type!==ei&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),_.type=ei,De=s.convert(_.type)),_.format===fr&&Ce===n.DEPTH_COMPONENT&&(Ce=n.DEPTH_STENCIL,_.type!==bi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),_.type=bi,De=s.convert(_.type))),Se&&(U?t.texStorage2D(n.TEXTURE_2D,1,Ce,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Ce,fe.width,fe.height,0,Re,De,null));else if(_.isDataTexture)if(Ke.length>0&&ze){U&&Se&&t.texStorage2D(n.TEXTURE_2D,he,Ce,Ke[0].width,Ke[0].height);for(let te=0,de=Ke.length;te<de;te++)Te=Ke[te],U?t.texSubImage2D(n.TEXTURE_2D,te,0,0,Te.width,Te.height,Re,De,Te.data):t.texImage2D(n.TEXTURE_2D,te,Ce,Te.width,Te.height,0,Re,De,Te.data);_.generateMipmaps=!1}else U?(Se&&t.texStorage2D(n.TEXTURE_2D,he,Ce,fe.width,fe.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,fe.width,fe.height,Re,De,fe.data)):t.texImage2D(n.TEXTURE_2D,0,Ce,fe.width,fe.height,0,Re,De,fe.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&Se&&t.texStorage3D(n.TEXTURE_2D_ARRAY,he,Ce,Ke[0].width,Ke[0].height,fe.depth);for(let te=0,de=Ke.length;te<de;te++)Te=Ke[te],_.format!==ln?Re!==null?U?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,Te.width,Te.height,fe.depth,Re,Te.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,Ce,Te.width,Te.height,fe.depth,0,Te.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,Te.width,Te.height,fe.depth,Re,De,Te.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,Ce,Te.width,Te.height,fe.depth,0,Re,De,Te.data)}else{U&&Se&&t.texStorage2D(n.TEXTURE_2D,he,Ce,Ke[0].width,Ke[0].height);for(let te=0,de=Ke.length;te<de;te++)Te=Ke[te],_.format!==ln?Re!==null?U?t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,Te.width,Te.height,Re,Te.data):t.compressedTexImage2D(n.TEXTURE_2D,te,Ce,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?t.texSubImage2D(n.TEXTURE_2D,te,0,0,Te.width,Te.height,Re,De,Te.data):t.texImage2D(n.TEXTURE_2D,te,Ce,Te.width,Te.height,0,Re,De,Te.data)}else if(_.isDataArrayTexture)U?(Se&&t.texStorage3D(n.TEXTURE_2D_ARRAY,he,Ce,fe.width,fe.height,fe.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,Re,De,fe.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ce,fe.width,fe.height,fe.depth,0,Re,De,fe.data);else if(_.isData3DTexture)U?(Se&&t.texStorage3D(n.TEXTURE_3D,he,Ce,fe.width,fe.height,fe.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,Re,De,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Ce,fe.width,fe.height,fe.depth,0,Re,De,fe.data);else if(_.isFramebufferTexture){if(Se)if(U)t.texStorage2D(n.TEXTURE_2D,he,Ce,fe.width,fe.height);else{let te=fe.width,de=fe.height;for(let Ue=0;Ue<he;Ue++)t.texImage2D(n.TEXTURE_2D,Ue,Ce,te,de,0,Re,De,null),te>>=1,de>>=1}}else if(Ke.length>0&&ze){U&&Se&&t.texStorage2D(n.TEXTURE_2D,he,Ce,Ke[0].width,Ke[0].height);for(let te=0,de=Ke.length;te<de;te++)Te=Ke[te],U?t.texSubImage2D(n.TEXTURE_2D,te,0,0,Re,De,Te):t.texImage2D(n.TEXTURE_2D,te,Ce,Re,De,Te);_.generateMipmaps=!1}else U?(Se&&t.texStorage2D(n.TEXTURE_2D,he,Ce,fe.width,fe.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Re,De,fe)):t.texImage2D(n.TEXTURE_2D,0,Ce,Re,De,fe);D(_,ze)&&P(Z),Me.__version=ne.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function _e(M,_,L){if(_.image.length!==6)return;const Z=Le(M,_),ee=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+L);const ne=i.get(ee);if(ee.version!==ne.__version||Z===!0){t.activeTexture(n.TEXTURE0+L);const Me=tt.getPrimaries(tt.workingColorSpace),ue=_.colorSpace===Qt?null:tt.getPrimaries(_.colorSpace),pe=_.colorSpace===Qt||Me===ue?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const be=_.isCompressedTexture||_.image[0].isCompressedTexture,qe=_.image[0]&&_.image[0].isDataTexture,fe=[];for(let te=0;te<6;te++)!be&&!qe?fe[te]=y(_.image[te],!1,!0,c):fe[te]=qe?_.image[te].image:_.image[te],fe[te]=xe(_,fe[te]);const ze=fe[0],Re=E(ze)||o,De=s.convert(_.format,_.colorSpace),Ce=s.convert(_.type),Te=$(_.internalFormat,De,Ce,_.colorSpace),Ke=o&&_.isVideoTexture!==!0,U=ne.__version===void 0||Z===!0;let Se=T(_,ze,Re);Be(n.TEXTURE_CUBE_MAP,_,Re);let he;if(be){Ke&&U&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Se,Te,ze.width,ze.height);for(let te=0;te<6;te++){he=fe[te].mipmaps;for(let de=0;de<he.length;de++){const Ue=he[de];_.format!==ln?De!==null?Ke?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de,0,0,Ue.width,Ue.height,De,Ue.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de,Te,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de,0,0,Ue.width,Ue.height,De,Ce,Ue.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de,Te,Ue.width,Ue.height,0,De,Ce,Ue.data)}}}else{he=_.mipmaps,Ke&&U&&(he.length>0&&Se++,t.texStorage2D(n.TEXTURE_CUBE_MAP,Se,Te,fe[0].width,fe[0].height));for(let te=0;te<6;te++)if(qe){Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,fe[te].width,fe[te].height,De,Ce,fe[te].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Te,fe[te].width,fe[te].height,0,De,Ce,fe[te].data);for(let de=0;de<he.length;de++){const $e=he[de].image[te].image;Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de+1,0,0,$e.width,$e.height,De,Ce,$e.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de+1,Te,$e.width,$e.height,0,De,Ce,$e.data)}}else{Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,De,Ce,fe[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Te,De,Ce,fe[te]);for(let de=0;de<he.length;de++){const Ue=he[de];Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de+1,0,0,De,Ce,Ue.image[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,de+1,Te,De,Ce,Ue.image[te])}}}D(_,Re)&&P(n.TEXTURE_CUBE_MAP),ne.__version=ee.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function le(M,_,L,Z,ee,ne){const Me=s.convert(L.format,L.colorSpace),ue=s.convert(L.type),pe=$(L.internalFormat,Me,ue,L.colorSpace);if(!i.get(_).__hasExternalTextures){const qe=Math.max(1,_.width>>ne),fe=Math.max(1,_.height>>ne);ee===n.TEXTURE_3D||ee===n.TEXTURE_2D_ARRAY?t.texImage3D(ee,ne,pe,qe,fe,_.depth,0,Me,ue,null):t.texImage2D(ee,ne,pe,qe,fe,0,Me,ue,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),Q(_)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,ee,i.get(L).__webglTexture,0,k(_)):(ee===n.TEXTURE_2D||ee>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,ee,i.get(L).__webglTexture,ne),t.bindFramebuffer(n.FRAMEBUFFER,null)}function g(M,_,L){if(n.bindRenderbuffer(n.RENDERBUFFER,M),_.depthBuffer&&!_.stencilBuffer){let Z=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(L||Q(_)){const ee=_.depthTexture;ee&&ee.isDepthTexture&&(ee.type===ti?Z=n.DEPTH_COMPONENT32F:ee.type===ei&&(Z=n.DEPTH_COMPONENT24));const ne=k(_);Q(_)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ne,Z,_.width,_.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,ne,Z,_.width,_.height)}else n.renderbufferStorage(n.RENDERBUFFER,Z,_.width,_.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(_.depthBuffer&&_.stencilBuffer){const Z=k(_);L&&Q(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,_.width,_.height):Q(_)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const Z=_.isWebGLMultipleRenderTargets===!0?_.texture:[_.texture];for(let ee=0;ee<Z.length;ee++){const ne=Z[ee],Me=s.convert(ne.format,ne.colorSpace),ue=s.convert(ne.type),pe=$(ne.internalFormat,Me,ue,ne.colorSpace),be=k(_);L&&Q(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,be,pe,_.width,_.height):Q(_)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,be,pe,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,pe,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function R(M,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),se(_.depthTexture,0);const Z=i.get(_.depthTexture).__webglTexture,ee=k(_);if(_.depthTexture.format===Ai)Q(_)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0,ee):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0);else if(_.depthTexture.format===fr)Q(_)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0,ee):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function C(M){const _=i.get(M),L=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!_.__autoAllocateDepthBuffer){if(L)throw new Error("target.depthTexture not supported in Cube render targets");R(_.__webglFramebuffer,M)}else if(L){_.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[Z]),_.__webglDepthbuffer[Z]=n.createRenderbuffer(),g(_.__webglDepthbuffer[Z],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=n.createRenderbuffer(),g(_.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function F(M,_,L){const Z=i.get(M);_!==void 0&&le(Z.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&C(M)}function O(M){const _=M.texture,L=i.get(M),Z=i.get(_);M.addEventListener("dispose",ae),M.isWebGLMultipleRenderTargets!==!0&&(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=_.version,a.memory.textures++);const ee=M.isWebGLCubeRenderTarget===!0,ne=M.isWebGLMultipleRenderTargets===!0,Me=E(M)||o;if(ee){L.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(o&&_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[ue]=[];for(let pe=0;pe<_.mipmaps.length;pe++)L.__webglFramebuffer[ue][pe]=n.createFramebuffer()}else L.__webglFramebuffer[ue]=n.createFramebuffer()}else{if(o&&_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let ue=0;ue<_.mipmaps.length;ue++)L.__webglFramebuffer[ue]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(ne)if(r.drawBuffers){const ue=M.texture;for(let pe=0,be=ue.length;pe<be;pe++){const qe=i.get(ue[pe]);qe.__webglTexture===void 0&&(qe.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&Q(M)===!1){const ue=ne?_:[_];L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let pe=0;pe<ue.length;pe++){const be=ue[pe];L.__webglColorRenderbuffer[pe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[pe]);const qe=s.convert(be.format,be.colorSpace),fe=s.convert(be.type),ze=$(be.internalFormat,qe,fe,be.colorSpace,M.isXRRenderTarget===!0),Re=k(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Re,ze,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,L.__webglColorRenderbuffer[pe])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),g(L.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ee){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),Be(n.TEXTURE_CUBE_MAP,_,Me);for(let ue=0;ue<6;ue++)if(o&&_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)le(L.__webglFramebuffer[ue][pe],M,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,pe);else le(L.__webglFramebuffer[ue],M,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);D(_,Me)&&P(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ne){const ue=M.texture;for(let pe=0,be=ue.length;pe<be;pe++){const qe=ue[pe],fe=i.get(qe);t.bindTexture(n.TEXTURE_2D,fe.__webglTexture),Be(n.TEXTURE_2D,qe,Me),le(L.__webglFramebuffer,M,qe,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,0),D(qe,Me)&&P(n.TEXTURE_2D)}t.unbindTexture()}else{let ue=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?ue=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ue,Z.__webglTexture),Be(ue,_,Me),o&&_.mipmaps&&_.mipmaps.length>0)for(let pe=0;pe<_.mipmaps.length;pe++)le(L.__webglFramebuffer[pe],M,_,n.COLOR_ATTACHMENT0,ue,pe);else le(L.__webglFramebuffer,M,_,n.COLOR_ATTACHMENT0,ue,0);D(_,Me)&&P(ue),t.unbindTexture()}M.depthBuffer&&C(M)}function X(M){const _=E(M)||o,L=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let Z=0,ee=L.length;Z<ee;Z++){const ne=L[Z];if(D(ne,_)){const Me=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ue=i.get(ne).__webglTexture;t.bindTexture(Me,ue),P(Me),t.unbindTexture()}}}function W(M){if(o&&M.samples>0&&Q(M)===!1){const _=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],L=M.width,Z=M.height;let ee=n.COLOR_BUFFER_BIT;const ne=[],Me=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=i.get(M),pe=M.isWebGLMultipleRenderTargets===!0;if(pe)for(let be=0;be<_.length;be++)t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let be=0;be<_.length;be++){ne.push(n.COLOR_ATTACHMENT0+be),M.depthBuffer&&ne.push(Me);const qe=ue.__ignoreDepthValues!==void 0?ue.__ignoreDepthValues:!1;if(qe===!1&&(M.depthBuffer&&(ee|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&(ee|=n.STENCIL_BUFFER_BIT)),pe&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ue.__webglColorRenderbuffer[be]),qe===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[Me]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[Me])),pe){const fe=i.get(_[be]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,fe,0)}n.blitFramebuffer(0,0,L,Z,0,0,L,Z,ee,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ne)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),pe)for(let be=0;be<_.length;be++){t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,ue.__webglColorRenderbuffer[be]);const qe=i.get(_[be]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,qe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}}function k(M){return Math.min(f,M.samples)}function Q(M){const _=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function K(M){const _=a.render.frame;x.get(M)!==_&&(x.set(M,_),M.update())}function xe(M,_){const L=M.colorSpace,Z=M.format,ee=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===Sa||L!==Wn&&L!==Qt&&(tt.getTransfer(L)===at?o===!1?e.has("EXT_sRGB")===!0&&Z===ln?(M.format=Sa,M.minFilter=$t,M.generateMipmaps=!1):_=Lf.sRGBToLinear(_):(Z!==ln||ee!==si)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",L)),_}this.allocateTextureUnit=re,this.resetTextureUnits=V,this.setTexture2D=se,this.setTexture2DArray=N,this.setTexture3D=H,this.setTextureCube=ge,this.rebindTextures=F,this.setupRenderTarget=O,this.updateRenderTargetMipmap=X,this.updateMultisampleRenderTarget=W,this.setupDepthRenderbuffer=C,this.setupFrameBufferTexture=le,this.useMultisampledRTT=Q}function tM(n,e,t){const i=t.isWebGL2;function r(s,a=Qt){let o;const l=tt.getTransfer(a);if(s===si)return n.UNSIGNED_BYTE;if(s===Tf)return n.UNSIGNED_SHORT_4_4_4_4;if(s===bf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Sm)return n.BYTE;if(s===Em)return n.SHORT;if(s===qa)return n.UNSIGNED_SHORT;if(s===yf)return n.INT;if(s===ei)return n.UNSIGNED_INT;if(s===ti)return n.FLOAT;if(s===Wr)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===ym)return n.ALPHA;if(s===ln)return n.RGBA;if(s===Tm)return n.LUMINANCE;if(s===bm)return n.LUMINANCE_ALPHA;if(s===Ai)return n.DEPTH_COMPONENT;if(s===fr)return n.DEPTH_STENCIL;if(s===Sa)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===Am)return n.RED;if(s===Af)return n.RED_INTEGER;if(s===wm)return n.RG;if(s===wf)return n.RG_INTEGER;if(s===Rf)return n.RGBA_INTEGER;if(s===Ro||s===Co||s===Po||s===Lo)if(l===at)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Ro)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Co)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Po)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Lo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Ro)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Co)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Po)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Lo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ql||s===Yl||s===jl||s===Kl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===ql)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Yl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===jl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Kl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Rm)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===$l||s===Zl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===$l)return l===at?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===Zl)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Jl||s===Ql||s===ec||s===tc||s===nc||s===ic||s===rc||s===sc||s===oc||s===ac||s===lc||s===cc||s===uc||s===fc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Jl)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ql)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===ec)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===tc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===nc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===ic)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===rc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===sc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===oc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ac)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===lc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===cc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===uc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===fc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Do||s===hc||s===dc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===Do)return l===at?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===hc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===dc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Cm||s===pc||s===mc||s===gc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===Do)return o.COMPRESSED_RED_RGTC1_EXT;if(s===pc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===mc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===gc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===bi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class nM extends Jt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class bs extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const iM={type:"move"};class ta{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new bs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new bs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new bs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,i),h=this._getHandJoint(c,v);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&d>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(iM)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new bs;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class rM extends Ht{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:Ai,u!==Ai&&u!==fr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Ai&&(i=ei),i===void 0&&u===fr&&(i=bi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Dt,this.minFilter=l!==void 0?l:Dt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class sM extends dr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,d=null,m=null,x=null;const v=t.getContextAttributes();let p=null,h=null;const b=[],y=[],E=new Jt;E.layers.enable(1),E.viewport=new xt;const w=new Jt;w.layers.enable(2),w.viewport=new xt;const D=[E,w],P=new nM;P.layers.enable(1),P.layers.enable(2);let $=null,T=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let H=b[N];return H===void 0&&(H=new ta,b[N]=H),H.getTargetRaySpace()},this.getControllerGrip=function(N){let H=b[N];return H===void 0&&(H=new ta,b[N]=H),H.getGripSpace()},this.getHand=function(N){let H=b[N];return H===void 0&&(H=new ta,b[N]=H),H.getHandSpace()};function A(N){const H=y.indexOf(N.inputSource);if(H===-1)return;const ge=b[H];ge!==void 0&&(ge.update(N.inputSource,N.frame,c||a),ge.dispatchEvent({type:N.type,data:N.inputSource}))}function ie(){r.removeEventListener("select",A),r.removeEventListener("selectstart",A),r.removeEventListener("selectend",A),r.removeEventListener("squeeze",A),r.removeEventListener("squeezestart",A),r.removeEventListener("squeezeend",A),r.removeEventListener("end",ie),r.removeEventListener("inputsourceschange",ae);for(let N=0;N<b.length;N++){const H=y[N];H!==null&&(y[N]=null,b[N].disconnect(H))}$=null,T=null,e.setRenderTarget(p),m=null,d=null,f=null,r=null,h=null,se.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){s=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){o=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(N){c=N},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(N){if(r=N,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",A),r.addEventListener("selectstart",A),r.addEventListener("selectend",A),r.addEventListener("squeeze",A),r.addEventListener("squeezestart",A),r.addEventListener("squeezeend",A),r.addEventListener("end",ie),r.addEventListener("inputsourceschange",ae),v.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const H={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,H),r.updateRenderState({baseLayer:m}),h=new Ri(m.framebufferWidth,m.framebufferHeight,{format:ln,type:si,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let H=null,ge=null,ve=null;v.depth&&(ve=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,H=v.stencil?fr:Ai,ge=v.stencil?bi:ei);const Ee={colorFormat:t.RGBA8,depthFormat:ve,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(Ee),r.updateRenderState({layers:[d]}),h=new Ri(d.textureWidth,d.textureHeight,{format:ln,type:si,depthTexture:new rM(d.textureWidth,d.textureHeight,ge,void 0,void 0,void 0,void 0,void 0,void 0,H),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const we=e.properties.get(h);we.__ignoreDepthValues=d.ignoreDepthValues}h.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function ae(N){for(let H=0;H<N.removed.length;H++){const ge=N.removed[H],ve=y.indexOf(ge);ve>=0&&(y[ve]=null,b[ve].disconnect(ge))}for(let H=0;H<N.added.length;H++){const ge=N.added[H];let ve=y.indexOf(ge);if(ve===-1){for(let we=0;we<b.length;we++)if(we>=y.length){y.push(ge),ve=we;break}else if(y[we]===null){y[we]=ge,ve=we;break}if(ve===-1)break}const Ee=b[ve];Ee&&Ee.connect(ge)}}const ce=new z,I=new z;function j(N,H,ge){ce.setFromMatrixPosition(H.matrixWorld),I.setFromMatrixPosition(ge.matrixWorld);const ve=ce.distanceTo(I),Ee=H.projectionMatrix.elements,we=ge.projectionMatrix.elements,Be=Ee[14]/(Ee[10]-1),Le=Ee[14]/(Ee[10]+1),Ne=(Ee[9]+1)/Ee[5],_e=(Ee[9]-1)/Ee[5],le=(Ee[8]-1)/Ee[0],g=(we[8]+1)/we[0],R=Be*le,C=Be*g,F=ve/(-le+g),O=F*-le;H.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(O),N.translateZ(F),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert();const X=Be+F,W=Le+F,k=R-O,Q=C+(ve-O),K=Ne*Le/W*X,xe=_e*Le/W*X;N.projectionMatrix.makePerspective(k,Q,K,xe,X,W),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}function J(N,H){H===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(H.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(r===null)return;P.near=w.near=E.near=N.near,P.far=w.far=E.far=N.far,($!==P.near||T!==P.far)&&(r.updateRenderState({depthNear:P.near,depthFar:P.far}),$=P.near,T=P.far);const H=N.parent,ge=P.cameras;J(P,H);for(let ve=0;ve<ge.length;ve++)J(ge[ve],H);ge.length===2?j(P,E,w):P.projectionMatrix.copy(E.projectionMatrix),V(N,P,H)};function V(N,H,ge){ge===null?N.matrix.copy(H.matrixWorld):(N.matrix.copy(ge.matrixWorld),N.matrix.invert(),N.matrix.multiply(H.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(H.projectionMatrix),N.projectionMatrixInverse.copy(H.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=Xr*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(N){l=N,d!==null&&(d.fixedFoveation=N),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=N)};let re=null;function oe(N,H){if(u=H.getViewerPose(c||a),x=H,u!==null){const ge=u.views;m!==null&&(e.setRenderTargetFramebuffer(h,m.framebuffer),e.setRenderTarget(h));let ve=!1;ge.length!==P.cameras.length&&(P.cameras.length=0,ve=!0);for(let Ee=0;Ee<ge.length;Ee++){const we=ge[Ee];let Be=null;if(m!==null)Be=m.getViewport(we);else{const Ne=f.getViewSubImage(d,we);Be=Ne.viewport,Ee===0&&(e.setRenderTargetTextures(h,Ne.colorTexture,d.ignoreDepthValues?void 0:Ne.depthStencilTexture),e.setRenderTarget(h))}let Le=D[Ee];Le===void 0&&(Le=new Jt,Le.layers.enable(Ee),Le.viewport=new xt,D[Ee]=Le),Le.matrix.fromArray(we.transform.matrix),Le.matrix.decompose(Le.position,Le.quaternion,Le.scale),Le.projectionMatrix.fromArray(we.projectionMatrix),Le.projectionMatrixInverse.copy(Le.projectionMatrix).invert(),Le.viewport.set(Be.x,Be.y,Be.width,Be.height),Ee===0&&(P.matrix.copy(Le.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),ve===!0&&P.cameras.push(Le)}}for(let ge=0;ge<b.length;ge++){const ve=y[ge],Ee=b[ge];ve!==null&&Ee!==void 0&&Ee.update(ve,H,c||a)}re&&re(N,H),H.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:H}),x=null}const se=new Vf;se.setAnimationLoop(oe),this.setAnimationLoop=function(N){re=N},this.dispose=function(){}}}function oM(n,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function i(p,h){h.color.getRGB(p.fogColor.value,Bf(n)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,b,y,E){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),f(p,h)):h.isMeshPhongMaterial?(s(p,h),u(p,h)):h.isMeshStandardMaterial?(s(p,h),d(p,h),h.isMeshPhysicalMaterial&&m(p,h,E)):h.isMeshMatcapMaterial?(s(p,h),x(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),v(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,b,y):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===zt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===zt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=e.get(h).envMap;if(b&&(p.envMap.value=b,p.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap){p.lightMap.value=h.lightMap;const y=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=h.lightMapIntensity*y,t(h.lightMap,p.lightMapTransform)}h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,b,y){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=y*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function f(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function d(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),e.get(h).envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===zt&&p.clearcoatNormalScale.value.negate())),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,h){h.matcap&&(p.matcap.value=h.matcap)}function v(p,h){const b=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function aM(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(b,y){const E=y.program;i.uniformBlockBinding(b,E)}function c(b,y){let E=r[b.id];E===void 0&&(x(b),E=u(b),r[b.id]=E,b.addEventListener("dispose",p));const w=y.program;i.updateUBOMapping(b,w);const D=e.render.frame;s[b.id]!==D&&(d(b),s[b.id]=D)}function u(b){const y=f();b.__bindingPointIndex=y;const E=n.createBuffer(),w=b.__size,D=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,w,D),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,y,E),E}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const y=r[b.id],E=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,y);for(let D=0,P=E.length;D<P;D++){const $=E[D];if(m($,D,w)===!0){const T=$.__offset,A=Array.isArray($.value)?$.value:[$.value];let ie=0;for(let ae=0;ae<A.length;ae++){const ce=A[ae],I=v(ce);typeof ce=="number"?($.__data[0]=ce,n.bufferSubData(n.UNIFORM_BUFFER,T+ie,$.__data)):ce.isMatrix3?($.__data[0]=ce.elements[0],$.__data[1]=ce.elements[1],$.__data[2]=ce.elements[2],$.__data[3]=ce.elements[0],$.__data[4]=ce.elements[3],$.__data[5]=ce.elements[4],$.__data[6]=ce.elements[5],$.__data[7]=ce.elements[0],$.__data[8]=ce.elements[6],$.__data[9]=ce.elements[7],$.__data[10]=ce.elements[8],$.__data[11]=ce.elements[0]):(ce.toArray($.__data,ie),ie+=I.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,T,$.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(b,y,E){const w=b.value;if(E[y]===void 0){if(typeof w=="number")E[y]=w;else{const D=Array.isArray(w)?w:[w],P=[];for(let $=0;$<D.length;$++)P.push(D[$].clone());E[y]=P}return!0}else if(typeof w=="number"){if(E[y]!==w)return E[y]=w,!0}else{const D=Array.isArray(E[y])?E[y]:[E[y]],P=Array.isArray(w)?w:[w];for(let $=0;$<D.length;$++){const T=D[$];if(T.equals(P[$])===!1)return T.copy(P[$]),!0}}return!1}function x(b){const y=b.uniforms;let E=0;const w=16;let D=0;for(let P=0,$=y.length;P<$;P++){const T=y[P],A={boundary:0,storage:0},ie=Array.isArray(T.value)?T.value:[T.value];for(let ae=0,ce=ie.length;ae<ce;ae++){const I=ie[ae],j=v(I);A.boundary+=j.boundary,A.storage+=j.storage}if(T.__data=new Float32Array(A.storage/Float32Array.BYTES_PER_ELEMENT),T.__offset=E,P>0){D=E%w;const ae=w-D;D!==0&&ae-A.boundary<0&&(E+=w-D,T.__offset=E)}E+=A.storage}return D=E%w,D>0&&(E+=w-D),b.__size=E,b.__cache={},this}function v(b){const y={boundary:0,storage:0};return typeof b=="number"?(y.boundary=4,y.storage=4):b.isVector2?(y.boundary=8,y.storage=8):b.isVector3||b.isColor?(y.boundary=16,y.storage=12):b.isVector4?(y.boundary=16,y.storage=16):b.isMatrix3?(y.boundary=48,y.storage=48):b.isMatrix4?(y.boundary=64,y.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),y}function p(b){const y=b.target;y.removeEventListener("dispose",p);const E=a.indexOf(y.__bindingPointIndex);a.splice(E,1),n.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function h(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:h}}class Yf{constructor(e={}){const{canvas:t=ig(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=a;const m=new Uint32Array(4),x=new Int32Array(4);let v=null,p=null;const h=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=vt,this._useLegacyLights=!1,this.toneMapping=ri,this.toneMappingExposure=1;const y=this;let E=!1,w=0,D=0,P=null,$=-1,T=null;const A=new xt,ie=new xt;let ae=null;const ce=new Qe(0);let I=0,j=t.width,J=t.height,V=1,re=null,oe=null;const se=new xt(0,0,j,J),N=new xt(0,0,j,J);let H=!1;const ge=new Gf;let ve=!1,Ee=!1,we=null;const Be=new it,Le=new je,Ne=new z,_e={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function le(){return P===null?V:1}let g=i;function R(S,B){for(let G=0;G<S.length;G++){const q=S[G],Y=t.getContext(q,B);if(Y!==null)return Y}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Xa}`),t.addEventListener("webglcontextlost",Ke,!1),t.addEventListener("webglcontextrestored",U,!1),t.addEventListener("webglcontextcreationerror",Se,!1),g===null){const B=["webgl2","webgl","experimental-webgl"];if(y.isWebGL1Renderer===!0&&B.shift(),g=R(B,S),g===null)throw R(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&g instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),g.getShaderPrecisionFormat===void 0&&(g.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let C,F,O,X,W,k,Q,K,xe,M,_,L,Z,ee,ne,Me,ue,pe,be,qe,fe,ze,Re,De;function Ce(){C=new _x(g),F=new ux(g,C,e),C.init(F),ze=new tM(g,C,F),O=new Q0(g,C,F),X=new Mx(g),W=new z0,k=new eM(g,C,O,W,F,ze,X),Q=new hx(y),K=new gx(y),xe=new Cg(g,F),Re=new lx(g,C,xe,F),M=new vx(g,xe,X,Re),_=new Tx(g,M,xe,X),be=new yx(g,F,k),Me=new fx(W),L=new B0(y,Q,K,C,F,Re,Me),Z=new oM(y,W),ee=new G0,ne=new Y0(C,F),pe=new ax(y,Q,K,O,_,d,l),ue=new J0(y,_,F),De=new aM(g,X,F,O),qe=new cx(g,C,X,F),fe=new xx(g,C,X,F),X.programs=L.programs,y.capabilities=F,y.extensions=C,y.properties=W,y.renderLists=ee,y.shadowMap=ue,y.state=O,y.info=X}Ce();const Te=new sM(y,g);this.xr=Te,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const S=C.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=C.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(S){S!==void 0&&(V=S,this.setSize(j,J,!1))},this.getSize=function(S){return S.set(j,J)},this.setSize=function(S,B,G=!0){if(Te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}j=S,J=B,t.width=Math.floor(S*V),t.height=Math.floor(B*V),G===!0&&(t.style.width=S+"px",t.style.height=B+"px"),this.setViewport(0,0,S,B)},this.getDrawingBufferSize=function(S){return S.set(j*V,J*V).floor()},this.setDrawingBufferSize=function(S,B,G){j=S,J=B,V=G,t.width=Math.floor(S*G),t.height=Math.floor(B*G),this.setViewport(0,0,S,B)},this.getCurrentViewport=function(S){return S.copy(A)},this.getViewport=function(S){return S.copy(se)},this.setViewport=function(S,B,G,q){S.isVector4?se.set(S.x,S.y,S.z,S.w):se.set(S,B,G,q),O.viewport(A.copy(se).multiplyScalar(V).floor())},this.getScissor=function(S){return S.copy(N)},this.setScissor=function(S,B,G,q){S.isVector4?N.set(S.x,S.y,S.z,S.w):N.set(S,B,G,q),O.scissor(ie.copy(N).multiplyScalar(V).floor())},this.getScissorTest=function(){return H},this.setScissorTest=function(S){O.setScissorTest(H=S)},this.setOpaqueSort=function(S){re=S},this.setTransparentSort=function(S){oe=S},this.getClearColor=function(S){return S.copy(pe.getClearColor())},this.setClearColor=function(){pe.setClearColor.apply(pe,arguments)},this.getClearAlpha=function(){return pe.getClearAlpha()},this.setClearAlpha=function(){pe.setClearAlpha.apply(pe,arguments)},this.clear=function(S=!0,B=!0,G=!0){let q=0;if(S){let Y=!1;if(P!==null){const ye=P.texture.format;Y=ye===Rf||ye===wf||ye===Af}if(Y){const ye=P.texture.type,Ae=ye===si||ye===ei||ye===qa||ye===bi||ye===Tf||ye===bf,Ie=pe.getClearColor(),Fe=pe.getClearAlpha(),We=Ie.r,He=Ie.g,Ve=Ie.b;Ae?(m[0]=We,m[1]=He,m[2]=Ve,m[3]=Fe,g.clearBufferuiv(g.COLOR,0,m)):(x[0]=We,x[1]=He,x[2]=Ve,x[3]=Fe,g.clearBufferiv(g.COLOR,0,x))}else q|=g.COLOR_BUFFER_BIT}B&&(q|=g.DEPTH_BUFFER_BIT),G&&(q|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ke,!1),t.removeEventListener("webglcontextrestored",U,!1),t.removeEventListener("webglcontextcreationerror",Se,!1),ee.dispose(),ne.dispose(),W.dispose(),Q.dispose(),K.dispose(),_.dispose(),Re.dispose(),De.dispose(),L.dispose(),Te.dispose(),Te.removeEventListener("sessionstart",Yt),Te.removeEventListener("sessionend",st),we&&(we.dispose(),we=null),At.stop()};function Ke(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function U(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;const S=X.autoReset,B=ue.enabled,G=ue.autoUpdate,q=ue.needsUpdate,Y=ue.type;Ce(),X.autoReset=S,ue.enabled=B,ue.autoUpdate=G,ue.needsUpdate=q,ue.type=Y}function Se(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function he(S){const B=S.target;B.removeEventListener("dispose",he),te(B)}function te(S){de(S),W.remove(S)}function de(S){const B=W.get(S).programs;B!==void 0&&(B.forEach(function(G){L.releaseProgram(G)}),S.isShaderMaterial&&L.releaseShaderCache(S))}this.renderBufferDirect=function(S,B,G,q,Y,ye){B===null&&(B=_e);const Ae=Y.isMesh&&Y.matrixWorld.determinant()<0,Ie=$f(S,B,G,q,Y);O.setMaterial(q,Ae);let Fe=G.index,We=1;if(q.wireframe===!0){if(Fe=M.getWireframeAttribute(G),Fe===void 0)return;We=2}const He=G.drawRange,Ve=G.attributes.position;let ct=He.start*We,Vt=(He.start+He.count)*We;ye!==null&&(ct=Math.max(ct,ye.start*We),Vt=Math.min(Vt,(ye.start+ye.count)*We)),Fe!==null?(ct=Math.max(ct,0),Vt=Math.min(Vt,Fe.count)):Ve!=null&&(ct=Math.max(ct,0),Vt=Math.min(Vt,Ve.count));const gt=Vt-ct;if(gt<0||gt===1/0)return;Re.setup(Y,q,Ie,G,Fe);let bn,lt=qe;if(Fe!==null&&(bn=xe.get(Fe),lt=fe,lt.setIndex(bn)),Y.isMesh)q.wireframe===!0?(O.setLineWidth(q.wireframeLinewidth*le()),lt.setMode(g.LINES)):lt.setMode(g.TRIANGLES);else if(Y.isLine){let Ye=q.linewidth;Ye===void 0&&(Ye=1),O.setLineWidth(Ye*le()),Y.isLineSegments?lt.setMode(g.LINES):Y.isLineLoop?lt.setMode(g.LINE_LOOP):lt.setMode(g.LINE_STRIP)}else Y.isPoints?lt.setMode(g.POINTS):Y.isSprite&&lt.setMode(g.TRIANGLES);if(Y.isInstancedMesh)lt.renderInstances(ct,gt,Y.count);else if(G.isInstancedBufferGeometry){const Ye=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,fo=Math.min(G.instanceCount,Ye);lt.renderInstances(ct,gt,fo)}else lt.render(ct,gt)};function Ue(S,B,G){S.transparent===!0&&S.side===On&&S.forceSinglePass===!1?(S.side=zt,S.needsUpdate=!0,Qr(S,B,G),S.side=ai,S.needsUpdate=!0,Qr(S,B,G),S.side=On):Qr(S,B,G)}this.compile=function(S,B,G=null){G===null&&(G=S),p=ne.get(G),p.init(),b.push(p),G.traverseVisible(function(Y){Y.isLight&&Y.layers.test(B.layers)&&(p.pushLight(Y),Y.castShadow&&p.pushShadow(Y))}),S!==G&&S.traverseVisible(function(Y){Y.isLight&&Y.layers.test(B.layers)&&(p.pushLight(Y),Y.castShadow&&p.pushShadow(Y))}),p.setupLights(y._useLegacyLights);const q=new Set;return S.traverse(function(Y){const ye=Y.material;if(ye)if(Array.isArray(ye))for(let Ae=0;Ae<ye.length;Ae++){const Ie=ye[Ae];Ue(Ie,G,Y),q.add(Ie)}else Ue(ye,G,Y),q.add(ye)}),b.pop(),p=null,q},this.compileAsync=function(S,B,G=null){const q=this.compile(S,B,G);return new Promise(Y=>{function ye(){if(q.forEach(function(Ae){W.get(Ae).currentProgram.isReady()&&q.delete(Ae)}),q.size===0){Y(S);return}setTimeout(ye,10)}C.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let $e=null;function ut(S){$e&&$e(S)}function Yt(){At.stop()}function st(){At.start()}const At=new Vf;At.setAnimationLoop(ut),typeof self<"u"&&At.setContext(self),this.setAnimationLoop=function(S){$e=S,Te.setAnimationLoop(S),S===null?At.stop():At.start()},Te.addEventListener("sessionstart",Yt),Te.addEventListener("sessionend",st),this.render=function(S,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),Te.enabled===!0&&Te.isPresenting===!0&&(Te.cameraAutoUpdate===!0&&Te.updateCamera(B),B=Te.getCamera()),S.isScene===!0&&S.onBeforeRender(y,S,B,P),p=ne.get(S,b.length),p.init(),b.push(p),Be.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),ge.setFromProjectionMatrix(Be),Ee=this.localClippingEnabled,ve=Me.init(this.clippingPlanes,Ee),v=ee.get(S,h.length),v.init(),h.push(v),dn(S,B,0,y.sortObjects),v.finish(),y.sortObjects===!0&&v.sort(re,oe),this.info.render.frame++,ve===!0&&Me.beginShadows();const G=p.state.shadowsArray;if(ue.render(G,S,B),ve===!0&&Me.endShadows(),this.info.autoReset===!0&&this.info.reset(),pe.render(v,S),p.setupLights(y._useLegacyLights),B.isArrayCamera){const q=B.cameras;for(let Y=0,ye=q.length;Y<ye;Y++){const Ae=q[Y];el(v,S,Ae,Ae.viewport)}}else el(v,S,B);P!==null&&(k.updateMultisampleRenderTarget(P),k.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(y,S,B),Re.resetDefaultState(),$=-1,T=null,b.pop(),b.length>0?p=b[b.length-1]:p=null,h.pop(),h.length>0?v=h[h.length-1]:v=null};function dn(S,B,G,q){if(S.visible===!1)return;if(S.layers.test(B.layers)){if(S.isGroup)G=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(B);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ge.intersectsSprite(S)){q&&Ne.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Be);const Ae=_.update(S),Ie=S.material;Ie.visible&&v.push(S,Ae,Ie,G,Ne.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ge.intersectsObject(S))){const Ae=_.update(S),Ie=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ne.copy(S.boundingSphere.center)):(Ae.boundingSphere===null&&Ae.computeBoundingSphere(),Ne.copy(Ae.boundingSphere.center)),Ne.applyMatrix4(S.matrixWorld).applyMatrix4(Be)),Array.isArray(Ie)){const Fe=Ae.groups;for(let We=0,He=Fe.length;We<He;We++){const Ve=Fe[We],ct=Ie[Ve.materialIndex];ct&&ct.visible&&v.push(S,Ae,ct,G,Ne.z,Ve)}}else Ie.visible&&v.push(S,Ae,Ie,G,Ne.z,null)}}const ye=S.children;for(let Ae=0,Ie=ye.length;Ae<Ie;Ae++)dn(ye[Ae],B,G,q)}function el(S,B,G,q){const Y=S.opaque,ye=S.transmissive,Ae=S.transparent;p.setupLightsView(G),ve===!0&&Me.setGlobalState(y.clippingPlanes,G),ye.length>0&&Kf(Y,ye,B,G),q&&O.viewport(A.copy(q)),Y.length>0&&Jr(Y,B,G),ye.length>0&&Jr(ye,B,G),Ae.length>0&&Jr(Ae,B,G),O.buffers.depth.setTest(!0),O.buffers.depth.setMask(!0),O.buffers.color.setMask(!0),O.setPolygonOffset(!1)}function Kf(S,B,G,q){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;const ye=F.isWebGL2;we===null&&(we=new Ri(1,1,{generateMipmaps:!0,type:C.has("EXT_color_buffer_half_float")?Wr:si,minFilter:kr,samples:ye?4:0})),y.getDrawingBufferSize(Le),ye?we.setSize(Le.x,Le.y):we.setSize(Ys(Le.x),Ys(Le.y));const Ae=y.getRenderTarget();y.setRenderTarget(we),y.getClearColor(ce),I=y.getClearAlpha(),I<1&&y.setClearColor(16777215,.5),y.clear();const Ie=y.toneMapping;y.toneMapping=ri,Jr(S,G,q),k.updateMultisampleRenderTarget(we),k.updateRenderTargetMipmap(we);let Fe=!1;for(let We=0,He=B.length;We<He;We++){const Ve=B[We],ct=Ve.object,Vt=Ve.geometry,gt=Ve.material,bn=Ve.group;if(gt.side===On&&ct.layers.test(q.layers)){const lt=gt.side;gt.side=zt,gt.needsUpdate=!0,tl(ct,G,q,Vt,gt,bn),gt.side=lt,gt.needsUpdate=!0,Fe=!0}}Fe===!0&&(k.updateMultisampleRenderTarget(we),k.updateRenderTargetMipmap(we)),y.setRenderTarget(Ae),y.setClearColor(ce,I),y.toneMapping=Ie}function Jr(S,B,G){const q=B.isScene===!0?B.overrideMaterial:null;for(let Y=0,ye=S.length;Y<ye;Y++){const Ae=S[Y],Ie=Ae.object,Fe=Ae.geometry,We=q===null?Ae.material:q,He=Ae.group;Ie.layers.test(G.layers)&&tl(Ie,B,G,Fe,We,He)}}function tl(S,B,G,q,Y,ye){S.onBeforeRender(y,B,G,q,Y,ye),S.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),Y.onBeforeRender(y,B,G,q,S,ye),Y.transparent===!0&&Y.side===On&&Y.forceSinglePass===!1?(Y.side=zt,Y.needsUpdate=!0,y.renderBufferDirect(G,B,q,Y,S,ye),Y.side=ai,Y.needsUpdate=!0,y.renderBufferDirect(G,B,q,Y,S,ye),Y.side=On):y.renderBufferDirect(G,B,q,Y,S,ye),S.onAfterRender(y,B,G,q,Y,ye)}function Qr(S,B,G){B.isScene!==!0&&(B=_e);const q=W.get(S),Y=p.state.lights,ye=p.state.shadowsArray,Ae=Y.state.version,Ie=L.getParameters(S,Y.state,ye,B,G),Fe=L.getProgramCacheKey(Ie);let We=q.programs;q.environment=S.isMeshStandardMaterial?B.environment:null,q.fog=B.fog,q.envMap=(S.isMeshStandardMaterial?K:Q).get(S.envMap||q.environment),We===void 0&&(S.addEventListener("dispose",he),We=new Map,q.programs=We);let He=We.get(Fe);if(He!==void 0){if(q.currentProgram===He&&q.lightsStateVersion===Ae)return il(S,Ie),He}else Ie.uniforms=L.getUniforms(S),S.onBuild(G,Ie,y),S.onBeforeCompile(Ie,y),He=L.acquireProgram(Ie,Fe),We.set(Fe,He),q.uniforms=Ie.uniforms;const Ve=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ve.clippingPlanes=Me.uniform),il(S,Ie),q.needsLights=Jf(S),q.lightsStateVersion=Ae,q.needsLights&&(Ve.ambientLightColor.value=Y.state.ambient,Ve.lightProbe.value=Y.state.probe,Ve.directionalLights.value=Y.state.directional,Ve.directionalLightShadows.value=Y.state.directionalShadow,Ve.spotLights.value=Y.state.spot,Ve.spotLightShadows.value=Y.state.spotShadow,Ve.rectAreaLights.value=Y.state.rectArea,Ve.ltc_1.value=Y.state.rectAreaLTC1,Ve.ltc_2.value=Y.state.rectAreaLTC2,Ve.pointLights.value=Y.state.point,Ve.pointLightShadows.value=Y.state.pointShadow,Ve.hemisphereLights.value=Y.state.hemi,Ve.directionalShadowMap.value=Y.state.directionalShadowMap,Ve.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Ve.spotShadowMap.value=Y.state.spotShadowMap,Ve.spotLightMatrix.value=Y.state.spotLightMatrix,Ve.spotLightMap.value=Y.state.spotLightMap,Ve.pointShadowMap.value=Y.state.pointShadowMap,Ve.pointShadowMatrix.value=Y.state.pointShadowMatrix),q.currentProgram=He,q.uniformsList=null,He}function nl(S){if(S.uniformsList===null){const B=S.currentProgram.getUniforms();S.uniformsList=Is.seqWithValue(B.seq,S.uniforms)}return S.uniformsList}function il(S,B){const G=W.get(S);G.outputColorSpace=B.outputColorSpace,G.instancing=B.instancing,G.instancingColor=B.instancingColor,G.skinning=B.skinning,G.morphTargets=B.morphTargets,G.morphNormals=B.morphNormals,G.morphColors=B.morphColors,G.morphTargetsCount=B.morphTargetsCount,G.numClippingPlanes=B.numClippingPlanes,G.numIntersection=B.numClipIntersection,G.vertexAlphas=B.vertexAlphas,G.vertexTangents=B.vertexTangents,G.toneMapping=B.toneMapping}function $f(S,B,G,q,Y){B.isScene!==!0&&(B=_e),k.resetTextureUnits();const ye=B.fog,Ae=q.isMeshStandardMaterial?B.environment:null,Ie=P===null?y.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:Wn,Fe=(q.isMeshStandardMaterial?K:Q).get(q.envMap||Ae),We=q.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,He=!!G.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ve=!!G.morphAttributes.position,ct=!!G.morphAttributes.normal,Vt=!!G.morphAttributes.color;let gt=ri;q.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(gt=y.toneMapping);const bn=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,lt=bn!==void 0?bn.length:0,Ye=W.get(q),fo=p.state.lights;if(ve===!0&&(Ee===!0||S!==T)){const kt=S===T&&q.id===$;Me.setState(q,S,kt)}let ft=!1;q.version===Ye.__version?(Ye.needsLights&&Ye.lightsStateVersion!==fo.state.version||Ye.outputColorSpace!==Ie||Y.isInstancedMesh&&Ye.instancing===!1||!Y.isInstancedMesh&&Ye.instancing===!0||Y.isSkinnedMesh&&Ye.skinning===!1||!Y.isSkinnedMesh&&Ye.skinning===!0||Y.isInstancedMesh&&Ye.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Ye.instancingColor===!1&&Y.instanceColor!==null||Ye.envMap!==Fe||q.fog===!0&&Ye.fog!==ye||Ye.numClippingPlanes!==void 0&&(Ye.numClippingPlanes!==Me.numPlanes||Ye.numIntersection!==Me.numIntersection)||Ye.vertexAlphas!==We||Ye.vertexTangents!==He||Ye.morphTargets!==Ve||Ye.morphNormals!==ct||Ye.morphColors!==Vt||Ye.toneMapping!==gt||F.isWebGL2===!0&&Ye.morphTargetsCount!==lt)&&(ft=!0):(ft=!0,Ye.__version=q.version);let ci=Ye.currentProgram;ft===!0&&(ci=Qr(q,B,Y));let rl=!1,gr=!1,ho=!1;const wt=ci.getUniforms(),ui=Ye.uniforms;if(O.useProgram(ci.program)&&(rl=!0,gr=!0,ho=!0),q.id!==$&&($=q.id,gr=!0),rl||T!==S){wt.setValue(g,"projectionMatrix",S.projectionMatrix),wt.setValue(g,"viewMatrix",S.matrixWorldInverse);const kt=wt.map.cameraPosition;kt!==void 0&&kt.setValue(g,Ne.setFromMatrixPosition(S.matrixWorld)),F.logarithmicDepthBuffer&&wt.setValue(g,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&wt.setValue(g,"isOrthographic",S.isOrthographicCamera===!0),T!==S&&(T=S,gr=!0,ho=!0)}if(Y.isSkinnedMesh){wt.setOptional(g,Y,"bindMatrix"),wt.setOptional(g,Y,"bindMatrixInverse");const kt=Y.skeleton;kt&&(F.floatVertexTextures?(kt.boneTexture===null&&kt.computeBoneTexture(),wt.setValue(g,"boneTexture",kt.boneTexture,k),wt.setValue(g,"boneTextureSize",kt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const po=G.morphAttributes;if((po.position!==void 0||po.normal!==void 0||po.color!==void 0&&F.isWebGL2===!0)&&be.update(Y,G,ci),(gr||Ye.receiveShadow!==Y.receiveShadow)&&(Ye.receiveShadow=Y.receiveShadow,wt.setValue(g,"receiveShadow",Y.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(ui.envMap.value=Fe,ui.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),gr&&(wt.setValue(g,"toneMappingExposure",y.toneMappingExposure),Ye.needsLights&&Zf(ui,ho),ye&&q.fog===!0&&Z.refreshFogUniforms(ui,ye),Z.refreshMaterialUniforms(ui,q,V,J,we),Is.upload(g,nl(Ye),ui,k)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Is.upload(g,nl(Ye),ui,k),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&wt.setValue(g,"center",Y.center),wt.setValue(g,"modelViewMatrix",Y.modelViewMatrix),wt.setValue(g,"normalMatrix",Y.normalMatrix),wt.setValue(g,"modelMatrix",Y.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const kt=q.uniformsGroups;for(let mo=0,Qf=kt.length;mo<Qf;mo++)if(F.isWebGL2){const sl=kt[mo];De.update(sl,ci),De.bind(sl,ci)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return ci}function Zf(S,B){S.ambientLightColor.needsUpdate=B,S.lightProbe.needsUpdate=B,S.directionalLights.needsUpdate=B,S.directionalLightShadows.needsUpdate=B,S.pointLights.needsUpdate=B,S.pointLightShadows.needsUpdate=B,S.spotLights.needsUpdate=B,S.spotLightShadows.needsUpdate=B,S.rectAreaLights.needsUpdate=B,S.hemisphereLights.needsUpdate=B}function Jf(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,B,G){W.get(S.texture).__webglTexture=B,W.get(S.depthTexture).__webglTexture=G;const q=W.get(S);q.__hasExternalTextures=!0,q.__hasExternalTextures&&(q.__autoAllocateDepthBuffer=G===void 0,q.__autoAllocateDepthBuffer||C.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,B){const G=W.get(S);G.__webglFramebuffer=B,G.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(S,B=0,G=0){P=S,w=B,D=G;let q=!0,Y=null,ye=!1,Ae=!1;if(S){const Fe=W.get(S);Fe.__useDefaultFramebuffer!==void 0?(O.bindFramebuffer(g.FRAMEBUFFER,null),q=!1):Fe.__webglFramebuffer===void 0?k.setupRenderTarget(S):Fe.__hasExternalTextures&&k.rebindTextures(S,W.get(S.texture).__webglTexture,W.get(S.depthTexture).__webglTexture);const We=S.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Ae=!0);const He=W.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(He[B])?Y=He[B][G]:Y=He[B],ye=!0):F.isWebGL2&&S.samples>0&&k.useMultisampledRTT(S)===!1?Y=W.get(S).__webglMultisampledFramebuffer:Array.isArray(He)?Y=He[G]:Y=He,A.copy(S.viewport),ie.copy(S.scissor),ae=S.scissorTest}else A.copy(se).multiplyScalar(V).floor(),ie.copy(N).multiplyScalar(V).floor(),ae=H;if(O.bindFramebuffer(g.FRAMEBUFFER,Y)&&F.drawBuffers&&q&&O.drawBuffers(S,Y),O.viewport(A),O.scissor(ie),O.setScissorTest(ae),ye){const Fe=W.get(S.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+B,Fe.__webglTexture,G)}else if(Ae){const Fe=W.get(S.texture),We=B||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Fe.__webglTexture,G||0,We)}$=-1},this.readRenderTargetPixels=function(S,B,G,q,Y,ye,Ae){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ie=W.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ae!==void 0&&(Ie=Ie[Ae]),Ie){O.bindFramebuffer(g.FRAMEBUFFER,Ie);try{const Fe=S.texture,We=Fe.format,He=Fe.type;if(We!==ln&&ze.convert(We)!==g.getParameter(g.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ve=He===Wr&&(C.has("EXT_color_buffer_half_float")||F.isWebGL2&&C.has("EXT_color_buffer_float"));if(He!==si&&ze.convert(He)!==g.getParameter(g.IMPLEMENTATION_COLOR_READ_TYPE)&&!(He===ti&&(F.isWebGL2||C.has("OES_texture_float")||C.has("WEBGL_color_buffer_float")))&&!Ve){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=S.width-q&&G>=0&&G<=S.height-Y&&g.readPixels(B,G,q,Y,ze.convert(We),ze.convert(He),ye)}finally{const Fe=P!==null?W.get(P).__webglFramebuffer:null;O.bindFramebuffer(g.FRAMEBUFFER,Fe)}}},this.copyFramebufferToTexture=function(S,B,G=0){const q=Math.pow(2,-G),Y=Math.floor(B.image.width*q),ye=Math.floor(B.image.height*q);k.setTexture2D(B,0),g.copyTexSubImage2D(g.TEXTURE_2D,G,0,0,S.x,S.y,Y,ye),O.unbindTexture()},this.copyTextureToTexture=function(S,B,G,q=0){const Y=B.image.width,ye=B.image.height,Ae=ze.convert(G.format),Ie=ze.convert(G.type);k.setTexture2D(G,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,G.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,G.unpackAlignment),B.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,q,S.x,S.y,Y,ye,Ae,Ie,B.image.data):B.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,q,S.x,S.y,B.mipmaps[0].width,B.mipmaps[0].height,Ae,B.mipmaps[0].data):g.texSubImage2D(g.TEXTURE_2D,q,S.x,S.y,Ae,Ie,B.image),q===0&&G.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),O.unbindTexture()},this.copyTextureToTexture3D=function(S,B,G,q,Y=0){if(y.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const ye=S.max.x-S.min.x+1,Ae=S.max.y-S.min.y+1,Ie=S.max.z-S.min.z+1,Fe=ze.convert(q.format),We=ze.convert(q.type);let He;if(q.isData3DTexture)k.setTexture3D(q,0),He=g.TEXTURE_3D;else if(q.isDataArrayTexture)k.setTexture2DArray(q,0),He=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,q.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,q.unpackAlignment);const Ve=g.getParameter(g.UNPACK_ROW_LENGTH),ct=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Vt=g.getParameter(g.UNPACK_SKIP_PIXELS),gt=g.getParameter(g.UNPACK_SKIP_ROWS),bn=g.getParameter(g.UNPACK_SKIP_IMAGES),lt=G.isCompressedTexture?G.mipmaps[0]:G.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,lt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,lt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,S.min.x),g.pixelStorei(g.UNPACK_SKIP_ROWS,S.min.y),g.pixelStorei(g.UNPACK_SKIP_IMAGES,S.min.z),G.isDataTexture||G.isData3DTexture?g.texSubImage3D(He,Y,B.x,B.y,B.z,ye,Ae,Ie,Fe,We,lt.data):G.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),g.compressedTexSubImage3D(He,Y,B.x,B.y,B.z,ye,Ae,Ie,Fe,lt.data)):g.texSubImage3D(He,Y,B.x,B.y,B.z,ye,Ae,Ie,Fe,We,lt),g.pixelStorei(g.UNPACK_ROW_LENGTH,Ve),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,ct),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Vt),g.pixelStorei(g.UNPACK_SKIP_ROWS,gt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,bn),Y===0&&q.generateMipmaps&&g.generateMipmap(He),O.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?k.setTextureCube(S,0):S.isData3DTexture?k.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?k.setTexture2DArray(S,0):k.setTexture2D(S,0),O.unbindTexture()},this.resetState=function(){w=0,D=0,P=null,O.reset(),Re.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Bn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ya?"display-p3":"srgb",t.unpackColorSpace=tt.workingColorSpace===lo?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===vt?wi:Cf}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===wi?vt:Wn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class lM extends Yf{}lM.prototype.isWebGL1Renderer=!0;class cM extends Gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class uM{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=Ma,this.updateRange={offset:0,count:-1},this.version=0,this.uuid=Hn()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=t.array[i+r];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Hn()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Hn()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Rt=new z;class Ks{constructor(e,t,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.applyMatrix4(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.applyNormalMatrix(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.transformDirection(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}setX(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=Mn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=Mn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=Mn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=Mn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array),r=et(r,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,t,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array),r=et(r,this.array),s=et(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return new fn(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ks(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class Qi extends $r{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Qe(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Yi;const yr=new z,ji=new z,Ki=new z,$i=new je,Tr=new je,jf=new it,As=new z,br=new z,ws=new z,ru=new je,na=new je,su=new je;class fM extends Gt{constructor(e=new Qi){if(super(),this.isSprite=!0,this.type="Sprite",Yi===void 0){Yi=new qn;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new uM(t,5);Yi.setIndex([0,1,2,0,2,3]),Yi.setAttribute("position",new Ks(i,3,0,!1)),Yi.setAttribute("uv",new Ks(i,2,3,!1))}this.geometry=Yi,this.material=e,this.center=new je(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),ji.setFromMatrixScale(this.matrixWorld),jf.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Ki.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&ji.multiplyScalar(-Ki.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const a=this.center;Rs(As.set(-.5,-.5,0),Ki,a,ji,r,s),Rs(br.set(.5,-.5,0),Ki,a,ji,r,s),Rs(ws.set(.5,.5,0),Ki,a,ji,r,s),ru.set(0,0),na.set(1,0),su.set(1,1);let o=e.ray.intersectTriangle(As,br,ws,!1,yr);if(o===null&&(Rs(br.set(-.5,.5,0),Ki,a,ji,r,s),na.set(0,1),o=e.ray.intersectTriangle(As,ws,br,!1,yr),o===null))return;const l=e.ray.origin.distanceTo(yr);l<e.near||l>e.far||t.push({distance:l,point:yr.clone(),uv:Zt.getInterpolation(yr,As,br,ws,ru,na,su,new je),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Rs(n,e,t,i,r,s){$i.subVectors(n,t).addScalar(.5).multiply(i),r!==void 0?(Tr.x=s*$i.x-r*$i.y,Tr.y=r*$i.x+s*$i.y):Tr.copy($i),n.copy(e),n.x+=Tr.x,n.y+=Tr.y,n.applyMatrix4(jf)}class hM extends Ht{constructor(e,t,i,r,s,a,o,l,c){super(e,t,i,r,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Qa extends qn{constructor(e=.5,t=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],u=[];let f=e;const d=(t-e)/r,m=new z,x=new je;for(let v=0;v<=r;v++){for(let p=0;p<=i;p++){const h=s+p/i*a;m.x=f*Math.cos(h),m.y=f*Math.sin(h),l.push(m.x,m.y,m.z),c.push(0,0,1),x.x=(m.x/t+1)/2,x.y=(m.y/t+1)/2,u.push(x.x,x.y)}f+=d}for(let v=0;v<r;v++){const p=v*(i+1);for(let h=0;h<i;h++){const b=h+p,y=b,E=b+i+1,w=b+i+2,D=b+1;o.push(y,E,D),o.push(E,w,D)}}this.setIndex(o),this.setAttribute("position",new En(l,3)),this.setAttribute("normal",new En(c,3)),this.setAttribute("uv",new En(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Qa(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Xa}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Xa);const dM=no({props:{message:{type:String,required:!0},isVisible:{type:Boolean,required:!0}},emits:["close"],setup(n,{emit:e}){const t=()=>{e("close")};return{message:n.message,isVisible:n.isVisible,closeAlert:t}}}),pM={class:"alert-content"};function mM(n,e,t,i,r,s){return n.isVisible?(Tt(),It("div",{key:0,class:"alert-overlay",onClick:e[2]||(e[2]=(...a)=>n.closeAlert&&n.closeAlert(...a))},[Pe("div",{class:"alert-box",onClick:e[1]||(e[1]=vf(()=>{},["stop"]))},[Pe("div",pM,[Pe("p",null,Qn(n.message),1),Pe("button",{class:"alert-close-btn",onClick:e[0]||(e[0]=(...a)=>n.closeAlert&&n.closeAlert(...a))},"OK")])])])):ni("",!0)}const gM=Wa(dM,[["render",mM],["__scopeId","data-v-73a45f19"]]),_M=["disabled"],vM={key:0,class:"empty-list"},xM={class:"object-info"},MM=["onClick"],SM={key:0},EM={key:1,class:"tag-input-overlay"},yM={class:"tag-input-box"},TM={class:"tag-input-div"},bM=["onKeydown"],AM=5,wM=.1,RM=no({__name:"ARComponent",props:{roomId:{}},setup(n){const e=n,t=Lt(),i=Lt(!1),r=Lt(null),s=Lt(!1),a=Lt(""),o=Lt(!1),l=Lt(!1),c=Lt(""),u=Lt([]);let f=!1,d=!1;const m=mf(()=>u.value.map(_e=>({name:_e.sprite.userData.text||"Sans nom",position:_e.sprite.position.clone()})));let x,v,p,h,b,y,E=null,w=null,D=null,P=new it,$=new it,T=.1,A=[];const ie=()=>{const _e=u.value.map(le=>{var g;return{name:le.sprite.userData.text||"",position:{x:le.sprite.position.x,y:le.sprite.position.y,z:le.sprite.position.z},baseMatrix:(g=le.baseMatrix)!=null&&g.elements?Array.from(le.baseMatrix.elements):null}});localStorage.setItem(`arTags_${e.roomId}`,JSON.stringify(_e))},ae=()=>{const _e=localStorage.getItem(`arTags_${e.roomId}`);if(!_e)return[];try{return JSON.parse(_e)}catch(le){return console.error("Failed to load tags from localStorage:",le),[]}},ce=_e=>{for(const le of u.value){const g=new z;if(g.setFromMatrixPosition(le.sprite.matrixWorld),g.distanceTo(_e)<wM)return!0}return!1},I=()=>{o.value=!o.value},j=_e=>{const le=u.value[_e];if(le){if(le.sprite.material instanceof Qi&&(le.sprite.material.map&&le.sprite.material.map.dispose(),le.sprite.material.dispose()),x.remove(le.sprite),le.anchor&&le.anchor.delete)try{le.anchor.delete()}catch{}u.value.splice(_e,1),ie()}},J=_e=>{var g,R,C;if(!x)return;for(const F of u.value)if(F.sprite.material instanceof Qi&&(F.sprite.material.map&&F.sprite.material.map.dispose(),F.sprite.material.dispose()),x.remove(F.sprite),F.anchor&&F.anchor.delete)try{F.anchor.delete()}catch{}u.value=[];const le=V(_e);for(const F of le){const O=se(F.name);F.position&&O.position.set(F.position.x,F.position.y,F.position.z);const X=F.baseMatrix?new it().fromArray(F.baseMatrix):new it().setPosition(((g=F.position)==null?void 0:g.x)||0,((R=F.position)==null?void 0:R.y)||0,((C=F.position)==null?void 0:C.z)||0);x.add(O),u.value.push({sprite:O,baseMatrix:X})}},V=_e=>{const le=localStorage.getItem(`arTags_${_e}`);if(!le)return[];try{return JSON.parse(le)}catch(g){return console.error("Failed to load tags from localStorage:",g),[]}};zs(()=>{re()});const re=async()=>{if(!d){d=!0;try{if("xr"in navigator){const _e=await navigator.xr.isSessionSupported("immersive-ar");r.value=_e}else r.value=!1}finally{d=!1}}},oe=async()=>{var C,F,O,X;if(!r.value||i.value||f)return;f=!0;const _e=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:document.body}});p=new Yf({antialias:!0,alpha:!0}),p.setSize(window.innerWidth,window.innerHeight),p.xr.enabled=!0,p.xr.setReferenceSpaceType("local"),p.xr.setSession(_e),(C=t.value)==null||C.appendChild(p.domElement);const le=()=>{var W;p.setAnimationLoop(null),i.value=!1,f=!1,s.value=!1,E!=null&&E.cancel&&E.cancel(),E=null,w=null,(W=t.value)!=null&&W.contains(p.domElement)&&t.value.removeChild(p.domElement);for(const k of u.value){if(k.sprite.material instanceof Qi&&(k.sprite.material.map&&k.sprite.material.map.dispose(),k.sprite.material.dispose()),k.anchor&&k.anchor.delete)try{k.anchor.delete()}catch{}x.remove(k.sprite)}u.value=[],p.dispose()};_e.addEventListener("end",le),x=new cM,v=new Jt(70,window.innerWidth/window.innerHeight,.01,20);const g=ae();for(const W of g){const k=se(W.name);W.position&&k.position.set(W.position.x,W.position.y,W.position.z);const Q=W.baseMatrix?new it().fromArray(W.baseMatrix):new it().setPosition(((F=W.position)==null?void 0:F.x)||0,((O=W.position)==null?void 0:O.y)||0,((X=W.position)==null?void 0:X.z)||0);x.add(k),u.value.push({sprite:k,baseMatrix:Q})}const R=new Qa(.15,.2,32).rotateX(-Math.PI/2);y=new $a({color:16777215}),b=new zn(R,y),b.matrixAutoUpdate=!1,b.visible=!1,x.add(b),$.identity(),h=p.xr.getController(0),h.addEventListener("select",N),x.add(h),_e.requestReferenceSpace("viewer").then(W=>{_e.requestHitTestSource({space:W}).then(k=>{E=k})}),_e.requestReferenceSpace("local").then(W=>{w=W}),p.setAnimationLoop(Be),i.value=!0,f=!1},se=_e=>{const R=document.createElement("canvas"),C=R.getContext("2d");C.font="64px Arial";const F=C.measureText(_e),O=Math.ceil(F.width),X=64;R.width=O+20*2,R.height=X+20*2,C.font="64px Arial",C.textAlign="center",C.textBaseline="middle",C.fillStyle="rgba(0, 0, 0, 0.6)",C.fillRect(0,0,R.width,R.height),C.fillStyle="white",C.fillText(_e,R.width/2,R.height/2);const W=new hM(R);W.needsUpdate=!0;const k=new Qi({map:W,transparent:!0}),Q=new fM(k);Q.userData.text=_e;const K=.001;return Q.scale.set(R.width*K,R.height*K,1),Q},N=()=>{b.visible&&(P.copy(b.matrix),a.value="",s.value=!0)},H=()=>{if(!i.value){Ee("L'AR n'est pas encore démarré.");return}if(!b||!b.visible){Ee("Aucune surface détectée actuellement. Veuillez attendre que le réticule apparaisse.");return}P.copy(b.matrix),a.value="",s.value=!0},ge=()=>{const _e=a.value.trim();if(!_e){ve();return}const le=new z;if(le.setFromMatrixPosition(P),ce(le)){Ee("Position trop proche d'un tag existant. Veuillez choisir un autre emplacement."),ve();return}const g=(C,F)=>{const O=se(_e);O.position.setFromMatrixPosition(C),x.add(O),u.value.push({sprite:O,anchor:F,baseMatrix:C.clone()}),ie()};(async()=>{if(D!=null&&D.createAnchor)try{const C=await D.createAnchor();g(P,C);return}catch(C){console.warn("WebXR anchor creation failed, fallback on position only",C)}g(P)})().catch(()=>g(P)),s.value=!1,a.value=""},ve=()=>{s.value=!1,a.value=""},Ee=_e=>{c.value=_e,l.value=!0},we=()=>{l.value=!1,c.value=""},Be=(_e,le)=>{if(le){if(E&&w){const g=le.getHitTestResults(E);if(g.length){const R=g[0];D=R;const C=R.getPose(w);if(C){b.visible=!0;const F=new it().fromArray(C.transform.matrix);if(A.push(F),A.length>AM&&A.shift(),A.length>0){const O=[],X=[];A.forEach(M=>{const _=new z,L=new pr,Z=new z;M.decompose(_,L,Z),O.push(_),X.push(L)});const W=O.reduce((M,_)=>M.add(_),new z).divideScalar(O.length);let k=X[0].clone();for(let M=1;M<X.length;M++)k.slerp(X[M],.5);const Q=new it;Q.compose(W,k,new z(1,1,1));const K=T;for(let M=0;M<16;M++)$.elements[M]=ng.lerp($.elements[M],Q.elements[M],K);b.matrix.copy($);const xe=new z;xe.setFromMatrixPosition($),ce(xe)?y.color.setHex(16711680):y.color.setHex(16777215)}}}else b.visible=!1,A=[]}for(const g of u.value)if(g.anchor&&w){const R=g.anchor.anchorSpace||g.anchor,C=le.getPose(R,w);if(C){const F=new it().fromArray(C.transform.matrix);g.sprite.position.setFromMatrixPosition(F)}}else g.baseMatrix&&g.sprite.position.setFromMatrixPosition(g.baseMatrix)}p.render(x,v)},Le=()=>{var _e;if(d=!1,f=!1,p&&p.setAnimationLoop(null),E!=null&&E.cancel)try{E.cancel()}catch{}E=null,w=null;for(const le of u.value){if(le.sprite.material instanceof Qi&&(le.sprite.material.map&&le.sprite.material.map.dispose(),le.sprite.material.dispose()),le.anchor&&le.anchor.delete)try{le.anchor.delete()}catch{}x&&x.remove(le.sprite)}u.value=[],p&&((_e=t.value)!=null&&_e.contains(p.domElement))&&t.value.removeChild(p.domElement),p&&p.dispose(),i.value=!1,f=!1,s.value=!1};zs(async()=>{await re(),setTimeout(()=>{oe()},500)}),ku(()=>{Le()});const Ne=async()=>{if(!(i.value||f)&&r.value)try{await oe()}catch(_e){console.error("Failed to start AR:",_e),f=!1}};return Ls(()=>e.roomId,async(_e,le)=>{if(le&&_e!==le){for(;d||f;)await new Promise(g=>setTimeout(g,50));i.value?J(_e):await Ne()}},{immediate:!1}),(_e,le)=>(Tt(),It(Kt,null,[Pe("div",{id:"ar-container",ref_key:"container",ref:t},null,512),Pe("button",{class:"panel-toggle btn-panel",onClick:I},Qn(o.value?"Fermer la liste":"Liste des objets"),1),Pe("button",{class:"btn-panel add-tag-btn",onClick:H,disabled:!i.value}," Ajouter un objet ",8,_M),Pe("aside",{class:Qs(["objects-panel",{open:o.value}]),"aria-label":"Liste des objets AR"},[Pe("div",{class:"panel-header"},[le[1]||(le[1]=Pe("h3",null,"Objets AR",-1)),Pe("button",{class:"close-panel",onClick:I},"✕")]),m.value.length===0?(Tt(),It("div",vM,"Aucun objet placé")):ni("",!0),Pe("ul",null,[(Tt(!0),It(Kt,null,Xu(m.value,(g,R)=>(Tt(),It("li",{key:R},[Pe("div",xM,[Pe("strong",null,Qn(g.name),1),Pe("small",null,"("+Qn(g.position.x.toFixed(2))+", "+Qn(g.position.y.toFixed(2))+", "+Qn(g.position.z.toFixed(2))+")",1)]),Pe("button",{class:"delete-object-btn",onClick:C=>j(R)},"Supprimer",8,MM)]))),128))])],2),r.value===!1?(Tt(),It("p",SM,"Votre navigateur ne supporte pas WebXR AR.")):ni("",!0),s.value?(Tt(),It("div",EM,[Pe("div",yM,[Pe("label",null,[Pe("div",TM,[le[2]||(le[2]=Mi(" Nom : ",-1)),Ou(Pe("input",{"onUpdate:modelValue":le[0]||(le[0]=g=>a.value=g),onKeydown:xf(vf(ge,["prevent"]),["enter"]),placeholder:"Entrez le nom...",autofocus:""},null,40,bM),[[_f,a.value]])])])])])):ni("",!0),nn(gM,{message:c.value,isVisible:l.value,onClose:we},null,8,["message","isVisible"])],64))}}),CM=Wa(RM,[["__scopeId","data-v-6625b41a"]]),PM={key:0},LM={key:1},DM=no({__name:"App",setup(n){const e=Lt("rooms"),t=Lt(null),i=s=>{t.value=s,e.value="ar"},r=()=>{e.value="rooms",t.value=null};return(s,a)=>e.value==="rooms"?(Tt(),It("div",PM,[nn(Hp,{onSelectRoom:i})])):e.value==="ar"&&t.value?(Tt(),It("div",LM,[Pe("button",{onClick:r,class:"back-btn"},"Retour aux Pièces"),nn(CM,{roomId:t.value},null,8,["roomId"])])):ni("",!0)}});Ep(DM).mount("#app");
