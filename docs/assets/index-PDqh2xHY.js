...
}`;function J0(n,e,t){let i=new zf;const r=new je,s=new je,a=new xt,o=new j0({depthPacking:Lm}),l=new K0,c={},u=t.maxTextureSize,f={[ai]:zt,[zt]:ai,[On]:On},d=new Ci({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:$0,fragmentShader:Z0}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new qn;x.setAttribute("position",new fn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new zn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=vf;let h=this.type;this.render=function(w,L,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const j=n.getRenderTarget(),T=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),re=n.state;re.setBlending(ii),re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const oe=h!==Dn&&this.type===Dn,ce=h===Dn&&this.type!==Dn;for(let I=0,Y=w.length;I<Y;I++){const $=w[I],V=$.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const ie=V.getFrameExtents();if(r.multiply(ie),s.copy(V.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ie.x),r.x=s.x*ie.x,V.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ie.y),r.y=s.y*ie.y,V.mapSize.y=s.y)),V.map===null||oe===!0||ce===!0){const se=this.type!==Dn?{minFilter:Lt,magFilter:Lt}:{};V.map!==null&&V.map.dispose(),V.map=new Ri(r.x,r.y,se),V.map.texture.name=$.name+".shadowMap",V.camera.updateProjectionMatrix()}n.setRenderTarget(V.map),n.clear();const ae=V.getViewportCount();for(let se=0;se<ae;se++){const N=V.getViewport(se);a.set(s.x*N.x,s.y*N.y,s.x*N.z,s.y*N.w),re.viewport(a),V.updateMatrices($,se),i=V.getFrustum(),y(L,P,V.camera,$,this.type)}V.isPointLightShadow!==!0&&this.type===Dn&&b(V,P),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget(j,T,A)};function b(w,L){const P=e.update(g);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Ri(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,n.setRenderTarget(w.mapPass),n.clear(),n.renderBufferDirect(L,null,P,d,g,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,n.setRenderTarget(w.map),n.clear(),n.renderBufferDirect(L,null,P,m,g,null)}function E(w,L,P,j){let T=null;const A=P.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)T=A;else if(T=P.isPointLight===!0?l:o,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0){const re=T.uuid,oe=L.uuid;let ce=c[re];ce===void 0&&(ce={},c[re]=ce);let I=ce[oe];I===void 0&&(I=T.clone(),ce[oe]=I),T=I}if(T.visible=L.visible,T.wireframe=L.wireframe,j===Dn?T.side=L.shadowSide!==null?L.shadowSide:L.side:T.side=L.shadowSide!==null?L.shadowSide:f[L.side],T.alphaMap=L.alphaMap,T.alphaTest=L.alphaTest,T.map=L.map,T.clipShadows=L.clipShadows,T.clippingPlanes=L.clippingPlanes,T.clipIntersection=L.clipIntersection,T.displacementMap=L.displacementMap,T.displacementScale=L.displacementScale,T.displacementBias=L.displacementBias,T.wireframeLinewidth=L.wireframeLinewidth,T.linewidth=L.linewidth,P.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const re=n.properties.get(T);re.light=P}return T}function y(w,L,P,j,T){if(w.visible===!1)return;if(w.layers.test(L.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&T===Dn)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,w.matrixWorld);const oe=e.update(w),ce=w.material;if(Array.isArray(ce)){const I=oe.groups;for(let Y=0,$=I.length;Y<$;Y++){const V=I[Y],ie=ce[V.materialIndex];if(ie&&ie.visible){const ae=E(w,ie,j,T);n.renderBufferDirect(P,null,oe,ae,w,V)}}}else if(ce.visible){const I=E(w,ce,j,T);n.renderBufferDirect(P,null,oe,I,w,null)}}const re=w.children;for(let oe=0,ce=re.length;oe<ce;oe++)y(re[oe],L,P,j,T)}}function Q0(n,e,t){const i=t.isWebGL2;function r(){let D=!1;const Me=new xt;let de=null;const Q=new xt(0,0,0,0);return{setMask:function(me){de!==me&&!D&&(n.colorMask(me,me,me,me),de=me)},setLocked:function(me){D=me},setClear:function(me,Ne,$e,ut,Yt){Yt===!0&&(me*=ut,Ne*=ut,$e*=ut),Me.set(me,Ne,$e,ut),Q.equals(Me)===!1&&(n.clearColor(me,Ne,$e,ut),Q.copy(Me))},reset:function(){D=!1,de=null,Q.set(-1,0,0,0)}}}function s(){let D=!1,Me=null,de=null,Q=null;return{setTest:function(me){me?Ee(n.DEPTH_TEST):Re(n.DEPTH_TEST)},setMask:function(me){Me!==me&&!D&&(n.depthMask(me),Me=me)},setFunc:function(me){if(de!==me){switch(me){case om:n.depthFunc(n.NEVER);break;case am:n.depthFunc(n.ALWAYS);break;case lm:n.depthFunc(n.LESS);break;case Gs:n.depthFunc(n.LEQUAL);break;case cm:n.depthFunc(n.EQUAL);break;case um:n.depthFunc(n.GEQUAL);break;case fm:n.depthFunc(n.GREATER);break;case hm:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}de=me}},setLocked:function(me){D=me},setClear:function(me){Q!==me&&(n.clearDepth(me),Q=me)},reset:function(){D=!1,Me=null,de=null,Q=null}}}function a(){let D=!1,Me=null,de=null,Q=null,me=null,Ne=null,$e=null,ut=null,Yt=null;return{setTest:function(st){D||(st?Ee(n.STENCIL_TEST):Re(n.STENCIL_TEST))},setMask:function(st){Me!==st&&!D&&(n.stencilMask(st),Me=st)},setFunc:function(st,At,dn){(de!==st||Q!==At||me!==dn)&&(n.stencilFunc(st,At,dn),de=st,Q=At,me=dn)},setOp:function(st,At,dn){(Ne!==st||$e!==At||ut!==dn)&&(n.stencilOp(st,At,dn),Ne=st,$e=At,ut=dn)},setLocked:function(st){D=st},setClear:function(st){Yt!==st&&(n.clearStencil(st),Yt=st)},reset:function(){D=!1,Me=null,de=null,Q=null,me=null,Ne=null,$e=null,ut=null,Yt=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let d={},m={},x=new WeakMap,g=[],p=null,h=!1,b=null,E=null,y=null,w=null,L=null,P=null,j=null,T=new Qe(0,0,0),A=0,re=!1,oe=null,ce=null,I=null,Y=null,$=null;const V=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ie=!1,ae=0;const se=n.getParameter(n.VERSION);se.indexOf("WebGL")!==-1?(ae=parseFloat(/^WebGL (\d)/.exec(se)[1]),ie=ae>=1):se.indexOf("OpenGL ES")!==-1&&(ae=parseFloat(/^OpenGL ES (\d)/.exec(se)[1]),ie=ae>=2);let N=null,H={};const ve=n.getParameter(n.SCISSOR_BOX),Se=n.getParameter(n.VIEWPORT),Ae=new xt().fromArray(ve),ue=new xt().fromArray(Se);function pe(D,Me,de,Q){const me=new Uint8Array(4),Ne=n.createTexture();n.bindTexture(D,Ne),n.texParameteri(D,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(D,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let $e=0;$e<de;$e++)i&&(D===n.TEXTURE_3D||D===n.TEXTURE_2D_ARRAY)?n.texImage3D(Me,0,n.RGBA,1,1,Q,0,n.RGBA,n.UNSIGNED_BYTE,me):n.texImage2D(Me+$e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,me);return Ne}const he={};he[n.TEXTURE_2D]=pe(n.TEXTURE_2D,n.TEXTURE_2D,1),he[n.TEXTURE_CUBE_MAP]=pe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(he[n.TEXTURE_2D_ARRAY]=pe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),he[n.TEXTURE_3D]=pe(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Ee(n.DEPTH_TEST),l.setFunc(Gs),ee(!1),X(Bl),Ee(n.CULL_FACE),B(ii);function Ee(D){d[D]!==!0&&(n.enable(D),d[D]=!0)}function Re(D){d[D]!==!1&&(n.disable(D),d[D]=!1)}function be(D,Me){return m[D]!==Me?(n.bindFramebuffer(D,Me),m[D]=Me,i&&(D===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=Me),D===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=Me)),!0):!1}function _(D,Me){let de=g,Q=!1;if(D)if(de=x.get(Me),de===void 0&&(de=[],x.set(Me,de)),D.isWebGLMultipleRenderTargets){const me=D.texture;if(de.length!==me.length||de[0]!==n.COLOR_ATTACHMENT0){for(let Ne=0,$e=me.length;Ne<$e;Ne++)de[Ne]=n.COLOR_ATTACHMENT0+Ne;de.length=me.length,Q=!0}}else de[0]!==n.COLOR_ATTACHMENT0&&(de[0]=n.COLOR_ATTACHMENT0,Q=!0);else de[0]!==n.BACK&&(de[0]=n.BACK,Q=!0);Q&&(t.isWebGL2?n.drawBuffers(de):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(de))}function R(D){return p!==D?(n.useProgram(D),p=D,!0):!1}const C={[Si]:n.FUNC_ADD,[Xp]:n.FUNC_SUBTRACT,[qp]:n.FUNC_REVERSE_SUBTRACT};if(i)C[Vl]=n.MIN,C[kl]=n.MAX;else{const D=e.get("EXT_blend_minmax");D!==null&&(C[Vl]=D.MIN_EXT,C[kl]=D.MAX_EXT)}const O={[Yp]:n.ZERO,[jp]:n.ONE,[Kp]:n.SRC_COLOR,[da]:n.SRC_ALPHA,[tm]:n.SRC_ALPHA_SATURATE,[Qp]:n.DST_COLOR,[Zp]:n.DST_ALPHA,[$p]:n.ONE_MINUS_SRC_COLOR,[pa]:n.ONE_MINUS_SRC_ALPHA,[em]:n.ONE_MINUS_DST_COLOR,[Jp]:n.ONE_MINUS_DST_ALPHA,[nm]:n.CONSTANT_COLOR,[im]:n.ONE_MINUS_CONSTANT_COLOR,[rm]:n.CONSTANT_ALPHA,[sm]:n.ONE_MINUS_CONSTANT_ALPHA};function B(D,Me,de,Q,me,Ne,$e,ut,Yt,st){if(D===ii){h===!0&&(Re(n.BLEND),h=!1);return}if(h===!1&&(Ee(n.BLEND),h=!0),D!==Wp){if(D!==b||st!==re){if((E!==Si||L!==Si)&&(n.blendEquation(n.FUNC_ADD),E=Si,L=Si),st)switch(D){case rr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case zl:n.blendFunc(n.ONE,n.ONE);break;case Hl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Gl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case rr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case zl:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Hl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Gl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}y=null,w=null,P=null,j=null,T.set(0,0,0),A=0,b=D,re=st}return}me=me||Me,Ne=Ne||de,$e=$e||Q,(Me!==E||me!==L)&&(n.blendEquationSeparate(C[Me],C[me]),E=Me,L=me),(de!==y||Q!==w||Ne!==P||$e!==j)&&(n.blendFuncSeparate(O[de],O[Q],O[Ne],O[$e]),y=de,w=Q,P=Ne,j=$e),(ut.equals(T)===!1||Yt!==A)&&(n.blendColor(ut.r,ut.g,ut.b,Yt),T.copy(ut),A=Yt),b=D,re=!1}function q(D,Me){D.side===On?Re(n.CULL_FACE):Ee(n.CULL_FACE);let de=D.side===zt;Me&&(de=!de),ee(de),D.blending===rr&&D.transparent===!1?B(ii):B(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),l.setFunc(D.depthFunc),l.setTest(D.depthTest),l.setMask(D.depthWrite),o.setMask(D.colorWrite);const Q=D.stencilWrite;c.setTest(Q),Q&&(c.setMask(D.stencilWriteMask),c.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),c.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),K(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?Ee(n.SAMPLE_ALPHA_TO_COVERAGE):Re(n.SAMPLE_ALPHA_TO_COVERAGE)}function ee(D){oe!==D&&(D?n.frontFace(n.CW):n.frontFace(n.CCW),oe=D)}function X(D){D!==Gp?(Ee(n.CULL_FACE),D!==ce&&(D===Bl?n.cullFace(n.BACK):D===Vp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Re(n.CULL_FACE),ce=D}function te(D){D!==I&&(ie&&n.lineWidth(D),I=D)}function K(D,Me,de){D?(Ee(n.POLYGON_OFFSET_FILL),(Y!==Me||$!==de)&&(n.polygonOffset(Me,de),Y=Me,$=de)):Re(n.POLYGON_OFFSET_FILL)}function ye(D){D?Ee(n.SCISSOR_TEST):Re(n.SCISSOR_TEST)}function M(D){D===void 0&&(D=n.TEXTURE0+V-1),N!==D&&(n.activeTexture(D),N=D)}function v(D,Me,de){de===void 0&&(N===null?de=n.TEXTURE0+V-1:de=N);let Q=H[de];Q===void 0&&(Q={type:void 0,texture:void 0},H[de]=Q),(Q.type!==D||Q.texture!==Me)&&(N!==de&&(n.activeTexture(de),N=de),n.bindTexture(D,Me||he[D]),Q.type=D,Q.texture=Me)}function U(){const D=H[N];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Z(){try{n.compressedTexImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function J(){try{n.compressedTexImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ne(){try{n.texSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{n.texSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function le(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function _e(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ce(){try{n.texStorage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function qe(){try{n.texStorage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{n.texImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ze(){try{n.texImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Le(D){Ae.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),Ae.copy(D))}function Ie(D){ue.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),ue.copy(D))}function De(D,Me){let de=f.get(Me);de===void 0&&(de=new WeakMap,f.set(Me,de));let Q=de.get(D);Q===void 0&&(Q=n.getUniformBlockIndex(Me,D.name),de.set(D,Q))}function we(D,Me){const Q=f.get(Me).get(D);u.get(Me)!==Q&&(n.uniformBlockBinding(Me,Q,D.__bindingPointIndex),u.set(Me,Q))}function Ke(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},N=null,H={},m={},x=new WeakMap,g=[],p=null,h=!1,b=null,E=null,y=null,w=null,L=null,P=null,j=null,T=new Qe(0,0,0),A=0,re=!1,oe=null,ce=null,I=null,Y=null,$=null,Ae.set(0,0,n.canvas.width,n.canvas.height),ue.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Ee,disable:Re,bindFramebuffer:be,drawBuffers:_,useProgram:R,setBlending:B,setMaterial:q,setFlipSided:ee,setCullFace:X,setLineWidth:te,setPolygonOffset:K,setScissorTest:ye,activeTexture:M,bindTexture:v,unbindTexture:U,compressedTexImage2D:Z,compressedTexImage3D:J,texImage2D:fe,texImage3D:ze,updateUBOMapping:De,uniformBlockBinding:we,texStorage2D:Ce,texStorage3D:qe,texSubImage2D:ne,texSubImage3D:xe,compressedTexSubImage2D:le,compressedTexSubImage3D:_e,scissor:Le,viewport:Ie,reset:Ke}}function eM(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),x=new WeakMap;let g;const p=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(M,v){return h?new OffscreenCanvas(M,v):Ys("canvas")}function E(M,v,U,Z){let J=1;if((M.width>Z||M.height>Z)&&(J=Z/Math.max(M.width,M.height)),J<1||v===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const ne=v?qs:Math.floor,xe=ne(J*M.width),le=ne(J*M.height);g===void 0&&(g=b(xe,le));const _e=U?b(xe,le):g;return _e.width=xe,_e.height=le,_e.getContext("2d").drawImage(M,0,0,xe,le),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+xe+"x"+le+")."),_e}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function y(M){return Sa(M.width)&&Sa(M.height)}function w(M){return o?!1:M.wrapS!==an||M.wrapT!==an||M.minFilter!==Lt&&M.minFilter!==$t}function L(M,v){return M.generateMipmaps&&v&&M.minFilter!==Lt&&M.minFilter!==$t}function P(M){n.generateMipmap(M)}function j(M,v,U,Z,J=!1){if(o===!1)return v;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ne=v;if(v===n.RED&&(U===n.FLOAT&&(ne=n.R32F),U===n.HALF_FLOAT&&(ne=n.R16F),U===n.UNSIGNED_BYTE&&(ne=n.R8)),v===n.RED_INTEGER&&(U===n.UNSIGNED_BYTE&&(ne=n.R8UI),U===n.UNSIGNED_SHORT&&(ne=n.R16UI),U===n.UNSIGNED_INT&&(ne=n.R32UI),U===n.BYTE&&(ne=n.R8I),U===n.SHORT&&(ne=n.R16I),U===n.INT&&(ne=n.R32I)),v===n.RG&&(U===n.FLOAT&&(ne=n.RG32F),U===n.HALF_FLOAT&&(ne=n.RG16F),U===n.UNSIGNED_BYTE&&(ne=n.RG8)),v===n.RGBA){const xe=J?Vs:tt.getTransfer(Z);U===n.FLOAT&&(ne=n.RGBA32F),U===n.HALF_FLOAT&&(ne=n.RGBA16F),U===n.UNSIGNED_BYTE&&(ne=xe===at?n.SRGB8_ALPHA8:n.RGBA8),U===n.UNSIGNED_SHORT_4_4_4_4&&(ne=n.RGBA4),U===n.UNSIGNED_SHORT_5_5_5_1&&(ne=n.RGB5_A1)}return(ne===n.R16F||ne===n.R32F||ne===n.RG16F||ne===n.RG32F||ne===n.RGBA16F||ne===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function T(M,v,U){return L(M,U)===!0||M.isFramebufferTexture&&M.minFilter!==Lt&&M.minFilter!==$t?Math.log2(Math.max(v.width,v.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?v.mipmaps.length:1}function A(M){return M===Lt||M===Wl||M===Ao?n.NEAREST:n.LINEAR}function re(M){const v=M.target;v.removeEventListener("dispose",re),ce(v),v.isVideoTexture&&x.delete(v)}function oe(M){const v=M.target;v.removeEventListener("dispose",oe),Y(v)}function ce(M){const v=i.get(M);if(v.__webglInit===void 0)return;const U=M.source,Z=p.get(U);if(Z){const J=Z[v.__cacheKey];J.usedTimes--,J.usedTimes===0&&I(M),Object.keys(Z).length===0&&p.delete(U)}i.remove(M)}function I(M){const v=i.get(M);n.deleteTexture(v.__webglTexture);const U=M.source,Z=p.get(U);delete Z[v.__cacheKey],a.memory.textures--}function Y(M){const v=M.texture,U=i.get(M),Z=i.get(v);if(Z.__webglTexture!==void 0&&(n.deleteTexture(Z.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(U.__webglFramebuffer[J]))for(let ne=0;ne<U.__webglFramebuffer[J].length;ne++)n.deleteFramebuffer(U.__webglFramebuffer[J][ne]);else n.deleteFramebuffer(U.__webglFramebuffer[J]);U.__webglDepthbuffer&&n.deleteRenderbuffer(U.__webglDepthbuffer[J])}else{if(Array.isArray(U.__webglFramebuffer))for(let J=0;J<U.__webglFramebuffer.length;J++)n.deleteFramebuffer(U.__webglFramebuffer[J]);else n.deleteFramebuffer(U.__webglFramebuffer);if(U.__webglDepthbuffer&&n.deleteRenderbuffer(U.__webglDepthbuffer),U.__webglMultisampledFramebuffer&&n.deleteFramebuffer(U.__webglMultisampledFramebuffer),U.__webglColorRenderbuffer)for(let J=0;J<U.__webglColorRenderbuffer.length;J++)U.__webglColorRenderbuffer[J]&&n.deleteRenderbuffer(U.__webglColorRenderbuffer[J]);U.__webglDepthRenderbuffer&&n.deleteRenderbuffer(U.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let J=0,ne=v.length;J<ne;J++){const xe=i.get(v[J]);xe.__webglTexture&&(n.deleteTexture(xe.__webglTexture),a.memory.textures--),i.remove(v[J])}i.remove(v),i.remove(M)}let $=0;function V(){$=0}function ie(){const M=$;return M>=l&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+l),$+=1,M}function ae(M){const v=[];return v.push(M.wrapS),v.push(M.wrapT),v.push(M.wrapR||0),v.push(M.magFilter),v.push(M.minFilter),v.push(M.anisotropy),v.push(M.internalFormat),v.push(M.format),v.push(M.type),v.push(M.generateMipmaps),v.push(M.premultiplyAlpha),v.push(M.flipY),v.push(M.unpackAlignment),v.push(M.colorSpace),v.join()}function se(M,v){const U=i.get(M);if(M.isVideoTexture&&K(M),M.isRenderTargetTexture===!1&&M.version>0&&U.__version!==M.version){const Z=M.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(U,M,v);return}}t.bindTexture(n.TEXTURE_2D,U.__webglTexture,n.TEXTURE0+v)}function N(M,v){const U=i.get(M);if(M.version>0&&U.__version!==M.version){Ee(U,M,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,U.__webglTexture,n.TEXTURE0+v)}function H(M,v){const U=i.get(M);if(M.version>0&&U.__version!==M.version){Ee(U,M,v);return}t.bindTexture(n.TEXTURE_3D,U.__webglTexture,n.TEXTURE0+v)}function ve(M,v){const U=i.get(M);if(M.version>0&&U.__version!==M.version){Re(U,M,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,U.__webglTexture,n.TEXTURE0+v)}const Se={[ga]:n.REPEAT,[an]:n.CLAMP_TO_EDGE,[va]:n.MIRRORED_REPEAT},Ae={[Lt]:n.NEAREST,[Wl]:n.NEAREST_MIPMAP_NEAREST,[Ao]:n.NEAREST_MIPMAP_LINEAR,[$t]:n.LINEAR,[Mm]:n.LINEAR_MIPMAP_NEAREST,[Vr]:n.LINEAR_MIPMAP_LINEAR},ue={[Im]:n.NEVER,[Gm]:n.ALWAYS,[Nm]:n.LESS,[Om]:n.LEQUAL,[Fm]:n.EQUAL,[Hm]:n.GEQUAL,[Bm]:n.GREATER,[zm]:n.NOTEQUAL};function pe(M,v,U){if(U?(n.texParameteri(M,n.TEXTURE_WRAP_S,Se[v.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,Se[v.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,Se[v.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,Ae[v.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,Ae[v.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(v.wrapS!==an||v.wrapT!==an)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,A(v.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,A(v.minFilter)),v.minFilter!==Lt&&v.minFilter!==$t&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),v.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,ue[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Z=e.get("EXT_texture_filter_anisotropic");if(v.magFilter===Lt||v.minFilter!==Ao&&v.minFilter!==Vr||v.type===ti&&e.has("OES_texture_float_linear")===!1||o===!1&&v.type===kr&&e.has("OES_texture_half_float_linear")===!1)return;(v.anisotropy>1||i.get(v).__currentAnisotropy)&&(n.texParameterf(M,Z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy)}}function he(M,v){let U=!1;M.__webglInit===void 0&&(M.__webglInit=!0,v.addEventListener("dispose",re));const Z=v.source;let J=p.get(Z);J===void 0&&(J={},p.set(Z,J));const ne=ae(v);if(ne!==M.__cacheKey){J[ne]===void 0&&(J[ne]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,U=!0),J[ne].usedTimes++;const xe=J[M.__cacheKey];xe!==void 0&&(J[M.__cacheKey].usedTimes--,xe.usedTimes===0&&I(v)),M.__cacheKey=ne,M.__webglTexture=J[ne].texture}return U}function Ee(M,v,U){let Z=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=n.TEXTURE_3D);const J=he(M,v),ne=v.source;t.bindTexture(Z,M.__webglTexture,n.TEXTURE0+U);const xe=i.get(ne);if(ne.version!==xe.__version||J===!0){t.activeTexture(n.TEXTURE0+U);const le=tt.getPrimaries(tt.workingColorSpace),_e=v.colorSpace===Qt?null:tt.getPrimaries(v.colorSpace),Ce=v.colorSpace===Qt||le===_e?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);const qe=w(v)&&y(v.image)===!1;let fe=E(v.image,qe,!1,u);fe=ye(v,fe);const ze=y(fe)||o,Le=s.convert(v.format,v.colorSpace);let Ie=s.convert(v.type),De=j(v.internalFormat,Le,Ie,v.colorSpace,v.isVideoTexture);pe(Z,v,ze);let we;const Ke=v.mipmaps,D=o&&v.isVideoTexture!==!0,Me=xe.__version===void 0||J===!0,de=T(v,fe,ze);if(v.isDepthTexture)De=n.DEPTH_COMPONENT,o?v.type===ti?De=n.DEPTH_COMPONENT32F:v.type===ei?De=n.DEPTH_COMPONENT24:v.type===bi?De=n.DEPTH24_STENCIL8:De=n.DEPTH_COMPONENT16:v.type===ti&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),v.format===Ai&&De===n.DEPTH_COMPONENT&&v.type!==Xa&&v.type!==ei&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),v.type=ei,Ie=s.convert(v.type)),v.format===ur&&De===n.DEPTH_COMPONENT&&(De=n.DEPTH_STENCIL,v.type!==bi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),v.type=bi,Ie=s.convert(v.type))),Me&&(D?t.texStorage2D(n.TEXTURE_2D,1,De,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,De,fe.width,fe.height,0,Le,Ie,null));else if(v.isDataTexture)if(Ke.length>0&&ze){D&&Me&&t.texStorage2D(n.TEXTURE_2D,de,De,Ke[0].width,Ke[0].height);for(let Q=0,me=Ke.length;Q<me;Q++)we=Ke[Q],D?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,we.width,we.height,Le,Ie,we.data):t.texImage2D(n.TEXTURE_2D,Q,De,we.width,we.height,0,Le,Ie,we.data);v.generateMipmaps=!1}else D?(Me&&t.texStorage2D(n.TEXTURE_2D,de,De,fe.width,fe.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,fe.width,fe.height,Le,Ie,fe.data)):t.texImage2D(n.TEXTURE_2D,0,De,fe.width,fe.height,0,Le,Ie,fe.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){D&&Me&&t.texStorage3D(n.TEXTURE_2D_ARRAY,de,De,Ke[0].width,Ke[0].height,fe.depth);for(let Q=0,me=Ke.length;Q<me;Q++)we=Ke[Q],v.format!==ln?Le!==null?D?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,we.width,we.height,fe.depth,Le,we.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Q,De,we.width,we.height,fe.depth,0,we.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?t.texSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,we.width,we.height,fe.depth,Le,Ie,we.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Q,De,we.width,we.height,fe.depth,0,Le,Ie,we.data)}else{D&&Me&&t.texStorage2D(n.TEXTURE_2D,de,De,Ke[0].width,Ke[0].height);for(let Q=0,me=Ke.length;Q<me;Q++)we=Ke[Q],v.format!==ln?Le!==null?D?t.compressedTexSubImage2D(n.TEXTURE_2D,Q,0,0,we.width,we.height,Le,we.data):t.compressedTexImage2D(n.TEXTURE_2D,Q,De,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,we.width,we.height,Le,Ie,we.data):t.texImage2D(n.TEXTURE_2D,Q,De,we.width,we.height,0,Le,Ie,we.data)}else if(v.isDataArrayTexture)D?(Me&&t.texStorage3D(n.TEXTURE_2D_ARRAY,de,De,fe.width,fe.height,fe.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,Le,Ie,fe.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,De,fe.width,fe.height,fe.depth,0,Le,Ie,fe.data);else if(v.isData3DTexture)D?(Me&&t.texStorage3D(n.TEXTURE_3D,de,De,fe.width,fe.height,fe.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,Le,Ie,fe.data)):t.texImage3D(n.TEXTURE_3D,0,De,fe.width,fe.height,fe.depth,0,Le,Ie,fe.data);else if(v.isFramebufferTexture){if(Me)if(D)t.texStorage2D(n.TEXTURE_2D,de,De,fe.width,fe.height);else{let Q=fe.width,me=fe.height;for(let Ne=0;Ne<de;Ne++)t.texImage2D(n.TEXTURE_2D,Ne,De,Q,me,0,Le,Ie,null),Q>>=1,me>>=1}}else if(Ke.length>0&&ze){D&&Me&&t.texStorage2D(n.TEXTURE_2D,de,De,Ke[0].width,Ke[0].height);for(let Q=0,me=Ke.length;Q<me;Q++)we=Ke[Q],D?t.texSubImage2D(n.TEXTURE_2D,Q,0,0,Le,Ie,we):t.texImage2D(n.TEXTURE_2D,Q,De,Le,Ie,we);v.generateMipmaps=!1}else D?(Me&&t.texStorage2D(n.TEXTURE_2D,de,De,fe.width,fe.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Le,Ie,fe)):t.texImage2D(n.TEXTURE_2D,0,De,Le,Ie,fe);L(v,ze)&&P(Z),xe.__version=ne.version,v.onUpdate&&v.onUpdate(v)}M.__version=v.version}function Re(M,v,U){if(v.image.length!==6)return;const Z=he(M,v),J=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+U);const ne=i.get(J);if(J.version!==ne.__version||Z===!0){t.activeTexture(n.TEXTURE0+U);const xe=tt.getPrimaries(tt.workingColorSpace),le=v.colorSpace===Qt?null:tt.getPrimaries(v.colorSpace),_e=v.colorSpace===Qt||xe===le?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);const Ce=v.isCompressedTexture||v.image[0].isCompressedTexture,qe=v.image[0]&&v.image[0].isDataTexture,fe=[];for(let Q=0;Q<6;Q++)!Ce&&!qe?fe[Q]=E(v.image[Q],!1,!0,c):fe[Q]=qe?v.image[Q].image:v.image[Q],fe[Q]=ye(v,fe[Q]);const ze=fe[0],Le=y(ze)||o,Ie=s.convert(v.format,v.colorSpace),De=s.convert(v.type),we=j(v.internalFormat,Ie,De,v.colorSpace),Ke=o&&v.isVideoTexture!==!0,D=ne.__version===void 0||Z===!0;let Me=T(v,ze,Le);pe(n.TEXTURE_CUBE_MAP,v,Le);let de;if(Ce){Ke&&D&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,we,ze.width,ze.height);for(let Q=0;Q<6;Q++){de=fe[Q].mipmaps;for(let me=0;me<de.length;me++){const Ne=de[me];v.format!==ln?Ie!==null?Ke?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me,0,0,Ne.width,Ne.height,Ie,Ne.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me,we,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me,0,0,Ne.width,Ne.height,Ie,De,Ne.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me,we,Ne.width,Ne.height,0,Ie,De,Ne.data)}}}else{de=v.mipmaps,Ke&&D&&(de.length>0&&Me++,t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,we,fe[0].width,fe[0].height));for(let Q=0;Q<6;Q++)if(qe){Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,fe[Q].width,fe[Q].height,Ie,De,fe[Q].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,we,fe[Q].width,fe[Q].height,0,Ie,De,fe[Q].data);for(let me=0;me<de.length;me++){const $e=de[me].image[Q].image;Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me+1,0,0,$e.width,$e.height,Ie,De,$e.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me+1,we,$e.width,$e.height,0,Ie,De,$e.data)}}else{Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ie,De,fe[Q]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,we,Ie,De,fe[Q]);for(let me=0;me<de.length;me++){const Ne=de[me];Ke?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me+1,0,0,Ie,De,Ne.image[Q]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,me+1,we,Ie,De,Ne.image[Q])}}}L(v,Le)&&P(n.TEXTURE_CUBE_MAP),ne.__version=J.version,v.onUpdate&&v.onUpdate(v)}M.__version=v.version}function be(M,v,U,Z,J,ne){const xe=s.convert(U.format,U.colorSpace),le=s.convert(U.type),_e=j(U.internalFormat,xe,le,U.colorSpace);if(!i.get(v).__hasExternalTextures){const qe=Math.max(1,v.width>>ne),fe=Math.max(1,v.height>>ne);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,ne,_e,qe,fe,v.depth,0,xe,le,null):t.texImage2D(J,ne,_e,qe,fe,0,xe,le,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),te(v)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,J,i.get(U).__webglTexture,0,X(v)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,J,i.get(U).__webglTexture,ne),t.bindFramebuffer(n.FRAMEBUFFER,null)}function _(M,v,U){if(n.bindRenderbuffer(n.RENDERBUFFER,M),v.depthBuffer&&!v.stencilBuffer){let Z=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(U||te(v)){const J=v.depthTexture;J&&J.isDepthTexture&&(J.type===ti?Z=n.DEPTH_COMPONENT32F:J.type===ei&&(Z=n.DEPTH_COMPONENT24));const ne=X(v);te(v)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ne,Z,v.width,v.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,ne,Z,v.width,v.height)}else n.renderbufferStorage(n.RENDERBUFFER,Z,v.width,v.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(v.depthBuffer&&v.stencilBuffer){const Z=X(v);U&&te(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,v.width,v.height):te(v)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const Z=v.isWebGLMultipleRenderTargets===!0?v.texture:[v.texture];for(let J=0;J<Z.length;J++){const ne=Z[J],xe=s.convert(ne.format,ne.colorSpace),le=s.convert(ne.type),_e=j(ne.internalFormat,xe,le,ne.colorSpace),Ce=X(v);U&&te(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ce,_e,v.width,v.height):te(v)?d.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ce,_e,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,_e,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function R(M,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),se(v.depthTexture,0);const Z=i.get(v.depthTexture).__webglTexture,J=X(v);if(v.depthTexture.format===Ai)te(v)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0,J):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0);else if(v.depthTexture.format===ur)te(v)?d.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0,J):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function C(M){const v=i.get(M),U=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!v.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");R(v.__webglFramebuffer,M)}else if(U){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]=n.createRenderbuffer(),_(v.__webglDepthbuffer[Z],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer=n.createRenderbuffer(),_(v.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function O(M,v,U){const Z=i.get(M);v!==void 0&&be(Z.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),U!==void 0&&C(M)}function B(M){const v=M.texture,U=i.get(M),Z=i.get(v);M.addEventListener("dispose",oe),M.isWebGLMultipleRenderTargets!==!0&&(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=v.version,a.memory.textures++);const J=M.isWebGLCubeRenderTarget===!0,ne=M.isWebGLMultipleRenderTargets===!0,xe=y(M)||o;if(J){U.__webglFramebuffer=[];for(let le=0;le<6;le++)if(o&&v.mipmaps&&v.mipmaps.length>0){U.__webglFramebuffer[le]=[];for(let _e=0;_e<v.mipmaps.length;_e++)U.__webglFramebuffer[le][_e]=n.createFramebuffer()}else U.__webglFramebuffer[le]=n.createFramebuffer()}else{if(o&&v.mipmaps&&v.mipmaps.length>0){U.__webglFramebuffer=[];for(let le=0;le<v.mipmaps.length;le++)U.__webglFramebuffer[le]=n.createFramebuffer()}else U.__webglFramebuffer=n.createFramebuffer();if(ne)if(r.drawBuffers){const le=M.texture;for(let _e=0,Ce=le.length;_e<Ce;_e++){const qe=i.get(le[_e]);qe.__webglTexture===void 0&&(qe.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&te(M)===!1){const le=ne?v:[v];U.__webglMultisampledFramebuffer=n.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let _e=0;_e<le.length;_e++){const Ce=le[_e];U.__webglColorRenderbuffer[_e]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,U.__webglColorRenderbuffer[_e]);const qe=s.convert(Ce.format,Ce.colorSpace),fe=s.convert(Ce.type),ze=j(Ce.internalFormat,qe,fe,Ce.colorSpace,M.isXRRenderTarget===!0),Le=X(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Le,ze,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+_e,n.RENDERBUFFER,U.__webglColorRenderbuffer[_e])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(U.__webglDepthRenderbuffer=n.createRenderbuffer(),_(U.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(J){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),pe(n.TEXTURE_CUBE_MAP,v,xe);for(let le=0;le<6;le++)if(o&&v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)be(U.__webglFramebuffer[le][_e],M,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,_e);else be(U.__webglFramebuffer[le],M,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);L(v,xe)&&P(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ne){const le=M.texture;for(let _e=0,Ce=le.length;_e<Ce;_e++){const qe=le[_e],fe=i.get(qe);t.bindTexture(n.TEXTURE_2D,fe.__webglTexture),pe(n.TEXTURE_2D,qe,xe),be(U.__webglFramebuffer,M,qe,n.COLOR_ATTACHMENT0+_e,n.TEXTURE_2D,0),L(qe,xe)&&P(n.TEXTURE_2D)}t.unbindTexture()}else{let le=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?le=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(le,Z.__webglTexture),pe(le,v,xe),o&&v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)be(U.__webglFramebuffer[_e],M,v,n.COLOR_ATTACHMENT0,le,_e);else be(U.__webglFramebuffer,M,v,n.COLOR_ATTACHMENT0,le,0);L(v,xe)&&P(le),t.unbindTexture()}M.depthBuffer&&C(M)}function q(M){const v=y(M)||o,U=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let Z=0,J=U.length;Z<J;Z++){const ne=U[Z];if(L(ne,v)){const xe=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,le=i.get(ne).__webglTexture;t.bindTexture(xe,le),P(xe),t.unbindTexture()}}}function ee(M){if(o&&M.samples>0&&te(M)===!1){const v=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],U=M.width,Z=M.height;let J=n.COLOR_BUFFER_BIT;const ne=[],xe=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=i.get(M),_e=M.isWebGLMultipleRenderTargets===!0;if(_e)for(let Ce=0;Ce<v.length;Ce++)t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ce,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ce,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let Ce=0;Ce<v.length;Ce++){ne.push(n.COLOR_ATTACHMENT0+Ce),M.depthBuffer&&ne.push(xe);const qe=le.__ignoreDepthValues!==void 0?le.__ignoreDepthValues:!1;if(qe===!1&&(M.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),_e&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,le.__webglColorRenderbuffer[Ce]),qe===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[xe]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[xe])),_e){const fe=i.get(v[Ce]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,fe,0)}n.blitFramebuffer(0,0,U,Z,0,0,U,Z,J,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ne)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),_e)for(let Ce=0;Ce<v.length;Ce++){t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ce,n.RENDERBUFFER,le.__webglColorRenderbuffer[Ce]);const qe=i.get(v[Ce]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ce,n.TEXTURE_2D,qe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}}function X(M){return Math.min(f,M.samples)}function te(M){const v=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function K(M){const v=a.render.frame;x.get(M)!==v&&(x.set(M,v),M.update())}function ye(M,v){const U=M.colorSpace,Z=M.format,J=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===Ma||U!==Wn&&U!==Qt&&(tt.getTransfer(U)===at?o===!1?e.has("EXT_sRGB")===!0&&Z===ln?(M.format=Ma,M.minFilter=$t,M.generateMipmaps=!1):v=Cf.sRGBToLinear(v):(Z!==ln||J!==si)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),v}this.allocateTextureUnit=ie,this.resetTextureUnits=V,this.setTexture2D=se,this.setTexture2DArray=N,this.setTexture3D=H,this.setTextureCube=ve,this.rebindTextures=O,this.setupRenderTarget=B,this.updateRenderTargetMipmap=q,this.updateMultisampleRenderTarget=ee,this.setupDepthRenderbuffer=C,this.setupFrameBufferTexture=be,this.useMultisampledRTT=te}function tM(n,e,t){const i=t.isWebGL2;function r(s,a=Qt){let o;const l=tt.getTransfer(a);if(s===si)return n.UNSIGNED_BYTE;if(s===Ef)return n.UNSIGNED_SHORT_4_4_4_4;if(s===yf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Sm)return n.BYTE;if(s===Em)return n.SHORT;if(s===Xa)return n.UNSIGNED_SHORT;if(s===Sf)return n.INT;if(s===ei)return n.UNSIGNED_INT;if(s===ti)return n.FLOAT;if(s===kr)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===ym)return n.ALPHA;if(s===ln)return n.RGBA;if(s===Tm)return n.LUMINANCE;if(s===bm)return n.LUMINANCE_ALPHA;if(s===Ai)return n.DEPTH_COMPONENT;if(s===ur)return n.DEPTH_STENCIL;if(s===Ma)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===Am)return n.RED;if(s===Tf)return n.RED_INTEGER;if(s===wm)return n.RG;if(s===bf)return n.RG_INTEGER;if(s===Af)return n.RGBA_INTEGER;if(s===wo||s===Ro||s===Co||s===Po)if(l===at)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===wo)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Ro)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Co)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Po)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===wo)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Ro)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Co)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Po)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Xl||s===ql||s===Yl||s===jl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===Xl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===ql)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Yl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===jl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Rm)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Kl||s===$l)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===Kl)return l===at?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===$l)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Zl||s===Jl||s===Ql||s===ec||s===tc||s===nc||s===ic||s===rc||s===sc||s===oc||s===ac||s===lc||s===cc||s===uc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Zl)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Jl)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Ql)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===ec)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===tc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===nc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===ic)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===rc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===sc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===oc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===ac)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===lc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===cc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===uc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Lo||s===fc||s===hc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===Lo)return l===at?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===fc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===hc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Cm||s===dc||s===pc||s===mc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===Lo)return o.COMPRESSED_RED_RGTC1_EXT;if(s===dc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===pc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===mc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===bi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class nM extends Jt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ts extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const iM={type:"move"};class ea{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ts,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ts,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ts,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const g of e.hand.values()){const p=t.getJointPose(g,i),h=this._getHandJoint(c,g);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&d>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(iM)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Ts;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class rM extends Ht{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:Ai,u!==Ai&&u!==ur)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Ai&&(i=ei),i===void 0&&u===ur&&(i=bi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Lt,this.minFilter=l!==void 0?l:Lt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class sM extends hr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,d=null,m=null,x=null;const g=t.getContextAttributes();let p=null,h=null;const b=[],E=[],y=new Jt;y.layers.enable(1),y.viewport=new xt;const w=new Jt;w.layers.enable(2),w.viewport=new xt;const L=[y,w],P=new nM;P.layers.enable(1),P.layers.enable(2);let j=null,T=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let H=b[N];return H===void 0&&(H=new ea,b[N]=H),H.getTargetRaySpace()},this.getControllerGrip=function(N){let H=b[N];return H===void 0&&(H=new ea,b[N]=H),H.getGripSpace()},this.getHand=function(N){let H=b[N];return H===void 0&&(H=new ea,b[N]=H),H.getHandSpace()};function A(N){const H=E.indexOf(N.inputSource);if(H===-1)return;const ve=b[H];ve!==void 0&&(ve.update(N.inputSource,N.frame,c||a),ve.dispatchEvent({type:N.type,data:N.inputSource}))}function re(){r.removeEventListener("select",A),r.removeEventListener("selectstart",A),r.removeEventListener("selectend",A),r.removeEventListener("squeeze",A),r.removeEventListener("squeezestart",A),r.removeEventListener("squeezeend",A),r.removeEventListener("end",re),r.removeEventListener("inputsourceschange",oe);for(let N=0;N<b.length;N++){const H=E[N];H!==null&&(E[N]=null,b[N].disconnect(H))}j=null,T=null,e.setRenderTarget(p),m=null,d=null,f=null,r=null,h=null,se.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){s=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){o=N,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(N){c=N},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(N){if(r=N,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",A),r.addEventListener("selectstart",A),r.addEventListener("selectend",A),r.addEventListener("squeeze",A),r.addEventListener("squeezestart",A),r.addEventListener("squeezeend",A),r.addEventListener("end",re),r.addEventListener("inputsourceschange",oe),g.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const H={antialias:r.renderState.layers===void 0?g.antialias:!0,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,H),r.updateRenderState({baseLayer:m}),h=new Ri(m.framebufferWidth,m.framebufferHeight,{format:ln,type:si,colorSpace:e.outputColorSpace,stencilBuffer:g.stencil})}else{let H=null,ve=null,Se=null;g.depth&&(Se=g.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,H=g.stencil?ur:Ai,ve=g.stencil?bi:ei);const Ae={colorFormat:t.RGBA8,depthFormat:Se,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(Ae),r.updateRenderState({layers:[d]}),h=new Ri(d.textureWidth,d.textureHeight,{format:ln,type:si,depthTexture:new rM(d.textureWidth,d.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,H),stencilBuffer:g.stencil,colorSpace:e.outputColorSpace,samples:g.antialias?4:0});const ue=e.properties.get(h);ue.__ignoreDepthValues=d.ignoreDepthValues}h.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function oe(N){for(let H=0;H<N.removed.length;H++){const ve=N.removed[H],Se=E.indexOf(ve);Se>=0&&(E[Se]=null,b[Se].disconnect(ve))}for(let H=0;H<N.added.length;H++){const ve=N.added[H];let Se=E.indexOf(ve);if(Se===-1){for(let ue=0;ue<b.length;ue++)if(ue>=E.length){E.push(ve),Se=ue;break}else if(E[ue]===null){E[ue]=ve,Se=ue;break}if(Se===-1)break}const Ae=b[Se];Ae&&Ae.connect(ve)}}const ce=new z,I=new z;function Y(N,H,ve){ce.setFromMatrixPosition(H.matrixWorld),I.setFromMatrixPosition(ve.matrixWorld);const Se=ce.distanceTo(I),Ae=H.projectionMatrix.elements,ue=ve.projectionMatrix.elements,pe=Ae[14]/(Ae[10]-1),he=Ae[14]/(Ae[10]+1),Ee=(Ae[9]+1)/Ae[5],Re=(Ae[9]-1)/Ae[5],be=(Ae[8]-1)/Ae[0],_=(ue[8]+1)/ue[0],R=pe*be,C=pe*_,O=Se/(-be+_),B=O*-be;H.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(B),N.translateZ(O),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert();const q=pe+O,ee=he+O,X=R-B,te=C+(Se-B),K=Ee*he/ee*q,ye=Re*he/ee*q;N.projectionMatrix.makePerspective(X,te,K,ye,q,ee),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}function $(N,H){H===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(H.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(r===null)return;P.near=w.near=y.near=N.near,P.far=w.far=y.far=N.far,(j!==P.near||T!==P.far)&&(r.updateRenderState({depthNear:P.near,depthFar:P.far}),j=P.near,T=P.far);const H=N.parent,ve=P.cameras;$(P,H);for(let Se=0;Se<ve.length;Se++)$(ve[Se],H);ve.length===2?Y(P,y,w):P.projectionMatrix.copy(y.projectionMatrix),V(N,P,H)};function V(N,H,ve){ve===null?N.matrix.copy(H.matrixWorld):(N.matrix.copy(ve.matrixWorld),N.matrix.invert(),N.matrix.multiply(H.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(H.projectionMatrix),N.projectionMatrixInverse.copy(H.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=Wr*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(N){l=N,d!==null&&(d.fixedFoveation=N),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=N)};let ie=null;function ae(N,H){if(u=H.getViewerPose(c||a),x=H,u!==null){const ve=u.views;m!==null&&(e.setRenderTargetFramebuffer(h,m.framebuffer),e.setRenderTarget(h));let Se=!1;ve.length!==P.cameras.length&&(P.cameras.length=0,Se=!0);for(let Ae=0;Ae<ve.length;Ae++){const ue=ve[Ae];let pe=null;if(m!==null)pe=m.getViewport(ue);else{const Ee=f.getViewSubImage(d,ue);pe=Ee.viewport,Ae===0&&(e.setRenderTargetTextures(h,Ee.colorTexture,d.ignoreDepthValues?void 0:Ee.depthStencilTexture),e.setRenderTarget(h))}let he=L[Ae];he===void 0&&(he=new Jt,he.layers.enable(Ae),he.viewport=new xt,L[Ae]=he),he.matrix.fromArray(ue.transform.matrix),he.matrix.decompose(he.position,he.quaternion,he.scale),he.projectionMatrix.fromArray(ue.projectionMatrix),he.projectionMatrixInverse.copy(he.projectionMatrix).invert(),he.viewport.set(pe.x,pe.y,pe.width,pe.height),Ae===0&&(P.matrix.copy(he.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Se===!0&&P.cameras.push(he)}}for(let ve=0;ve<b.length;ve++){const Se=E[ve],Ae=b[ve];Se!==null&&Ae!==void 0&&Ae.update(Se,H,c||a)}ie&&ie(N,H),H.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:H}),x=null}const se=new Hf;se.setAnimationLoop(ae),this.setAnimationLoop=function(N){ie=N},this.dispose=function(){}}}function oM(n,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function i(p,h){h.color.getRGB(p.fogColor.value,Ff(n)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,b,E,y){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),f(p,h)):h.isMeshPhongMaterial?(s(p,h),u(p,h)):h.isMeshStandardMaterial?(s(p,h),d(p,h),h.isMeshPhysicalMaterial&&m(p,h,y)):h.isMeshMatcapMaterial?(s(p,h),x(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),g(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,b,E):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===zt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===zt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=e.get(h).envMap;if(b&&(p.envMap.value=b,p.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap){p.lightMap.value=h.lightMap;const E=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=h.lightMapIntensity*E,t(h.lightMap,p.lightMapTransform)}h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,b,E){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=E*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function f(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function d(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),e.get(h).envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===zt&&p.clearcoatNormalScale.value.negate())),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,h){h.matcap&&(p.matcap.value=h.matcap)}function g(p,h){const b=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function aM(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(b,E){const y=E.program;i.uniformBlockBinding(b,y)}function c(b,E){let y=r[b.id];y===void 0&&(x(b),y=u(b),r[b.id]=y,b.addEventListener("dispose",p));const w=E.program;i.updateUBOMapping(b,w);const L=e.render.frame;s[b.id]!==L&&(d(b),s[b.id]=L)}function u(b){const E=f();b.__bindingPointIndex=E;const y=n.createBuffer(),w=b.__size,L=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,w,L),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,E,y),y}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const E=r[b.id],y=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,E);for(let L=0,P=y.length;L<P;L++){const j=y[L];if(m(j,L,w)===!0){const T=j.__offset,A=Array.isArray(j.value)?j.value:[j.value];let re=0;for(let oe=0;oe<A.length;oe++){const ce=A[oe],I=g(ce);typeof ce=="number"?(j.__data[0]=ce,n.bufferSubData(n.UNIFORM_BUFFER,T+re,j.__data)):ce.isMatrix3?(j.__data[0]=ce.elements[0],j.__data[1]=ce.elements[1],j.__data[2]=ce.elements[2],j.__data[3]=ce.elements[0],j.__data[4]=ce.elements[3],j.__data[5]=ce.elements[4],j.__data[6]=ce.elements[5],j.__data[7]=ce.elements[0],j.__data[8]=ce.elements[6],j.__data[9]=ce.elements[7],j.__data[10]=ce.elements[8],j.__data[11]=ce.elements[0]):(ce.toArray(j.__data,re),re+=I.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,T,j.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(b,E,y){const w=b.value;if(y[E]===void 0){if(typeof w=="number")y[E]=w;else{const L=Array.isArray(w)?w:[w],P=[];for(let j=0;j<L.length;j++)P.push(L[j].clone());y[E]=P}return!0}else if(typeof w=="number"){if(y[E]!==w)return y[E]=w,!0}else{const L=Array.isArray(y[E])?y[E]:[y[E]],P=Array.isArray(w)?w:[w];for(let j=0;j<L.length;j++){const T=L[j];if(T.equals(P[j])===!1)return T.copy(P[j]),!0}}return!1}function x(b){const E=b.uniforms;let y=0;const w=16;let L=0;for(let P=0,j=E.length;P<j;P++){const T=E[P],A={boundary:0,storage:0},re=Array.isArray(T.value)?T.value:[T.value];for(let oe=0,ce=re.length;oe<ce;oe++){const I=re[oe],Y=g(I);A.boundary+=Y.boundary,A.storage+=Y.storage}if(T.__data=new Float32Array(A.storage/Float32Array.BYTES_PER_ELEMENT),T.__offset=y,P>0){L=y%w;const oe=w-L;L!==0&&oe-A.boundary<0&&(y+=w-L,T.__offset=y)}y+=A.storage}return L=y%w,L>0&&(y+=w-L),b.__size=y,b.__cache={},this}function g(b){const E={boundary:0,storage:0};return typeof b=="number"?(E.boundary=4,E.storage=4):b.isVector2?(E.boundary=8,E.storage=8):b.isVector3||b.isColor?(E.boundary=16,E.storage=12):b.isVector4?(E.boundary=16,E.storage=16):b.isMatrix3?(E.boundary=48,E.storage=48):b.isMatrix4?(E.boundary=64,E.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),E}function p(b){const E=b.target;E.removeEventListener("dispose",p);const y=a.indexOf(E.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function h(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:h}}class Xf{constructor(e={}){const{canvas:t=i_(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=a;const m=new Uint32Array(4),x=new Int32Array(4);let g=null,p=null;const h=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=vt,this._useLegacyLights=!1,this.toneMapping=ri,this.toneMappingExposure=1;const E=this;let y=!1,w=0,L=0,P=null,j=-1,T=null;const A=new xt,re=new xt;let oe=null;const ce=new Qe(0);let I=0,Y=t.width,$=t.height,V=1,ie=null,ae=null;const se=new xt(0,0,Y,$),N=new xt(0,0,Y,$);let H=!1;const ve=new zf;let Se=!1,Ae=!1,ue=null;const pe=new it,he=new je,Ee=new z,Re={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function be(){return P===null?V:1}let _=i;function R(S,F){for(let G=0;G<S.length;G++){const k=S[G],W=t.getContext(k,F);if(W!==null)return W}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Wa}`),t.addEventListener("webglcontextlost",Ke,!1),t.addEventListener("webglcontextrestored",D,!1),t.addEventListener("webglcontextcreationerror",Me,!1),_===null){const F=["webgl2","webgl","experimental-webgl"];if(E.isWebGL1Renderer===!0&&F.shift(),_=R(F,S),_===null)throw R(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&_ instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),_.getShaderPrecisionFormat===void 0&&(_.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let C,O,B,q,ee,X,te,K,ye,M,v,U,Z,J,ne,xe,le,_e,Ce,qe,fe,ze,Le,Ie;function De(){C=new gx(_),O=new ux(_,C,e),C.init(O),ze=new tM(_,C,O),B=new Q0(_,C,O),q=new Mx(_),ee=new z0,X=new eM(_,C,B,ee,O,ze,q),te=new hx(E),K=new _x(E),ye=new C_(_,O),Le=new lx(_,C,ye,O),M=new vx(_,ye,q,Le),v=new Tx(_,M,ye,q),Ce=new yx(_,O,X),xe=new fx(ee),U=new B0(E,te,K,C,O,Le,xe),Z=new oM(E,ee),J=new G0,ne=new Y0(C,O),_e=new ax(E,te,K,B,v,d,l),le=new J0(E,v,O),Ie=new aM(_,q,O,B),qe=new cx(_,C,q,O),fe=new xx(_,C,q,O),q.programs=U.programs,E.capabilities=O,E.extensions=C,E.properties=ee,E.renderLists=J,E.shadowMap=le,E.state=B,E.info=q}De();const we=new sM(E,_);this.xr=we,this.getContext=function(){return _},this.getContextAttributes=function(){return _.getContextAttributes()},this.forceContextLoss=function(){const S=C.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=C.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(S){S!==void 0&&(V=S,this.setSize(Y,$,!1))},this.getSize=function(S){return S.set(Y,$)},this.setSize=function(S,F,G=!0){if(we.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=S,$=F,t.width=Math.floor(S*V),t.height=Math.floor(F*V),G===!0&&(t.style.width=S+"px",t.style.height=F+"px"),this.setViewport(0,0,S,F)},this.getDrawingBufferSize=function(S){return S.set(Y*V,$*V).floor()},this.setDrawingBufferSize=function(S,F,G){Y=S,$=F,V=G,t.width=Math.floor(S*G),t.height=Math.floor(F*G),this.setViewport(0,0,S,F)},this.getCurrentViewport=function(S){return S.copy(A)},this.getViewport=function(S){return S.copy(se)},this.setViewport=function(S,F,G,k){S.isVector4?se.set(S.x,S.y,S.z,S.w):se.set(S,F,G,k),B.viewport(A.copy(se).multiplyScalar(V).floor())},this.getScissor=function(S){return S.copy(N)},this.setScissor=function(S,F,G,k){S.isVector4?N.set(S.x,S.y,S.z,S.w):N.set(S,F,G,k),B.scissor(re.copy(N).multiplyScalar(V).floor())},this.getScissorTest=function(){return H},this.setScissorTest=function(S){B.setScissorTest(H=S)},this.setOpaqueSort=function(S){ie=S},this.setTransparentSort=function(S){ae=S},this.getClearColor=function(S){return S.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor.apply(_e,arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha.apply(_e,arguments)},this.clear=function(S=!0,F=!0,G=!0){let k=0;if(S){let W=!1;if(P!==null){const Te=P.texture.format;W=Te===Af||Te===bf||Te===Tf}if(W){const Te=P.texture.type,Pe=Te===si||Te===ei||Te===Xa||Te===bi||Te===Ef||Te===yf,Fe=_e.getClearColor(),Oe=_e.getClearAlpha(),We=Fe.r,He=Fe.g,Ve=Fe.b;Pe?(m[0]=We,m[1]=He,m[2]=Ve,m[3]=Oe,_.clearBufferuiv(_.COLOR,0,m)):(x[0]=We,x[1]=He,x[2]=Ve,x[3]=Oe,_.clearBufferiv(_.COLOR,0,x))}else k|=_.COLOR_BUFFER_BIT}F&&(k|=_.DEPTH_BUFFER_BIT),G&&(k|=_.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),_.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ke,!1),t.removeEventListener("webglcontextrestored",D,!1),t.removeEventListener("webglcontextcreationerror",Me,!1),J.dispose(),ne.dispose(),ee.dispose(),te.dispose(),K.dispose(),v.dispose(),Le.dispose(),Ie.dispose(),U.dispose(),we.dispose(),we.removeEventListener("sessionstart",Yt),we.removeEventListener("sessionend",st),ue&&(ue.dispose(),ue=null),At.stop()};function Ke(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),y=!0}function D(){console.log("THREE.WebGLRenderer: Context Restored."),y=!1;const S=q.autoReset,F=le.enabled,G=le.autoUpdate,k=le.needsUpdate,W=le.type;De(),q.autoReset=S,le.enabled=F,le.autoUpdate=G,le.needsUpdate=k,le.type=W}function Me(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function de(S){const F=S.target;F.removeEventListener("dispose",de),Q(F)}function Q(S){me(S),ee.remove(S)}function me(S){const F=ee.get(S).programs;F!==void 0&&(F.forEach(function(G){U.releaseProgram(G)}),S.isShaderMaterial&&U.releaseShaderCache(S))}this.renderBufferDirect=function(S,F,G,k,W,Te){F===null&&(F=Re);const Pe=W.isMesh&&W.matrixWorld.determinant()<0,Fe=Kf(S,F,G,k,W);B.setMaterial(k,Pe);let Oe=G.index,We=1;if(k.wireframe===!0){if(Oe=M.getWireframeAttribute(G),Oe===void 0)return;We=2}const He=G.drawRange,Ve=G.attributes.position;let ct=He.start*We,Vt=(He.start+He.count)*We;Te!==null&&(ct=Math.max(ct,Te.start*We),Vt=Math.min(Vt,(Te.start+Te.count)*We)),Oe!==null?(ct=Math.max(ct,0),Vt=Math.min(Vt,Oe.count)):Ve!=null&&(ct=Math.max(ct,0),Vt=Math.min(Vt,Ve.count));const _t=Vt-ct;if(_t<0||_t===1/0)return;Le.setup(W,k,Fe,G,Oe);let bn,lt=qe;if(Oe!==null&&(bn=ye.get(Oe),lt=fe,lt.setIndex(bn)),W.isMesh)k.wireframe===!0?(B.setLineWidth(k.wireframeLinewidth*be()),lt.setMode(_.LINES)):lt.setMode(_.TRIANGLES);else if(W.isLine){let Ye=k.linewidth;Ye===void 0&&(Ye=1),B.setLineWidth(Ye*be()),W.isLineSegments?lt.setMode(_.LINES):W.isLineLoop?lt.setMode(_.LINE_LOOP):lt.setMode(_.LINE_STRIP)}else W.isPoints?lt.setMode(_.POINTS):W.isSprite&&lt.setMode(_.TRIANGLES);if(W.isInstancedMesh)lt.renderInstances(ct,_t,W.count);else if(G.isInstancedBufferGeometry){const Ye=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,uo=Math.min(G.instanceCount,Ye);lt.renderInstances(ct,_t,uo)}else lt.render(ct,_t)};function Ne(S,F,G){S.transparent===!0&&S.side===On&&S.forceSinglePass===!1?(S.side=zt,S.needsUpdate=!0,Jr(S,F,G),S.side=ai,S.needsUpdate=!0,Jr(S,F,G),S.side=On):Jr(S,F,G)}this.compile=function(S,F,G=null){G===null&&(G=S),p=ne.get(G),p.init(),b.push(p),G.traverseVisible(function(W){W.isLight&&W.layers.test(F.layers)&&(p.pushLight(W),W.castShadow&&p.pushShadow(W))}),S!==G&&S.traverseVisible(function(W){W.isLight&&W.layers.test(F.layers)&&(p.pushLight(W),W.castShadow&&p.pushShadow(W))}),p.setupLights(E._useLegacyLights);const k=new Set;return S.traverse(function(W){const Te=W.material;if(Te)if(Array.isArray(Te))for(let Pe=0;Pe<Te.length;Pe++){const Fe=Te[Pe];Ne(Fe,G,W),k.add(Fe)}else Ne(Te,G,W),k.add(Te)}),b.pop(),p=null,k},this.compileAsync=function(S,F,G=null){const k=this.compile(S,F,G);return new Promise(W=>{function Te(){if(k.forEach(function(Pe){ee.get(Pe).currentProgram.isReady()&&k.delete(Pe)}),k.size===0){W(S);return}setTimeout(Te,10)}C.get("KHR_parallel_shader_compile")!==null?Te():setTimeout(Te,10)})};let $e=null;function ut(S){$e&&$e(S)}function Yt(){At.stop()}function st(){At.start()}const At=new Hf;At.setAnimationLoop(ut),typeof self<"u"&&At.setContext(self),this.setAnimationLoop=function(S){$e=S,we.setAnimationLoop(S),S===null?At.stop():At.start()},we.addEventListener("sessionstart",Yt),we.addEventListener("sessionend",st),this.render=function(S,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),we.enabled===!0&&we.isPresenting===!0&&(we.cameraAutoUpdate===!0&&we.updateCamera(F),F=we.getCamera()),S.isScene===!0&&S.onBeforeRender(E,S,F,P),p=ne.get(S,b.length),p.init(),b.push(p),pe.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),ve.setFromProjectionMatrix(pe),Ae=this.localClippingEnabled,Se=xe.init(this.clippingPlanes,Ae),g=J.get(S,h.length),g.init(),h.push(g),dn(S,F,0,E.sortObjects),g.finish(),E.sortObjects===!0&&g.sort(ie,ae),this.info.render.frame++,Se===!0&&xe.beginShadows();const G=p.state.shadowsArray;if(le.render(G,S,F),Se===!0&&xe.endShadows(),this.info.autoReset===!0&&this.info.reset(),_e.render(g,S),p.setupLights(E._useLegacyLights),F.isArrayCamera){const k=F.cameras;for(let W=0,Te=k.length;W<Te;W++){const Pe=k[W];Qa(g,S,Pe,Pe.viewport)}}else Qa(g,S,F);P!==null&&(X.updateMultisampleRenderTarget(P),X.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(E,S,F),Le.resetDefaultState(),j=-1,T=null,b.pop(),b.length>0?p=b[b.length-1]:p=null,h.pop(),h.length>0?g=h[h.length-1]:g=null};function dn(S,F,G,k){if(S.visible===!1)return;if(S.layers.test(F.layers)){if(S.isGroup)G=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(F);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ve.intersectsSprite(S)){k&&Ee.setFromMatrixPosition(S.matrixWorld).applyMatrix4(pe);const Pe=v.update(S),Fe=S.material;Fe.visible&&g.push(S,Pe,Fe,G,Ee.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ve.intersectsObject(S))){const Pe=v.update(S),Fe=S.material;if(k&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ee.copy(S.boundingSphere.center)):(Pe.boundingSphere===null&&Pe.computeBoundingSphere(),Ee.copy(Pe.boundingSphere.center)),Ee.applyMatrix4(S.matrixWorld).applyMatrix4(pe)),Array.isArray(Fe)){const Oe=Pe.groups;for(let We=0,He=Oe.length;We<He;We++){const Ve=Oe[We],ct=Fe[Ve.materialIndex];ct&&ct.visible&&g.push(S,Pe,ct,G,Ee.z,Ve)}}else Fe.visible&&g.push(S,Pe,Fe,G,Ee.z,null)}}const Te=S.children;for(let Pe=0,Fe=Te.length;Pe<Fe;Pe++)dn(Te[Pe],F,G,k)}function Qa(S,F,G,k){const W=S.opaque,Te=S.transmissive,Pe=S.transparent;p.setupLightsView(G),Se===!0&&xe.setGlobalState(E.clippingPlanes,G),Te.length>0&&jf(W,Te,F,G),k&&B.viewport(A.copy(k)),W.length>0&&Zr(W,F,G),Te.length>0&&Zr(Te,F,G),Pe.length>0&&Zr(Pe,F,G),B.buffers.depth.setTest(!0),B.buffers.depth.setMask(!0),B.buffers.color.setMask(!0),B.setPolygonOffset(!1)}function jf(S,F,G,k){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;const Te=O.isWebGL2;ue===null&&(ue=new Ri(1,1,{generateMipmaps:!0,type:C.has("EXT_color_buffer_half_float")?kr:si,minFilter:Vr,samples:Te?4:0})),E.getDrawingBufferSize(he),Te?ue.setSize(he.x,he.y):ue.setSize(qs(he.x),qs(he.y));const Pe=E.getRenderTarget();E.setRenderTarget(ue),E.getClearColor(ce),I=E.getClearAlpha(),I<1&&E.setClearColor(16777215,.5),E.clear();const Fe=E.toneMapping;E.toneMapping=ri,Zr(S,G,k),X.updateMultisampleRenderTarget(ue),X.updateRenderTargetMipmap(ue);let Oe=!1;for(let We=0,He=F.length;We<He;We++){const Ve=F[We],ct=Ve.object,Vt=Ve.geometry,_t=Ve.material,bn=Ve.group;if(_t.side===On&&ct.layers.test(k.layers)){const lt=_t.side;_t.side=zt,_t.needsUpdate=!0,el(ct,G,k,Vt,_t,bn),_t.side=lt,_t.needsUpdate=!0,Oe=!0}}Oe===!0&&(X.updateMultisampleRenderTarget(ue),X.updateRenderTargetMipmap(ue)),E.setRenderTarget(Pe),E.setClearColor(ce,I),E.toneMapping=Fe}function Zr(S,F,G){const k=F.isScene===!0?F.overrideMaterial:null;for(let W=0,Te=S.length;W<Te;W++){const Pe=S[W],Fe=Pe.object,Oe=Pe.geometry,We=k===null?Pe.material:k,He=Pe.group;Fe.layers.test(G.layers)&&el(Fe,F,G,Oe,We,He)}}function el(S,F,G,k,W,Te){S.onBeforeRender(E,F,G,k,W,Te),S.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),W.onBeforeRender(E,F,G,k,S,Te),W.transparent===!0&&W.side===On&&W.forceSinglePass===!1?(W.side=zt,W.needsUpdate=!0,E.renderBufferDirect(G,F,k,W,S,Te),W.side=ai,W.needsUpdate=!0,E.renderBufferDirect(G,F,k,W,S,Te),W.side=On):E.renderBufferDirect(G,F,k,W,S,Te),S.onAfterRender(E,F,G,k,W,Te)}function Jr(S,F,G){F.isScene!==!0&&(F=Re);const k=ee.get(S),W=p.state.lights,Te=p.state.shadowsArray,Pe=W.state.version,Fe=U.getParameters(S,W.state,Te,F,G),Oe=U.getProgramCacheKey(Fe);let We=k.programs;k.environment=S.isMeshStandardMaterial?F.environment:null,k.fog=F.fog,k.envMap=(S.isMeshStandardMaterial?K:te).get(S.envMap||k.environment),We===void 0&&(S.addEventListener("dispose",de),We=new Map,k.programs=We);let He=We.get(Oe);if(He!==void 0){if(k.currentProgram===He&&k.lightsStateVersion===Pe)return nl(S,Fe),He}else Fe.uniforms=U.getUniforms(S),S.onBuild(G,Fe,E),S.onBeforeCompile(Fe,E),He=U.acquireProgram(Fe,Oe),We.set(Oe,He),k.uniforms=Fe.uniforms;const Ve=k.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ve.clippingPlanes=xe.uniform),nl(S,Fe),k.needsLights=Zf(S),k.lightsStateVersion=Pe,k.needsLights&&(Ve.ambientLightColor.value=W.state.ambient,Ve.lightProbe.value=W.state.probe,Ve.directionalLights.value=W.state.directional,Ve.directionalLightShadows.value=W.state.directionalShadow,Ve.spotLights.value=W.state.spot,Ve.spotLightShadows.value=W.state.spotShadow,Ve.rectAreaLights.value=W.state.rectArea,Ve.ltc_1.value=W.state.rectAreaLTC1,Ve.ltc_2.value=W.state.rectAreaLTC2,Ve.pointLights.value=W.state.point,Ve.pointLightShadows.value=W.state.pointShadow,Ve.hemisphereLights.value=W.state.hemi,Ve.directionalShadowMap.value=W.state.directionalShadowMap,Ve.directionalShadowMatrix.value=W.state.directionalShadowMatrix,Ve.spotShadowMap.value=W.state.spotShadowMap,Ve.spotLightMatrix.value=W.state.spotLightMatrix,Ve.spotLightMap.value=W.state.spotLightMap,Ve.pointShadowMap.value=W.state.pointShadowMap,Ve.pointShadowMatrix.value=W.state.pointShadowMatrix),k.currentProgram=He,k.uniformsList=null,He}function tl(S){if(S.uniformsList===null){const F=S.currentProgram.getUniforms();S.uniformsList=Us.seqWithValue(F.seq,S.uniforms)}return S.uniformsList}function nl(S,F){const G=ee.get(S);G.outputColorSpace=F.outputColorSpace,G.instancing=F.instancing,G.instancingColor=F.instancingColor,G.skinning=F.skinning,G.morphTargets=F.morphTargets,G.morphNormals=F.morphNormals,G.morphColors=F.morphColors,G.morphTargetsCount=F.morphTargetsCount,G.numClippingPlanes=F.numClippingPlanes,G.numIntersection=F.numClipIntersection,G.vertexAlphas=F.vertexAlphas,G.vertexTangents=F.vertexTangents,G.toneMapping=F.toneMapping}function Kf(S,F,G,k,W){F.isScene!==!0&&(F=Re),X.resetTextureUnits();const Te=F.fog,Pe=k.isMeshStandardMaterial?F.environment:null,Fe=P===null?E.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:Wn,Oe=(k.isMeshStandardMaterial?K:te).get(k.envMap||Pe),We=k.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,He=!!G.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Ve=!!G.morphAttributes.position,ct=!!G.morphAttributes.normal,Vt=!!G.morphAttributes.color;let _t=ri;k.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(_t=E.toneMapping);const bn=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,lt=bn!==void 0?bn.length:0,Ye=ee.get(k),uo=p.state.lights;if(Se===!0&&(Ae===!0||S!==T)){const kt=S===T&&k.id===j;xe.setState(k,S,kt)}let ft=!1;k.version===Ye.__version?(Ye.needsLights&&Ye.lightsStateVersion!==uo.state.version||Ye.outputColorSpace!==Fe||W.isInstancedMesh&&Ye.instancing===!1||!W.isInstancedMesh&&Ye.instancing===!0||W.isSkinnedMesh&&Ye.skinning===!1||!W.isSkinnedMesh&&Ye.skinning===!0||W.isInstancedMesh&&Ye.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&Ye.instancingColor===!1&&W.instanceColor!==null||Ye.envMap!==Oe||k.fog===!0&&Ye.fog!==Te||Ye.numClippingPlanes!==void 0&&(Ye.numClippingPlanes!==xe.numPlanes||Ye.numIntersection!==xe.numIntersection)||Ye.vertexAlphas!==We||Ye.vertexTangents!==He||Ye.morphTargets!==Ve||Ye.morphNormals!==ct||Ye.morphColors!==Vt||Ye.toneMapping!==_t||O.isWebGL2===!0&&Ye.morphTargetsCount!==lt)&&(ft=!0):(ft=!0,Ye.__version=k.version);let ci=Ye.currentProgram;ft===!0&&(ci=Jr(k,F,W));let il=!1,mr=!1,fo=!1;const wt=ci.getUniforms(),ui=Ye.uniforms;if(B.useProgram(ci.program)&&(il=!0,mr=!0,fo=!0),k.id!==j&&(j=k.id,mr=!0),il||T!==S){wt.setValue(_,"projectionMatrix",S.projectionMatrix),wt.setValue(_,"viewMatrix",S.matrixWorldInverse);const kt=wt.map.cameraPosition;kt!==void 0&&kt.setValue(_,Ee.setFromMatrixPosition(S.matrixWorld)),O.logarithmicDepthBuffer&&wt.setValue(_,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&wt.setValue(_,"isOrthographic",S.isOrthographicCamera===!0),T!==S&&(T=S,mr=!0,fo=!0)}if(W.isSkinnedMesh){wt.setOptional(_,W,"bindMatrix"),wt.setOptional(_,W,"bindMatrixInverse");const kt=W.skeleton;kt&&(O.floatVertexTextures?(kt.boneTexture===null&&kt.computeBoneTexture(),wt.setValue(_,"boneTexture",kt.boneTexture,X),wt.setValue(_,"boneTextureSize",kt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const ho=G.morphAttributes;if((ho.position!==void 0||ho.normal!==void 0||ho.color!==void 0&&O.isWebGL2===!0)&&Ce.update(W,G,ci),(mr||Ye.receiveShadow!==W.receiveShadow)&&(Ye.receiveShadow=W.receiveShadow,wt.setValue(_,"receiveShadow",W.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(ui.envMap.value=Oe,ui.flipEnvMap.value=Oe.isCubeTexture&&Oe.isRenderTargetTexture===!1?-1:1),mr&&(wt.setValue(_,"toneMappingExposure",E.toneMappingExposure),Ye.needsLights&&$f(ui,fo),Te&&k.fog===!0&&Z.refreshFogUniforms(ui,Te),Z.refreshMaterialUniforms(ui,k,V,$,ue),Us.upload(_,tl(Ye),ui,X)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Us.upload(_,tl(Ye),ui,X),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&wt.setValue(_,"center",W.center),wt.setValue(_,"modelViewMatrix",W.modelViewMatrix),wt.setValue(_,"normalMatrix",W.normalMatrix),wt.setValue(_,"modelMatrix",W.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const kt=k.uniformsGroups;for(let po=0,Jf=kt.length;po<Jf;po++)if(O.isWebGL2){const rl=kt[po];Ie.update(rl,ci),Ie.bind(rl,ci)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return ci}function $f(S,F){S.ambientLightColor.needsUpdate=F,S.lightProbe.needsUpdate=F,S.directionalLights.needsUpdate=F,S.directionalLightShadows.needsUpdate=F,S.pointLights.needsUpdate=F,S.pointLightShadows.needsUpdate=F,S.spotLights.needsUpdate=F,S.spotLightShadows.needsUpdate=F,S.rectAreaLights.needsUpdate=F,S.hemisphereLights.needsUpdate=F}function Zf(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,F,G){ee.get(S.texture).__webglTexture=F,ee.get(S.depthTexture).__webglTexture=G;const k=ee.get(S);k.__hasExternalTextures=!0,k.__hasExternalTextures&&(k.__autoAllocateDepthBuffer=G===void 0,k.__autoAllocateDepthBuffer||C.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,F){const G=ee.get(S);G.__webglFramebuffer=F,G.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(S,F=0,G=0){P=S,w=F,L=G;let k=!0,W=null,Te=!1,Pe=!1;if(S){const Oe=ee.get(S);Oe.__useDefaultFramebuffer!==void 0?(B.bindFramebuffer(_.FRAMEBUFFER,null),k=!1):Oe.__webglFramebuffer===void 0?X.setupRenderTarget(S):Oe.__hasExternalTextures&&X.rebindTextures(S,ee.get(S.texture).__webglTexture,ee.get(S.depthTexture).__webglTexture);const We=S.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Pe=!0);const He=ee.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(He[F])?W=He[F][G]:W=He[F],Te=!0):O.isWebGL2&&S.samples>0&&X.useMultisampledRTT(S)===!1?W=ee.get(S).__webglMultisampledFramebuffer:Array.isArray(He)?W=He[G]:W=He,A.copy(S.viewport),re.copy(S.scissor),oe=S.scissorTest}else A.copy(se).multiplyScalar(V).floor(),re.copy(N).multiplyScalar(V).floor(),oe=H;if(B.bindFramebuffer(_.FRAMEBUFFER,W)&&O.drawBuffers&&k&&B.drawBuffers(S,W),B.viewport(A),B.scissor(re),B.setScissorTest(oe),Te){const Oe=ee.get(S.texture);_.framebufferTexture2D(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,_.TEXTURE_CUBE_MAP_POSITIVE_X+F,Oe.__webglTexture,G)}else if(Pe){const Oe=ee.get(S.texture),We=F||0;_.framebufferTextureLayer(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,Oe.__webglTexture,G||0,We)}j=-1},this.readRenderTargetPixels=function(S,F,G,k,W,Te,Pe){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=ee.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Pe!==void 0&&(Fe=Fe[Pe]),Fe){B.bindFramebuffer(_.FRAMEBUFFER,Fe);try{const Oe=S.texture,We=Oe.format,He=Oe.type;if(We!==ln&&ze.convert(We)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ve=He===kr&&(C.has("EXT_color_buffer_half_float")||O.isWebGL2&&C.has("EXT_color_buffer_float"));if(He!==si&&ze.convert(He)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_TYPE)&&!(He===ti&&(O.isWebGL2||C.has("OES_texture_float")||C.has("WEBGL_color_buffer_float")))&&!Ve){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=S.width-k&&G>=0&&G<=S.height-W&&_.readPixels(F,G,k,W,ze.convert(We),ze.convert(He),Te)}finally{const Oe=P!==null?ee.get(P).__webglFramebuffer:null;B.bindFramebuffer(_.FRAMEBUFFER,Oe)}}},this.copyFramebufferToTexture=function(S,F,G=0){const k=Math.pow(2,-G),W=Math.floor(F.image.width*k),Te=Math.floor(F.image.height*k);X.setTexture2D(F,0),_.copyTexSubImage2D(_.TEXTURE_2D,G,0,0,S.x,S.y,W,Te),B.unbindTexture()},this.copyTextureToTexture=function(S,F,G,k=0){const W=F.image.width,Te=F.image.height,Pe=ze.convert(G.format),Fe=ze.convert(G.type);X.setTexture2D(G,0),_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,G.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,G.unpackAlignment),F.isDataTexture?_.texSubImage2D(_.TEXTURE_2D,k,S.x,S.y,W,Te,Pe,Fe,F.image.data):F.isCompressedTexture?_.compressedTexSubImage2D(_.TEXTURE_2D,k,S.x,S.y,F.mipmaps[0].width,F.mipmaps[0].height,Pe,F.mipmaps[0].data):_.texSubImage2D(_.TEXTURE_2D,k,S.x,S.y,Pe,Fe,F.image),k===0&&G.generateMipmaps&&_.generateMipmap(_.TEXTURE_2D),B.unbindTexture()},this.copyTextureToTexture3D=function(S,F,G,k,W=0){if(E.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Te=S.max.x-S.min.x+1,Pe=S.max.y-S.min.y+1,Fe=S.max.z-S.min.z+1,Oe=ze.convert(k.format),We=ze.convert(k.type);let He;if(k.isData3DTexture)X.setTexture3D(k,0),He=_.TEXTURE_3D;else if(k.isDataArrayTexture)X.setTexture2DArray(k,0),He=_.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,k.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,k.unpackAlignment);const Ve=_.getParameter(_.UNPACK_ROW_LENGTH),ct=_.getParameter(_.UNPACK_IMAGE_HEIGHT),Vt=_.getParameter(_.UNPACK_SKIP_PIXELS),_t=_.getParameter(_.UNPACK_SKIP_ROWS),bn=_.getParameter(_.UNPACK_SKIP_IMAGES),lt=G.isCompressedTexture?G.mipmaps[0]:G.image;_.pixelStorei(_.UNPACK_ROW_LENGTH,lt.width),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,lt.height),_.pixelStorei(_.UNPACK_SKIP_PIXELS,S.min.x),_.pixelStorei(_.UNPACK_SKIP_ROWS,S.min.y),_.pixelStorei(_.UNPACK_SKIP_IMAGES,S.min.z),G.isDataTexture||G.isData3DTexture?_.texSubImage3D(He,W,F.x,F.y,F.z,Te,Pe,Fe,Oe,We,lt.data):G.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),_.compressedTexSubImage3D(He,W,F.x,F.y,F.z,Te,Pe,Fe,Oe,lt.data)):_.texSubImage3D(He,W,F.x,F.y,F.z,Te,Pe,Fe,Oe,We,lt),_.pixelStorei(_.UNPACK_ROW_LENGTH,Ve),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,ct),_.pixelStorei(_.UNPACK_SKIP_PIXELS,Vt),_.pixelStorei(_.UNPACK_SKIP_ROWS,_t),_.pixelStorei(_.UNPACK_SKIP_IMAGES,bn),W===0&&k.generateMipmaps&&_.generateMipmap(He),B.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?X.setTextureCube(S,0):S.isData3DTexture?X.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?X.setTexture2DArray(S,0):X.setTexture2D(S,0),B.unbindTexture()},this.resetState=function(){w=0,L=0,P=null,B.reset(),Le.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Bn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===qa?"display-p3":"srgb",t.unpackColorSpace=tt.workingColorSpace===ao?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===vt?wi:wf}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===wi?vt:Wn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class lM extends Xf{}lM.prototype.isWebGL1Renderer=!0;class cM extends Gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class uM{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=xa,this.updateRange={offset:0,count:-1},this.version=0,this.uuid=Hn()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=t.array[i+r];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Hn()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Hn()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Rt=new z;class js{constructor(e,t,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.applyMatrix4(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.applyNormalMatrix(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)Rt.fromBufferAttribute(this,t),Rt.transformDirection(e),this.setXYZ(t,Rt.x,Rt.y,Rt.z);return this}setX(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=et(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=Mn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=Mn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=Mn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=Mn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array),r=et(r,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,t,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=et(t,this.array),i=et(i,this.array),r=et(r,this.array),s=et(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return new fn(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new js(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class qf extends Kr{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Qe(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Yi;const Er=new z,ji=new z,Ki=new z,$i=new je,yr=new je,Yf=new it,bs=new z,Tr=new z,As=new z,iu=new je,ta=new je,ru=new je;class fM extends Gt{constructor(e=new qf){if(super(),this.isSprite=!0,this.type="Sprite",Yi===void 0){Yi=new qn;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new uM(t,5);Yi.setIndex([0,1,2,0,2,3]),Yi.setAttribute("position",new js(i,3,0,!1)),Yi.setAttribute("uv",new js(i,2,3,!1))}this.geometry=Yi,this.material=e,this.center=new je(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),ji.setFromMatrixScale(this.matrixWorld),Yf.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Ki.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&ji.multiplyScalar(-Ki.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const a=this.center;ws(bs.set(-.5,-.5,0),Ki,a,ji,r,s),ws(Tr.set(.5,-.5,0),Ki,a,ji,r,s),ws(As.set(.5,.5,0),Ki,a,ji,r,s),iu.set(0,0),ta.set(1,0),ru.set(1,1);let o=e.ray.intersectTriangle(bs,Tr,As,!1,Er);if(o===null&&(ws(Tr.set(-.5,.5,0),Ki,a,ji,r,s),ta.set(0,1),o=e.ray.intersectTriangle(bs,As,Tr,!1,Er),o===null))return;const l=e.ray.origin.distanceTo(Er);l<e.near||l>e.far||t.push({distance:l,point:Er.clone(),uv:Zt.getInterpolation(Er,bs,Tr,As,iu,ta,ru,new je),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function ws(n,e,t,i,r,s){$i.subVectors(n,t).addScalar(.5).multiply(i),r!==void 0?(yr.x=s*$i.x-r*$i.y,yr.y=r*$i.x+s*$i.y):yr.copy($i),n.copy(e),n.x+=yr.x,n.y+=yr.y,n.applyMatrix4(Yf)}class hM extends Ht{constructor(e,t,i,r,s,a,o,l,c){super(e,t,i,r,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Ja extends qn{constructor(e=.5,t=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],u=[];let f=e;const d=(t-e)/r,m=new z,x=new je;for(let g=0;g<=r;g++){for(let p=0;p<=i;p++){const h=s+p/i*a;m.x=f*Math.cos(h),m.y=f*Math.sin(h),l.push(m.x,m.y,m.z),c.push(0,0,1),x.x=(m.x/t+1)/2,x.y=(m.y/t+1)/2,u.push(x.x,x.y)}f+=d}for(let g=0;g<r;g++){const p=g*(i+1);for(let h=0;h<i;h++){const b=h+p,E=b,y=b+i+1,w=b+i+2,L=b+1;o.push(E,y,L),o.push(y,w,L)}}this.setIndex(o),this.setAttribute("position",new En(l,3)),this.setAttribute("normal",new En(c,3)),this.setAttribute("uv",new En(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ja(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Wa}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Wa);const dM=to({props:{message:{type:String,required:!0},isVisible:{type:Boolean,required:!0}},emits:["close"],setup(n,{emit:e}){const t=()=>{e("close")};return{message:n.message,isVisible:n.isVisible,closeAlert:t}}}),pM={class:"alert-content"};function mM(n,e,t,i,r,s){return n.isVisible?(Tt(),Ut("div",{key:0,class:"alert-overlay",onClick:e[2]||(e[2]=(...a)=>n.closeAlert&&n.closeAlert(...a))},[Ue("div",{class:"alert-box",onClick:e[1]||(e[1]=_f(()=>{},["stop"]))},[Ue("div",pM,[Ue("p",null,Qn(n.message),1),Ue("button",{class:"alert-close-btn",onClick:e[0]||(e[0]=(...a)=>n.closeAlert&&n.closeAlert(...a))},"OK")])])])):ni("",!0)}const _M=ka(dM,[["render",mM],["__scopeId","data-v-73a45f19"]]),gM=["disabled"],vM={key:0,class:"empty-list"},xM={class:"object-info"},MM=["onClick"],SM={key:0},EM={key:1,class:"tag-input-overlay"},yM={class:"tag-input-box"},TM={class:"tag-input-div"},bM=["onKeydown"],AM=5,wM=.1,RM=to({__name:"ARComponent",props:{roomId:{}},setup(n){const e=n,t=Bt(),i=Bt(!1),r=Bt(null),s=Bt(!1),a=Bt(""),o=Bt(!1),l=Bt(!1),c=Bt(""),u=df(()=>y.map(ue=>({name:ue.sprite.userData.text||"Sans nom",position:ue.sprite.position.clone()})));let f,d,m,x,g,p,h=null,b=null,E=null,y=[],w=new it,L=new it,P=.1,j=[];const T=()=>{const ue=y.map(pe=>{var he;return{name:pe.sprite.userData.text||"",position:{x:pe.sprite.position.x,y:pe.sprite.position.y,z:pe.sprite.position.z},baseMatrix:(he=pe.baseMatrix)!=null&&he.elements?Array.from(pe.baseMatrix.elements):null}});localStorage.setItem(`arTags_${e.roomId}`,JSON.stringify(ue))},A=()=>{const ue=localStorage.getItem(`arTags_${e.roomId}`);if(!ue)return[];try{return JSON.parse(ue)}catch(pe){return console.error("Failed to load tags from localStorage:",pe),[]}},re=ue=>{for(const pe of y){const he=new z;if(he.setFromMatrixPosition(pe.sprite.matrixWorld),he.distanceTo(ue)<wM)return!0}return!1},oe=()=>{o.value=!o.value},ce=ue=>{const pe=y[ue];if(pe){if(f.remove(pe.sprite),pe.anchor&&pe.anchor.delete)try{pe.anchor.delete()}catch{}y.splice(ue,1),T()}},I=ue=>{var he,Ee,Re;for(const be of y)if(f.remove(be.sprite),be.anchor&&be.anchor.delete)try{be.anchor.delete()}catch{}y=[];const pe=Y(ue);for(const be of pe){const _=ie(be.name);be.position&&_.position.set(be.position.x,be.position.y,be.position.z);const R=be.baseMatrix?new it().fromArray(be.baseMatrix):new it().setPosition(((he=be.position)==null?void 0:he.x)||0,((Ee=be.position)==null?void 0:Ee.y)||0,((Re=be.position)==null?void 0:Re.z)||0);f.add(_),y.push({sprite:_,baseMatrix:R})}},Y=ue=>{const pe=localStorage.getItem(`arTags_${ue}`);if(!pe)return[];try{return JSON.parse(pe)}catch(he){return console.error("Failed to load tags from localStorage:",he),[]}};Bs(()=>{$()});const $=async()=>{if("xr"in navigator){const ue=await navigator.xr.isSessionSupported("immersive-ar");r.value=ue}else r.value=!1},V=async()=>{var Re,be,_,R;if(!r.value)return;const ue=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:document.body}});m=new Xf({antialias:!0,alpha:!0}),m.setSize(window.innerWidth,window.innerHeight),m.xr.enabled=!0,m.xr.setReferenceSpaceType("local"),m.xr.setSession(ue),(Re=t.value)==null||Re.appendChild(m.domElement);const pe=()=>{var C;m.setAnimationLoop(null),i.value=!1,s.value=!1,h!=null&&h.cancel&&h.cancel(),h=null,b=null,(C=t.value)!=null&&C.contains(m.domElement)&&t.value.removeChild(m.domElement);for(const O of y){if(O.anchor&&O.anchor.delete)try{O.anchor.delete()}catch{}f.remove(O.sprite)}y=[],m.dispose()};ue.addEventListener("end",pe),f=new cM,d=new Jt(70,window.innerWidth/window.innerHeight,.01,20);const he=A();for(const C of he){const O=ie(C.name);C.position&&O.position.set(C.position.x,C.position.y,C.position.z);const B=C.baseMatrix?new it().fromArray(C.baseMatrix):new it().setPosition(((be=C.position)==null?void 0:be.x)||0,((_=C.position)==null?void 0:_.y)||0,((R=C.position)==null?void 0:R.z)||0);f.add(O),y.push({sprite:O,baseMatrix:B})}const Ee=new Ja(.15,.2,32).rotateX(-Math.PI/2);p=new Ka({color:16777215}),g=new zn(Ee,p),g.matrixAutoUpdate=!1,g.visible=!1,f.add(g),L.identity(),x=m.xr.getController(0),x.addEventListener("select",ae),f.add(x),ue.requestReferenceSpace("viewer").then(C=>{ue.requestHitTestSource({space:C}).then(O=>{h=O})}),ue.requestReferenceSpace("local").then(C=>{b=C}),m.setAnimationLoop(Ae),i.value=!0},ie=ue=>{const Ee=document.createElement("canvas"),Re=Ee.getContext("2d");Re.font="64px Arial";const be=Re.measureText(ue),_=Math.ceil(be.width),R=64;Ee.width=_+20*2,Ee.height=R+20*2,Re.font="64px Arial",Re.textAlign="center",Re.textBaseline="middle",Re.fillStyle="rgba(0, 0, 0, 0.6)",Re.fillRect(0,0,Ee.width,Ee.height),Re.fillStyle="white",Re.fillText(ue,Ee.width/2,Ee.height/2);const C=new hM(Ee);C.needsUpdate=!0;const O=new qf({map:C,transparent:!0}),B=new fM(O);B.userData.text=ue;const q=.001;return B.scale.set(Ee.width*q,Ee.height*q,1),B},ae=()=>{g.visible&&(w.copy(g.matrix),a.value="",s.value=!0)},se=()=>{if(!i.value){ve("L'AR n'est pas encore démarré.");return}if(!g||!g.visible){ve("Aucune surface détectée actuellement. Veuillez attendre que le réticule apparaisse.");return}w.copy(g.matrix),a.value="",s.value=!0},N=()=>{const ue=a.value.trim();if(!ue){H();return}const pe=new z;if(pe.setFromMatrixPosition(w),re(pe)){ve("Position trop proche d'un tag existant. Veuillez choisir un autre emplacement."),H();return}const he=(Re,be)=>{const _=ie(ue);_.position.setFromMatrixPosition(Re),f.add(_),y.push({sprite:_,anchor:be,baseMatrix:Re.clone()}),T()};(async()=>{if(E!=null&&E.createAnchor)try{const Re=await E.createAnchor();he(w,Re);return}catch(Re){console.warn("WebXR anchor creation failed, fallback on position only",Re)}he(w)})().catch(()=>he(w)),s.value=!1,a.value=""},H=()=>{s.value=!1,a.value=""},ve=ue=>{c.value=ue,l.value=!0},Se=()=>{l.value=!1,c.value=""},Ae=(ue,pe)=>{if(pe){if(h&&b){const he=pe.getHitTestResults(h);if(he.length){const Ee=he[0];E=Ee;const Re=Ee.getPose(b);if(Re){g.visible=!0;const be=new it().fromArray(Re.transform.matrix);if(j.push(be),j.length>AM&&j.shift(),j.length>0){const _=[],R=[];j.forEach(X=>{const te=new z,K=new dr,ye=new z;X.decompose(te,K,ye),_.push(te),R.push(K)});const C=_.reduce((X,te)=>X.add(te),new z).divideScalar(_.length);let O=R[0].clone();for(let X=1;X<R.length;X++)O.slerp(R[X],.5);const B=new it;B.compose(C,O,new z(1,1,1));const q=P;for(let X=0;X<16;X++)L.elements[X]=n_.lerp(L.elements[X],B.elements[X],q);g.matrix.copy(L);const ee=new z;ee.setFromMatrixPosition(L),re(ee)?p.color.setHex(16711680):p.color.setHex(16777215)}}}else g.visible=!1,j=[]}for(const he of y)if(he.anchor&&b){const Ee=he.anchor.anchorSpace||he.anchor,Re=pe.getPose(Ee,b);if(Re){const be=new it().fromArray(Re.transform.matrix);he.sprite.position.setFromMatrixPosition(be)}}else he.baseMatrix&&he.sprite.position.setFromMatrixPosition(he.baseMatrix)}m.render(f,d)};return Bs(()=>{setTimeout(()=>{V()},500)}),Ps(()=>e.roomId,(ue,pe)=>{ue!==pe&&i.value&&I(ue)}),(ue,pe)=>(Tt(),Ut(Kt,null,[Ue("div",{id:"ar-container",ref_key:"container",ref:t},null,512),Ue("button",{class:"panel-toggle btn-panel",onClick:oe},Qn(o.value?"Fermer la liste":"Liste des objets"),1),Ue("button",{class:"btn-panel add-tag-btn",onClick:se,disabled:!i.value}," Ajouter un objet ",8,gM),Ue("aside",{class:Js(["objects-panel",{open:o.value}]),"aria-label":"Liste des objets AR"},[Ue("div",{class:"panel-header"},[pe[1]||(pe[1]=Ue("h3",null,"Objets AR",-1)),Ue("button",{class:"close-panel",onClick:oe},"✕")]),u.value.length===0?(Tt(),Ut("div",vM,"Aucun objet placé")):ni("",!0),Ue("ul",null,[(Tt(!0),Ut(Kt,null,ku(u.value,(he,Ee)=>(Tt(),Ut("li",{key:Ee},[Ue("div",xM,[Ue("strong",null,Qn(he.name),1),Ue("small",null,"("+Qn(he.position.x.toFixed(2))+", "+Qn(he.position.y.toFixed(2))+", "+Qn(he.position.z.toFixed(2))+")",1)]),Ue("button",{class:"delete-object-btn",onClick:Re=>ce(Ee)},"Supprimer",8,MM)]))),128))])],2),r.value===!1?(Tt(),Ut("p",SM,"Votre navigateur ne supporte pas WebXR AR.")):ni("",!0),s.value?(Tt(),Ut("div",EM,[Ue("div",yM,[Ue("label",null,[Ue("div",TM,[pe[2]||(pe[2]=Mi(" Nom : ",-1)),Fu(Ue("input",{"onUpdate:modelValue":pe[0]||(pe[0]=he=>a.value=he),onKeydown:gf(_f(N,["prevent"]),["enter"]),placeholder:"Entrez le nom...",autofocus:""},null,40,bM),[[mf,a.value]])])])])])):ni("",!0),nn(_M,{message:c.value,isVisible:l.value,onClose:Se},null,8,["message","isVisible"])],64))}}),CM=ka(RM,[["__scopeId","data-v-c97038da"]]),PM={key:0},LM={key:1},DM=to({__name:"App",setup(n){const e=Bt("rooms"),t=Bt(null),i=s=>{t.value=s,e.value="ar"},r=()=>{e.value="rooms",t.value=null};return(s,a)=>e.value==="rooms"?(Tt(),Ut("div",PM,[nn(Hp,{onSelectRoom:i})])):e.value==="ar"&&t.value?(Tt(),Ut("div",LM,[Ue("button",{onClick:r,class:"back-btn"},"Retour aux Pièces"),nn(CM,{roomId:t.value},null,8,["roomId"])])):ni("",!0)}});Ep(DM).mount("#app");
