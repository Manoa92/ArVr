...
}`;function py(t,e,n){let i=new Wl;const r=new Je,s=new Je,a=new bt,o=new uy({depthPacking:Kv}),l=new fy,c={},u=n.maxTextureSize,f={[Mi]:Yt,[Yt]:Mi,[Dn]:Dn},h=new $i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:hy,fragmentShader:dy}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const v=new ri;v.setAttribute("position",new Nn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Un(v,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ud;let d=this.type;this.render=function(R,L,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const G=t.getRenderTarget(),S=t.getActiveCubeFace(),A=t.getActiveMipmapLevel(),q=t.state;q.setBlending(_i),q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);const F=d!==qn&&this.type===qn,ee=d===qn&&this.type!==qn;for(let D=0,K=R.length;D<K;D++){const J=R[D],z=J.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const oe=z.getFrameExtents();if(r.multiply(oe),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/oe.x),r.x=s.x*oe.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/oe.y),r.y=s.y*oe.y,z.mapSize.y=s.y)),z.map===null||F===!0||ee===!0){const ue=this.type!==qn?{minFilter:zt,magFilter:zt}:{};z.map!==null&&z.map.dispose(),z.map=new Xi(r.x,r.y,ue),z.map.texture.name=J.name+".shadowMap",z.camera.updateProjectionMatrix()}t.setRenderTarget(z.map),t.clear();const he=z.getViewportCount();for(let ue=0;ue<he;ue++){const O=z.getViewport(ue);a.set(s.x*O.x,s.y*O.y,s.x*O.z,s.y*O.w),q.viewport(a),z.updateMatrices(J,ue),i=z.getFrustum(),y(L,C,z.camera,J,this.type)}z.isPointLightShadow!==!0&&this.type===qn&&T(z,C),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,t.setRenderTarget(G,S,A)};function T(R,L){const C=e.update(_);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Xi(r.x,r.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,t.setRenderTarget(R.mapPass),t.clear(),t.renderBufferDirect(L,null,C,h,_,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,t.setRenderTarget(R.map),t.clear(),t.renderBufferDirect(L,null,C,p,_,null)}function M(R,L,C,G){let S=null;const A=C.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(A!==void 0)S=A;else if(S=C.isPointLight===!0?l:o,t.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0){const q=S.uuid,F=L.uuid;let ee=c[q];ee===void 0&&(ee={},c[q]=ee);let D=ee[F];D===void 0&&(D=S.clone(),ee[F]=D),S=D}if(S.visible=L.visible,S.wireframe=L.wireframe,G===qn?S.side=L.shadowSide!==null?L.shadowSide:L.side:S.side=L.shadowSide!==null?L.shadowSide:f[L.side],S.alphaMap=L.alphaMap,S.alphaTest=L.alphaTest,S.map=L.map,S.clipShadows=L.clipShadows,S.clippingPlanes=L.clippingPlanes,S.clipIntersection=L.clipIntersection,S.displacementMap=L.displacementMap,S.displacementScale=L.displacementScale,S.displacementBias=L.displacementBias,S.wireframeLinewidth=L.wireframeLinewidth,S.linewidth=L.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const q=t.properties.get(S);q.light=C}return S}function y(R,L,C,G,S){if(R.visible===!1)return;if(R.layers.test(L.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===qn)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,R.matrixWorld);const F=e.update(R),ee=R.material;if(Array.isArray(ee)){const D=F.groups;for(let K=0,J=D.length;K<J;K++){const z=D[K],oe=ee[z.materialIndex];if(oe&&oe.visible){const he=M(R,oe,G,S);t.renderBufferDirect(C,null,F,he,R,z)}}}else if(ee.visible){const D=M(R,ee,G,S);t.renderBufferDirect(C,null,F,D,R,null)}}const q=R.children;for(let F=0,ee=q.length;F<ee;F++)y(q[F],L,C,G,S)}}function my(t,e,n){const i=n.isWebGL2;function r(){let U=!1;const Te=new bt;let ge=null;const se=new bt(0,0,0,0);return{setMask:function(_e){ge!==_e&&!U&&(t.colorMask(_e,_e,_e,_e),ge=_e)},setLocked:function(_e){U=_e},setClear:function(_e,Ne,Ke,mt,an){an===!0&&(_e*=mt,Ne*=mt,Ke*=mt),Te.set(_e,Ne,Ke,mt),se.equals(Te)===!1&&(t.clearColor(_e,Ne,Ke,mt),se.copy(Te))},reset:function(){U=!1,ge=null,se.set(-1,0,0,0)}}}function s(){let U=!1,Te=null,ge=null,se=null;return{setTest:function(_e){_e?Y(t.DEPTH_TEST):fe(t.DEPTH_TEST)},setMask:function(_e){Te!==_e&&!U&&(t.depthMask(_e),Te=_e)},setFunc:function(_e){if(ge!==_e){switch(_e){case bv:t.depthFunc(t.NEVER);break;case Av:t.depthFunc(t.ALWAYS);break;case Rv:t.depthFunc(t.LESS);break;case uo:t.depthFunc(t.LEQUAL);break;case wv:t.depthFunc(t.EQUAL);break;case Cv:t.depthFunc(t.GEQUAL);break;case Pv:t.depthFunc(t.GREATER);break;case Lv:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ge=_e}},setLocked:function(_e){U=_e},setClear:function(_e){se!==_e&&(t.clearDepth(_e),se=_e)},reset:function(){U=!1,Te=null,ge=null,se=null}}}function a(){let U=!1,Te=null,ge=null,se=null,_e=null,Ne=null,Ke=null,mt=null,an=null;return{setTest:function(rt){U||(rt?Y(t.STENCIL_TEST):fe(t.STENCIL_TEST))},setMask:function(rt){Te!==rt&&!U&&(t.stencilMask(rt),Te=rt)},setFunc:function(rt,Ut,Tn){(ge!==rt||se!==Ut||_e!==Tn)&&(t.stencilFunc(rt,Ut,Tn),ge=rt,se=Ut,_e=Tn)},setOp:function(rt,Ut,Tn){(Ne!==rt||Ke!==Ut||mt!==Tn)&&(t.stencilOp(rt,Ut,Tn),Ne=rt,Ke=Ut,mt=Tn)},setLocked:function(rt){U=rt},setClear:function(rt){an!==rt&&(t.clearStencil(rt),an=rt)},reset:function(){U=!1,Te=null,ge=null,se=null,_e=null,Ne=null,Ke=null,mt=null,an=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let h={},p={},v=new WeakMap,_=[],m=null,d=!1,T=null,M=null,y=null,R=null,L=null,C=null,G=null,S=new Ze(0,0,0),A=0,q=!1,F=null,ee=null,D=null,K=null,J=null;const z=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let oe=!1,he=0;const ue=t.getParameter(t.VERSION);ue.indexOf("WebGL")!==-1?(he=parseFloat(/^WebGL (\d)/.exec(ue)[1]),oe=he>=1):ue.indexOf("OpenGL ES")!==-1&&(he=parseFloat(/^OpenGL ES (\d)/.exec(ue)[1]),oe=he>=2);let O=null,$={};const xe=t.getParameter(t.SCISSOR_BOX),Me=t.getParameter(t.VIEWPORT),Ee=new bt().fromArray(xe),we=new bt().fromArray(Me);function N(U,Te,ge,se){const _e=new Uint8Array(4),Ne=t.createTexture();t.bindTexture(U,Ne),t.texParameteri(U,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(U,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ke=0;Ke<ge;Ke++)i&&(U===t.TEXTURE_3D||U===t.TEXTURE_2D_ARRAY)?t.texImage3D(Te,0,t.RGBA,1,1,se,0,t.RGBA,t.UNSIGNED_BYTE,_e):t.texImage2D(Te+Ke,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,_e);return Ne}const V={};V[t.TEXTURE_2D]=N(t.TEXTURE_2D,t.TEXTURE_2D,1),V[t.TEXTURE_CUBE_MAP]=N(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(V[t.TEXTURE_2D_ARRAY]=N(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),V[t.TEXTURE_3D]=N(t.TEXTURE_3D,t.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Y(t.DEPTH_TEST),l.setFunc(uo),ae(!1),re(ou),Y(t.CULL_FACE),k(_i);function Y(U){h[U]!==!0&&(t.enable(U),h[U]=!0)}function fe(U){h[U]!==!1&&(t.disable(U),h[U]=!1)}function me(U,Te){return p[U]!==Te?(t.bindFramebuffer(U,Te),p[U]=Te,i&&(U===t.DRAW_FRAMEBUFFER&&(p[t.FRAMEBUFFER]=Te),U===t.FRAMEBUFFER&&(p[t.DRAW_FRAMEBUFFER]=Te)),!0):!1}function g(U,Te){let ge=_,se=!1;if(U)if(ge=v.get(Te),ge===void 0&&(ge=[],v.set(Te,ge)),U.isWebGLMultipleRenderTargets){const _e=U.texture;if(ge.length!==_e.length||ge[0]!==t.COLOR_ATTACHMENT0){for(let Ne=0,Ke=_e.length;Ne<Ke;Ne++)ge[Ne]=t.COLOR_ATTACHMENT0+Ne;ge.length=_e.length,se=!0}}else ge[0]!==t.COLOR_ATTACHMENT0&&(ge[0]=t.COLOR_ATTACHMENT0,se=!0);else ge[0]!==t.BACK&&(ge[0]=t.BACK,se=!0);se&&(n.isWebGL2?t.drawBuffers(ge):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(ge))}function w(U){return m!==U?(t.useProgram(U),m=U,!0):!1}const P={[Fi]:t.FUNC_ADD,[uv]:t.FUNC_SUBTRACT,[fv]:t.FUNC_REVERSE_SUBTRACT};if(i)P[uu]=t.MIN,P[fu]=t.MAX;else{const U=e.get("EXT_blend_minmax");U!==null&&(P[uu]=U.MIN_EXT,P[fu]=U.MAX_EXT)}const B={[hv]:t.ZERO,[dv]:t.ONE,[pv]:t.SRC_COLOR,[il]:t.SRC_ALPHA,[Sv]:t.SRC_ALPHA_SATURATE,[vv]:t.DST_COLOR,[gv]:t.DST_ALPHA,[mv]:t.ONE_MINUS_SRC_COLOR,[rl]:t.ONE_MINUS_SRC_ALPHA,[xv]:t.ONE_MINUS_DST_COLOR,[_v]:t.ONE_MINUS_DST_ALPHA,[Mv]:t.CONSTANT_COLOR,[Ev]:t.ONE_MINUS_CONSTANT_COLOR,[yv]:t.CONSTANT_ALPHA,[Tv]:t.ONE_MINUS_CONSTANT_ALPHA};function k(U,Te,ge,se,_e,Ne,Ke,mt,an,rt){if(U===_i){d===!0&&(fe(t.BLEND),d=!1);return}if(d===!1&&(Y(t.BLEND),d=!0),U!==cv){if(U!==T||rt!==q){if((M!==Fi||L!==Fi)&&(t.blendEquation(t.FUNC_ADD),M=Fi,L=Fi),rt)switch(U){case Mr:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case au:t.blendFunc(t.ONE,t.ONE);break;case lu:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case cu:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Mr:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case au:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case lu:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case cu:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}y=null,R=null,C=null,G=null,S.set(0,0,0),A=0,T=U,q=rt}return}_e=_e||Te,Ne=Ne||ge,Ke=Ke||se,(Te!==M||_e!==L)&&(t.blendEquationSeparate(P[Te],P[_e]),M=Te,L=_e),(ge!==y||se!==R||Ne!==C||Ke!==G)&&(t.blendFuncSeparate(B[ge],B[se],B[Ne],B[Ke]),y=ge,R=se,C=Ne,G=Ke),(mt.equals(S)===!1||an!==A)&&(t.blendColor(mt.r,mt.g,mt.b,an),S.copy(mt),A=an),T=U,q=!1}function X(U,Te){U.side===Dn?fe(t.CULL_FACE):Y(t.CULL_FACE);let ge=U.side===Yt;Te&&(ge=!ge),ae(ge),U.blending===Mr&&U.transparent===!1?k(_i):k(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),l.setFunc(U.depthFunc),l.setTest(U.depthTest),l.setMask(U.depthWrite),o.setMask(U.colorWrite);const se=U.stencilWrite;c.setTest(se),se&&(c.setMask(U.stencilWriteMask),c.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),c.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),te(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Y(t.SAMPLE_ALPHA_TO_COVERAGE):fe(t.SAMPLE_ALPHA_TO_COVERAGE)}function ae(U){F!==U&&(U?t.frontFace(t.CW):t.frontFace(t.CCW),F=U)}function re(U){U!==ov?(Y(t.CULL_FACE),U!==ee&&(U===ou?t.cullFace(t.BACK):U===av?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):fe(t.CULL_FACE),ee=U}function le(U){U!==D&&(oe&&t.lineWidth(U),D=U)}function te(U,Te,ge){U?(Y(t.POLYGON_OFFSET_FILL),(K!==Te||J!==ge)&&(t.polygonOffset(Te,ge),K=Te,J=ge)):fe(t.POLYGON_OFFSET_FILL)}function be(U){U?Y(t.SCISSOR_TEST):fe(t.SCISSOR_TEST)}function E(U){U===void 0&&(U=t.TEXTURE0+z-1),O!==U&&(t.activeTexture(U),O=U)}function x(U,Te,ge){ge===void 0&&(O===null?ge=t.TEXTURE0+z-1:ge=O);let se=$[ge];se===void 0&&(se={type:void 0,texture:void 0},$[ge]=se),(se.type!==U||se.texture!==Te)&&(O!==ge&&(t.activeTexture(ge),O=ge),t.bindTexture(U,Te||V[U]),se.type=U,se.texture=Te)}function I(){const U=$[O];U!==void 0&&U.type!==void 0&&(t.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function ne(){try{t.compressedTexImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ie(){try{t.compressedTexImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ce(){try{t.texSubImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ye(){try{t.texSubImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function de(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ve(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ce(){try{t.texStorage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Xe(){try{t.texStorage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function pe(){try{t.texImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function He(){try{t.texImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Le(U){Ee.equals(U)===!1&&(t.scissor(U.x,U.y,U.z,U.w),Ee.copy(U))}function Ie(U){we.equals(U)===!1&&(t.viewport(U.x,U.y,U.z,U.w),we.copy(U))}function De(U,Te){let ge=f.get(Te);ge===void 0&&(ge=new WeakMap,f.set(Te,ge));let se=ge.get(U);se===void 0&&(se=t.getUniformBlockIndex(Te,U.name),ge.set(U,se))}function Re(U,Te){const se=f.get(Te).get(U);u.get(Te)!==se&&(t.uniformBlockBinding(Te,se,U.__bindingPointIndex),u.set(Te,se))}function Ye(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),i===!0&&(t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null)),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),h={},O=null,$={},p={},v=new WeakMap,_=[],m=null,d=!1,T=null,M=null,y=null,R=null,L=null,C=null,G=null,S=new Ze(0,0,0),A=0,q=!1,F=null,ee=null,D=null,K=null,J=null,Ee.set(0,0,t.canvas.width,t.canvas.height),we.set(0,0,t.canvas.width,t.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Y,disable:fe,bindFramebuffer:me,drawBuffers:g,useProgram:w,setBlending:k,setMaterial:X,setFlipSided:ae,setCullFace:re,setLineWidth:le,setPolygonOffset:te,setScissorTest:be,activeTexture:E,bindTexture:x,unbindTexture:I,compressedTexImage2D:ne,compressedTexImage3D:ie,texImage2D:pe,texImage3D:He,updateUBOMapping:De,uniformBlockBinding:Re,texStorage2D:Ce,texStorage3D:Xe,texSubImage2D:ce,texSubImage3D:ye,compressedTexSubImage2D:de,compressedTexSubImage3D:ve,scissor:Le,viewport:Ie,reset:Ye}}function gy(t,e,n,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),v=new WeakMap;let _;const m=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(E,x){return d?new OffscreenCanvas(E,x):_o("canvas")}function M(E,x,I,ne){let ie=1;if((E.width>ne||E.height>ne)&&(ie=ne/Math.max(E.width,E.height)),ie<1||x===!0)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap){const ce=x?go:Math.floor,ye=ce(ie*E.width),de=ce(ie*E.height);_===void 0&&(_=T(ye,de));const ve=I?T(ye,de):_;return ve.width=ye,ve.height=de,ve.getContext("2d").drawImage(E,0,0,ye,de),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+ye+"x"+de+")."),ve}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function y(E){return ul(E.width)&&ul(E.height)}function R(E){return o?!1:E.wrapS!==vn||E.wrapT!==vn||E.minFilter!==zt&&E.minFilter!==un}function L(E,x){return E.generateMipmaps&&x&&E.minFilter!==zt&&E.minFilter!==un}function C(E){t.generateMipmap(E)}function G(E,x,I,ne,ie=!1){if(o===!1)return x;if(E!==null){if(t[E]!==void 0)return t[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ce=x;if(x===t.RED&&(I===t.FLOAT&&(ce=t.R32F),I===t.HALF_FLOAT&&(ce=t.R16F),I===t.UNSIGNED_BYTE&&(ce=t.R8)),x===t.RED_INTEGER&&(I===t.UNSIGNED_BYTE&&(ce=t.R8UI),I===t.UNSIGNED_SHORT&&(ce=t.R16UI),I===t.UNSIGNED_INT&&(ce=t.R32UI),I===t.BYTE&&(ce=t.R8I),I===t.SHORT&&(ce=t.R16I),I===t.INT&&(ce=t.R32I)),x===t.RG&&(I===t.FLOAT&&(ce=t.RG32F),I===t.HALF_FLOAT&&(ce=t.RG16F),I===t.UNSIGNED_BYTE&&(ce=t.RG8)),x===t.RGBA){const ye=ie?fo:nt.getTransfer(ne);I===t.FLOAT&&(ce=t.RGBA32F),I===t.HALF_FLOAT&&(ce=t.RGBA16F),I===t.UNSIGNED_BYTE&&(ce=ye===ot?t.SRGB8_ALPHA8:t.RGBA8),I===t.UNSIGNED_SHORT_4_4_4_4&&(ce=t.RGBA4),I===t.UNSIGNED_SHORT_5_5_5_1&&(ce=t.RGB5_A1)}return(ce===t.R16F||ce===t.R32F||ce===t.RG16F||ce===t.RG32F||ce===t.RGBA16F||ce===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ce}function S(E,x,I){return L(E,I)===!0||E.isFramebufferTexture&&E.minFilter!==zt&&E.minFilter!==un?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function A(E){return E===zt||E===hu||E===ca?t.NEAREST:t.LINEAR}function q(E){const x=E.target;x.removeEventListener("dispose",q),ee(x),x.isVideoTexture&&v.delete(x)}function F(E){const x=E.target;x.removeEventListener("dispose",F),K(x)}function ee(E){const x=i.get(E);if(x.__webglInit===void 0)return;const I=E.source,ne=m.get(I);if(ne){const ie=ne[x.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&D(E),Object.keys(ne).length===0&&m.delete(I)}i.remove(E)}function D(E){const x=i.get(E);t.deleteTexture(x.__webglTexture);const I=E.source,ne=m.get(I);delete ne[x.__cacheKey],a.memory.textures--}function K(E){const x=E.texture,I=i.get(E),ne=i.get(x);if(ne.__webglTexture!==void 0&&(t.deleteTexture(ne.__webglTexture),a.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let ie=0;ie<6;ie++){if(Array.isArray(I.__webglFramebuffer[ie]))for(let ce=0;ce<I.__webglFramebuffer[ie].length;ce++)t.deleteFramebuffer(I.__webglFramebuffer[ie][ce]);else t.deleteFramebuffer(I.__webglFramebuffer[ie]);I.__webglDepthbuffer&&t.deleteRenderbuffer(I.__webglDepthbuffer[ie])}else{if(Array.isArray(I.__webglFramebuffer))for(let ie=0;ie<I.__webglFramebuffer.length;ie++)t.deleteFramebuffer(I.__webglFramebuffer[ie]);else t.deleteFramebuffer(I.__webglFramebuffer);if(I.__webglDepthbuffer&&t.deleteRenderbuffer(I.__webglDepthbuffer),I.__webglMultisampledFramebuffer&&t.deleteFramebuffer(I.__webglMultisampledFramebuffer),I.__webglColorRenderbuffer)for(let ie=0;ie<I.__webglColorRenderbuffer.length;ie++)I.__webglColorRenderbuffer[ie]&&t.deleteRenderbuffer(I.__webglColorRenderbuffer[ie]);I.__webglDepthRenderbuffer&&t.deleteRenderbuffer(I.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let ie=0,ce=x.length;ie<ce;ie++){const ye=i.get(x[ie]);ye.__webglTexture&&(t.deleteTexture(ye.__webglTexture),a.memory.textures--),i.remove(x[ie])}i.remove(x),i.remove(E)}let J=0;function z(){J=0}function oe(){const E=J;return E>=l&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+l),J+=1,E}function he(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function ue(E,x){const I=i.get(E);if(E.isVideoTexture&&te(E),E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){const ne=E.image;if(ne===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ne.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(I,E,x);return}}n.bindTexture(t.TEXTURE_2D,I.__webglTexture,t.TEXTURE0+x)}function O(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){Y(I,E,x);return}n.bindTexture(t.TEXTURE_2D_ARRAY,I.__webglTexture,t.TEXTURE0+x)}function $(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){Y(I,E,x);return}n.bindTexture(t.TEXTURE_3D,I.__webglTexture,t.TEXTURE0+x)}function xe(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){fe(I,E,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+x)}const Me={[al]:t.REPEAT,[vn]:t.CLAMP_TO_EDGE,[ll]:t.MIRRORED_REPEAT},Ee={[zt]:t.NEAREST,[hu]:t.NEAREST_MIPMAP_NEAREST,[ca]:t.NEAREST_MIPMAP_LINEAR,[un]:t.LINEAR,[Hv]:t.LINEAR_MIPMAP_NEAREST,[us]:t.LINEAR_MIPMAP_LINEAR},we={[Jv]:t.NEVER,[s0]:t.ALWAYS,[Qv]:t.LESS,[t0]:t.LEQUAL,[e0]:t.EQUAL,[r0]:t.GEQUAL,[n0]:t.GREATER,[i0]:t.NOTEQUAL};function N(E,x,I){if(I?(t.texParameteri(E,t.TEXTURE_WRAP_S,Me[x.wrapS]),t.texParameteri(E,t.TEXTURE_WRAP_T,Me[x.wrapT]),(E===t.TEXTURE_3D||E===t.TEXTURE_2D_ARRAY)&&t.texParameteri(E,t.TEXTURE_WRAP_R,Me[x.wrapR]),t.texParameteri(E,t.TEXTURE_MAG_FILTER,Ee[x.magFilter]),t.texParameteri(E,t.TEXTURE_MIN_FILTER,Ee[x.minFilter])):(t.texParameteri(E,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(E,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),(E===t.TEXTURE_3D||E===t.TEXTURE_2D_ARRAY)&&t.texParameteri(E,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),(x.wrapS!==vn||x.wrapT!==vn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),t.texParameteri(E,t.TEXTURE_MAG_FILTER,A(x.magFilter)),t.texParameteri(E,t.TEXTURE_MIN_FILTER,A(x.minFilter)),x.minFilter!==zt&&x.minFilter!==un&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),x.compareFunction&&(t.texParameteri(E,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(E,t.TEXTURE_COMPARE_FUNC,we[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ne=e.get("EXT_texture_filter_anisotropic");if(x.magFilter===zt||x.minFilter!==ca&&x.minFilter!==us||x.type===gi&&e.has("OES_texture_float_linear")===!1||o===!1&&x.type===fs&&e.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||i.get(x).__currentAnisotropy)&&(t.texParameterf(E,ne.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy)}}function V(E,x){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",q));const ne=x.source;let ie=m.get(ne);ie===void 0&&(ie={},m.set(ne,ie));const ce=he(x);if(ce!==E.__cacheKey){ie[ce]===void 0&&(ie[ce]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,I=!0),ie[ce].usedTimes++;const ye=ie[E.__cacheKey];ye!==void 0&&(ie[E.__cacheKey].usedTimes--,ye.usedTimes===0&&D(x)),E.__cacheKey=ce,E.__webglTexture=ie[ce].texture}return I}function Y(E,x,I){let ne=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(ne=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(ne=t.TEXTURE_3D);const ie=V(E,x),ce=x.source;n.bindTexture(ne,E.__webglTexture,t.TEXTURE0+I);const ye=i.get(ce);if(ce.version!==ye.__version||ie===!0){n.activeTexture(t.TEXTURE0+I);const de=nt.getPrimaries(nt.workingColorSpace),ve=x.colorSpace===hn?null:nt.getPrimaries(x.colorSpace),Ce=x.colorSpace===hn||de===ve?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);const Xe=R(x)&&y(x.image)===!1;let pe=M(x.image,Xe,!1,u);pe=be(x,pe);const He=y(pe)||o,Le=s.convert(x.format,x.colorSpace);let Ie=s.convert(x.type),De=G(x.internalFormat,Le,Ie,x.colorSpace,x.isVideoTexture);N(ne,x,He);let Re;const Ye=x.mipmaps,U=o&&x.isVideoTexture!==!0,Te=ye.__version===void 0||ie===!0,ge=S(x,pe,He);if(x.isDepthTexture)De=t.DEPTH_COMPONENT,o?x.type===gi?De=t.DEPTH_COMPONENT32F:x.type===mi?De=t.DEPTH_COMPONENT24:x.type===Vi?De=t.DEPTH24_STENCIL8:De=t.DEPTH_COMPONENT16:x.type===gi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===ki&&De===t.DEPTH_COMPONENT&&x.type!==Hl&&x.type!==mi&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=mi,Ie=s.convert(x.type)),x.format===wr&&De===t.DEPTH_COMPONENT&&(De=t.DEPTH_STENCIL,x.type!==Vi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=Vi,Ie=s.convert(x.type))),Te&&(U?n.texStorage2D(t.TEXTURE_2D,1,De,pe.width,pe.height):n.texImage2D(t.TEXTURE_2D,0,De,pe.width,pe.height,0,Le,Ie,null));else if(x.isDataTexture)if(Ye.length>0&&He){U&&Te&&n.texStorage2D(t.TEXTURE_2D,ge,De,Ye[0].width,Ye[0].height);for(let se=0,_e=Ye.length;se<_e;se++)Re=Ye[se],U?n.texSubImage2D(t.TEXTURE_2D,se,0,0,Re.width,Re.height,Le,Ie,Re.data):n.texImage2D(t.TEXTURE_2D,se,De,Re.width,Re.height,0,Le,Ie,Re.data);x.generateMipmaps=!1}else U?(Te&&n.texStorage2D(t.TEXTURE_2D,ge,De,pe.width,pe.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,pe.width,pe.height,Le,Ie,pe.data)):n.texImage2D(t.TEXTURE_2D,0,De,pe.width,pe.height,0,Le,Ie,pe.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){U&&Te&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ge,De,Ye[0].width,Ye[0].height,pe.depth);for(let se=0,_e=Ye.length;se<_e;se++)Re=Ye[se],x.format!==xn?Le!==null?U?n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,se,0,0,0,Re.width,Re.height,pe.depth,Le,Re.data,0,0):n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,se,De,Re.width,Re.height,pe.depth,0,Re.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?n.texSubImage3D(t.TEXTURE_2D_ARRAY,se,0,0,0,Re.width,Re.height,pe.depth,Le,Ie,Re.data):n.texImage3D(t.TEXTURE_2D_ARRAY,se,De,Re.width,Re.height,pe.depth,0,Le,Ie,Re.data)}else{U&&Te&&n.texStorage2D(t.TEXTURE_2D,ge,De,Ye[0].width,Ye[0].height);for(let se=0,_e=Ye.length;se<_e;se++)Re=Ye[se],x.format!==xn?Le!==null?U?n.compressedTexSubImage2D(t.TEXTURE_2D,se,0,0,Re.width,Re.height,Le,Re.data):n.compressedTexImage2D(t.TEXTURE_2D,se,De,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?n.texSubImage2D(t.TEXTURE_2D,se,0,0,Re.width,Re.height,Le,Ie,Re.data):n.texImage2D(t.TEXTURE_2D,se,De,Re.width,Re.height,0,Le,Ie,Re.data)}else if(x.isDataArrayTexture)U?(Te&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ge,De,pe.width,pe.height,pe.depth),n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,pe.width,pe.height,pe.depth,Le,Ie,pe.data)):n.texImage3D(t.TEXTURE_2D_ARRAY,0,De,pe.width,pe.height,pe.depth,0,Le,Ie,pe.data);else if(x.isData3DTexture)U?(Te&&n.texStorage3D(t.TEXTURE_3D,ge,De,pe.width,pe.height,pe.depth),n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,pe.width,pe.height,pe.depth,Le,Ie,pe.data)):n.texImage3D(t.TEXTURE_3D,0,De,pe.width,pe.height,pe.depth,0,Le,Ie,pe.data);else if(x.isFramebufferTexture){if(Te)if(U)n.texStorage2D(t.TEXTURE_2D,ge,De,pe.width,pe.height);else{let se=pe.width,_e=pe.height;for(let Ne=0;Ne<ge;Ne++)n.texImage2D(t.TEXTURE_2D,Ne,De,se,_e,0,Le,Ie,null),se>>=1,_e>>=1}}else if(Ye.length>0&&He){U&&Te&&n.texStorage2D(t.TEXTURE_2D,ge,De,Ye[0].width,Ye[0].height);for(let se=0,_e=Ye.length;se<_e;se++)Re=Ye[se],U?n.texSubImage2D(t.TEXTURE_2D,se,0,0,Le,Ie,Re):n.texImage2D(t.TEXTURE_2D,se,De,Le,Ie,Re);x.generateMipmaps=!1}else U?(Te&&n.texStorage2D(t.TEXTURE_2D,ge,De,pe.width,pe.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,Le,Ie,pe)):n.texImage2D(t.TEXTURE_2D,0,De,Le,Ie,pe);L(x,He)&&C(ne),ye.__version=ce.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function fe(E,x,I){if(x.image.length!==6)return;const ne=V(E,x),ie=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,E.__webglTexture,t.TEXTURE0+I);const ce=i.get(ie);if(ie.version!==ce.__version||ne===!0){n.activeTexture(t.TEXTURE0+I);const ye=nt.getPrimaries(nt.workingColorSpace),de=x.colorSpace===hn?null:nt.getPrimaries(x.colorSpace),ve=x.colorSpace===hn||ye===de?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Ce=x.isCompressedTexture||x.image[0].isCompressedTexture,Xe=x.image[0]&&x.image[0].isDataTexture,pe=[];for(let se=0;se<6;se++)!Ce&&!Xe?pe[se]=M(x.image[se],!1,!0,c):pe[se]=Xe?x.image[se].image:x.image[se],pe[se]=be(x,pe[se]);const He=pe[0],Le=y(He)||o,Ie=s.convert(x.format,x.colorSpace),De=s.convert(x.type),Re=G(x.internalFormat,Ie,De,x.colorSpace),Ye=o&&x.isVideoTexture!==!0,U=ce.__version===void 0||ne===!0;let Te=S(x,He,Le);N(t.TEXTURE_CUBE_MAP,x,Le);let ge;if(Ce){Ye&&U&&n.texStorage2D(t.TEXTURE_CUBE_MAP,Te,Re,He.width,He.height);for(let se=0;se<6;se++){ge=pe[se].mipmaps;for(let _e=0;_e<ge.length;_e++){const Ne=ge[_e];x.format!==xn?Ie!==null?Ye?n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,0,0,Ne.width,Ne.height,Ie,Ne.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,Re,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ye?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,0,0,Ne.width,Ne.height,Ie,De,Ne.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,Re,Ne.width,Ne.height,0,Ie,De,Ne.data)}}}else{ge=x.mipmaps,Ye&&U&&(ge.length>0&&Te++,n.texStorage2D(t.TEXTURE_CUBE_MAP,Te,Re,pe[0].width,pe[0].height));for(let se=0;se<6;se++)if(Xe){Ye?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,pe[se].width,pe[se].height,Ie,De,pe[se].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Re,pe[se].width,pe[se].height,0,Ie,De,pe[se].data);for(let _e=0;_e<ge.length;_e++){const Ke=ge[_e].image[se].image;Ye?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,0,0,Ke.width,Ke.height,Ie,De,Ke.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,Re,Ke.width,Ke.height,0,Ie,De,Ke.data)}}else{Ye?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Ie,De,pe[se]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Re,Ie,De,pe[se]);for(let _e=0;_e<ge.length;_e++){const Ne=ge[_e];Ye?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,0,0,Ie,De,Ne.image[se]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,Re,Ie,De,Ne.image[se])}}}L(x,Le)&&C(t.TEXTURE_CUBE_MAP),ce.__version=ie.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function me(E,x,I,ne,ie,ce){const ye=s.convert(I.format,I.colorSpace),de=s.convert(I.type),ve=G(I.internalFormat,ye,de,I.colorSpace);if(!i.get(x).__hasExternalTextures){const Xe=Math.max(1,x.width>>ce),pe=Math.max(1,x.height>>ce);ie===t.TEXTURE_3D||ie===t.TEXTURE_2D_ARRAY?n.texImage3D(ie,ce,ve,Xe,pe,x.depth,0,ye,de,null):n.texImage2D(ie,ce,ve,Xe,pe,0,ye,de,null)}n.bindFramebuffer(t.FRAMEBUFFER,E),le(x)?h.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ne,ie,i.get(I).__webglTexture,0,re(x)):(ie===t.TEXTURE_2D||ie>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ne,ie,i.get(I).__webglTexture,ce),n.bindFramebuffer(t.FRAMEBUFFER,null)}function g(E,x,I){if(t.bindRenderbuffer(t.RENDERBUFFER,E),x.depthBuffer&&!x.stencilBuffer){let ne=o===!0?t.DEPTH_COMPONENT24:t.DEPTH_COMPONENT16;if(I||le(x)){const ie=x.depthTexture;ie&&ie.isDepthTexture&&(ie.type===gi?ne=t.DEPTH_COMPONENT32F:ie.type===mi&&(ne=t.DEPTH_COMPONENT24));const ce=re(x);le(x)?h.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ce,ne,x.width,x.height):t.renderbufferStorageMultisample(t.RENDERBUFFER,ce,ne,x.width,x.height)}else t.renderbufferStorage(t.RENDERBUFFER,ne,x.width,x.height);t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.RENDERBUFFER,E)}else if(x.depthBuffer&&x.stencilBuffer){const ne=re(x);I&&le(x)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ne,t.DEPTH24_STENCIL8,x.width,x.height):le(x)?h.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ne,t.DEPTH24_STENCIL8,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,t.DEPTH_STENCIL,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.RENDERBUFFER,E)}else{const ne=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let ie=0;ie<ne.length;ie++){const ce=ne[ie],ye=s.convert(ce.format,ce.colorSpace),de=s.convert(ce.type),ve=G(ce.internalFormat,ye,de,ce.colorSpace),Ce=re(x);I&&le(x)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ce,ve,x.width,x.height):le(x)?h.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ce,ve,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,ve,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function w(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),ue(x.depthTexture,0);const ne=i.get(x.depthTexture).__webglTexture,ie=re(x);if(x.depthTexture.format===ki)le(x)?h.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ne,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ne,0);else if(x.depthTexture.format===wr)le(x)?h.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ne,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function P(E){const x=i.get(E),I=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");w(x.__webglFramebuffer,E)}else if(I){x.__webglDepthbuffer=[];for(let ne=0;ne<6;ne++)n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[ne]),x.__webglDepthbuffer[ne]=t.createRenderbuffer(),g(x.__webglDepthbuffer[ne],E,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=t.createRenderbuffer(),g(x.__webglDepthbuffer,E,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function B(E,x,I){const ne=i.get(E);x!==void 0&&me(ne.__webglFramebuffer,E,E.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),I!==void 0&&P(E)}function k(E){const x=E.texture,I=i.get(E),ne=i.get(x);E.addEventListener("dispose",F),E.isWebGLMultipleRenderTargets!==!0&&(ne.__webglTexture===void 0&&(ne.__webglTexture=t.createTexture()),ne.__version=x.version,a.memory.textures++);const ie=E.isWebGLCubeRenderTarget===!0,ce=E.isWebGLMultipleRenderTargets===!0,ye=y(E)||o;if(ie){I.__webglFramebuffer=[];for(let de=0;de<6;de++)if(o&&x.mipmaps&&x.mipmaps.length>0){I.__webglFramebuffer[de]=[];for(let ve=0;ve<x.mipmaps.length;ve++)I.__webglFramebuffer[de][ve]=t.createFramebuffer()}else I.__webglFramebuffer[de]=t.createFramebuffer()}else{if(o&&x.mipmaps&&x.mipmaps.length>0){I.__webglFramebuffer=[];for(let de=0;de<x.mipmaps.length;de++)I.__webglFramebuffer[de]=t.createFramebuffer()}else I.__webglFramebuffer=t.createFramebuffer();if(ce)if(r.drawBuffers){const de=E.texture;for(let ve=0,Ce=de.length;ve<Ce;ve++){const Xe=i.get(de[ve]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=t.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&E.samples>0&&le(E)===!1){const de=ce?x:[x];I.__webglMultisampledFramebuffer=t.createFramebuffer(),I.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ve=0;ve<de.length;ve++){const Ce=de[ve];I.__webglColorRenderbuffer[ve]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,I.__webglColorRenderbuffer[ve]);const Xe=s.convert(Ce.format,Ce.colorSpace),pe=s.convert(Ce.type),He=G(Ce.internalFormat,Xe,pe,Ce.colorSpace,E.isXRRenderTarget===!0),Le=re(E);t.renderbufferStorageMultisample(t.RENDERBUFFER,Le,He,E.width,E.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.RENDERBUFFER,I.__webglColorRenderbuffer[ve])}t.bindRenderbuffer(t.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=t.createRenderbuffer(),g(I.__webglDepthRenderbuffer,E,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,ne.__webglTexture),N(t.TEXTURE_CUBE_MAP,x,ye);for(let de=0;de<6;de++)if(o&&x.mipmaps&&x.mipmaps.length>0)for(let ve=0;ve<x.mipmaps.length;ve++)me(I.__webglFramebuffer[de][ve],E,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve);else me(I.__webglFramebuffer[de],E,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);L(x,ye)&&C(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ce){const de=E.texture;for(let ve=0,Ce=de.length;ve<Ce;ve++){const Xe=de[ve],pe=i.get(Xe);n.bindTexture(t.TEXTURE_2D,pe.__webglTexture),N(t.TEXTURE_2D,Xe,ye),me(I.__webglFramebuffer,E,Xe,t.COLOR_ATTACHMENT0+ve,t.TEXTURE_2D,0),L(Xe,ye)&&C(t.TEXTURE_2D)}n.unbindTexture()}else{let de=t.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(o?de=E.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),n.bindTexture(de,ne.__webglTexture),N(de,x,ye),o&&x.mipmaps&&x.mipmaps.length>0)for(let ve=0;ve<x.mipmaps.length;ve++)me(I.__webglFramebuffer[ve],E,x,t.COLOR_ATTACHMENT0,de,ve);else me(I.__webglFramebuffer,E,x,t.COLOR_ATTACHMENT0,de,0);L(x,ye)&&C(de),n.unbindTexture()}E.depthBuffer&&P(E)}function X(E){const x=y(E)||o,I=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let ne=0,ie=I.length;ne<ie;ne++){const ce=I[ne];if(L(ce,x)){const ye=E.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,de=i.get(ce).__webglTexture;n.bindTexture(ye,de),C(ye),n.unbindTexture()}}}function ae(E){if(o&&E.samples>0&&le(E)===!1){const x=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],I=E.width,ne=E.height;let ie=t.COLOR_BUFFER_BIT;const ce=[],ye=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,de=i.get(E),ve=E.isWebGLMultipleRenderTargets===!0;if(ve)for(let Ce=0;Ce<x.length;Ce++)n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let Ce=0;Ce<x.length;Ce++){ce.push(t.COLOR_ATTACHMENT0+Ce),E.depthBuffer&&ce.push(ye);const Xe=de.__ignoreDepthValues!==void 0?de.__ignoreDepthValues:!1;if(Xe===!1&&(E.depthBuffer&&(ie|=t.DEPTH_BUFFER_BIT),E.stencilBuffer&&(ie|=t.STENCIL_BUFFER_BIT)),ve&&t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,de.__webglColorRenderbuffer[Ce]),Xe===!0&&(t.invalidateFramebuffer(t.READ_FRAMEBUFFER,[ye]),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[ye])),ve){const pe=i.get(x[Ce]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,pe,0)}t.blitFramebuffer(0,0,I,ne,0,0,I,ne,ie,t.NEAREST),p&&t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ce)}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ve)for(let Ce=0;Ce<x.length;Ce++){n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.RENDERBUFFER,de.__webglColorRenderbuffer[Ce]);const Xe=i.get(x[Ce]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.TEXTURE_2D,Xe,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}}function re(E){return Math.min(f,E.samples)}function le(E){const x=i.get(E);return o&&E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function te(E){const x=a.render.frame;v.get(E)!==x&&(v.set(E,x),E.update())}function be(E,x){const I=E.colorSpace,ne=E.format,ie=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||E.format===cl||I!==ni&&I!==hn&&(nt.getTransfer(I)===ot?o===!1?e.has("EXT_sRGB")===!0&&ne===xn?(E.format=cl,E.minFilter=un,E.generateMipmaps=!1):x=Ed.sRGBToLinear(x):(ne!==xn||ie!==xi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),x}this.allocateTextureUnit=oe,this.resetTextureUnits=z,this.setTexture2D=ue,this.setTexture2DArray=O,this.setTexture3D=$,this.setTextureCube=xe,this.rebindTextures=B,this.setupRenderTarget=k,this.updateRenderTargetMipmap=X,this.updateMultisampleRenderTarget=ae,this.setupDepthRenderbuffer=P,this.setupFrameBufferTexture=me,this.useMultisampledRTT=le}function _y(t,e,n){const i=n.isWebGL2;function r(s,a=hn){let o;const l=nt.getTransfer(a);if(s===xi)return t.UNSIGNED_BYTE;if(s===pd)return t.UNSIGNED_SHORT_4_4_4_4;if(s===md)return t.UNSIGNED_SHORT_5_5_5_1;if(s===zv)return t.BYTE;if(s===Gv)return t.SHORT;if(s===Hl)return t.UNSIGNED_SHORT;if(s===dd)return t.INT;if(s===mi)return t.UNSIGNED_INT;if(s===gi)return t.FLOAT;if(s===fs)return i?t.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===Vv)return t.ALPHA;if(s===xn)return t.RGBA;if(s===kv)return t.LUMINANCE;if(s===Wv)return t.LUMINANCE_ALPHA;if(s===ki)return t.DEPTH_COMPONENT;if(s===wr)return t.DEPTH_STENCIL;if(s===cl)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===Xv)return t.RED;if(s===gd)return t.RED_INTEGER;if(s===qv)return t.RG;if(s===_d)return t.RG_INTEGER;if(s===vd)return t.RGBA_INTEGER;if(s===ua||s===fa||s===ha||s===da)if(l===ot)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===ua)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===fa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===ha)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===da)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===ua)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===fa)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===ha)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===da)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===du||s===pu||s===mu||s===gu)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===du)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===pu)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===mu)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===gu)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===$v)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===_u||s===vu)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===_u)return l===ot?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===vu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===xu||s===Su||s===Mu||s===Eu||s===yu||s===Tu||s===bu||s===Au||s===Ru||s===wu||s===Cu||s===Pu||s===Lu||s===Du)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===xu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Su)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Mu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Eu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===yu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Tu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===bu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Au)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ru)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===wu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Cu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Pu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Lu)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Du)return l===ot?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===pa||s===Uu||s===Iu)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===pa)return l===ot?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Uu)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Iu)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Yv||s===Nu||s===Ou||s===Fu)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===pa)return o.COMPRESSED_RED_RGTC1_EXT;if(s===Nu)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ou)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Fu)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Vi?i?t.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):t[s]!==void 0?t[s]:null}return{convert:r}}class vy extends fn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ys extends Dt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const xy={type:"move"};class Ba{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ys,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ys,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new W,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new W),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ys,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new W,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new W),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const _ of e.hand.values()){const m=n.getJointPose(_,i),d=this._getHandJoint(c,_);m!==null&&(d.matrix.fromArray(m.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=m.radius),d.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),p=.02,v=.005;c.inputState.pinching&&h>p+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=p-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(xy)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Ys;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}class Sy extends sn{constructor(e,n,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:ki,u!==ki&&u!==wr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===ki&&(i=mi),i===void 0&&u===wr&&(i=Vi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:n},this.magFilter=o!==void 0?o:zt,this.minFilter=l!==void 0?l:zt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const n=super.toJSON(e);return this.compareFunction!==null&&(n.compareFunction=this.compareFunction),n}}class My extends Pr{constructor(e,n){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,p=null,v=null;const _=n.getContextAttributes();let m=null,d=null;const T=[],M=[],y=new fn;y.layers.enable(1),y.viewport=new bt;const R=new fn;R.layers.enable(2),R.viewport=new bt;const L=[y,R],C=new vy;C.layers.enable(1),C.layers.enable(2);let G=null,S=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(O){let $=T[O];return $===void 0&&($=new Ba,T[O]=$),$.getTargetRaySpace()},this.getControllerGrip=function(O){let $=T[O];return $===void 0&&($=new Ba,T[O]=$),$.getGripSpace()},this.getHand=function(O){let $=T[O];return $===void 0&&($=new Ba,T[O]=$),$.getHandSpace()};function A(O){const $=M.indexOf(O.inputSource);if($===-1)return;const xe=T[$];xe!==void 0&&(xe.update(O.inputSource,O.frame,c||a),xe.dispatchEvent({type:O.type,data:O.inputSource}))}function q(){r.removeEventListener("select",A),r.removeEventListener("selectstart",A),r.removeEventListener("selectend",A),r.removeEventListener("squeeze",A),r.removeEventListener("squeezestart",A),r.removeEventListener("squeezeend",A),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",F);for(let O=0;O<T.length;O++){const $=M[O];$!==null&&(M[O]=null,T[O].disconnect($))}G=null,S=null,e.setRenderTarget(m),p=null,h=null,f=null,r=null,d=null,ue.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(O){s=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(O){o=O,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(O){c=O},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(O){if(r=O,r!==null){if(m=e.getRenderTarget(),r.addEventListener("select",A),r.addEventListener("selectstart",A),r.addEventListener("selectend",A),r.addEventListener("squeeze",A),r.addEventListener("squeezestart",A),r.addEventListener("squeezeend",A),r.addEventListener("end",q),r.addEventListener("inputsourceschange",F),_.xrCompatible!==!0&&await n.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const $={antialias:r.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,$),r.updateRenderState({baseLayer:p}),d=new Xi(p.framebufferWidth,p.framebufferHeight,{format:xn,type:xi,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let $=null,xe=null,Me=null;_.depth&&(Me=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,$=_.stencil?wr:ki,xe=_.stencil?Vi:mi);const Ee={colorFormat:n.RGBA8,depthFormat:Me,scaleFactor:s};f=new XRWebGLBinding(r,n),h=f.createProjectionLayer(Ee),r.updateRenderState({layers:[h]}),d=new Xi(h.textureWidth,h.textureHeight,{format:xn,type:xi,depthTexture:new Sy(h.textureWidth,h.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,$),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0});const we=e.properties.get(d);we.__ignoreDepthValues=h.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function F(O){for(let $=0;$<O.removed.length;$++){const xe=O.removed[$],Me=M.indexOf(xe);Me>=0&&(M[Me]=null,T[Me].disconnect(xe))}for(let $=0;$<O.added.length;$++){const xe=O.added[$];let Me=M.indexOf(xe);if(Me===-1){for(let we=0;we<T.length;we++)if(we>=M.length){M.push(xe),Me=we;break}else if(M[we]===null){M[we]=xe,Me=we;break}if(Me===-1)break}const Ee=T[Me];Ee&&Ee.connect(xe)}}const ee=new W,D=new W;function K(O,$,xe){ee.setFromMatrixPosition($.matrixWorld),D.setFromMatrixPosition(xe.matrixWorld);const Me=ee.distanceTo(D),Ee=$.projectionMatrix.elements,we=xe.projectionMatrix.elements,N=Ee[14]/(Ee[10]-1),V=Ee[14]/(Ee[10]+1),Y=(Ee[9]+1)/Ee[5],fe=(Ee[9]-1)/Ee[5],me=(Ee[8]-1)/Ee[0],g=(we[8]+1)/we[0],w=N*me,P=N*g,B=Me/(-me+g),k=B*-me;$.matrixWorld.decompose(O.position,O.quaternion,O.scale),O.translateX(k),O.translateZ(B),O.matrixWorld.compose(O.position,O.quaternion,O.scale),O.matrixWorldInverse.copy(O.matrixWorld).invert();const X=N+B,ae=V+B,re=w-k,le=P+(Me-k),te=Y*V/ae*X,be=fe*V/ae*X;O.projectionMatrix.makePerspective(re,le,te,be,X,ae),O.projectionMatrixInverse.copy(O.projectionMatrix).invert()}function J(O,$){$===null?O.matrixWorld.copy(O.matrix):O.matrixWorld.multiplyMatrices($.matrixWorld,O.matrix),O.matrixWorldInverse.copy(O.matrixWorld).invert()}this.updateCamera=function(O){if(r===null)return;C.near=R.near=y.near=O.near,C.far=R.far=y.far=O.far,(G!==C.near||S!==C.far)&&(r.updateRenderState({depthNear:C.near,depthFar:C.far}),G=C.near,S=C.far);const $=O.parent,xe=C.cameras;J(C,$);for(let Me=0;Me<xe.length;Me++)J(xe[Me],$);xe.length===2?K(C,y,R):C.projectionMatrix.copy(y.projectionMatrix),z(O,C,$)};function z(O,$,xe){xe===null?O.matrix.copy($.matrixWorld):(O.matrix.copy(xe.matrixWorld),O.matrix.invert(),O.matrix.multiply($.matrixWorld)),O.matrix.decompose(O.position,O.quaternion,O.scale),O.updateMatrixWorld(!0),O.projectionMatrix.copy($.projectionMatrix),O.projectionMatrixInverse.copy($.projectionMatrixInverse),O.isPerspectiveCamera&&(O.fov=hs*2*Math.atan(1/O.projectionMatrix.elements[5]),O.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(O){l=O,h!==null&&(h.fixedFoveation=O),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=O)};let oe=null;function he(O,$){if(u=$.getViewerPose(c||a),v=$,u!==null){const xe=u.views;p!==null&&(e.setRenderTargetFramebuffer(d,p.framebuffer),e.setRenderTarget(d));let Me=!1;xe.length!==C.cameras.length&&(C.cameras.length=0,Me=!0);for(let Ee=0;Ee<xe.length;Ee++){const we=xe[Ee];let N=null;if(p!==null)N=p.getViewport(we);else{const Y=f.getViewSubImage(h,we);N=Y.viewport,Ee===0&&(e.setRenderTargetTextures(d,Y.colorTexture,h.ignoreDepthValues?void 0:Y.depthStencilTexture),e.setRenderTarget(d))}let V=L[Ee];V===void 0&&(V=new fn,V.layers.enable(Ee),V.viewport=new bt,L[Ee]=V),V.matrix.fromArray(we.transform.matrix),V.matrix.decompose(V.position,V.quaternion,V.scale),V.projectionMatrix.fromArray(we.projectionMatrix),V.projectionMatrixInverse.copy(V.projectionMatrix).invert(),V.viewport.set(N.x,N.y,N.width,N.height),Ee===0&&(C.matrix.copy(V.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),Me===!0&&C.cameras.push(V)}}for(let xe=0;xe<T.length;xe++){const Me=M[xe],Ee=T[xe];Me!==null&&Ee!==void 0&&Ee.update(Me,$,c||a)}oe&&oe(O,$),$.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:$}),v=null}const ue=new Dd;ue.setAnimationLoop(he),this.setAnimationLoop=function(O){oe=O},this.dispose=function(){}}}function Ey(t,e){function n(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Cd(t)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,T,M,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),f(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),h(m,d),d.isMeshPhysicalMaterial&&p(m,d,y)):d.isMeshMatcapMaterial?(s(m,d),v(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),_(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,T,M):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,n(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,n(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,n(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Yt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,n(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Yt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,n(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,n(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,n(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const T=e.get(d).envMap;if(T&&(m.envMap.value=T,m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap){m.lightMap.value=d.lightMap;const M=t._useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=d.lightMapIntensity*M,n(d.lightMap,m.lightMapTransform)}d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,n(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,n(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,T,M){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*T,m.scale.value=M*.5,d.map&&(m.map.value=d.map,n(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,n(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,n(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,n(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function f(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function h(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,n(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,n(d.roughnessMap,m.roughnessMapTransform)),e.get(d).envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,T){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,n(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,n(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,n(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,n(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,n(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Yt&&m.clearcoatNormalScale.value.negate())),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,n(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,n(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,n(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,n(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,n(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,n(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,n(d.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,d){d.matcap&&(m.matcap.value=d.matcap)}function _(m,d){const T=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function yy(t,e,n,i){let r={},s={},a=[];const o=n.isWebGL2?t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(T,M){const y=M.program;i.uniformBlockBinding(T,y)}function c(T,M){let y=r[T.id];y===void 0&&(v(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",m));const R=M.program;i.updateUBOMapping(T,R);const L=e.render.frame;s[T.id]!==L&&(h(T),s[T.id]=L)}function u(T){const M=f();T.__bindingPointIndex=M;const y=t.createBuffer(),R=T.__size,L=T.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,R,L),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,M,y),y}function f(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(T){const M=r[T.id],y=T.uniforms,R=T.__cache;t.bindBuffer(t.UNIFORM_BUFFER,M);for(let L=0,C=y.length;L<C;L++){const G=y[L];if(p(G,L,R)===!0){const S=G.__offset,A=Array.isArray(G.value)?G.value:[G.value];let q=0;for(let F=0;F<A.length;F++){const ee=A[F],D=_(ee);typeof ee=="number"?(G.__data[0]=ee,t.bufferSubData(t.UNIFORM_BUFFER,S+q,G.__data)):ee.isMatrix3?(G.__data[0]=ee.elements[0],G.__data[1]=ee.elements[1],G.__data[2]=ee.elements[2],G.__data[3]=ee.elements[0],G.__data[4]=ee.elements[3],G.__data[5]=ee.elements[4],G.__data[6]=ee.elements[5],G.__data[7]=ee.elements[0],G.__data[8]=ee.elements[6],G.__data[9]=ee.elements[7],G.__data[10]=ee.elements[8],G.__data[11]=ee.elements[0]):(ee.toArray(G.__data,q),q+=D.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,S,G.__data)}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(T,M,y){const R=T.value;if(y[M]===void 0){if(typeof R=="number")y[M]=R;else{const L=Array.isArray(R)?R:[R],C=[];for(let G=0;G<L.length;G++)C.push(L[G].clone());y[M]=C}return!0}else if(typeof R=="number"){if(y[M]!==R)return y[M]=R,!0}else{const L=Array.isArray(y[M])?y[M]:[y[M]],C=Array.isArray(R)?R:[R];for(let G=0;G<L.length;G++){const S=L[G];if(S.equals(C[G])===!1)return S.copy(C[G]),!0}}return!1}function v(T){const M=T.uniforms;let y=0;const R=16;let L=0;for(let C=0,G=M.length;C<G;C++){const S=M[C],A={boundary:0,storage:0},q=Array.isArray(S.value)?S.value:[S.value];for(let F=0,ee=q.length;F<ee;F++){const D=q[F],K=_(D);A.boundary+=K.boundary,A.storage+=K.storage}if(S.__data=new Float32Array(A.storage/Float32Array.BYTES_PER_ELEMENT),S.__offset=y,C>0){L=y%R;const F=R-L;L!==0&&F-A.boundary<0&&(y+=R-L,S.__offset=y)}y+=A.storage}return L=y%R,L>0&&(y+=R-L),T.__size=y,T.__cache={},this}function _(T){const M={boundary:0,storage:0};return typeof T=="number"?(M.boundary=4,M.storage=4):T.isVector2?(M.boundary=8,M.storage=8):T.isVector3||T.isColor?(M.boundary=16,M.storage=12):T.isVector4?(M.boundary=16,M.storage=16):T.isMatrix3?(M.boundary=48,M.storage=48):T.isMatrix4?(M.boundary=64,M.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),M}function m(T){const M=T.target;M.removeEventListener("dispose",m);const y=a.indexOf(M.__bindingPointIndex);a.splice(y,1),t.deleteBuffer(r[M.id]),delete r[M.id],delete s[M.id]}function d(){for(const T in r)t.deleteBuffer(r[T]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}class Bd{constructor(e={}){const{canvas:n=S0(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let h;i!==null?h=i.getContextAttributes().alpha:h=a;const p=new Uint32Array(4),v=new Int32Array(4);let _=null,m=null;const d=[],T=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=At,this._useLegacyLights=!1,this.toneMapping=vi,this.toneMappingExposure=1;const M=this;let y=!1,R=0,L=0,C=null,G=-1,S=null;const A=new bt,q=new bt;let F=null;const ee=new Ze(0);let D=0,K=n.width,J=n.height,z=1,oe=null,he=null;const ue=new bt(0,0,K,J),O=new bt(0,0,K,J);let $=!1;const xe=new Wl;let Me=!1,Ee=!1,we=null;const N=new dt,V=new Je,Y=new W,fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function me(){return C===null?z:1}let g=i;function w(b,H){for(let j=0;j<b.length;j++){const Z=b[j],Q=n.getContext(Z,H);if(Q!==null)return Q}return null}try{const b={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Bl}`),n.addEventListener("webglcontextlost",Ye,!1),n.addEventListener("webglcontextrestored",U,!1),n.addEventListener("webglcontextcreationerror",Te,!1),g===null){const H=["webgl2","webgl","experimental-webgl"];if(M.isWebGL1Renderer===!0&&H.shift(),g=w(H,b),g===null)throw w(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&g instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),g.getShaderPrecisionFormat===void 0&&(g.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let P,B,k,X,ae,re,le,te,be,E,x,I,ne,ie,ce,ye,de,ve,Ce,Xe,pe,He,Le,Ie;function De(){P=new UM(g),B=new RM(g,P,e),P.init(B),He=new _y(g,P,B),k=new my(g,P,B),X=new OM(g),ae=new ty,re=new gy(g,P,k,ae,B,He,X),le=new CM(M),te=new DM(M),be=new q0(g,B),Le=new bM(g,P,be,B),E=new IM(g,be,X,Le),x=new zM(g,E,be,X),Ce=new HM(g,B,re),ye=new wM(ae),I=new ey(M,le,te,P,B,Le,ye),ne=new Ey(M,ae),ie=new iy,ce=new cy(P,B),ve=new TM(M,le,te,k,x,h,l),de=new py(M,x,B),Ie=new yy(g,X,B,k),Xe=new AM(g,P,X,B),pe=new NM(g,P,X,B),X.programs=I.programs,M.capabilities=B,M.extensions=P,M.properties=ae,M.renderLists=ie,M.shadowMap=de,M.state=k,M.info=X}De();const Re=new My(M,g);this.xr=Re,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const b=P.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=P.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(b){b!==void 0&&(z=b,this.setSize(K,J,!1))},this.getSize=function(b){return b.set(K,J)},this.setSize=function(b,H,j=!0){if(Re.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}K=b,J=H,n.width=Math.floor(b*z),n.height=Math.floor(H*z),j===!0&&(n.style.width=b+"px",n.style.height=H+"px"),this.setViewport(0,0,b,H)},this.getDrawingBufferSize=function(b){return b.set(K*z,J*z).floor()},this.setDrawingBufferSize=function(b,H,j){K=b,J=H,z=j,n.width=Math.floor(b*j),n.height=Math.floor(H*j),this.setViewport(0,0,b,H)},this.getCurrentViewport=function(b){return b.copy(A)},this.getViewport=function(b){return b.copy(ue)},this.setViewport=function(b,H,j,Z){b.isVector4?ue.set(b.x,b.y,b.z,b.w):ue.set(b,H,j,Z),k.viewport(A.copy(ue).multiplyScalar(z).floor())},this.getScissor=function(b){return b.copy(O)},this.setScissor=function(b,H,j,Z){b.isVector4?O.set(b.x,b.y,b.z,b.w):O.set(b,H,j,Z),k.scissor(q.copy(O).multiplyScalar(z).floor())},this.getScissorTest=function(){return $},this.setScissorTest=function(b){k.setScissorTest($=b)},this.setOpaqueSort=function(b){oe=b},this.setTransparentSort=function(b){he=b},this.getClearColor=function(b){return b.copy(ve.getClearColor())},this.setClearColor=function(){ve.setClearColor.apply(ve,arguments)},this.getClearAlpha=function(){return ve.getClearAlpha()},this.setClearAlpha=function(){ve.setClearAlpha.apply(ve,arguments)},this.clear=function(b=!0,H=!0,j=!0){let Z=0;if(b){let Q=!1;if(C!==null){const Ae=C.texture.format;Q=Ae===vd||Ae===_d||Ae===gd}if(Q){const Ae=C.texture.type,Pe=Ae===xi||Ae===mi||Ae===Hl||Ae===Vi||Ae===pd||Ae===md,Oe=ve.getClearColor(),Fe=ve.getClearAlpha(),ke=Oe.r,ze=Oe.g,Ge=Oe.b;Pe?(p[0]=ke,p[1]=ze,p[2]=Ge,p[3]=Fe,g.clearBufferuiv(g.COLOR,0,p)):(v[0]=ke,v[1]=ze,v[2]=Ge,v[3]=Fe,g.clearBufferiv(g.COLOR,0,v))}else Z|=g.COLOR_BUFFER_BIT}H&&(Z|=g.DEPTH_BUFFER_BIT),j&&(Z|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Ye,!1),n.removeEventListener("webglcontextrestored",U,!1),n.removeEventListener("webglcontextcreationerror",Te,!1),ie.dispose(),ce.dispose(),ae.dispose(),le.dispose(),te.dispose(),x.dispose(),Le.dispose(),Ie.dispose(),I.dispose(),Re.dispose(),Re.removeEventListener("sessionstart",an),Re.removeEventListener("sessionend",rt),we&&(we.dispose(),we=null),Ut.stop()};function Ye(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),y=!0}function U(){console.log("THREE.WebGLRenderer: Context Restored."),y=!1;const b=X.autoReset,H=de.enabled,j=de.autoUpdate,Z=de.needsUpdate,Q=de.type;De(),X.autoReset=b,de.enabled=H,de.autoUpdate=j,de.needsUpdate=Z,de.type=Q}function Te(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function ge(b){const H=b.target;H.removeEventListener("dispose",ge),se(H)}function se(b){_e(b),ae.remove(b)}function _e(b){const H=ae.get(b).programs;H!==void 0&&(H.forEach(function(j){I.releaseProgram(j)}),b.isShaderMaterial&&I.releaseShaderCache(b))}this.renderBufferDirect=function(b,H,j,Z,Q,Ae){H===null&&(H=fe);const Pe=Q.isMesh&&Q.matrixWorld.determinant()<0,Oe=Gd(b,H,j,Z,Q);k.setMaterial(Z,Pe);let Fe=j.index,ke=1;if(Z.wireframe===!0){if(Fe=E.getWireframeAttribute(j),Fe===void 0)return;ke=2}const ze=j.drawRange,Ge=j.attributes.position;let ht=ze.start*ke,jt=(ze.start+ze.count)*ke;Ae!==null&&(ht=Math.max(ht,Ae.start*ke),jt=Math.min(jt,(Ae.start+Ae.count)*ke)),Fe!==null?(ht=Math.max(ht,0),jt=Math.min(jt,Fe.count)):Ge!=null&&(ht=Math.max(ht,0),jt=Math.min(jt,Ge.count));const yt=jt-ht;if(yt<0||yt===1/0)return;Le.setup(Q,Z,Oe,j,Fe);let Fn,lt=Xe;if(Fe!==null&&(Fn=be.get(Fe),lt=pe,lt.setIndex(Fn)),Q.isMesh)Z.wireframe===!0?(k.setLineWidth(Z.wireframeLinewidth*me()),lt.setMode(g.LINES)):lt.setMode(g.TRIANGLES);else if(Q.isLine){let qe=Z.linewidth;qe===void 0&&(qe=1),k.setLineWidth(qe*me()),Q.isLineSegments?lt.setMode(g.LINES):Q.isLineLoop?lt.setMode(g.LINE_LOOP):lt.setMode(g.LINE_STRIP)}else Q.isPoints?lt.setMode(g.POINTS):Q.isSprite&&lt.setMode(g.TRIANGLES);if(Q.isInstancedMesh)lt.renderInstances(ht,yt,Q.count);else if(j.isInstancedBufferGeometry){const qe=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,Go=Math.min(j.instanceCount,qe);lt.renderInstances(ht,yt,Go)}else lt.render(ht,yt)};function Ne(b,H,j){b.transparent===!0&&b.side===Dn&&b.forceSinglePass===!1?(b.side=Yt,b.needsUpdate=!0,Es(b,H,j),b.side=Mi,b.needsUpdate=!0,Es(b,H,j),b.side=Dn):Es(b,H,j)}this.compile=function(b,H,j=null){j===null&&(j=b),m=ce.get(j),m.init(),T.push(m),j.traverseVisible(function(Q){Q.isLight&&Q.layers.test(H.layers)&&(m.pushLight(Q),Q.castShadow&&m.pushShadow(Q))}),b!==j&&b.traverseVisible(function(Q){Q.isLight&&Q.layers.test(H.layers)&&(m.pushLight(Q),Q.castShadow&&m.pushShadow(Q))}),m.setupLights(M._useLegacyLights);const Z=new Set;return b.traverse(function(Q){const Ae=Q.material;if(Ae)if(Array.isArray(Ae))for(let Pe=0;Pe<Ae.length;Pe++){const Oe=Ae[Pe];Ne(Oe,j,Q),Z.add(Oe)}else Ne(Ae,j,Q),Z.add(Ae)}),T.pop(),m=null,Z},this.compileAsync=function(b,H,j=null){const Z=this.compile(b,H,j);return new Promise(Q=>{function Ae(){if(Z.forEach(function(Pe){ae.get(Pe).currentProgram.isReady()&&Z.delete(Pe)}),Z.size===0){Q(b);return}setTimeout(Ae,10)}P.get("KHR_parallel_shader_compile")!==null?Ae():setTimeout(Ae,10)})};let Ke=null;function mt(b){Ke&&Ke(b)}function an(){Ut.stop()}function rt(){Ut.start()}const Ut=new Dd;Ut.setAnimationLoop(mt),typeof self<"u"&&Ut.setContext(self),this.setAnimationLoop=function(b){Ke=b,Re.setAnimationLoop(b),b===null?Ut.stop():Ut.start()},Re.addEventListener("sessionstart",an),Re.addEventListener("sessionend",rt),this.render=function(b,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),Re.enabled===!0&&Re.isPresenting===!0&&(Re.cameraAutoUpdate===!0&&Re.updateCamera(H),H=Re.getCamera()),b.isScene===!0&&b.onBeforeRender(M,b,H,C),m=ce.get(b,T.length),m.init(),T.push(m),N.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),xe.setFromProjectionMatrix(N),Ee=this.localClippingEnabled,Me=ye.init(this.clippingPlanes,Ee),_=ie.get(b,d.length),_.init(),d.push(_),Tn(b,H,0,M.sortObjects),_.finish(),M.sortObjects===!0&&_.sort(oe,he),this.info.render.frame++,Me===!0&&ye.beginShadows();const j=m.state.shadowsArray;if(de.render(j,b,H),Me===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset(),ve.render(_,b),m.setupLights(M._useLegacyLights),H.isArrayCamera){const Z=H.cameras;for(let Q=0,Ae=Z.length;Q<Ae;Q++){const Pe=Z[Q];Kl(_,b,Pe,Pe.viewport)}}else Kl(_,b,H);C!==null&&(re.updateMultisampleRenderTarget(C),re.updateRenderTargetMipmap(C)),b.isScene===!0&&b.onAfterRender(M,b,H),Le.resetDefaultState(),G=-1,S=null,T.pop(),T.length>0?m=T[T.length-1]:m=null,d.pop(),d.length>0?_=d[d.length-1]:_=null};function Tn(b,H,j,Z){if(b.visible===!1)return;if(b.layers.test(H.layers)){if(b.isGroup)j=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(H);else if(b.isLight)m.pushLight(b),b.castShadow&&m.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||xe.intersectsSprite(b)){Z&&Y.setFromMatrixPosition(b.matrixWorld).applyMatrix4(N);const Pe=x.update(b),Oe=b.material;Oe.visible&&_.push(b,Pe,Oe,j,Y.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||xe.intersectsObject(b))){const Pe=x.update(b),Oe=b.material;if(Z&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Y.copy(b.boundingSphere.center)):(Pe.boundingSphere===null&&Pe.computeBoundingSphere(),Y.copy(Pe.boundingSphere.center)),Y.applyMatrix4(b.matrixWorld).applyMatrix4(N)),Array.isArray(Oe)){const Fe=Pe.groups;for(let ke=0,ze=Fe.length;ke<ze;ke++){const Ge=Fe[ke],ht=Oe[Ge.materialIndex];ht&&ht.visible&&_.push(b,Pe,ht,j,Y.z,Ge)}}else Oe.visible&&_.push(b,Pe,Oe,j,Y.z,null)}}const Ae=b.children;for(let Pe=0,Oe=Ae.length;Pe<Oe;Pe++)Tn(Ae[Pe],H,j,Z)}function Kl(b,H,j,Z){const Q=b.opaque,Ae=b.transmissive,Pe=b.transparent;m.setupLightsView(j),Me===!0&&ye.setGlobalState(M.clippingPlanes,j),Ae.length>0&&zd(Q,Ae,H,j),Z&&k.viewport(A.copy(Z)),Q.length>0&&Ms(Q,H,j),Ae.length>0&&Ms(Ae,H,j),Pe.length>0&&Ms(Pe,H,j),k.buffers.depth.setTest(!0),k.buffers.depth.setMask(!0),k.buffers.color.setMask(!0),k.setPolygonOffset(!1)}function zd(b,H,j,Z){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;const Ae=B.isWebGL2;we===null&&(we=new Xi(1,1,{generateMipmaps:!0,type:P.has("EXT_color_buffer_half_float")?fs:xi,minFilter:us,samples:Ae?4:0})),M.getDrawingBufferSize(V),Ae?we.setSize(V.x,V.y):we.setSize(go(V.x),go(V.y));const Pe=M.getRenderTarget();M.setRenderTarget(we),M.getClearColor(ee),D=M.getClearAlpha(),D<1&&M.setClearColor(16777215,.5),M.clear();const Oe=M.toneMapping;M.toneMapping=vi,Ms(b,j,Z),re.updateMultisampleRenderTarget(we),re.updateRenderTargetMipmap(we);let Fe=!1;for(let ke=0,ze=H.length;ke<ze;ke++){const Ge=H[ke],ht=Ge.object,jt=Ge.geometry,yt=Ge.material,Fn=Ge.group;if(yt.side===Dn&&ht.layers.test(Z.layers)){const lt=yt.side;yt.side=Yt,yt.needsUpdate=!0,Zl(ht,j,Z,jt,yt,Fn),yt.side=lt,yt.needsUpdate=!0,Fe=!0}}Fe===!0&&(re.updateMultisampleRenderTarget(we),re.updateRenderTargetMipmap(we)),M.setRenderTarget(Pe),M.setClearColor(ee,D),M.toneMapping=Oe}function Ms(b,H,j){const Z=H.isScene===!0?H.overrideMaterial:null;for(let Q=0,Ae=b.length;Q<Ae;Q++){const Pe=b[Q],Oe=Pe.object,Fe=Pe.geometry,ke=Z===null?Pe.material:Z,ze=Pe.group;Oe.layers.test(j.layers)&&Zl(Oe,H,j,Fe,ke,ze)}}function Zl(b,H,j,Z,Q,Ae){b.onBeforeRender(M,H,j,Z,Q,Ae),b.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),Q.onBeforeRender(M,H,j,Z,b,Ae),Q.transparent===!0&&Q.side===Dn&&Q.forceSinglePass===!1?(Q.side=Yt,Q.needsUpdate=!0,M.renderBufferDirect(j,H,Z,Q,b,Ae),Q.side=Mi,Q.needsUpdate=!0,M.renderBufferDirect(j,H,Z,Q,b,Ae),Q.side=Dn):M.renderBufferDirect(j,H,Z,Q,b,Ae),b.onAfterRender(M,H,j,Z,Q,Ae)}function Es(b,H,j){H.isScene!==!0&&(H=fe);const Z=ae.get(b),Q=m.state.lights,Ae=m.state.shadowsArray,Pe=Q.state.version,Oe=I.getParameters(b,Q.state,Ae,H,j),Fe=I.getProgramCacheKey(Oe);let ke=Z.programs;Z.environment=b.isMeshStandardMaterial?H.environment:null,Z.fog=H.fog,Z.envMap=(b.isMeshStandardMaterial?te:le).get(b.envMap||Z.environment),ke===void 0&&(b.addEventListener("dispose",ge),ke=new Map,Z.programs=ke);let ze=ke.get(Fe);if(ze!==void 0){if(Z.currentProgram===ze&&Z.lightsStateVersion===Pe)return Ql(b,Oe),ze}else Oe.uniforms=I.getUniforms(b),b.onBuild(j,Oe,M),b.onBeforeCompile(Oe,M),ze=I.acquireProgram(Oe,Fe),ke.set(Fe,ze),Z.uniforms=Oe.uniforms;const Ge=Z.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Ge.clippingPlanes=ye.uniform),Ql(b,Oe),Z.needsLights=kd(b),Z.lightsStateVersion=Pe,Z.needsLights&&(Ge.ambientLightColor.value=Q.state.ambient,Ge.lightProbe.value=Q.state.probe,Ge.directionalLights.value=Q.state.directional,Ge.directionalLightShadows.value=Q.state.directionalShadow,Ge.spotLights.value=Q.state.spot,Ge.spotLightShadows.value=Q.state.spotShadow,Ge.rectAreaLights.value=Q.state.rectArea,Ge.ltc_1.value=Q.state.rectAreaLTC1,Ge.ltc_2.value=Q.state.rectAreaLTC2,Ge.pointLights.value=Q.state.point,Ge.pointLightShadows.value=Q.state.pointShadow,Ge.hemisphereLights.value=Q.state.hemi,Ge.directionalShadowMap.value=Q.state.directionalShadowMap,Ge.directionalShadowMatrix.value=Q.state.directionalShadowMatrix,Ge.spotShadowMap.value=Q.state.spotShadowMap,Ge.spotLightMatrix.value=Q.state.spotLightMatrix,Ge.spotLightMap.value=Q.state.spotLightMap,Ge.pointShadowMap.value=Q.state.pointShadowMap,Ge.pointShadowMatrix.value=Q.state.pointShadowMatrix),Z.currentProgram=ze,Z.uniformsList=null,ze}function Jl(b){if(b.uniformsList===null){const H=b.currentProgram.getUniforms();b.uniformsList=Qs.seqWithValue(H.seq,b.uniforms)}return b.uniformsList}function Ql(b,H){const j=ae.get(b);j.outputColorSpace=H.outputColorSpace,j.instancing=H.instancing,j.instancingColor=H.instancingColor,j.skinning=H.skinning,j.morphTargets=H.morphTargets,j.morphNormals=H.morphNormals,j.morphColors=H.morphColors,j.morphTargetsCount=H.morphTargetsCount,j.numClippingPlanes=H.numClippingPlanes,j.numIntersection=H.numClipIntersection,j.vertexAlphas=H.vertexAlphas,j.vertexTangents=H.vertexTangents,j.toneMapping=H.toneMapping}function Gd(b,H,j,Z,Q){H.isScene!==!0&&(H=fe),re.resetTextureUnits();const Ae=H.fog,Pe=Z.isMeshStandardMaterial?H.environment:null,Oe=C===null?M.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:ni,Fe=(Z.isMeshStandardMaterial?te:le).get(Z.envMap||Pe),ke=Z.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,ze=!!j.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),Ge=!!j.morphAttributes.position,ht=!!j.morphAttributes.normal,jt=!!j.morphAttributes.color;let yt=vi;Z.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(yt=M.toneMapping);const Fn=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,lt=Fn!==void 0?Fn.length:0,qe=ae.get(Z),Go=m.state.lights;if(Me===!0&&(Ee===!0||b!==S)){const Kt=b===S&&Z.id===G;ye.setState(Z,b,Kt)}let gt=!1;Z.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==Go.state.version||qe.outputColorSpace!==Oe||Q.isInstancedMesh&&qe.instancing===!1||!Q.isInstancedMesh&&qe.instancing===!0||Q.isSkinnedMesh&&qe.skinning===!1||!Q.isSkinnedMesh&&qe.skinning===!0||Q.isInstancedMesh&&qe.instancingColor===!0&&Q.instanceColor===null||Q.isInstancedMesh&&qe.instancingColor===!1&&Q.instanceColor!==null||qe.envMap!==Fe||Z.fog===!0&&qe.fog!==Ae||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==ye.numPlanes||qe.numIntersection!==ye.numIntersection)||qe.vertexAlphas!==ke||qe.vertexTangents!==ze||qe.morphTargets!==Ge||qe.morphNormals!==ht||qe.morphColors!==jt||qe.toneMapping!==yt||B.isWebGL2===!0&&qe.morphTargetsCount!==lt)&&(gt=!0):(gt=!0,qe.__version=Z.version);let yi=qe.currentProgram;gt===!0&&(yi=Es(Z,H,Q));let ec=!1,Ur=!1,Vo=!1;const It=yi.getUniforms(),Ti=qe.uniforms;if(k.useProgram(yi.program)&&(ec=!0,Ur=!0,Vo=!0),Z.id!==G&&(G=Z.id,Ur=!0),ec||S!==b){It.setValue(g,"projectionMatrix",b.projectionMatrix),It.setValue(g,"viewMatrix",b.matrixWorldInverse);const Kt=It.map.cameraPosition;Kt!==void 0&&Kt.setValue(g,Y.setFromMatrixPosition(b.matrixWorld)),B.logarithmicDepthBuffer&&It.setValue(g,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&It.setValue(g,"isOrthographic",b.isOrthographicCamera===!0),S!==b&&(S=b,Ur=!0,Vo=!0)}if(Q.isSkinnedMesh){It.setOptional(g,Q,"bindMatrix"),It.setOptional(g,Q,"bindMatrixInverse");const Kt=Q.skeleton;Kt&&(B.floatVertexTextures?(Kt.boneTexture===null&&Kt.computeBoneTexture(),It.setValue(g,"boneTexture",Kt.boneTexture,re),It.setValue(g,"boneTextureSize",Kt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const ko=j.morphAttributes;if((ko.position!==void 0||ko.normal!==void 0||ko.color!==void 0&&B.isWebGL2===!0)&&Ce.update(Q,j,yi),(Ur||qe.receiveShadow!==Q.receiveShadow)&&(qe.receiveShadow=Q.receiveShadow,It.setValue(g,"receiveShadow",Q.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(Ti.envMap.value=Fe,Ti.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),Ur&&(It.setValue(g,"toneMappingExposure",M.toneMappingExposure),qe.needsLights&&Vd(Ti,Vo),Ae&&Z.fog===!0&&ne.refreshFogUniforms(Ti,Ae),ne.refreshMaterialUniforms(Ti,Z,z,J,we),Qs.upload(g,Jl(qe),Ti,re)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(Qs.upload(g,Jl(qe),Ti,re),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&It.setValue(g,"center",Q.center),It.setValue(g,"modelViewMatrix",Q.modelViewMatrix),It.setValue(g,"normalMatrix",Q.normalMatrix),It.setValue(g,"modelMatrix",Q.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const Kt=Z.uniformsGroups;for(let Wo=0,Wd=Kt.length;Wo<Wd;Wo++)if(B.isWebGL2){const tc=Kt[Wo];Ie.update(tc,yi),Ie.bind(tc,yi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return yi}function Vd(b,H){b.ambientLightColor.needsUpdate=H,b.lightProbe.needsUpdate=H,b.directionalLights.needsUpdate=H,b.directionalLightShadows.needsUpdate=H,b.pointLights.needsUpdate=H,b.pointLightShadows.needsUpdate=H,b.spotLights.needsUpdate=H,b.spotLightShadows.needsUpdate=H,b.rectAreaLights.needsUpdate=H,b.hemisphereLights.needsUpdate=H}function kd(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(b,H,j){ae.get(b.texture).__webglTexture=H,ae.get(b.depthTexture).__webglTexture=j;const Z=ae.get(b);Z.__hasExternalTextures=!0,Z.__hasExternalTextures&&(Z.__autoAllocateDepthBuffer=j===void 0,Z.__autoAllocateDepthBuffer||P.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Z.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(b,H){const j=ae.get(b);j.__webglFramebuffer=H,j.__useDefaultFramebuffer=H===void 0},this.setRenderTarget=function(b,H=0,j=0){C=b,R=H,L=j;let Z=!0,Q=null,Ae=!1,Pe=!1;if(b){const Fe=ae.get(b);Fe.__useDefaultFramebuffer!==void 0?(k.bindFramebuffer(g.FRAMEBUFFER,null),Z=!1):Fe.__webglFramebuffer===void 0?re.setupRenderTarget(b):Fe.__hasExternalTextures&&re.rebindTextures(b,ae.get(b.texture).__webglTexture,ae.get(b.depthTexture).__webglTexture);const ke=b.texture;(ke.isData3DTexture||ke.isDataArrayTexture||ke.isCompressedArrayTexture)&&(Pe=!0);const ze=ae.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(ze[H])?Q=ze[H][j]:Q=ze[H],Ae=!0):B.isWebGL2&&b.samples>0&&re.useMultisampledRTT(b)===!1?Q=ae.get(b).__webglMultisampledFramebuffer:Array.isArray(ze)?Q=ze[j]:Q=ze,A.copy(b.viewport),q.copy(b.scissor),F=b.scissorTest}else A.copy(ue).multiplyScalar(z).floor(),q.copy(O).multiplyScalar(z).floor(),F=$;if(k.bindFramebuffer(g.FRAMEBUFFER,Q)&&B.drawBuffers&&Z&&k.drawBuffers(b,Q),k.viewport(A),k.scissor(q),k.setScissorTest(F),Ae){const Fe=ae.get(b.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+H,Fe.__webglTexture,j)}else if(Pe){const Fe=ae.get(b.texture),ke=H||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Fe.__webglTexture,j||0,ke)}G=-1},this.readRenderTargetPixels=function(b,H,j,Z,Q,Ae,Pe){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Oe=ae.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Pe!==void 0&&(Oe=Oe[Pe]),Oe){k.bindFramebuffer(g.FRAMEBUFFER,Oe);try{const Fe=b.texture,ke=Fe.format,ze=Fe.type;if(ke!==xn&&He.convert(ke)!==g.getParameter(g.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ge=ze===fs&&(P.has("EXT_color_buffer_half_float")||B.isWebGL2&&P.has("EXT_color_buffer_float"));if(ze!==xi&&He.convert(ze)!==g.getParameter(g.IMPLEMENTATION_COLOR_READ_TYPE)&&!(ze===gi&&(B.isWebGL2||P.has("OES_texture_float")||P.has("WEBGL_color_buffer_float")))&&!Ge){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=b.width-Z&&j>=0&&j<=b.height-Q&&g.readPixels(H,j,Z,Q,He.convert(ke),He.convert(ze),Ae)}finally{const Fe=C!==null?ae.get(C).__webglFramebuffer:null;k.bindFramebuffer(g.FRAMEBUFFER,Fe)}}},this.copyFramebufferToTexture=function(b,H,j=0){const Z=Math.pow(2,-j),Q=Math.floor(H.image.width*Z),Ae=Math.floor(H.image.height*Z);re.setTexture2D(H,0),g.copyTexSubImage2D(g.TEXTURE_2D,j,0,0,b.x,b.y,Q,Ae),k.unbindTexture()},this.copyTextureToTexture=function(b,H,j,Z=0){const Q=H.image.width,Ae=H.image.height,Pe=He.convert(j.format),Oe=He.convert(j.type);re.setTexture2D(j,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,j.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,j.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,j.unpackAlignment),H.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,Z,b.x,b.y,Q,Ae,Pe,Oe,H.image.data):H.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,Z,b.x,b.y,H.mipmaps[0].width,H.mipmaps[0].height,Pe,H.mipmaps[0].data):g.texSubImage2D(g.TEXTURE_2D,Z,b.x,b.y,Pe,Oe,H.image),Z===0&&j.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),k.unbindTexture()},this.copyTextureToTexture3D=function(b,H,j,Z,Q=0){if(M.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Ae=b.max.x-b.min.x+1,Pe=b.max.y-b.min.y+1,Oe=b.max.z-b.min.z+1,Fe=He.convert(Z.format),ke=He.convert(Z.type);let ze;if(Z.isData3DTexture)re.setTexture3D(Z,0),ze=g.TEXTURE_3D;else if(Z.isDataArrayTexture)re.setTexture2DArray(Z,0),ze=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,Z.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,Z.unpackAlignment);const Ge=g.getParameter(g.UNPACK_ROW_LENGTH),ht=g.getParameter(g.UNPACK_IMAGE_HEIGHT),jt=g.getParameter(g.UNPACK_SKIP_PIXELS),yt=g.getParameter(g.UNPACK_SKIP_ROWS),Fn=g.getParameter(g.UNPACK_SKIP_IMAGES),lt=j.isCompressedTexture?j.mipmaps[0]:j.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,lt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,lt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,b.min.x),g.pixelStorei(g.UNPACK_SKIP_ROWS,b.min.y),g.pixelStorei(g.UNPACK_SKIP_IMAGES,b.min.z),j.isDataTexture||j.isData3DTexture?g.texSubImage3D(ze,Q,H.x,H.y,H.z,Ae,Pe,Oe,Fe,ke,lt.data):j.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),g.compressedTexSubImage3D(ze,Q,H.x,H.y,H.z,Ae,Pe,Oe,Fe,lt.data)):g.texSubImage3D(ze,Q,H.x,H.y,H.z,Ae,Pe,Oe,Fe,ke,lt),g.pixelStorei(g.UNPACK_ROW_LENGTH,Ge),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,ht),g.pixelStorei(g.UNPACK_SKIP_PIXELS,jt),g.pixelStorei(g.UNPACK_SKIP_ROWS,yt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Fn),Q===0&&Z.generateMipmaps&&g.generateMipmap(ze),k.unbindTexture()},this.initTexture=function(b){b.isCubeTexture?re.setTextureCube(b,0):b.isData3DTexture?re.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?re.setTexture2DArray(b,0):re.setTexture2D(b,0),k.unbindTexture()},this.resetState=function(){R=0,L=0,C=null,k.reset(),Le.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Zn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===zl?"display-p3":"srgb",n.unpackColorSpace=nt.workingColorSpace===Bo?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===At?Wi:xd}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Wi?At:ni}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class Ty extends Bd{}Ty.prototype.isWebGL1Renderer=!0;class by extends Dt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n}}class $l extends ri{constructor(e=.5,n=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:n,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],u=[];let f=e;const h=(n-e)/r,p=new W,v=new Je;for(let _=0;_<=r;_++){for(let m=0;m<=i;m++){const d=s+m/i*a;p.x=f*Math.cos(d),p.y=f*Math.sin(d),l.push(p.x,p.y,p.z),c.push(0,0,1),v.x=(p.x/n+1)/2,v.y=(p.y/n+1)/2,u.push(v.x,v.y)}f+=h}for(let _=0;_<r;_++){const m=_*(i+1);for(let d=0;d<i;d++){const T=d+m,M=T,y=T+i+1,R=T+i+2,L=T+1;o.push(M,y,L),o.push(y,R,L)}}this.setIndex(o),this.setAttribute("position",new on(l,3)),this.setAttribute("normal",new on(c,3)),this.setAttribute("uv",new on(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new $l(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}class Yl extends ri{constructor(e=1,n=32,i=16,r=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:i,phiStart:r,phiLength:s,thetaStart:a,thetaLength:o},n=Math.max(3,Math.floor(n)),i=Math.max(2,Math.floor(i));const l=Math.min(a+o,Math.PI);let c=0;const u=[],f=new W,h=new W,p=[],v=[],_=[],m=[];for(let d=0;d<=i;d++){const T=[],M=d/i;let y=0;d===0&&a===0?y=.5/n:d===i&&l===Math.PI&&(y=-.5/n);for(let R=0;R<=n;R++){const L=R/n;f.x=-e*Math.cos(r+L*s)*Math.sin(a+M*o),f.y=e*Math.cos(a+M*o),f.z=e*Math.sin(r+L*s)*Math.sin(a+M*o),v.push(f.x,f.y,f.z),h.copy(f).normalize(),_.push(h.x,h.y,h.z),m.push(L+y,1-M),T.push(c++)}u.push(T)}for(let d=0;d<i;d++)for(let T=0;T<n;T++){const M=u[d][T+1],y=u[d][T],R=u[d+1][T],L=u[d+1][T+1];(d!==0||a>0)&&p.push(M,y,L),(d!==i-1||l<Math.PI)&&p.push(y,R,L)}this.setIndex(p),this.setAttribute("position",new on(v,3)),this.setAttribute("normal",new on(_,3)),this.setAttribute("uv",new on(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Yl(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Ay extends xs{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ze(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ze(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Sd,this.normalScale=new Je(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Hd extends Dt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ze(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),n}}const Ha=new dt,Rf=new W,wf=new W;class Ry{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Je(512,512),this.map=null,this.mapPass=null,this.matrix=new dt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Wl,this._frameExtents=new Je(1,1),this._viewportCount=1,this._viewports=[new bt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;Rf.setFromMatrixPosition(e.matrixWorld),n.position.copy(Rf),wf.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(wf),n.updateMatrixWorld(),Ha.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Ha),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Ha)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class wy extends Ry{constructor(){super(new Ud(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Cy extends Hd{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Dt.DEFAULT_UP),this.updateMatrix(),this.target=new Dt,this.shadow=new wy}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Py extends Hd{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Bl}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Bl);const Ly={class:"ar-page"},Dy={key:0,class:"overlay centered"},Uy={key:1,class:"overlay centered error-box"},Iy={key:2,class:"overlay centered start-box"},Ny={key:0,class:"points-panel"},Oy={class:"panel-header"},Fy={class:"point-list"},By={class:"coords"},Hy=["onClick"],zy={key:0,class:"empty"},Gy={key:0,class:"reticle-hint"},Vy=.0025,ky=gs({__name:"ARView",setup(t){const e=Jh(),n=Nl(),i=Fl(),r=cd(),s=xt(()=>e.params.id),a=xt(()=>i.getRoomById(s.value)),o=xt(()=>r.getPoints(s.value)),l=Qt(null),c=Qt(null),u=Qt(""),f=Qt(!1),h=Qt(!1),p=Qt("bon"),v=Qt(0),_=xt(()=>`quality-${p.value}`);let m=null,d=null,T=null,M=null,y=null,R=!1,L=null,C=null,G=!1;const S=new Map,A=new Map,q=new Map,F=ma.degToRad(.7);Co(async()=>{if(!a.value){n.replace("/");return}if(!navigator.xr){c.value=!1,u.value="WebXR n'est pas disponible sur ce navigateur.";return}try{c.value=await navigator.xr.isSessionSupported("immersive-ar"),c.value||(u.value="La RA immersive n'est pas supportée sur cet appareil.")}catch{c.value=!1,u.value="Impossible de vérifier le support WebXR."}}),Rl(()=>{we()});async function ee(){if(navigator.xr){try{M=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["anchors","dom-overlay"]})}catch(N){u.value=`Impossible de démarrer la session AR : ${N.message}`;return}M.addEventListener("end",Me),M.addEventListener("select",J),D(),m.xr.setReferenceSpaceType("local"),await m.xr.setSession(M),h.value=!0,m.setAnimationLoop(K)}}function D(){d=new by,T=new fn(70,window.innerWidth/window.innerHeight,.01,20),m=new Bd({canvas:l.value,antialias:!0,alpha:!0}),m.setPixelRatio(window.devicePixelRatio),m.setSize(window.innerWidth,window.innerHeight),m.xr.enabled=!0,d.add(new Py(16777215,1.5));const N=new Cy(16777215,1);N.position.set(1,2,1),d.add(N);const V=new $l(.04,.06,32);V.applyMatrix4(new dt().makeRotationX(-Math.PI/2));const Y=new kl({color:16777215,side:Dn});C=new Un(V,Y),C.matrixAutoUpdate=!1,C.visible=!1,d.add(C);for(const fe of o.value)O(fe);l.value.addEventListener("pointerdown",z)}function K(N,V){if(!M||!m||!d||!T)return;L=V;const Y=m.xr.getReferenceSpace();if(Y){if(R||(R=!0,M.requestReferenceSpace("viewer").then(fe=>{var w;const me=M;if(!me)return;const g=(w=me.requestHitTestSource)==null?void 0:w.call(me,{space:fe});g&&g.then(P=>{y=P})}).catch(()=>{})),y&&C){const fe=V.getHitTestResults(y);if(fe.length>0){const g=fe[0].getPose(Y);g&&(G=!0,C.visible=!0,C.matrix.fromArray(g.transform.matrix))}else G=!1,C.visible=!1}ue(V,Y),m.render(d,T)}}function J(N){oe(N.frame)}function z(){oe(L)}async function oe(N){if(!G||!C||!d)return;const V=new W,Y=new qi,fe=new W;C.matrix.decompose(V,Y,fe);const me=r.addPoint(s.value,{position:{x:V.x,y:V.y,z:V.z},quaternion:{x:Y.x,y:Y.y,z:Y.z,w:Y.w}});O(me),N&&await he(me.id,N)}async function he(N,V){if(!y)return;const Y=V.getHitTestResults(y);if(Y.length===0)return;const fe=Y[0];if(fe.createAnchor)try{const me=await fe.createAnchor();A.set(N,me)}catch{}}function ue(N,V){if(A.size===0){p.value="faible",v.value=0;return}const Y=new W,fe=new qi,me=new W;let g=0,w=0;for(const[B,k]of A){const X=S.get(B);if(!X)continue;const ae=N.getPose(k.anchorSpace,V);if(!ae){X.visible=!1;continue}g+=1,X.visible=!0,new dt().fromArray(ae.transform.matrix).decompose(Y,fe,me);const le=q.get(B);if(!le){X.position.copy(Y),X.quaternion.copy(fe),q.set(B,{position:Y.clone(),quaternion:fe.clone()});continue}const te=Y.distanceTo(le.position),be=fe.angleTo(le.quaternion);if(w+=te,te<Vy&&be<F)continue;const E=ma.clamp(.18+te*10,.14,.62),x=ma.clamp(E+.08,.2,.75);X.position.lerp(Y,E),X.quaternion.slerp(fe,x),le.position.copy(Y),le.quaternion.copy(fe)}if(g===0){p.value="faible",v.value=0;return}const P=w/g;v.value=P*1e3,P<.004?p.value="excellent":P<.012?p.value="bon":p.value="faible"}function O(N){if(!d)return;const V=new Yl(.03,16,16),Y=new Ay({color:16729156}),fe=new Un(V,Y);fe.position.set(N.pose.position.x,N.pose.position.y,N.pose.position.z),d.add(fe),S.set(N.id,fe)}function $(N){r.removePoint(s.value,N);const V=S.get(N);V&&d&&(d.remove(V),V.geometry.dispose(),V.material.dispose()),S.delete(N);const Y=A.get(N);Y&&(Y.delete(),A.delete(N)),q.delete(N)}function xe(){for(const[N,V]of S)d&&d.remove(V),V.geometry.dispose(),V.material.dispose(),S.delete(N);for(const[N,V]of A)V.delete(),A.delete(N);q.clear(),r.clearPoints(s.value)}function Me(){we(),n.push(`/rooms/${s.value}`)}async function Ee(){M?await M.end():(we(),n.push(`/rooms/${s.value}`))}function we(){var N;h.value=!1,M==null||M.removeEventListener("select",J),(N=l.value)==null||N.removeEventListener("pointerdown",z),m==null||m.setAnimationLoop(null);for(const V of S.values())V.geometry.dispose(),V.material.dispose();S.clear();for(const V of A.values())V.delete();A.clear(),q.clear(),C&&(C.geometry.dispose(),C.material.dispose(),C=null),m==null||m.dispose(),m=null,d=null,T=null,y=null,R=!1,L=null,G=!1,p.value="bon",v.value=0,M=null}return(N,V)=>{var Y;return at(),ut("div",Ly,[$e("canvas",{ref_key:"canvasRef",ref:l,class:"ar-canvas"},null,512),c.value===null?(at(),ut("div",Dy,[...V[3]||(V[3]=[$e("p",null,"Vérification du support WebXR…",-1)])])):c.value===!1?(at(),ut("div",Uy,[$e("p",null,Ht(u.value),1),$e("button",{onClick:V[0]||(V[0]=fe=>rn(n).push(`/rooms/${s.value}`))},"Retour")])):h.value?(at(),ut(qt,{key:3},[$e("div",{class:yo(["tracking-chip",_.value])}," Suivi "+Ht(p.value)+" · ~"+Ht(v.value.toFixed(1))+" mm ",3),$e("button",{class:"hud-btn ar-back-btn",onClick:Ee},"← Retour"),$e("button",{class:"hud-btn exit-btn",onClick:Ee},"✕ Quitter"),$e("button",{class:"hud-btn list-btn",onClick:V[2]||(V[2]=fe=>f.value=!f.value)}," ☰ Points ("+Ht(o.value.length)+") ",1),$t(Zm,{name:"slide"},{default:ch(()=>[f.value?(at(),ut("div",Ny,[$e("div",Oy,[V[5]||(V[5]=$e("span",null,"Points placés",-1)),o.value.length>0?(at(),ut("button",{key:0,class:"danger-btn",onClick:xe}," Tout supprimer ")):gr("",!0)]),$e("ul",Fy,[(at(!0),ut(qt,null,wl(o.value,fe=>(at(),ut("li",{key:fe.id,class:"point-item"},[$e("span",By," ("+Ht(fe.pose.position.x.toFixed(2))+", "+Ht(fe.pose.position.y.toFixed(2))+", "+Ht(fe.pose.position.z.toFixed(2))+") ",1),$e("button",{class:"danger-btn small",onClick:me=>$(fe.id)},"✕",8,Hy)]))),128)),o.value.length===0?(at(),ut("li",zy,"Tapez l'écran pour placer un point.")):gr("",!0)])])):gr("",!0)]),_:1}),rn(G)?gr("",!0):(at(),ut("div",Gy," Pointez vers une surface détectée… "))],64)):(at(),ut("div",Iy,[$e("h2",null,Ht((Y=a.value)==null?void 0:Y.name),1),V[4]||(V[4]=$e("p",null,"Pointez la caméra vers une surface plane.",-1)),$e("button",{class:"ar-start-btn",onClick:ee},"Lancer la RA"),$e("button",{class:"back-btn",onClick:V[1]||(V[1]=fe=>rn(n).push(`/rooms/${s.value}`))},"Annuler")]))])}}}),Wy=Oo(ky,[["__scopeId","data-v-334ea582"]]),Xy=H_({history:__(),routes:[{path:"/",component:Y_},{path:"/rooms/:id",component:sv},{path:"/rooms/:id/ar",component:Wy}]}),qy={};function $y(t,e){const n=nm("RouterView");return at(),Hh(n)}const Yy=Oo(qy,[["render",$y]]),jl=Tg(Yy);jl.use(Rg());jl.use(Xy);jl.mount("#app");
